...
public abstract class AbstractCursor implements CrossProcessCursor, Cursor {
    ...
    public int getColumnIndexOrThrow(String str) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("column '", str, "' does not exist"));
    }
    ...
    @Override // android.database.CrossProcessCursor
    /* renamed from: getWindow  reason: collision with other method in class */
    public CursorWindow mo12419getWindow() {
        return null;
    }
    ...
    public boolean update(int i, Object obj) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("null rowid. mRowIdColumnIndex = ");
        outline107.append(this.mRowIdColumnIndex);

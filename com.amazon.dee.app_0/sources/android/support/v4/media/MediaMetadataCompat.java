...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<MediaMetadataCompat>() { // from class: android.support.v4.media.MediaMetadataCompat.1
            ...
            public MediaMetadataCompat mo57createFromParcel(Parcel parcel) {
            ...
            public MediaMetadataCompat[] mo58newArray(int i) {
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            if (MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(str) && MediaMetadataCompat.METADATA_KEYS_TYPE.get(str).intValue() != 2) {
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("The ", str, " key cannot be used to put a Bitmap"));
            }
        ...
        public Builder putLong(String str, long j) {
            if (MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(str) && MediaMetadataCompat.METADATA_KEYS_TYPE.get(str).intValue() != 0) {
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("The ", str, " key cannot be used to put a long"));
            }
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            if (MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(str) && MediaMetadataCompat.METADATA_KEYS_TYPE.get(str).intValue() != 3) {
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("The ", str, " key cannot be used to put a Rating"));
            }
            int i = Build.VERSION.SDK_INT;
        ...
        public Builder putString(String str, String str2) {
            if (MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(str) && MediaMetadataCompat.METADATA_KEYS_TYPE.get(str).intValue() != 1) {
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("The ", str, " key cannot be used to put a String"));
            }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            if (MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(str) && MediaMetadataCompat.METADATA_KEYS_TYPE.get(str).intValue() != 1) {
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("The ", str, " key cannot be used to put a CharSequence"));
            }

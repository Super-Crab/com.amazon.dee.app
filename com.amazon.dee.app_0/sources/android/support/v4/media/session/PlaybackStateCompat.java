...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Parcelable.Creator<PlaybackStateCompat> CREATOR = new Parcelable.Creator<PlaybackStateCompat>() { // from class: android.support.v4.media.session.PlaybackStateCompat.1
        ...
        public PlaybackStateCompat mo69createFromParcel(Parcel parcel) {
        ...
        public PlaybackStateCompat[] mo70newArray(int i) {
    ...
    public String toString() {
        StringBuilder outline112 = GeneratedOutlineSupport1.outline112("PlaybackState {", "state=");
        outline112.append(this.mState);
        outline112.append(", position=");
        outline112.append(this.mPosition);
        outline112.append(", buffered position=");
        outline112.append(this.mBufferedPosition);
        outline112.append(", speed=");
        outline112.append(this.mSpeed);
        outline112.append(", updated=");
        outline112.append(this.mUpdateTime);
        outline112.append(", actions=");
        outline112.append(this.mActions);
        outline112.append(", error code=");
        outline112.append(this.mErrorCode);
        outline112.append(", error message=");
        outline112.append(this.mErrorMessage);
        outline112.append(", custom actions=");
        outline112.append(this.mCustomActions);
        outline112.append(", active item id=");
        return GeneratedOutlineSupport1.outline87(outline112, this.mActiveItemId, EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE);
    }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Parcelable.Creator<CustomAction> CREATOR = new Parcelable.Creator<CustomAction>() { // from class: android.support.v4.media.session.PlaybackStateCompat.CustomAction.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public CustomAction mo71createFromParcel(Parcel parcel) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public CustomAction[] mo72newArray(int i) {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Action:mName='");
            outline107.append((Object) this.mName);
            outline107.append(", mIcon=");
            outline107.append(this.mIcon);
            outline107.append(", mExtras=");
            outline107.append(this.mExtras);

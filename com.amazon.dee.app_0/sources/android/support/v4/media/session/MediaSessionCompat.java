...
public class MediaSessionCompat {
                    ...
                    switch (message.what) {
                        ...
                        case 28:
                            if (MediaSessionImplBase.this.mQueue != null) {
                                int i = message.arg1;
                                QueueItem queueItem = (i < 0 || i >= MediaSessionImplBase.this.mQueue.size()) ? null : MediaSessionImplBase.this.mQueue.get(message.arg1);
                                if (queueItem != null) {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Parcelable.Creator<QueueItem> CREATOR = new Parcelable.Creator<QueueItem>() { // from class: android.support.v4.media.session.MediaSessionCompat.QueueItem.1
            ...
            public QueueItem mo61createFromParcel(Parcel parcel) {
            ...
            public QueueItem[] mo62newArray(int i) {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("MediaSession.QueueItem {Description=");
            outline107.append(this.mDescription);
            outline107.append(", Id=");
            return GeneratedOutlineSupport1.outline87(outline107, this.mId, " }");
        }
    ...
    public static final class Token implements Parcelable {
        public static final Parcelable.Creator<Token> CREATOR = new Parcelable.Creator<Token>() { // from class: android.support.v4.media.session.MediaSessionCompat.Token.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public Token mo65createFromParcel(Parcel parcel) {
                int i = Build.VERSION.SDK_INT;
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public Token[] mo66newArray(int i) {
                return new Token[i];
            }
        };
    ...
    public static final class ResultReceiverWrapper implements Parcelable {
        public static final Parcelable.Creator<ResultReceiverWrapper> CREATOR = new Parcelable.Creator<ResultReceiverWrapper>() { // from class: android.support.v4.media.session.MediaSessionCompat.ResultReceiverWrapper.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public ResultReceiverWrapper mo63createFromParcel(Parcel parcel) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public ResultReceiverWrapper[] mo64newArray(int i) {

...
public final class MediaControllerCompat {
    ...
    static class TransportControlsApi21 extends TransportControls {
        ...
        public void setCaptioningEnabled(boolean z) {
            sendCustomAction(MediaSessionCompat.ACTION_SET_CAPTIONING_ENABLED, GeneratedOutlineSupport1.outline13(MediaSessionCompat.ACTION_ARGUMENT_CAPTIONING_ENABLED, z));
        }
    ...
    static void validateCustomAction(String str, Bundle bundle) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
    }

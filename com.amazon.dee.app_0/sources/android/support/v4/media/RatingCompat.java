...
public final class RatingCompat implements Parcelable {
    public static final Parcelable.Creator<RatingCompat> CREATOR = new Parcelable.Creator<RatingCompat>() { // from class: android.support.v4.media.RatingCompat.1
        ...
        public RatingCompat mo59createFromParcel(Parcel parcel) {
        ...
        public RatingCompat[] mo60newArray(int i) {
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Rating:style=");
        outline107.append(this.mRatingStyle);
        outline107.append(" rating=");
        float f = this.mRatingValue;
        outline107.append(f < 0.0f ? "unrated" : String.valueOf(f));

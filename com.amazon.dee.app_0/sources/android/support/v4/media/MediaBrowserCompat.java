...
public final class MediaBrowserCompat {
    ...
    private static class CustomActionResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int i, Bundle bundle) {
            ...
            if (i == -1) {
                ...
                StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Unknown result code: ", i, " (extras=");
                outline109.append(this.mExtras);
                outline109.append(", resultData=");
                outline109.append(bundle);
                outline109.append(")");
                Log.w(MediaBrowserCompat.TAG, outline109.toString());
            } else {
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
                ...
                if (itemCallback != null) {
                    if (!this.mBrowserFwk.isConnected()) {
                        ...
                        try {
                            ...
                            GeneratedOutlineSupport1.outline163("Remote error getting media item: ", str, MediaBrowserCompat.TAG);
        ...
        public void onLoadChildren(Messenger messenger, String str, List list, Bundle bundle, Bundle bundle2) {
            ...
            if (subscription == null) {
                ...
                GeneratedOutlineSupport1.outline158("onLoadChildren for id that isn't subscribed id=", str);
                return;
            }
        ...
        public void subscribe(@NonNull String str, Bundle bundle, @NonNull SubscriptionCallback subscriptionCallback) {
            ...
            try {
                ...
                GeneratedOutlineSupport1.outline163("Remote error subscribing media item: ", str, MediaBrowserCompat.TAG);
            }
        }
        ...
        public void unsubscribe(@NonNull String str, SubscriptionCallback subscriptionCallback) {
            ...
            if (serviceBinderWrapper != null) {
                try {
                    ...
                    GeneratedOutlineSupport1.outline158("removeSubscription failed with RemoteException parentId=", str);
                }
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            boolean isCurrent(String str) {
                ...
                if (mediaBrowserImplBase.mServiceConnection != this || (i = mediaBrowserImplBase.mState) == 0 || i == 1) {
                    ...
                    StringBuilder outline113 = GeneratedOutlineSupport1.outline113(str, " for ");
                    outline113.append(MediaBrowserImplBase.this.mServiceComponent);
                    outline113.append(" with mServiceConnection=");
                    outline113.append(MediaBrowserImplBase.this.mServiceConnection);
                    outline113.append(" this=");
                    outline113.append(this);
                    Log.i(MediaBrowserCompat.TAG, outline113.toString());
                    return false;
                }
                return true;
            }
            ...
            public void onServiceConnected(final ComponentName componentName, final IBinder iBinder) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.1
                    ...
                    public void run() {
                        if (MediaBrowserCompat.DEBUG) {
                            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("MediaServiceConnection.onServiceConnected name=");
                            outline107.append(componentName);
                            outline107.append(" binder=");
                            outline107.append(iBinder);
                            outline107.toString();
                        ...
                        mediaBrowserImplBase4.mState = 2;
                        try {
                            if (MediaBrowserCompat.DEBUG) {
                                mediaBrowserImplBase4.dump();
                            }
                            MediaBrowserImplBase.this.mServiceBinderWrapper.connect(MediaBrowserImplBase.this.mContext, MediaBrowserImplBase.this.mCallbacksMessenger);
                        } catch (RemoteException unused) {
                            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("RemoteException during connect for ");
                            outline1072.append(MediaBrowserImplBase.this.mServiceComponent);
                            Log.w(MediaBrowserCompat.TAG, outline1072.toString());
                            if (!MediaBrowserCompat.DEBUG) {
                                return;
                            }
                            MediaBrowserImplBase.this.dump();
            ...
            public void onServiceDisconnected(final ComponentName componentName) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.2
                    ...
                    public void run() {
                        if (MediaBrowserCompat.DEBUG) {
                            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("MediaServiceConnection.onServiceDisconnected name=");
                            outline107.append(componentName);
                            outline107.append(" this=");
                            outline107.append(this);
                            outline107.append(" mServiceConnection=");
                            outline107.append(MediaBrowserImplBase.this.mServiceConnection);
                            outline107.toString();
                            MediaBrowserImplBase.this.dump();
                        }
                        if (!MediaServiceConnection.this.isCurrent(MetricsConstants.CLIENT_CONNECTION_ON_SERVICE_DISCONNECTED)) {
                            return;
                        }
                        MediaBrowserImplBase mediaBrowserImplBase = MediaBrowserImplBase.this;
        ...
        private static String getStateLabel(int i) {
            return i != 0 ? i != 1 ? i != 2 ? i != 3 ? i != 4 ? GeneratedOutlineSupport1.outline49("UNKNOWN/", i) : "CONNECT_STATE_SUSPENDED" : "CONNECT_STATE_CONNECTED" : "CONNECT_STATE_CONNECTING" : "CONNECT_STATE_DISCONNECTED" : "CONNECT_STATE_DISCONNECTING";
        }
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            ...
            if (this.mCallbacksMessenger != messenger || (i = this.mState) == 0 || i == 1) {
                ...
                StringBuilder outline113 = GeneratedOutlineSupport1.outline113(str, " for ");
                outline113.append(this.mServiceComponent);
                outline113.append(" with mCallbacksMessenger=");
                outline113.append(this.mCallbacksMessenger);
                outline113.append(" this=");
                outline113.append(this);
                Log.i(MediaBrowserCompat.TAG, outline113.toString());
                return false;
        ...
        public void connect() {
            int i = this.mState;
            if (i != 0 && i != 1) {
                throw new IllegalStateException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), ")"));
            }
            this.mState = 2;
            this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.1
                ...
                public void run() {
                    ...
                    if (MediaBrowserCompat.DEBUG && mediaBrowserImplBase.mServiceConnection != null) {
                        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("mServiceConnection should be null. Instead it is ");
                        outline107.append(MediaBrowserImplBase.this.mServiceConnection);
                    ...
                    if (mediaBrowserImplBase2.mServiceBinderWrapper == null) {
                        if (mediaBrowserImplBase2.mCallbacksMessenger == null) {
                            ...
                            try {
                                ...
                                StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("Failed binding to service ");
                                outline1072.append(MediaBrowserImplBase.this.mServiceComponent);
                                Log.e(MediaBrowserCompat.TAG, outline1072.toString());
                            }
                            if (!z) {
                        ...
                        StringBuilder outline1073 = GeneratedOutlineSupport1.outline107("mCallbacksMessenger should be null. Instead it is ");
                        outline1073.append(MediaBrowserImplBase.this.mCallbacksMessenger);
                        throw new RuntimeException(outline1073.toString());
                    }
                    StringBuilder outline1074 = GeneratedOutlineSupport1.outline107("mServiceBinderWrapper should be null. Instead it is ");
                    outline1074.append(MediaBrowserImplBase.this.mServiceBinderWrapper);
                ...
                public void run() {
                    ...
                    if (messenger != null) {
                        try {
                            ...
                            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("RemoteException during connect for ");
                            outline107.append(MediaBrowserImplBase.this.mServiceComponent);
                            Log.w(MediaBrowserCompat.TAG, outline107.toString());
                        }
                    }
                    MediaBrowserImplBase mediaBrowserImplBase2 = MediaBrowserImplBase.this;
        ...
        void dump() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("  mServiceComponent=");
            outline107.append(this.mServiceComponent);
            outline107.toString();
            String str = "  mCallback=" + this.mCallback;
            String str2 = "  mRootHints=" + this.mRootHints;
            String str3 = "  mState=" + getStateLabel(this.mState);
            String str4 = "  mServiceConnection=" + this.mServiceConnection;
            String str5 = "  mServiceBinderWrapper=" + this.mServiceBinderWrapper;
            String str6 = "  mCallbacksMessenger=" + this.mCallbacksMessenger;
            String str7 = "  mRootId=" + this.mRootId;
            String str8 = "  mMediaSessionToken=" + this.mMediaSessionToken;
        }
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("getExtras() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("getRoot() called while not connected(state="), getStateLabel(this.mState), ")"));
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(GeneratedOutlineSupport1.outline86(GeneratedOutlineSupport1.outline107("getServiceComponent() called while not connected (state="), this.mState, ")"));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(GeneratedOutlineSupport1.outline86(GeneratedOutlineSupport1.outline107("getSessionToken() called while not connected(state="), this.mState, ")"));
        }
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl
        public void onConnectionFailed(Messenger messenger) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("onConnectFailed for ");
            outline107.append(this.mServiceComponent);
            Log.e(MediaBrowserCompat.TAG, outline107.toString());
            if (!isCurrent(messenger, "onConnectFailed")) {
                return;
            }
            if (this.mState != 2) {
                StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("onConnect from service while mState=");
                outline1072.append(getStateLabel(this.mState));
                outline1072.append("... ignoring");
                Log.w(MediaBrowserCompat.TAG, outline1072.toString());
                return;
            }
        ...
        public void onLoadChildren(Messenger messenger, String str, List list, Bundle bundle, Bundle bundle2) {
            ...
            if (MediaBrowserCompat.DEBUG) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("onLoadChildren for ");
                outline107.append(this.mServiceComponent);
        ...
        public void onServiceConnected(Messenger messenger, String str, MediaSessionCompat.Token token, Bundle bundle) {
            ...
            if (this.mState != 2) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("onConnect from service while mState=");
                outline107.append(getStateLabel(this.mState));
                outline107.append("... ignoring");
                Log.w(MediaBrowserCompat.TAG, outline107.toString());
                return;
            }
            this.mRootId = str;
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            ...
            throw new IllegalStateException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("search() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public void subscribe(@NonNull String str, Bundle bundle, @NonNull SubscriptionCallback subscriptionCallback) {
            ...
            if (isConnected()) {
                try {
                    ...
                    GeneratedOutlineSupport1.outline158("addSubscription failed with RemoteException parentId=", str);
                }
            }
        }
    ...
    public static class MediaItem implements Parcelable {
        public static final Parcelable.Creator<MediaItem> CREATOR = new Parcelable.Creator<MediaItem>() { // from class: android.support.v4.media.MediaBrowserCompat.MediaItem.1
            ...
            public MediaItem mo53createFromParcel(Parcel parcel) {
            ...
            public MediaItem[] mo54newArray(int i) {
        ...
        public String toString() {
            StringBuilder outline112 = GeneratedOutlineSupport1.outline112("MediaItem{", "mFlags=");
            outline112.append(this.mFlags);
            outline112.append(", mDescription=");
            outline112.append(this.mDescription);

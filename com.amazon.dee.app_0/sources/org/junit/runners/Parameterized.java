...
public class Parameterized extends Suite {
    ...
    private static TestWithParameters createTestWithParameters(TestClass testClass, String str, int i, Object[] objArr) {
        return new TestWithParameters(GeneratedOutlineSupport1.outline75("[", MessageFormat.format(str.replaceAll("\\{index\\}", Integer.toString(i)), objArr), "]"), testClass, Arrays.asList(objArr));
    }
    ...
    private FrameworkMethod getParametersMethod() throws Exception {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("No public static parameters method on class ");

...
public abstract class AbstractSubscriberInfo implements SubscriberInfo {
    ...
    public SubscriberMethod createSubscriberMethod(String str, Class<?> cls, ThreadMode threadMode, int i, boolean z) {
        try {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Could not find subscriber method in ");
            outline107.append(this.subscriberClass);
            outline107.append(". Maybe a missing ProGuard rule?");
            throw new EventBusException(outline107.toString(), e);
        }
    }
}

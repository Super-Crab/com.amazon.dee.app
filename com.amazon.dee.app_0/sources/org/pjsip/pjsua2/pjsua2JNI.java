...
public class pjsua2JNI {
    ...
    public static final native long Account_enumBuddies(long j, Account account) throws Exception;

    public static final native long Account_findBuddy__SWIG_0(long j, Account account, String str, long j2, FindBuddyMatch findBuddyMatch) throws Exception;

    public static final native long Account_findBuddy__SWIG_1(long j, Account account, String str) throws Exception;
    ...
    public static final native void Account_onPublishErrorNotify(long j, Account account, long j2, OnPublishErrorNotifyParam onPublishErrorNotifyParam);

    public static final native void Account_onPublishErrorNotifySwigExplicitAccount(long j, Account account, long j2, OnPublishErrorNotifyParam onPublishErrorNotifyParam);
    ...
    public static final native void Account_updateRegHeaders(long j, Account account, long j2, SipHeaderVector sipHeaderVector) throws Exception;

    public static final native String AudDevManager_capName(long j, AudDevManager audDevManager, int i);

    public static final native long AudDevManager_enumDev(long j, AudDevManager audDevManager) throws Exception;
    ...
    public static final native boolean AudioMediaPlayer_onEofSwigExplicitAudioMediaPlayer(long j, AudioMediaPlayer audioMediaPlayer);
    ...
    public static final native void AudioMediaRecorder_createRecorder__SWIG_0(long j, AudioMediaRecorder audioMediaRecorder, String str, long j2, long j3, long j4) throws Exception;

    public static final native void AudioMediaRecorder_createRecorder__SWIG_1(long j, AudioMediaRecorder audioMediaRecorder, String str, long j2, long j3) throws Exception;
    ...
    public static final native int Call_makeCall(long j, Call call, String str, long j2, CallOpParam callOpParam) throws Exception;

    public static final native void Call_onCallAnswer(long j, Call call, long j2, OnCallAnswerParam onCallAnswerParam);

    public static final native void Call_onCallAnswerSwigExplicitCall(long j, Call call, long j2, OnCallAnswerParam onCallAnswerParam);

    public static final native void Call_onCallEarlyMedia(long j, Call call, long j2, OnCallSdpCreatedParam onCallSdpCreatedParam);

    public static final native void Call_onCallEarlyMediaSwigExplicitCall(long j, Call call, long j2, OnCallSdpCreatedParam onCallSdpCreatedParam);
    ...
    public static final native void Call_onCallRemoteReinvite(long j, Call call, long j2, OnCallRemoteUpdateParam onCallRemoteUpdateParam);

    public static final native void Call_onCallRemoteReinviteSwigExplicitCall(long j, Call call, long j2, OnCallRemoteUpdateParam onCallRemoteUpdateParam);

    public static final native void Call_onCallRemoteUpdate(long j, Call call, long j2, OnCallRemoteUpdateParam onCallRemoteUpdateParam);

    public static final native void Call_onCallRemoteUpdateSwigExplicitCall(long j, Call call, long j2, OnCallRemoteUpdateParam onCallRemoteUpdateParam);
    ...
    public static final native void Call_onCallSessionRefresh(long j, Call call);

    public static final native void Call_onCallSessionRefreshSwigExplicitCall(long j, Call call);

    public static final native boolean Call_onCallSipInfo(long j, Call call, long j2, OnCallSipInfoParam onCallSipInfoParam);

    public static final native void Call_onCallSipInfoResponse(long j, Call call, long j2, OnCallSipInfoResponseParam onCallSipInfoResponseParam);

    public static final native void Call_onCallSipInfoResponseSwigExplicitCall(long j, Call call, long j2, OnCallSipInfoResponseParam onCallSipInfoResponseParam);

    public static final native boolean Call_onCallSipInfoSwigExplicitCall(long j, Call call, long j2, OnCallSipInfoParam onCallSipInfoParam);
    ...
    public static final native void Call_reinviteResponse(long j, Call call, int i, String str);

    public static final native int Call_remoteHasCap(long j, Call call, int i, String str, String str2);

    public static final native void Call_sendAnswer(long j, Call call, int i, String str);

    public static final native void Call_sendDTMFinInfo(long j, Call call, int i, String str, int i2);

    public static final native void Call_sendInfoMessage(long j, Call call, int i, String str, String str2);
    ...
    public static final native void Call_sendOffer(long j, Call call, int i, String str);
    ...
    public static final native void Call_updateResponse(long j, Call call, int i, String str);
    ...
    public static final native void CodecFmtpVector_add(long j, CodecFmtpVector codecFmtpVector, long j2, CodecFmtp codecFmtp);
    ...
    public static final native long CodecFmtpVector_get(long j, CodecFmtpVector codecFmtpVector, int i);
    ...
    public static final native void CodecFmtpVector_set(long j, CodecFmtpVector codecFmtpVector, int i, long j2, CodecFmtp codecFmtp);

    public static final native long CodecFmtpVector_size(long j, CodecFmtpVector codecFmtpVector);
    ...
    public static final native long Endpoint_codecEnum(long j, Endpoint endpoint) throws Exception;

    public static final native long Endpoint_codecGetParam(long j, Endpoint endpoint, String str) throws Exception;

    public static final native void Endpoint_codecSetParam(long j, Endpoint endpoint, String str, long j2) throws Exception;
    ...
    public static final native long Endpoint_mediaEnumPorts(long j, Endpoint endpoint) throws Exception;
    ...
    public static final native void Endpoint_transportClose__SWIG_0(long j, Endpoint endpoint, int i, boolean z) throws Exception;

    public static final native void Endpoint_transportClose__SWIG_1(long j, Endpoint endpoint, int i) throws Exception;
    ...
    public static final native long Endpoint_videoCodecEnum(long j, Endpoint endpoint) throws Exception;
    ...
    public static final native long OnCallAnswerParam_rdata_get(long j, OnCallAnswerParam onCallAnswerParam);

    public static final native void OnCallAnswerParam_rdata_set(long j, OnCallAnswerParam onCallAnswerParam, long j2, SipRxData sipRxData);

    public static final native long OnCallAnswerParam_remSdp_get(long j, OnCallAnswerParam onCallAnswerParam);

    public static final native void OnCallAnswerParam_remSdp_set(long j, OnCallAnswerParam onCallAnswerParam, long j2, SdpSession sdpSession);
    ...
    public static final native String OnCallRemoteUpdateParam_cType_get(long j, OnCallRemoteUpdateParam onCallRemoteUpdateParam);

    public static final native void OnCallRemoteUpdateParam_cType_set(long j, OnCallRemoteUpdateParam onCallRemoteUpdateParam, String str);

    public static final native boolean OnCallRemoteUpdateParam_isOffer_get(long j, OnCallRemoteUpdateParam onCallRemoteUpdateParam);

    public static final native void OnCallRemoteUpdateParam_isOffer_set(long j, OnCallRemoteUpdateParam onCallRemoteUpdateParam, boolean z);

    public static final native String OnCallRemoteUpdateParam_msgBody_get(long j, OnCallRemoteUpdateParam onCallRemoteUpdateParam);

    public static final native void OnCallRemoteUpdateParam_msgBody_set(long j, OnCallRemoteUpdateParam onCallRemoteUpdateParam, String str);
    ...
    public static final native String OnCallSipInfoParam_cType_get(long j, OnCallSipInfoParam onCallSipInfoParam);

    public static final native void OnCallSipInfoParam_cType_set(long j, OnCallSipInfoParam onCallSipInfoParam, String str);

    public static final native String OnCallSipInfoParam_msgBody_get(long j, OnCallSipInfoParam onCallSipInfoParam);

    public static final native void OnCallSipInfoParam_msgBody_set(long j, OnCallSipInfoParam onCallSipInfoParam, String str);

    public static final native String OnCallSipInfoResponseParam_contentType_get(long j, OnCallSipInfoResponseParam onCallSipInfoResponseParam);

    public static final native void OnCallSipInfoResponseParam_contentType_set(long j, OnCallSipInfoResponseParam onCallSipInfoResponseParam, String str);

    public static final native int OnCallSipInfoResponseParam_cseq_get(long j, OnCallSipInfoResponseParam onCallSipInfoResponseParam);

    public static final native void OnCallSipInfoResponseParam_cseq_set(long j, OnCallSipInfoResponseParam onCallSipInfoResponseParam, int i);

    public static final native String OnCallSipInfoResponseParam_reason_get(long j, OnCallSipInfoResponseParam onCallSipInfoResponseParam);

    public static final native void OnCallSipInfoResponseParam_reason_set(long j, OnCallSipInfoResponseParam onCallSipInfoResponseParam, String str);

    public static final native int OnCallSipInfoResponseParam_statusCode_get(long j, OnCallSipInfoResponseParam onCallSipInfoResponseParam);

    public static final native void OnCallSipInfoResponseParam_statusCode_set(long j, OnCallSipInfoResponseParam onCallSipInfoResponseParam, int i);
    ...
    public static final native void OnCreateMediaTransportSrtpParam_cryptos_set(long j, OnCreateMediaTransportSrtpParam onCreateMediaTransportSrtpParam, long j2);
    ...
    public static final native String OnPublishErrorNotifyParam_reason_get(long j, OnPublishErrorNotifyParam onPublishErrorNotifyParam);

    public static final native void OnPublishErrorNotifyParam_reason_set(long j, OnPublishErrorNotifyParam onPublishErrorNotifyParam, String str);

    public static final native int OnPublishErrorNotifyParam_statusCode_get(long j, OnPublishErrorNotifyParam onPublishErrorNotifyParam);

    public static final native void OnPublishErrorNotifyParam_statusCode_set(long j, OnPublishErrorNotifyParam onPublishErrorNotifyParam, int i);
    ...
    public static final native String SipMsg_contentType_get(long j, SipMsg sipMsg);

    public static final native void SipMsg_contentType_set(long j, SipMsg sipMsg, String str);

    public static final native long SipMsg_headers_get(long j, SipMsg sipMsg);

    public static final native void SipMsg_headers_set(long j, SipMsg sipMsg, long j2, SipHeaderVector sipHeaderVector);

    public static final native long SipMsg_pjMsg_get(long j, SipMsg sipMsg);

    public static final native void SipMsg_pjMsg_set(long j, SipMsg sipMsg, long j2);

    public static final native long SipMsg_request_get(long j, SipMsg sipMsg);

    public static final native void SipMsg_request_set(long j, SipMsg sipMsg, long j2, SipRequestLine sipRequestLine);

    public static final native long SipMsg_status_get(long j, SipMsg sipMsg);

    public static final native void SipMsg_status_set(long j, SipMsg sipMsg, long j2, SipStatusLine sipStatusLine);

    public static final native int SipMsg_type_get(long j, SipMsg sipMsg);

    public static final native void SipMsg_type_set(long j, SipMsg sipMsg, int i);
    ...
    public static final native int SipRequestLine_method_get(long j, SipRequestLine sipRequestLine);

    public static final native void SipRequestLine_method_set(long j, SipRequestLine sipRequestLine, int i);

    public static final native String SipRequestLine_name_get(long j, SipRequestLine sipRequestLine);

    public static final native void SipRequestLine_name_set(long j, SipRequestLine sipRequestLine, String str);

    public static final native long SipRequestLine_pjRequest_get(long j, SipRequestLine sipRequestLine);

    public static final native void SipRequestLine_pjRequest_set(long j, SipRequestLine sipRequestLine, long j2);
    ...
    public static final native String SipRxData_sdp_get(long j, SipRxData sipRxData);

    public static final native void SipRxData_sdp_set(long j, SipRxData sipRxData, String str);

    public static final native long SipRxData_sipMsg_get(long j, SipRxData sipRxData);

    public static final native void SipRxData_sipMsg_set(long j, SipRxData sipRxData, long j2, SipMsg sipMsg);
    ...
    public static final native int SipStatusLine_code_get(long j, SipStatusLine sipStatusLine);

    public static final native void SipStatusLine_code_set(long j, SipStatusLine sipStatusLine, int i);

    public static final native long SipStatusLine_pjStatus_get(long j, SipStatusLine sipStatusLine);

    public static final native void SipStatusLine_pjStatus_set(long j, SipStatusLine sipStatusLine, long j2);

    public static final native String SipStatusLine_reason_get(long j, SipStatusLine sipStatusLine);

    public static final native void SipStatusLine_reason_set(long j, SipStatusLine sipStatusLine, String str);

    public static final native int SipTransaction_cseq_get(long j, SipTransaction sipTransaction);

    public static final native void SipTransaction_cseq_set(long j, SipTransaction sipTransaction, int i);
    ...
    public static final native long SipTxData_sipMsg_get(long j, SipTxData sipTxData);

    public static final native void SipTxData_sipMsg_set(long j, SipTxData sipTxData, long j2, SipMsg sipMsg);
    ...
    public static void SwigDirector_Account_onPublishErrorNotify(Account account, long j) {
        account.onPublishErrorNotify(new OnPublishErrorNotifyParam(j, false));
    }
    ...
    public static void SwigDirector_Call_onCallAnswer(Call call, long j) {
        call.onCallAnswer(new OnCallAnswerParam(j, false));
    }

    public static void SwigDirector_Call_onCallEarlyMedia(Call call, long j) {
        call.onCallEarlyMedia(new OnCallSdpCreatedParam(j, false));
    }
    ...
    public static void SwigDirector_Call_onCallRemoteReinvite(Call call, long j) {
        call.onCallRemoteReinvite(new OnCallRemoteUpdateParam(j, false));
    }

    public static void SwigDirector_Call_onCallRemoteUpdate(Call call, long j) {
        call.onCallRemoteUpdate(new OnCallRemoteUpdateParam(j, false));
    }
    ...
    public static void SwigDirector_Call_onCallSessionRefresh(Call call) {
        call.onCallSessionRefresh();
    }

    public static boolean SwigDirector_Call_onCallSipInfo(Call call, long j) {
        return call.onCallSipInfo(new OnCallSipInfoParam(j, false));
    }

    public static void SwigDirector_Call_onCallSipInfoResponse(Call call, long j) {
        call.onCallSipInfoResponse(new OnCallSipInfoResponseParam(j, false));
    }
    ...
    public static final native long VidDevManager_enumDev(long j, VidDevManager vidDevManager) throws Exception;
    ...
    public static final native void VideoDevInfoVector_add(long j, VideoDevInfoVector videoDevInfoVector, long j2, VideoDevInfo videoDevInfo);
    ...
    public static final native long VideoDevInfoVector_get(long j, VideoDevInfoVector videoDevInfoVector, int i);
    ...
    public static final native void VideoDevInfoVector_set(long j, VideoDevInfoVector videoDevInfoVector, int i, long j2, VideoDevInfo videoDevInfo);

    public static final native long VideoDevInfoVector_size(long j, VideoDevInfoVector videoDevInfoVector);
    ...
    public static final native void VideoDevInfo_fmt_set(long j, VideoDevInfo videoDevInfo, long j2, MediaFormatVector mediaFormatVector);
    ...
    public static final native void delete_OnCallAnswerParam(long j);
    ...
    public static final native void delete_OnCallRemoteUpdateParam(long j);
    ...
    public static final native void delete_OnCallSipInfoParam(long j);

    public static final native void delete_OnCallSipInfoResponseParam(long j);
    ...
    public static final native void delete_OnPublishErrorNotifyParam(long j);
    ...
    public static final native void delete_SipMsg(long j);
    ...
    public static final native void delete_SipRequestLine(long j);

    public static final native void delete_SipRxData(long j);

    public static final native void delete_SipStatusLine(long j);
    ...
    public static final native long new_CodecFmtpVector__SWIG_1(long j);
    ...
    public static final native long new_OnCallAnswerParam();
    ...
    public static final native long new_OnCallRemoteUpdateParam();
    ...
    public static final native long new_OnCallSipInfoParam();

    public static final native long new_OnCallSipInfoResponseParam();
    ...
    public static final native long new_OnPublishErrorNotifyParam();
    ...
    public static final native long new_SipMsg();
    ...
    public static final native long new_SipRequestLine();

    public static final native long new_SipRxData();

    public static final native long new_SipStatusLine();
    ...
    public static final native long new_VideoDevInfoVector__SWIG_1(long j);

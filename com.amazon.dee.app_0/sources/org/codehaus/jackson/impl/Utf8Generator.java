    ...
    */
    ...
    public void close() throws IOException {
        ...
        if (this._outputBuffer != null && isEnabled(JsonGenerator.Feature.AUTO_CLOSE_JSON_CONTENT)) {
            while (true) {
                JsonWriteContext mo12876getOutputContext = mo12876getOutputContext();
                if (mo12876getOutputContext.inArray()) {
                    writeEndArray();
                } else if (!mo12876getOutputContext.inObject()) {
                    break;
                } else {
                    writeEndObject();
                }
    ...
    public final void writeEndArray() throws IOException, JsonGenerationException {
        ...
        this._writeContext = this._writeContext.mo12871getParent();
    }

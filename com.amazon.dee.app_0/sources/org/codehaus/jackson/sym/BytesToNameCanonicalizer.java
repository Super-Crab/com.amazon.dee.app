...
public final class BytesToNameCanonicalizer {
    ...
    private void rehash() {
        ...
        StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Internal error: count after rehash ", i3, "; should be ");
        outline109.append(this._count);
        throw new RuntimeException(outline109.toString());
    }
    ...
    protected void reportTooManyCollisions(int i) {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Longest collision chain in symbol table (of size ");
        outline107.append(this._count);
        outline107.append(") now exceeds maximum, ");
        outline107.append(i);
        outline107.append(" -- suspect a DoS attack based on hash collisions");
    ...
    public final int calcHash(int i, int i2) {
        int i3 = this._hashSeed ^ ((i2 * 33) + (i ^ (i >>> 15)));
        return i3 + (i3 >>> 7);
    }

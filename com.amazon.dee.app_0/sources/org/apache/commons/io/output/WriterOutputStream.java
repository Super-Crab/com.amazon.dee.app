...
public class WriterOutputStream extends OutputStream {
    ...
    public WriterOutputStream(Writer writer, Charset charset, int i, boolean z) {
        this(writer, charset.newDecoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE).replaceWith(WebConstants.UriConstants.QUESTIONMARK_KEY), i, z);
    }

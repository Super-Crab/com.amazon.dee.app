...
public abstract class ToStringStyle implements Serializable {
    ...
    private static final class MultiLineToStringStyle extends ToStringStyle {
        ...
        MultiLineToStringStyle() {
            setContentStart("[");
            setFieldSeparator(GeneratedOutlineSupport1.outline83(new StringBuffer(), SystemUtils.LINE_SEPARATOR, "  "));
            setFieldSeparatorAtStart(true);
            setContentEnd(GeneratedOutlineSupport1.outline83(new StringBuffer(), SystemUtils.LINE_SEPARATOR, "]"));
        }

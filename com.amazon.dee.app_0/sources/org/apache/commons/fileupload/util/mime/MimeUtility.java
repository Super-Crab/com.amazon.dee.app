            ...
            if (LINEAR_WHITESPACE.indexOf(str.charAt(i)) != -1) {
                ...
                while (true) {
                    if (i4 >= length) {
                        ...
                        i = i5;
                        break;
                    } else if (LINEAR_WHITESPACE.indexOf(str.charAt(i4)) == -1) {
                        i3 = i4;
                        i2 = i;
                        i = i3;
                        break;
        ...
        if (str.startsWith(ENCODED_TOKEN_MARKER)) {
            ...
            if (indexOf != -1) {
                ...
                if (indexOf2 != -1) {
                    ...
                    throw new ParseException(GeneratedOutlineSupport1.outline72("Missing encoded text in RFC 2047 encoded-word: ", str));
                }
                throw new ParseException(GeneratedOutlineSupport1.outline72("Missing encoding in RFC 2047 encoded-word: ", str));
            }
            throw new ParseException(GeneratedOutlineSupport1.outline72("Missing charset in RFC 2047 encoded-word: ", str));
        }
        throw new ParseException(GeneratedOutlineSupport1.outline72("Invalid RFC 2047 encoded-word: ", str));
    }

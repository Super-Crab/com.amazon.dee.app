...
public class Md5Crypt {
    ...
    public static String apr1Crypt(byte[] bArr) {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107(APR1_PREFIX);
        outline107.append(B64.getRandomSalt(8));
        return apr1Crypt(bArr, outline107.toString());
    }

    public static String md5Crypt(byte[] bArr) {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107(MD5_PREFIX);
        outline107.append(B64.getRandomSalt(8));
        return md5Crypt(bArr, outline107.toString());
    }

    public static String apr1Crypt(byte[] bArr, String str) {
        if (str != null && !str.startsWith(APR1_PREFIX)) {
            str = GeneratedOutlineSupport1.outline72(APR1_PREFIX, str);
        }
    ...
    public static String md5Crypt(byte[] bArr, String str, String str2) {
        ...
        if (str == null) {
            ...
            outline107.append(str2.replace("$", "\\$"));
            outline107.append("([\\.\\/a-zA-Z0-9]{1,8}).*");
        ...
        StringBuilder sb = new StringBuilder(GeneratedOutlineSupport1.outline75(str2, group, "$"));

...
public class MatchRatingApproachEncoder implements StringEncoder {
    ...
    String cleanName(String str) {
        ...
        for (String str2 : new String[]{"\\-", "[&]", "\\'", ArcusConfig.PATH_SEPARATOR, "[\\,]"}) {
    ...
    String getFirst3Last3(String str) {
        ...
        return length > 6 ? GeneratedOutlineSupport1.outline72(str.substring(0, 3), str.substring(length - 3, length)) : str;
    }
    ...
    public boolean isEncodeEquals(String str, String str2) {
        ...
        return leftToRightThenRightToLeftProcessing(first3Last3, first3Last32) >= getMinRating(Math.abs(first3Last32.length() + first3Last3.length()));
    }
    ...
    String removeVowels(String str) {
        ...
        return isVowel(substring) ? GeneratedOutlineSupport1.outline72(substring, replaceAll) : replaceAll;
    }

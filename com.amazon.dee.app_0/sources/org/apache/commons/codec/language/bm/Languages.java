...
public class Languages {
    ...
    public static final class SomeLanguages extends LanguageSet {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Languages(");
            outline107.append(this.languages.toString());
            outline107.append(")");
    ...
    public static Languages getInstance(String str) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline72("Unable to resolve required resource: ", str));
    }
}

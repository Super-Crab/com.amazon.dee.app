...
public class ExceptionUtils {
    ...
    public static String getMessage(Throwable th) {
        ...
        StringBuilder outline113 = GeneratedOutlineSupport1.outline113(shortClassName, RealTimeTextConstants.COLON_SPACE);
        outline113.append(StringUtils.defaultString(message));
        ...
        while (true) {
            ...
            if (length >= 0) {
                ...
                if (length == i) {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107(WRAPPED_MARKER);
                    outline107.append(throwables[length].toString());

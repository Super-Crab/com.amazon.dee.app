...
public class ObjectUtils {
    ...
    public static byte CONST_BYTE(int i) throws IllegalArgumentException {
        if (i < -128 || i > 127) {
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("Supplied value must be a valid byte literal between -128 and 127: [", i, "]"));
        }
        return (byte) i;
    }
    ...
    public static short CONST_SHORT(int i) throws IllegalArgumentException {
        if (i < -32768 || i > 32767) {
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("Supplied value must be a valid byte literal between -32768 and 32767: [", i, "]"));
        }
        return (short) i;
    }
        ...
        if (t instanceof Cloneable) {
            if (t.getClass().isArray()) {
                ...
                try {
                    ...
                    throw new CloneFailedException(GeneratedOutlineSupport1.outline45(t, GeneratedOutlineSupport1.outline107("Cannot clone Cloneable type ")), e);
                } catch (NoSuchMethodException e2) {
                    throw new CloneFailedException(GeneratedOutlineSupport1.outline46(t, GeneratedOutlineSupport1.outline107("Cloneable type "), " has no clone method"), e2);
                } catch (InvocationTargetException e3) {
                    throw new CloneFailedException(GeneratedOutlineSupport1.outline45(t, GeneratedOutlineSupport1.outline107("Exception cloning Cloneable type ")), e3.getCause());
                }
            }
        } else {
            return null;

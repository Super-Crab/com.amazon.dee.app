...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("FastDateFormat[");
        outline107.append(this.printer.getPattern());
        outline107.append(",");
        outline107.append(this.printer.getLocale());
        outline107.append(",");
        outline107.append(this.printer.getTimeZone().getID());
        outline107.append("]");

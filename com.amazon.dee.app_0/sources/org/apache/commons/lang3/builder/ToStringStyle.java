...
public abstract class ToStringStyle implements Serializable {
    ...
    private String fieldNameValueSeparator = Config.Compare.EQUAL_TO;
    private boolean fieldSeparatorAtStart = false;
    private boolean fieldSeparatorAtEnd = false;
    private String fieldSeparator = ",";
    private String arrayStart = EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_OPEN;
    private String arraySeparator = ",";
    private boolean arrayContentDetail = true;
    private String arrayEnd = EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE;
    private boolean defaultFullDetail = true;
    private String nullText = DefaultRecordChecker.Regex.EMPTY;
    private String sizeStartText = "<size=";
    private String sizeEndText = Config.Compare.GREATER_THAN;
    private String summaryObjectStartText = Config.Compare.LESS_THAN;
    private String summaryObjectEndText = Config.Compare.GREATER_THAN;
    ...
    private static final class MultiLineToStringStyle extends ToStringStyle {
        ...
        MultiLineToStringStyle() {
            setContentStart("[");
            setFieldSeparator(GeneratedOutlineSupport1.outline91(new StringBuilder(), SystemUtils.LINE_SEPARATOR, "  "));
            setFieldSeparatorAtStart(true);
            setContentEnd(GeneratedOutlineSupport1.outline91(new StringBuilder(), SystemUtils.LINE_SEPARATOR, "]"));
        }
    ...
    private static final class JsonToStringStyle extends ToStringStyle {
        private static final long serialVersionUID = 1;
        private String FIELD_NAME_PREFIX = EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED;

        JsonToStringStyle() {
            setUseClassName(false);
            setUseIdentityHashCode(false);
            setContentStart(EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_OPEN);
            setContentEnd(EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE);
            setArrayStart("[");
            setArrayEnd("]");
            setFieldSeparator(",");
        ...
        private void appendValueAsString(StringBuffer stringBuffer, String str) {
            stringBuffer.append(EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED + str + EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED);
        }

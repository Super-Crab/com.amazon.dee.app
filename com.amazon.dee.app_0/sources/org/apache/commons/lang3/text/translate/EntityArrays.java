...
public class EntityArrays {
    ...
    private static final String[][] BASIC_ESCAPE = {new String[]{EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED, "&quot;"}, new String[]{WebConstants.UriConstants.AMPERSAND_KEY, "&amp;"}, new String[]{Config.Compare.LESS_THAN, "&lt;"}, new String[]{Config.Compare.GREATER_THAN, "&gt;"}};
    ...
    private static final String[][] JAVA_CTRL_CHARS_ESCAPE = {new String[]{"\b", "\\b"}, new String[]{"\n", "\\n"}, new String[]{DeviceDatabaseUtils.DELIMITER, "\\t"}, new String[]{"\f", "\\f"}, new String[]{StringUtils.CR, "\\r"}};

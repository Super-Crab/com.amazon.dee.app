    ...
    public StrBuilder insert(int i, char[] cArr, int i2, int i3) {
        ...
        if (i2 >= 0 && i2 <= cArr.length) {
            if (i3 < 0 || i2 + i3 > cArr.length) {
                throw new StringIndexOutOfBoundsException(GeneratedOutlineSupport1.outline49("Invalid length: ", i3));
            }
            if (i3 > 0) {
        ...
        throw new StringIndexOutOfBoundsException(GeneratedOutlineSupport1.outline49("Invalid offset: ", i2));
    }
    ...
    public StrBuilder append(char[] cArr, int i, int i2) {
        ...
        if (i >= 0 && i <= cArr.length) {
            if (i2 < 0 || i + i2 > cArr.length) {
                throw new StringIndexOutOfBoundsException(GeneratedOutlineSupport1.outline49("Invalid length: ", i2));
            }
            if (i2 > 0) {
                int length = length();
                ensureCapacity(length + i2);
        ...
        throw new StringIndexOutOfBoundsException(GeneratedOutlineSupport1.outline49("Invalid startIndex: ", i2));
    }

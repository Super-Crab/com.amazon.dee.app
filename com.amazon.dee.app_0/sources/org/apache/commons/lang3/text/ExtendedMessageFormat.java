...
public class ExtendedMessageFormat extends MessageFormat {
    ...
    private StringBuilder appendQuotedString(String str, ParsePosition parsePosition, StringBuilder sb) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Unterminated quoted string at position ", index));
    }
    ...
    private String parseFormatDescription(String str, ParsePosition parsePosition) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Unterminated format element at position ", index));
    }
    ...
    private int readArgumentIndex(String str, ParsePosition parsePosition) {
        ...
        if (z) {
            StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Invalid format argument index at position ", index, RealTimeTextConstants.COLON_SPACE);
            outline109.append(str.substring(index, parsePosition.getIndex()));
        ...
        while (parsePosition.getIndex() < str.length()) {
            ...
            if (c != '\'') {
                if (c == '{') {
                    ...
                    Validate.isTrue(z);
                    if (charArray[parsePosition.getIndex()] != '}') {
                        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Unreadable format element at position ", index));
                    }
                }

                    ...
                    if (i9 >= i3) {
                        ...
                        if (isMatch3 == 0) {
                            ...
                            if (valueDelimiterMatcher != null) {
                                ...
                                z = z2;
                                int i11 = 0;
                                while (i11 < charArray.length && (isEnableSubstitutionInVariables || variablePrefixMatcher.isMatch(charArray, i11, i11, charArray.length) == 0)) {
                                    int isMatch4 = valueDelimiterMatcher.isMatch(charArray, i11);
                                    if (isMatch4 != 0) {
                                        strMatcher = variablePrefixMatcher;
                                        String substring = str2.substring(0, i11);
                                        str = str2.substring(i11 + isMatch4);
                                        str2 = substring;
                                        break;
                                    }
                                    i11++;
                            ...
                            list2.add(str2);
                            String resolveVariable = resolveVariable(str2, strBuilder, i6, i9);

    ...
    public static String random(int i, int i2, int i3, boolean z, boolean z2, char[] cArr, Random random) {
        ...
        if (i >= 0) {
            ...
            if (i2 == 0 && i3 == 0) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline54("Parameter end (", i3, ") must be greater than start (", i2, ")"));
            }
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("Requested random string length ", i, " is less than 0."));
        }
    }

...
public class Conversion {
    ...
    public static int byteArrayToInt(byte[] bArr, int i, int i2, int i3, int i4) {
        ...
        if (GeneratedOutlineSupport1.outline2(i4, -1, 8, i3) >= 32) {
    ...
    public static long byteArrayToLong(byte[] bArr, int i, long j, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 8, i2) >= 64) {
    ...
    public static short byteArrayToShort(byte[] bArr, int i, short s, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 8, i2) >= 16) {
    ...
    public static String byteToHex(byte b, int i, String str, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 4, i) < 8) {
    ...
    */
    public static boolean[] hexDigitMsb0ToBinary(char r3) {
        ...
        L9:
            ...
            java.lang.String r3 = com.android.tools.r8.GeneratedOutlineSupport1.outline48(r1, r3, r2)
            r0.<init>(r3)
            throw r0
        L17:
                    ...
                    default:
                        switch (c) {
                            ...
                            case 'f':
                                return 15;
                            default:
                                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline48("Cannot interpret '", c, "' as a hexadecimal digit"));
                        }
                }
        }
    }
    ...
    */
    ...
    public static byte hexToByte(String str, int i, byte b, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 4, i2) >= 8) {
    ...
    public static int hexToInt(String str, int i, int i2, int i3, int i4) {
        ...
        if (GeneratedOutlineSupport1.outline2(i4, -1, 4, i3) >= 32) {
    ...
    public static long hexToLong(String str, int i, long j, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 4, i2) >= 64) {
    ...
    public static short hexToShort(String str, int i, short s, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 4, i2) >= 16) {
    ...
    public static long intArrayToLong(int[] iArr, int i, long j, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 32, i2) >= 64) {
    ...
    public static byte[] intToByteArray(int i, int i2, byte[] bArr, int i3, int i4) {
        ...
        if (GeneratedOutlineSupport1.outline2(i4, -1, 8, i2) >= 32) {
    ...
    public static String intToHex(int i, int i2, String str, int i3, int i4) {
        ...
        if (GeneratedOutlineSupport1.outline2(i4, -1, 4, i2) < 32) {
            StringBuilder sb = new StringBuilder(str);
            int length = sb.length();
            for (int i5 = 0; i5 < i4; i5++) {
                int i6 = (i >> ((i5 * 4) + i2)) & 15;
    ...
    public static char intToHexDigit(int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("nibble value not between 0 and 15: ", i));
    }
    ...
    public static short[] intToShortArray(int i, int i2, short[] sArr, int i3, int i4) {
        ...
        if (GeneratedOutlineSupport1.outline2(i4, -1, 16, i2) >= 32) {
    ...
    public static byte[] longToByteArray(long j, int i, byte[] bArr, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 8, i) >= 64) {
    ...
    public static String longToHex(long j, int i, String str, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 4, i) < 64) {
            StringBuilder sb = new StringBuilder(str);
            int length = sb.length();
            for (int i4 = 0; i4 < i3; i4++) {
    ...
    public static int[] longToIntArray(long j, int i, int[] iArr, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 32, i) >= 64) {
    ...
    public static short[] longToShortArray(long j, int i, short[] sArr, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 16, i) >= 64) {
    ...
    public static int shortArrayToInt(short[] sArr, int i, int i2, int i3, int i4) {
        ...
        if (GeneratedOutlineSupport1.outline2(i4, -1, 16, i3) >= 32) {
    ...
    public static long shortArrayToLong(short[] sArr, int i, long j, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 16, i2) >= 64) {
    ...
    public static byte[] shortToByteArray(short s, int i, byte[] bArr, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 8, i) >= 16) {
    ...
    public static String shortToHex(short s, int i, String str, int i2, int i3) {
        ...
        if (GeneratedOutlineSupport1.outline2(i3, -1, 4, i) < 16) {
            StringBuilder sb = new StringBuilder(str);
            int length = sb.length();
            for (int i4 = 0; i4 < i3; i4++) {
                int i5 = (s >> ((i4 * 4) + i)) & 15;
    ...
    public static char binaryToHexDigitMsb0_4bits(boolean[] zArr, int i) {
        if (zArr.length <= 8) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("src.length-srcPos<4: src.length=");
            outline107.append(zArr.length);
            outline107.append(", srcPos=");
            outline107.append(i);
            throw new IllegalArgumentException(outline107.toString());
        }
        StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("src.length>8: src.length=");
        outline1072.append(zArr.length);

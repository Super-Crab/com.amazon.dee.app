    ...
    public int bitIndex(String str, int i, int i2, String str2, int i3, int i4) {
        ...
        if (i % 16 == 0 && i3 % 16 == 0 && i2 % 16 == 0 && i4 % 16 == 0) {
            ...
            for (int i9 = 0; i9 < max; i9++) {
                int i10 = i5 + i9;
                int i11 = i6 + i9;
                char charAt2 = i10 >= i7 ? (char) 0 : str.charAt(i10);
                if (charAt2 != ((str2 == null || i11 >= i8) ? (char) 0 : str2.charAt(i11))) {
                    return (Integer.numberOfLeadingZeros(charAt2 ^ charAt) + (i9 * 16)) - 16;
                }
                if (charAt2 != 0) {
                    z = false;
                }

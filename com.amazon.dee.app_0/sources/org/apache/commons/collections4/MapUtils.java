...
public class MapUtils {
            ...
            if (objArr != null && objArr.length != 0) {
                ...
                if (obj instanceof Map.Entry) {
                    ...
                    while (i < length2) {
                        ...
                        map.put(keyValue.mo12677getKey(), keyValue.mo12678getValue());
                        i++;
                    }
                    ...
                    for (int i2 = 0; i2 < objArr.length; i2++) {
                        ...
                        if (objArr2 != null && objArr2.length >= 2) {
                            ...
                            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Invalid array element: ", i2));
                        }
                    }
                } else {
    ...
    private static void verbosePrintInternal(PrintStream printStream, Object obj, Map<?, ?> map, Deque<Map<?, ?>> deque, boolean z) {
        ...
        printIndent(printStream, deque.size());
        printStream.println(EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_OPEN);
        deque.addLast(map);
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            ...
            if ((value instanceof Map) && !deque.contains(value)) {
                ...
                if (indexOf == -1) {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("(ancestor[");
                    outline107.append(((deque.size() - 1) - indexOf) - 1);
                    outline107.append("] Map)");
        ...
        if (z) {
            ...
            outline1072.append(map.getClass().getName());
    ...
    public static <K, V, E> void populateMap(Map<K, V> map, Iterable<? extends E> iterable, Transformer<E, K> transformer, Transformer<E, V> transformer2) {
        for (E e : iterable) {
            map.put(transformer.mo12738transform(e), transformer2.mo12738transform(e));
        }
    }
    ...
    public static <K, V, E> void populateMap(MultiMap<K, V> multiMap, Iterable<? extends E> iterable, Transformer<E, K> transformer, Transformer<E, V> transformer2) {
        for (E e : iterable) {
            multiMap.put(transformer.mo12738transform(e), transformer2.mo12738transform(e));
        }
    }

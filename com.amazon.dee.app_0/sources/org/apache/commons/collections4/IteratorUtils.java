...
public class IteratorUtils {
    ...
    public static <E> Iterable<E> asIterable(Iterator<? extends E> it2) {
        if (it2 != null) {
            return new IteratorIterable(it2, false);
        }
        throw new NullPointerException("Iterator must not be null");
    }
    ...
    public static <E> boolean contains(Iterator<E> it2, Object obj) {
        return matchesAny(it2, EqualPredicate.equalPredicate(obj));
    }
    ...
    public static <E> E find(Iterator<E> it2, Predicate<? super E> predicate) {
        if (predicate != null) {
            if (it2 == null) {
                return null;
            }
    ...
    public static <E> E first(Iterator<E> it2) {
        return (E) get(it2, 0);
    }
    ...
    public static <E> E get(Iterator<E> it2, int i) {
        ...
        throw new IndexOutOfBoundsException(GeneratedOutlineSupport1.outline49("Entry does not exist: ", i));
    }
    ...
    public static <E> boolean matchesAll(Iterator<E> it2, Predicate<? super E> predicate) {
        if (predicate != null) {
            if (it2 == null) {
                return true;
            }
    ...
    public static <E> Iterator<E> peekingIterator(Iterator<? extends E> it2) {
        return PeekingIterator.peekingIterator(it2);
    }

    public static <E> Iterator<E> pushbackIterator(Iterator<? extends E> it2) {
        return PushbackIterator.pushbackIterator(it2);
    }
    ...
    public static <E> SkippingIterator<E> skippingIterator(Iterator<E> it2, long j) {
        return new SkippingIterator<>(it2, j);
    }
    ...
    public static <E> String toString(Iterator<E> it2) {
        return toString(it2, TransformerUtils.stringValueTransformer(), DEFAULT_TOSTRING_DELIMITER, DEFAULT_TOSTRING_PREFIX, DEFAULT_TOSTRING_SUFFIX);
    }
    ...
    public static <E> Iterator<E> unmodifiableIterator(Iterator<E> it2) {
        return UnmodifiableIterator.unmodifiableIterator(it2);
    }
    ...
    public static <E> BoundedIterator<E> boundedIterator(Iterator<? extends E> it2, long j, long j2) {
        return new BoundedIterator<>(it2, j, j2);
    }
    ...
    public static <E> String toString(Iterator<E> it2, Transformer<? super E, String> transformer) {
        return toString(it2, transformer, DEFAULT_TOSTRING_DELIMITER, DEFAULT_TOSTRING_PREFIX, DEFAULT_TOSTRING_SUFFIX);
    }

    public static <E> ZippingIterator<E> zippingIterator(Iterator<? extends E> it2, Iterator<? extends E> it3, Iterator<? extends E> it4) {
        return new ZippingIterator<>(it2, it3, it4);
    }
    ...
    public static <E> String toString(Iterator<E> it2, Transformer<? super E, String> transformer, String str, String str2, String str3) {
        if (transformer != null) {
            ...
            if (str3 != null) {
                ...
                if (it2 != null) {
                    while (it2.hasNext()) {
                        sb.append(transformer.mo12738transform(it2.next()));
                        sb.append(str);
                    }

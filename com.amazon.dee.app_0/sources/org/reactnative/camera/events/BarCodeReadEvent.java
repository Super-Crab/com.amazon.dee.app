    ...
    private WritableMap serializeEventData() {
        ...
        for (ResultPoint resultPoint : this.mBarCode.getResultPoints()) {
            if (resultPoint != null) {
                ...
                createMap3.putString(ReactProperties.HereMapMarker.X, String.valueOf(resultPoint.getX()));
                createMap3.putString(ReactProperties.HereMapMarker.Y, String.valueOf(resultPoint.getY()));

...
public final class LoggerFactory {
    ...
    private static void reportActualBinding(Set<URL> set) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Actual binding is of type [");
        outline107.append(StaticLoggerBinder.getSingleton().getLoggerFactoryClassStr());
        outline107.append("]");
        Util.report(outline107.toString());
    }

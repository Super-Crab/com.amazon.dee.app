...
public final class LimitChronology extends AssembledChronology {
    ...
    public class LimitException extends IllegalArgumentException {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("IllegalArgumentException: ");
    ...
    public int hashCode() {
        ...
        return (getBase().hashCode() * 7) + hashCode + i;
    }

    @Override // org.joda.time.chrono.BaseChronology, org.joda.time.Chronology
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("LimitChronology[");
        outline107.append(getBase().toString());
        outline107.append(", ");
        String str = "NoLimit";
        outline107.append(getLowerLimit() == null ? str : getLowerLimit().toString());
        outline107.append(", ");
        if (getUpperLimit() != null) {

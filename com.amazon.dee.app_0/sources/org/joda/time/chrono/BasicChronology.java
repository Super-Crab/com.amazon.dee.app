...
public abstract class BasicChronology extends AssembledChronology {
    ...
    private static final DurationField cHalfdaysField = new PreciseDurationField(DurationFieldType.halfdays(), TransferCriteriaBuilder.REPEAT_INTERVAL_12_HOURS);
    ...
    long getFirstWeekOfYearMillis(int i) {
        ...
        return dayOfWeek > 8 - this.iMinDaysInFirstWeek ? ((8 - dayOfWeek) * 86400000) + yearMillis : yearMillis - ((dayOfWeek - 1) * 86400000);
    }
    ...
    public long getYearMonthDayMillis(int i, int i2, int i3) {
        return ((i3 - 1) * 86400000) + getYearMillis(i) + getTotalMillisByYearMonth(i, i2);
    }

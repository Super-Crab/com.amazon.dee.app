...
public final class ZonedChronology extends AssembledChronology {
    ...
    static boolean useTimeArithmetic(DurationField durationField) {
        return durationField != null && durationField.getUnitMillis() < TransferCriteriaBuilder.REPEAT_INTERVAL_12_HOURS;
    }
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("ZonedChronology[");
        outline107.append(getBase());
        outline107.append(", ");
        outline107.append(getZone().getID());

...
public final class IslamicChronology extends BasicChronology {
    ...
    long calculateFirstDayOfYearMillis(int i) {
        ...
        if (i <= MAX_YEAR) {
            if (i < MIN_YEAR) {
                throw new ArithmeticException(GeneratedOutlineSupport1.outline53("Year is too small: ", i, " < ", MIN_YEAR));
            }
        ...
        throw new ArithmeticException(GeneratedOutlineSupport1.outline53("Year is too large: ", i, " > ", MAX_YEAR));
    }
    ...
    long getTotalMillisByYearMonth(int i, int i2) {
        ...
        int i4 = i3 % 2;
        int i5 = i3 / 2;
        return i4 == 1 ? (i5 * MILLIS_PER_MONTH_PAIR) + MILLIS_PER_LONG_MONTH : i5 * MILLIS_PER_MONTH_PAIR;
    }

        ...
        try {
            ...
            if (julianChronology == null) {
                synchronized (julianChronologyArr) {
                    ...
                    if (julianChronology == null) {
                        JulianChronology julianChronology2 = dateTimeZone == DateTimeZone.UTC ? new JulianChronology(null, null, i) : new JulianChronology(ZonedChronology.getInstance(getInstance(DateTimeZone.UTC, i), dateTimeZone), null, i);

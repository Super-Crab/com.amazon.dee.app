...
public final class GJChronology extends AssembledChronology {
    ...
    private final class ImpreciseCutoverField extends CutoverField {
        ...
        public long add(long j, int i) {
            ...
            if (j < this.iCutover) {
                ...
                return (add < this.iCutover || add - GJChronology.this.iGapDuration < this.iCutover) ? add : julianToGregorian(add);
            }
            long add2 = this.iGregorianField.add(j, i);
            if (add2 >= this.iCutover || GJChronology.this.iGapDuration + add2 >= this.iCutover) {
                return add2;
            }
    ...
    public int hashCode() {
        return this.iCutoverInstant.hashCode() + getMinimumDaysInFirstWeek() + getZone().hashCode() + ("GJ".hashCode() * 11);
    }

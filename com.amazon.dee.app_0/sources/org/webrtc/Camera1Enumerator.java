...
public class Camera1Enumerator implements CameraEnumerator {
    ...
    private static List<CameraEnumerationAndroid.CaptureFormat> enumerateFormats(int i) {
        ...
        try {
            try {
                ...
                StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Get supported formats for camera index ", i, " done. Time spent: ");
                outline109.append(elapsedRealtime2 - elapsedRealtime);
                outline109.append(" ms.");
                Logging.d(TAG, outline109.toString());
                return arrayList;
    ...
    public static int getCameraIndex(String str) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline72("No such camera: ", str));
    }
    ...
    public boolean isExternalFacing(String str) {
        Logging.w(TAG, "External facing camera is not supported with Camera1Enumerator");
        return false;
    }

...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size(160, 120), new Size(240, 160), new Size(DeviceConfigConstants.VIDEO_WIDTH_320, 240), new Size(400, 240), new Size(480, DeviceConfigConstants.VIDEO_WIDTH_320), new Size(640, 360), new Size(640, 480), new Size(768, 480), new Size(854, 480), new Size(800, DeviceConfigConstants.VIDEO_BITRATE_600_KBPS), new Size(960, 540), new Size(960, 640), new Size(1024, 576), new Size(1024, DeviceConfigConstants.VIDEO_BITRATE_600_KBPS), new Size(1280, 720), new Size(1280, 1024), new Size(1920, PhotoshopDirectory.TAG_COUNT_INFORMATION), new Size(1920, DateTimeConstants.MINUTES_PER_DAY), new Size(2560, DateTimeConstants.MINUTES_PER_DAY), new Size(3840, 2160)));
    ...
    public static class CaptureFormat {
        ...
        public static class FramerateRange {
            ...
            public String toString() {
                ...
                outline107.append(this.min / 1000.0f);
                outline107.append(":");
                outline107.append(this.max / 1000.0f);
                outline107.append("]");
        ...
        public String toString() {
            return this.width + ReactProperties.HereMapMarker.X + this.height + "@" + this.framerate;
        }

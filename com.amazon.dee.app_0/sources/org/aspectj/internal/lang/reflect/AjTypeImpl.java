            ...
            for (Method method : this.clazz.getDeclaredMethods()) {
                if (method.isAnnotationPresent(ajcITD.class) && method.getName().contains("ajc$interFieldInit")) {
                    ...
                    try {
                        ...
                        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Can't find field get dispatch method for ");
    ...
    public PerClause getPerClause() {
        if (isAspect()) {
            ...
            if (value.equals("")) {
                ...
                return new PointcutBasedPerClauseImpl(PerClauseKind.PERTHIS, GeneratedOutlineSupport1.outline50(value, -1, 8));
            } else {
                if (value.startsWith("pertarget(")) {
                    return new PointcutBasedPerClauseImpl(PerClauseKind.PERTARGET, GeneratedOutlineSupport1.outline50(value, -1, 10));
                }
                if (value.startsWith("percflow(")) {
                    return new PointcutBasedPerClauseImpl(PerClauseKind.PERCFLOW, GeneratedOutlineSupport1.outline50(value, -1, 9));
                }
                if (value.startsWith("percflowbelow(")) {
                    return new PointcutBasedPerClauseImpl(PerClauseKind.PERCFLOWBELOW, GeneratedOutlineSupport1.outline50(value, -1, 14));
                }
                if (value.startsWith("pertypewithin")) {
                    return new TypePatternBasedPerClauseImpl(PerClauseKind.PERTYPEWITHIN, GeneratedOutlineSupport1.outline50(value, -1, 14));
                }
                throw new IllegalStateException(GeneratedOutlineSupport1.outline72("Per-clause not recognized: ", value));
            }
        }
        return null;
    }

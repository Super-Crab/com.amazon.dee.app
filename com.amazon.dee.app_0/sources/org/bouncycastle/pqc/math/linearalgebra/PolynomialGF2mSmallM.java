...
public class PolynomialGF2mSmallM {
    ...
    public PolynomialGF2mSmallM(GF2mField gF2mField, int i, char c, SecureRandom secureRandom) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline48(" Error: type ", c, " is not defined for GF2smallmPolynomial"));
    }
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107(" Polynomial over ");
        outline107.append(this.field.toString());
        outline107.append(": \n");
        String sb = outline107.toString();
        for (int i = 0; i < this.coefficients.length; i++) {
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107(sb);
            outline1072.append(this.field.elementToStr(this.coefficients[i]));
            outline1072.append("Y^");

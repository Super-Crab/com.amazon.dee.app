...
public final class ByteUtils {
    ...
    public static String toBinaryString(byte[] bArr) {
        ...
        while (i < bArr.length) {
            ...
            for (int i2 = 0; i2 < 8; i2++) {
                str2 = GeneratedOutlineSupport1.outline49(str2, (b >>> i2) & 1);
            }
            str = i != bArr.length + (-1) ? GeneratedOutlineSupport1.outline72(str2, " ") : str2;
            i++;
        }
        return str;
    }
    ...
    public static String toHexString(byte[] bArr, String str, String str2) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            ...
            if (i < bArr.length - 1) {
                str3 = GeneratedOutlineSupport1.outline72(str3, str2);
            }
        }
        return str3;
    }

...
public class ParSet extends ASN1Object {
    ...
    private ParSet(ASN1Sequence aSN1Sequence) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline100(aSN1Sequence, GeneratedOutlineSupport1.outline107("sie of seqOfParams = ")));
    }
    ...
    private static int checkBigIntegerInIntRangeAndPositive(ASN1Encodable aSN1Encodable) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("BigInteger not in Range: ", intValueExact));
    }

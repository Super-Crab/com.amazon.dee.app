...
public class RainbowPrivateKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        outline137.add(new DEROctetString(this.b1));
        aSN1EncodableVector.add(new DERSequence(outline137));
        ...
        ASN1EncodableVector outline1372 = GeneratedOutlineSupport1.outline137(aSN1EncodableVector3, aSN1EncodableVector);
        outline1372.add(new DEROctetString(this.b2));

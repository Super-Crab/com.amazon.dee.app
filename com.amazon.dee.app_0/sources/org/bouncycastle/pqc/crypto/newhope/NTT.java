        ...
        for (int i = 0; i < 10; i += 2) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                while (i5 < 1023) {
                    ...
                    short s = sArr2[i4];
                    sArr[i5] = (short) (i6 + i8);
                    sArr[i7] = Reduce.montgomery(((i6 + ExifDirectoryBase.TAG_DATETIME_ORIGINAL) - i8) * s);
                    i5 += i2 * 2;
                    i4 = i9;
                }
            }
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                while (i13 < 1023) {
                    ...
                    sArr[i15] = Reduce.montgomery(((i14 + ExifDirectoryBase.TAG_DATETIME_ORIGINAL) - i16) * s2);
                    i13 += i10 * 2;
                    i12 = i17;
                }
            }

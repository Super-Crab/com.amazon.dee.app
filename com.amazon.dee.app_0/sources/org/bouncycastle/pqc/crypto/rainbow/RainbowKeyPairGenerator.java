        ...
        for (int i23 = 0; i23 < i2; i23++) {
            ...
            while (true) {
                ...
                if (i24 < sArr17.length) {
                    ...
                    sArr15[i23] = computeInField.addVect(sArr15[i23], computeInField.multVect(this.A1[i23][i24], this.pub_singular[i24]));
                    sArr16[i23] = GF2Field.addElem(sArr16[i23], GF2Field.multElem(this.A1[i23][i24], this.pub_scalar[i24]));
                    i24++;
                }
            }
            sArr16[i23] = GF2Field.addElem(sArr16[i23], this.b1[i23]);
        }

...
public class Layer {
    ...
    public int hashCode() {
        int hashCode = Arrays.hashCode(this.coeff_alpha);
        int hashCode2 = Arrays.hashCode(this.coeff_beta);
        int hashCode3 = Arrays.hashCode(this.coeff_gamma);
        return Arrays.hashCode(this.coeff_eta) + ((hashCode3 + ((hashCode2 + ((hashCode + (((((this.vi * 37) + this.viNext) * 37) + this.oi) * 37)) * 37)) * 37)) * 37);
    }

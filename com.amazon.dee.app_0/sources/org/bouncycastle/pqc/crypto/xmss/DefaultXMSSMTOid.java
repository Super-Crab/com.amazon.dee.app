...
public final class DefaultXMSSMTOid implements XMSSOid {
    ...
    private static String createKey(String str, int i, int i2, int i3, int i4, int i5) {
        if (str != null) {
            return str + ProcessIdUtil.DEFAULT_PROCESSID + i + ProcessIdUtil.DEFAULT_PROCESSID + i2 + ProcessIdUtil.DEFAULT_PROCESSID + i3 + ProcessIdUtil.DEFAULT_PROCESSID + i4 + ProcessIdUtil.DEFAULT_PROCESSID + i5;
        }

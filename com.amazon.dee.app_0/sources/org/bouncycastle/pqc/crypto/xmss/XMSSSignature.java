...
public final class XMSSSignature extends XMSSReducedSignature implements XMSSStoreableObjectInterface, Encodable {
    ...
    public static class Builder extends XMSSReducedSignature.Builder {
        ...
        public XMSSSignature mo12865build() {
    ...
    public byte[] toByteArray() {
        int treeDigestSize = getParams().getTreeDigestSize();
        byte[] bArr = new byte[GeneratedOutlineSupport1.outline1(treeDigestSize, 4, getParams().getWOTSPlus().getParams().getLen() * treeDigestSize, getParams().getHeight() * treeDigestSize)];

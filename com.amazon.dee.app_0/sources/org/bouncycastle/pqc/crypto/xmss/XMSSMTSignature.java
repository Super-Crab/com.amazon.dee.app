    ...
    private XMSSMTSignature(Builder builder) {
        ...
        if (xMSSMTParameters != null) {
            ...
            for (int i2 = i + treeDigestSize; i2 < bArr.length; i2 += height) {
                this.reducedSignatures.add(new XMSSReducedSignature.Builder(this.params.getXMSSParameters()).withReducedSignature(XMSSUtil.extractBytesAtOffset(bArr, i2, height)).mo12865build());
            }
            return;
        }

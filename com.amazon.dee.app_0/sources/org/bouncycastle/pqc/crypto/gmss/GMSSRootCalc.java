...
public class GMSSRootCalc {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.heightOfTree + 1 + size; i2++) {
            str = GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107(str), new String(Hex.encode(getStatByte()[i2])), " ");
        }
        StringBuilder outline113 = GeneratedOutlineSupport1.outline113(str, "  ");
        outline113.append(this.digestProvider.get().getDigestSize());

...
public class Treehash {
    ...
    public void initialize() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport1.outline86(GeneratedOutlineSupport1.outline107("Seed "), this.maxHeight, " not initialized"));
    }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.tailLength + 3; i2++) {
            if (getStatByte()[i2] != null) {
                outline113 = GeneratedOutlineSupport1.outline107(str);
                outline113.append(new String(Hex.encode(getStatByte()[i2])));
                outline113.append(" ");
            } else {
                outline113 = GeneratedOutlineSupport1.outline113(str, "null ");
            }
            str = outline113.toString();
        }
        StringBuilder outline1132 = GeneratedOutlineSupport1.outline113(str, "  ");
        outline1132.append(this.messDigestTree.getDigestSize());
        return outline1132.toString();
    }

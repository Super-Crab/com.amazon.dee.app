    ...
    public static void l_tree(HashFunctions hashFunctions, byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3) {
        ...
        for (int i6 = 0; i6 < 7; i6++) {
            ...
            while (true) {
                ...
                hashFunctions.hash_2n_n_mask(bArr2, (i7 * 32) + i2, bArr2, (i7 * 2 * 32) + i2, bArr3, (i6 * 2 * 32) + i3);
                i7++;
            }
            if ((i5 & 1) != 0) {
                System.arraycopy(bArr2, GeneratedOutlineSupport1.outline2(i5, -1, 32, i2), bArr2, (i4 * 32) + i2, 32);
                i4++;
            }
            i5 = i4;
        }

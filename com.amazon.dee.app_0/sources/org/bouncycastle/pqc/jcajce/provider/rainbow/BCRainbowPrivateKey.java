...
public class BCRainbowPrivateKey implements PrivateKey {
    ...
    public int hashCode() {
        int hashCode = org.bouncycastle.util.Arrays.hashCode(this.A1inv);
        int hashCode2 = org.bouncycastle.util.Arrays.hashCode(this.b1);
        int hashCode3 = org.bouncycastle.util.Arrays.hashCode(this.A2inv);
        int hashCode4 = org.bouncycastle.util.Arrays.hashCode(this.vi) + ((org.bouncycastle.util.Arrays.hashCode(this.b2) + ((hashCode3 + ((hashCode2 + ((hashCode + (this.layers.length * 37)) * 37)) * 37)) * 37)) * 37);
        for (int length = this.layers.length - 1; length >= 0; length--) {
            hashCode4 = (hashCode4 * 37) + this.layers[length].hashCode();
        }
        return hashCode4;
    }
}

...
public class BCRainbowPublicKey implements PublicKey {
    ...
    public int hashCode() {
        int hashCode = Arrays.hashCode(this.coeffquadratic);
        int hashCode2 = Arrays.hashCode(this.coeffsingular);
        return Arrays.hashCode(this.coeffscalar) + ((hashCode2 + ((hashCode + (this.docLength * 37)) * 37)) * 37);
    }
}

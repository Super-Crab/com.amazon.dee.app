...
public class McElieceCCA2KeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    protected PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        if (!(keySpec instanceof PKCS8EncodedKeySpec)) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unsupported key specification: ");
            outline107.append(keySpec.getClass());
            outline107.append(".");
        ...
        try {
            ...
            throw new InvalidKeySpecException(GeneratedOutlineSupport1.outline65("Unable to decode PKCS8EncodedKeySpec: ", e));
        }
    }
    ...
    protected PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            try {
                ...
                throw new InvalidKeySpecException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("Unable to decode X509EncodedKeySpec: ")));
            }
    ...
    public KeySpec getKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        if (key instanceof BCMcElieceCCA2PrivateKey) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unsupported key type: ");
            outline107.append(key.getClass());
            outline107.append(".");
            throw new InvalidKeySpecException(outline107.toString());

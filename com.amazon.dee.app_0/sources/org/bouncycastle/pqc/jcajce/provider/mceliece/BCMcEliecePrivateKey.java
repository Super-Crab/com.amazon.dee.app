...
public class BCMcEliecePrivateKey implements CipherParameters, PrivateKey {
    ...
    public int hashCode() {
        ...
        int hashCode = this.params.getField().hashCode();
        int hashCode2 = this.params.getGoppaPoly().hashCode();
        int hashCode3 = this.params.getP1().hashCode();
        int hashCode4 = this.params.getP2().hashCode();
        return this.params.getSInv().hashCode() + ((hashCode4 + ((hashCode3 + ((hashCode2 + ((hashCode + ((n + (this.params.getK() * 37)) * 37)) * 37)) * 37)) * 37)) * 37);
    }
}

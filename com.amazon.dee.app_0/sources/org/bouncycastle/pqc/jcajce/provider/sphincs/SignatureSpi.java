    ...
    protected void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        if (privateKey instanceof BCSphincs256PrivateKey) {
            ...
            if (!this.treeDigest.equals((ASN1Primitive) bCSphincs256PrivateKey.getTreeDigest())) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("SPHINCS-256 signature for tree digest: ");
                outline107.append(bCSphincs256PrivateKey.getTreeDigest());
    ...
    protected void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        if (publicKey instanceof BCSphincs256PublicKey) {
            ...
            if (!this.treeDigest.equals((ASN1Primitive) bCSphincs256PublicKey.getTreeDigest())) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("SPHINCS-256 signature for tree digest: ");
                outline107.append(bCSphincs256PublicKey.getTreeDigest());
                throw new InvalidKeyException(outline107.toString());
            }

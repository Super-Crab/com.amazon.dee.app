...
public class LocalizedMessage {
    ...
    public LocalizedMessage(String str, String str2, String str3) throws NullPointerException, UnsupportedEncodingException {
        ...
        if (!Charset.isSupported(str3)) {
            throw new UnsupportedEncodingException(GeneratedOutlineSupport1.outline75("The encoding \"", str3, "\" is not supported."));
        }
        this.encoding = str3;
    }
    ...
    public String getEntry(String str, Locale locale, TimeZone timeZone) throws MissingEntryException {
        String str2 = this.id;
        if (str != null) {
            str2 = GeneratedOutlineSupport1.outline75(str2, ".", str);
        }
        String str3 = str2;
        try {
            ...
            String outline91 = GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline115("Can't find entry ", str3, " in resource file "), this.resource, ".");
            String str4 = this.resource;
            ClassLoader classLoader = this.loader;
            if (classLoader == null) {
                classLoader = getClassLoader();
            }
            throw new MissingEntryException(outline91, str4, str3, locale, classLoader);
        }
    }
    ...
    public String toString() {
        StringBuffer outline103 = GeneratedOutlineSupport1.outline103("Resource: \"");
        outline103.append(this.resource);
        outline103.append("\" Id: \"");
        outline103.append(this.id);
        outline103.append(EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED);
        outline103.append(" Arguments: ");
        outline103.append(this.arguments.getArguments().length);
        outline103.append(" normal");
        FilteredArguments filteredArguments = this.extraArgs;
        if (filteredArguments != null && filteredArguments.getArguments().length > 0) {
            outline103.append(", ");
            outline103.append(this.extraArgs.getArguments().length);
            outline103.append(" extra");
        }
        outline103.append(" Encoding: ");
        outline103.append(this.encoding);
        outline103.append(" ClassLoader: ");
        outline103.append(this.loader);

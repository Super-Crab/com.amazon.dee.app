...
public class PEMUtil {
    ...
    public PEMUtil(String str) {
        this._header1 = GeneratedOutlineSupport1.outline75("-----BEGIN ", str, "-----");
        this._header2 = GeneratedOutlineSupport1.outline75("-----BEGIN X509 ", str, "-----");
        this._footer1 = GeneratedOutlineSupport1.outline75("-----END ", str, "-----");
        this._footer2 = GeneratedOutlineSupport1.outline75("-----END X509 ", str, "-----");
    }

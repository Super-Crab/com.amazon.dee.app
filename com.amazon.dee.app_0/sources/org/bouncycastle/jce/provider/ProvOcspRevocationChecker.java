...
public class ProvOcspRevocationChecker implements PKIXCertRevocationChecker {
    ...
    private CertID createCertID(AlgorithmIdentifier algorithmIdentifier, Certificate certificate, ASN1Integer aSN1Integer) throws CertPathValidatorException {
        try {
            ...
            throw new CertPathValidatorException(GeneratedOutlineSupport1.outline68("problem creating ID: ", e), e);
        }
    }
    ...
    private Certificate extractCert() throws CertPathValidatorException {
        try {
            ...
            throw new CertPathValidatorException(GeneratedOutlineSupport1.outline41(e, GeneratedOutlineSupport1.outline107("cannot process signing cert: ")), e, this.parameters.getCertPath(), this.parameters.getIndex());
        }
    }
    ...
    public static boolean validatedOcspResponse(BasicOCSPResponse basicOCSPResponse, PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, byte[] bArr, X509Certificate x509Certificate, JcaJceHelper jcaJceHelper) throws CertPathValidatorException {
        try {
            ...
            if (signerCert != null) {
                ...
                X509Certificate x509Certificate2 = (X509Certificate) jcaJceHelper.createCertificateFactory(KeyUtils.X509_CERITIFATE_FACTORY).generateCertificate(new ByteArrayInputStream(certs.getObjectAt(0).toASN1Primitive().getEncoded()));
            ...
            throw new CertPathValidatorException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("OCSP response failure: ")), e, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
        } catch (CertPathValidatorException e2) {
            throw e2;
        } catch (GeneralSecurityException e3) {
            throw new CertPathValidatorException(GeneratedOutlineSupport1.outline99(e3, GeneratedOutlineSupport1.outline107("OCSP response failure: ")), e3, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
        }
    }

    /* JADX WARN: Code restructure failed: missing block: B:65:0x019b, code lost:
        if (r0.getHashAlgorithm().equals(r1.getCertID().getHashAlgorithm()) != false) goto L55;
     */

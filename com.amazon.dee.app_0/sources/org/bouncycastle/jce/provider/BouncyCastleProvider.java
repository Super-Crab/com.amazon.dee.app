...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    private static final String[] ASYMMETRIC_CIPHERS = {"DSA", "DH", KeyUtils.ALGORITHM_EC, KeyUtils.ALGORITHM_RSA, "GOST", "ECGOST", "ElGamal", "DSTU4145", "GM", "EdEC"};
    ...
    private void loadAlgorithms(String str, String[] strArr) {
        for (int i = 0; i != strArr.length; i++) {
            ...
            outline107.append("$Mappings");
            Class loadClass = ClassUtil.loadClass(BouncyCastleProvider.class, outline107.toString());
            if (loadClass != null) {
                try {

...
public class X509StoreLDAPAttrCerts extends X509StoreSpi {
    ...
    public void engineInit(X509StoreParameters x509StoreParameters) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline40(X509LDAPCertStoreParameters.class, GeneratedOutlineSupport1.outline107("Initialization parameters must be an instance of "), "."));
    }
}

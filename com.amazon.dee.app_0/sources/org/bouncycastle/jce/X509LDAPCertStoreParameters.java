...
public class X509LDAPCertStoreParameters implements X509StoreParameters, CertStoreParameters {
    ...
    public static X509LDAPCertStoreParameters getInstance(LDAPCertStoreParameters lDAPCertStoreParameters) {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("ldap://");
        outline107.append(lDAPCertStoreParameters.getServerName());
        outline107.append(":");
        outline107.append(lDAPCertStoreParameters.getPort());
        return new Builder(outline107.toString(), "").build();
    }

...
public class IESCipher extends CipherSpi {
    ...
    public void engineInit(int i, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameters != null) {
            try {
                ...
                throw new InvalidAlgorithmParameterException(GeneratedOutlineSupport1.outline42(e, GeneratedOutlineSupport1.outline107("cannot recognise parameters: ")));
            }
        } else {
            parameterSpec = null;
        }
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException, InvalidKeyException {
        ...
        throw new InvalidAlgorithmParameterException(GeneratedOutlineSupport1.outline86(GeneratedOutlineSupport1.outline107("NONCE in IES Parameters needs to be "), this.ivLength, " bytes long"));
    }

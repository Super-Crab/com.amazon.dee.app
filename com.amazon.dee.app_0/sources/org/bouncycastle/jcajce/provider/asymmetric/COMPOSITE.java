...
public class COMPOSITE {
    ...
    public static class KeyFactory extends BaseKeyFactorySpi {
        ...
        protected Key engineTranslateKey(Key key) throws InvalidKeyException {
            try {
                ...
                throw new InvalidKeyException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("key could not be parsed: ")));
            }
        }
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            StringBuilder outline119 = GeneratedOutlineSupport1.outline119(GeneratedOutlineSupport1.outline121(configurableProvider, "KeyFactory.COMPOSITE", "org.bouncycastle.jcajce.provider.asymmetric.COMPOSITE$KeyFactory", "KeyFactory."), MiscObjectIdentifiers.id_alg_composite, configurableProvider, "org.bouncycastle.jcajce.provider.asymmetric.COMPOSITE$KeyFactory", "KeyFactory.OID.");
            outline119.append(MiscObjectIdentifiers.id_alg_composite);
            configurableProvider.addAlgorithm(outline119.toString(), "org.bouncycastle.jcajce.provider.asymmetric.COMPOSITE$KeyFactory");

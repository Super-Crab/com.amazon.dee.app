...
public class CipherSpi extends BaseCipherSpi {
    ...
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec instanceof OAEPParameterSpec) {
            ...
            if (digest == null) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("no match on digest algorithm: ");
                outline107.append(oAEPParameterSpec.getDigestAlgorithm());
            ...
            if (digest2 == null) {
                StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("no match on MGF digest algorithm: ");
                outline1072.append(mGF1ParameterSpec.getDigestAlgorithm());
        ...
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
                        throw new InvalidParameterException(GeneratedOutlineSupport1.outline52("unknown opmode ", i, " passed to ElGamal"));
                    }
                }
            }
            ...
            if (!upperCase.equals("OAEPPADDING")) {
                if (upperCase.equals("OAEPWITHMD5ANDMGF1PADDING")) {
                    ...
                    if (upperCase.equals("OAEPWITHSHA224ANDMGF1PADDING")) {
                        ...
                        throw new NoSuchPaddingException(GeneratedOutlineSupport1.outline72(str, " unavailable with ElGamal."));
                    } else {

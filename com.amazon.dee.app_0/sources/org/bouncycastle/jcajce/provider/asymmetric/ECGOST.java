...
public class ECGOST {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder outline122 = GeneratedOutlineSupport1.outline122(configurableProvider, "Alg.Alias.Signature.GOST-3410-2001", "ECGOST3410", "KeyAgreement.ECGOST3410", "org.bouncycastle.jcajce.provider.asymmetric.ecgost.KeyAgreementSpi$ECVKO");
            outline122.append("Alg.Alias.KeyAgreement.");
            GeneratedOutlineSupport1.outline183(outline122, CryptoProObjectIdentifiers.gostR3410_2001, configurableProvider, "ECGOST3410");
            GeneratedOutlineSupport1.outline183(GeneratedOutlineSupport1.outline121(configurableProvider, "Alg.Alias.KeyAgreement.GOST-3410-2001", "ECGOST3410", "Alg.Alias.KeyAgreement."), CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_ESDH, configurableProvider, "ECGOST3410");
            ...
            StringBuilder outline1222 = GeneratedOutlineSupport1.outline122(configurableProvider, "KeyAgreement.ECGOST3410-2012-256", "org.bouncycastle.jcajce.provider.asymmetric.ecgost12.KeyAgreementSpi$ECVKO256", "KeyAgreement.ECGOST3410-2012-512", "org.bouncycastle.jcajce.provider.asymmetric.ecgost12.KeyAgreementSpi$ECVKO512");
            outline1222.append("Alg.Alias.KeyAgreement.");
            GeneratedOutlineSupport1.outline183(GeneratedOutlineSupport1.outline119(GeneratedOutlineSupport1.outline119(GeneratedOutlineSupport1.outline119(outline1222, RosstandartObjectIdentifiers.id_tc26_agreement_gost_3410_12_256, configurableProvider, "ECGOST3410-2012-256", "Alg.Alias.KeyAgreement."), RosstandartObjectIdentifiers.id_tc26_agreement_gost_3410_12_512, configurableProvider, "ECGOST3410-2012-512", "Alg.Alias.KeyAgreement."), RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256, configurableProvider, "ECGOST3410-2012-256", "Alg.Alias.KeyAgreement."), RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512, configurableProvider, "ECGOST3410-2012-512");
        }
    }
}

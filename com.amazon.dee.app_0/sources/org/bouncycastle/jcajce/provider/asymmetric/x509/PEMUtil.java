...
public class PEMUtil {
    ...
    public class Boundaries {
        ...
        private Boundaries(String str) {
            this._header = GeneratedOutlineSupport1.outline75("-----BEGIN ", str, "-----");
            this._footer = GeneratedOutlineSupport1.outline75("-----END ", str, "-----");
        }
    ...
    public PEMUtil(String str) {
        this._supportedBoundaries = new Boundaries[]{new Boundaries(str), new Boundaries(GeneratedOutlineSupport1.outline72("X509 ", str)), new Boundaries("PKCS7")};
    }

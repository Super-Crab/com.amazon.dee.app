...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    public CertPath engineGenerateCertPath(List list) throws CertificateException {
        for (Object obj : list) {
            if (obj != null && !(obj instanceof X509Certificate)) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("list contains non X509Certificate object while creating CertPath\n");
    ...
    public Certificate engineGenerateCertificate(InputStream inputStream) throws CertificateException {
        ...
        try {
            ...
            throw new ExCertificateException(GeneratedOutlineSupport1.outline41(e, GeneratedOutlineSupport1.outline107("parsing issue: ")), e);
        }
    }

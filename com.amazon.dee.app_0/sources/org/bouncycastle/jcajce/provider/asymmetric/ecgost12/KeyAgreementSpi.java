...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    private void initFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException {
        if (!(key instanceof PrivateKey)) {
            ...
            throw new InvalidKeyException(GeneratedOutlineSupport1.outline91(sb, getSimpleName(ECPrivateKey.class), " for initialisation"));
        }
    ...
    protected Key engineDoPhase(Key key, boolean z) throws InvalidKeyException, IllegalStateException {
        if (this.parameters != null) {
            ...
            try {
                ...
                throw new InvalidKeyException(GeneratedOutlineSupport1.outline41(e, GeneratedOutlineSupport1.outline107("calculation failed: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ecgost12.KeyAgreementSpi.1

...
public class BCRSAPublicKey implements RSAPublicKey {
    ...
    public String getAlgorithm() {
        return this.algorithmIdentifier.getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_RSASSA_PSS) ? "RSASSA-PSS" : KeyUtils.ALGORITHM_RSA;
    }
    ...
    public String toString() {
        ...
        stringBuffer.append("]");
        stringBuffer.append(",[");
        GeneratedOutlineSupport1.outline174(stringBuffer, RSAUtil.generateExponentFingerprint(getPublicExponent()), "]", lineSeparator, "        modulus: ");

...
public class DRBG {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(new StringBuilder(), DRBG.PREFIX, "$Default", configurableProvider, "SecureRandom.DEFAULT"), DRBG.PREFIX, "$NonceAndIV", configurableProvider, "SecureRandom.NONCEANDIV");
        }
    }
        ...
        return (EntropySourceProvider) AccessController.doPrivileged(new PrivilegedAction<EntropySourceProvider>() { // from class: org.bouncycastle.jcajce.provider.drbg.DRBG.3
            ...
            public EntropySourceProvider run() {
                try {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("entropy source ");
                    outline107.append(propertyValue);
                    outline107.append(" not created: ");

...
public final class DESede {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            GeneratedOutlineSupport1.outline182(new StringBuilder(), PREFIX, "$ECB", configurableProvider, "Cipher.DESEDE");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline123(configurableProvider, "Cipher", PKCSObjectIdentifiers.des_EDE3_CBC, GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$CBC")), PREFIX, "$Wrap", configurableProvider, "Cipher.DESEDEWRAP");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline123(configurableProvider, "Cipher", PKCSObjectIdentifiers.id_alg_CMS3DESwrap, GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$Wrap")), PREFIX, "$RFC3211", configurableProvider, "Cipher.DESEDERFC3211WRAP");
            ...
            if (configurableProvider.hasAlgorithm("MessageDigest", "SHA-1")) {
                GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(new StringBuilder(), PREFIX, "$PBEWithSHAAndDES3Key", configurableProvider, "Cipher.PBEWITHSHAAND3-KEYTRIPLEDES-CBC"), PREFIX, "$PBEWithSHAAndDES2Key", configurableProvider, "Cipher.PBEWITHSHAAND2-KEYTRIPLEDES-CBC");
            ...
            StringBuilder outline117 = GeneratedOutlineSupport1.outline117(new StringBuilder(), PREFIX, "$KeyGenerator", configurableProvider, "KeyGenerator.DESEDE");
            outline117.append("KeyGenerator.");
            outline117.append(PKCSObjectIdentifiers.des_EDE3_CBC);
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(new StringBuilder(), PREFIX, "$KeyGenerator3", configurableProvider, outline117.toString()), PREFIX, "$KeyGenerator", configurableProvider, "KeyGenerator.DESEDEWRAP"), PREFIX, "$KeyFactory", configurableProvider, "SecretKeyFactory.DESEDE");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline123(configurableProvider, "SecretKeyFactory", OIWObjectIdentifiers.desEDE, GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$KeyFactory")), PREFIX, "$CMAC", configurableProvider, "Mac.DESEDECMAC"), PREFIX, "$CBCMAC", configurableProvider, "Mac.DESEDEMAC");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline120(configurableProvider, "Alg.Alias.Mac.DESEDE", "DESEDEMAC"), PREFIX, "$DESedeCFB8", configurableProvider, "Mac.DESEDEMAC/CFB8");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline120(configurableProvider, "Alg.Alias.Mac.DESEDE/CFB8", "DESEDEMAC/CFB8"), PREFIX, "$DESede64", configurableProvider, "Mac.DESEDEMAC64");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline120(configurableProvider, "Alg.Alias.Mac.DESEDE64", "DESEDEMAC64"), PREFIX, "$DESede64with7816d4", configurableProvider, "Mac.DESEDEMAC64WITHISO7816-4PADDING");
            ...
            StringBuilder outline122 = GeneratedOutlineSupport1.outline122(configurableProvider, "Alg.Alias.Mac.DESEDEISO9797ALG1WITHISO7816-4PADDING", "DESEDEMAC64WITHISO7816-4PADDING", "AlgorithmParameters.DESEDE", "org.bouncycastle.jcajce.provider.symmetric.util.IvAlgorithmParameters");
            outline122.append("Alg.Alias.AlgorithmParameters.");
            StringBuilder outline1172 = GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline118(outline122, PKCSObjectIdentifiers.des_EDE3_CBC, configurableProvider, "DESEDE"), PREFIX, "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.DESEDE");
            outline1172.append("Alg.Alias.AlgorithmParameterGenerator.");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline118(outline1172, PKCSObjectIdentifiers.des_EDE3_CBC, configurableProvider, "DESEDE"), PREFIX, "$PBEWithSHAAndDES3KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAAND3-KEYTRIPLEDES-CBC"), PREFIX, "$PBEWithSHAAndDES2KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAAND2-KEYTRIPLEDES-CBC");

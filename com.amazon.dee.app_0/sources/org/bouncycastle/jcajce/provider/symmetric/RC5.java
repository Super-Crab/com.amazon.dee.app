...
public final class RC5 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            GeneratedOutlineSupport1.outline182(new StringBuilder(), PREFIX, "$ECB32", configurableProvider, "Cipher.RC5");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline120(configurableProvider, "Alg.Alias.Cipher.RC5-32", "RC5"), PREFIX, "$ECB64", configurableProvider, "Cipher.RC5-64"), PREFIX, "$KeyGen32", configurableProvider, "KeyGenerator.RC5");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline120(configurableProvider, "Alg.Alias.KeyGenerator.RC5-32", "RC5"), PREFIX, "$KeyGen64", configurableProvider, "KeyGenerator.RC5-64"), PREFIX, "$AlgParams", configurableProvider, "AlgorithmParameters.RC5"), PREFIX, "$AlgParams", configurableProvider, "AlgorithmParameters.RC5-64"), PREFIX, "$Mac32", configurableProvider, "Mac.RC5MAC");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline120(configurableProvider, "Alg.Alias.Mac.RC5", "RC5MAC"), PREFIX, "$CFB8Mac32", configurableProvider, "Mac.RC5MAC/CFB8");

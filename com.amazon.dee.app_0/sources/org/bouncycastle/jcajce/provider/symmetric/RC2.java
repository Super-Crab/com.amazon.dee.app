...
public final class RC2 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(new StringBuilder(), PREFIX, "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.RC2"), PREFIX, "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.1.2.840.113549.3.2"), PREFIX, "$KeyGenerator", configurableProvider, "KeyGenerator.RC2"), PREFIX, "$KeyGenerator", configurableProvider, "KeyGenerator.1.2.840.113549.3.2"), PREFIX, "$AlgParams", configurableProvider, "AlgorithmParameters.RC2"), PREFIX, "$AlgParams", configurableProvider, "AlgorithmParameters.1.2.840.113549.3.2"), PREFIX, "$ECB", configurableProvider, "Cipher.RC2"), PREFIX, "$Wrap", configurableProvider, "Cipher.RC2WRAP");
            configurableProvider.addAlgorithm("Alg.Alias.Cipher", PKCSObjectIdentifiers.id_alg_CMSRC2wrap, "RC2WRAP");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline123(configurableProvider, "Cipher", PKCSObjectIdentifiers.RC2_CBC, GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$CBC")), PREFIX, "$CBCMAC", configurableProvider, "Mac.RC2MAC");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline120(configurableProvider, "Alg.Alias.Mac.RC2", "RC2MAC"), PREFIX, "$CFB8MAC", configurableProvider, "Mac.RC2MAC/CFB8");
            ...
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline122(configurableProvider, "Alg.Alias.SecretKeyFactory.1.2.840.113549.1.12.1.5", "PBEWITHSHAAND128BITRC2-CBC", "Alg.Alias.SecretKeyFactory.1.2.840.113549.1.12.1.6", "PBEWITHSHAAND40BITRC2-CBC"), PREFIX, "$PBEWithMD2KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD2ANDRC2"), PREFIX, "$PBEWithMD5KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD5ANDRC2"), PREFIX, "$PBEWithSHA1KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHA1ANDRC2"), PREFIX, "$PBEWithSHAAnd128BitKeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAAND128BITRC2-CBC"), PREFIX, "$PBEWithSHAAnd40BitKeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAAND40BITRC2-CBC");
            ...
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline122(configurableProvider, "Alg.Alias.Cipher.PBEWITHSHA1AND128BITRC2-CBC", "PBEWITHSHAAND128BITRC2-CBC", "Alg.Alias.Cipher.PBEWITHSHA1AND40BITRC2-CBC", "PBEWITHSHAAND40BITRC2-CBC"), PREFIX, "$PBEWithSHA1AndRC2", configurableProvider, "Cipher.PBEWITHSHA1ANDRC2");
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline122(configurableProvider, "Alg.Alias.Cipher.PBEWITHSHAANDRC2-CBC", "PBEWITHSHA1ANDRC2", "Alg.Alias.Cipher.PBEWITHSHA1ANDRC2-CBC", "PBEWITHSHA1ANDRC2"), PREFIX, "$PBEWithSHAAnd128BitRC2", configurableProvider, "Cipher.PBEWITHSHAAND128BITRC2-CBC"), PREFIX, "$PBEWithSHAAnd40BitRC2", configurableProvider, "Cipher.PBEWITHSHAAND40BITRC2-CBC"), PREFIX, "$PBEWithMD5AndRC2", configurableProvider, "Cipher.PBEWITHMD5ANDRC2");

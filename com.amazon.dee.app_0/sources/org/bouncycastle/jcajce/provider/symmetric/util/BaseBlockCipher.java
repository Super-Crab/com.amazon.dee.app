...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    /* JADX WARN: Removed duplicated region for block: B:252:0x04a5 A[Catch: Exception -> 0x04ce, IllegalArgumentException -> 0x04d9, TryCatch #3 {IllegalArgumentException -> 0x04d9, Exception -> 0x04ce, blocks: (B:246:0x0477, B:247:0x0492, B:248:0x0493, B:250:0x049f, B:252:0x04a5, B:254:0x04a9, B:249:0x049a), top: B:266:0x046e }] */
    ...
    /* JADX WARN: Type inference failed for: r5v30, types: [org.bouncycastle.crypto.params.ParametersWithRandom] */
            ...
            if (this.modeName.equals("ECB")) {
                ...
                if (this.modeName.startsWith("PGPCFB")) {
                    ...
                    if (!equals && this.modeName.length() != 6) {
                        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("no mode support for ");
                        outline107.append(this.modeName);

...
abstract class SymmetricAlgorithmProvider extends AlgorithmProvider {
    ...
    public void addCMacAlgorithm(ConfigurableProvider configurableProvider, String str, String str2, String str3) {
        ...
        String outline92 = GeneratedOutlineSupport1.outline92(new StringBuilder(), "Alg.Alias.Mac.", str, "CMAC");
        configurableProvider.addAlgorithm(outline92, str + "-CMAC");
        configurableProvider.addAlgorithm("KeyGenerator." + str + "-CMAC", str3);
        String outline922 = GeneratedOutlineSupport1.outline92(new StringBuilder(), "Alg.Alias.KeyGenerator.", str, "CMAC");
        configurableProvider.addAlgorithm(outline922, str + "-CMAC");
    }
    ...
    public void addGMacAlgorithm(ConfigurableProvider configurableProvider, String str, String str2, String str3) {
        ...
        String outline92 = GeneratedOutlineSupport1.outline92(new StringBuilder(), "Alg.Alias.Mac.", str, "GMAC");
        configurableProvider.addAlgorithm(outline92, str + "-GMAC");
        configurableProvider.addAlgorithm("KeyGenerator." + str + "-GMAC", str3);
        String outline922 = GeneratedOutlineSupport1.outline92(new StringBuilder(), "Alg.Alias.KeyGenerator.", str, "GMAC");
        configurableProvider.addAlgorithm(outline922, str + "-GMAC");
    }

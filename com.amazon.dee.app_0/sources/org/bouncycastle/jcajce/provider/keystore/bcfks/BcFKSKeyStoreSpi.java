...
public class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    private static class SharedKeyStoreSpi extends BcFKSKeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
        ...
        public SharedKeyStoreSpi(JcaJceHelper jcaJceHelper) {
            ...
            try {
                ...
                jcaJceHelper.createSecureRandom(ChipIconTitleViewHolder.STATE_DEFAULT).nextBytes(this.seedKey);
                this.cache = new HashMap();
            } catch (GeneralSecurityException e) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("can't create random - ");
        ...
        public Key engineGetKey(String str, char[] cArr) throws NoSuchAlgorithmException, UnrecoverableKeyException {
            try {
                ...
                if (this.cache.containsKey(str) && !Arrays.constantTimeAreEqual(this.cache.get(str), calculateMac)) {
                    throw new UnrecoverableKeyException(GeneratedOutlineSupport1.outline75("unable to recover key (", str, ")"));
                }
                ...
                StringBuilder outline115 = GeneratedOutlineSupport1.outline115("unable to recover key (", str, "): ");
                outline115.append(e.getMessage());
                throw new UnrecoverableKeyException(outline115.toString());
            }
        }
    ...
    static {
        ...
        publicAlgMap.put(PKCSObjectIdentifiers.rsaEncryption, KeyUtils.ALGORITHM_RSA);
        publicAlgMap.put(X9ObjectIdentifiers.id_ecPublicKey, KeyUtils.ALGORITHM_EC);
    ...
    private byte[] calculateMac(byte[] bArr, AlgorithmIdentifier algorithmIdentifier, KeyDerivationFunc keyDerivationFunc, char[] cArr) throws NoSuchAlgorithmException, IOException, NoSuchProviderException {
        ...
        try {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Cannot set up MAC calculation: ");
    ...
    private Certificate decodeCertificate(Object obj) {
        ...
        if (jcaJceHelper != null) {
            try {
                return jcaJceHelper.createCertificateFactory(KeyUtils.X509_CERITIFATE_FACTORY).generateCertificate(new ByteArrayInputStream(org.bouncycastle.asn1.x509.Certificate.getInstance(obj).getEncoded()));
            } catch (Exception unused) {
                return null;
            }
        }
        try {
            return CertificateFactory.getInstance(KeyUtils.X509_CERITIFATE_FACTORY).generateCertificate(new ByteArrayInputStream(org.bouncycastle.asn1.x509.Certificate.getInstance(obj).getEncoded()));
    ...
    private char[] extractPassword(KeyStore.LoadStoreParameter loadStoreParameter) throws IOException {
        ...
        if (!(protectionParameter instanceof KeyStore.CallbackHandlerProtection)) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("no support for protection parameter of type ");
            outline107.append(protectionParameter.getClass().getName());
            throw new IllegalArgumentException(outline107.toString());
        }
        ...
        try {
            ...
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("PasswordCallback not recognised: ");
            outline1072.append(e.getMessage());
            throw new IllegalArgumentException(outline1072.toString(), e);
        }
    }
    ...
    private byte[] generateKey(KeyDerivationFunc keyDerivationFunc, String str, char[] cArr, int i) throws IOException {
        ...
        if (MiscObjectIdentifiers.id_scrypt.equals((ASN1Primitive) keyDerivationFunc.getAlgorithm())) {
            ...
            if (pBKDF2Params.getPrf().getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_hmacWithSHA512)) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("BCFKS KeyStore: unrecognized MAC PBKD PRF: ");
                outline107.append(pBKDF2Params.getPrf().getAlgorithm());
                throw new IOException(outline107.toString());
            }
        }
    }
    ...
    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i) {
        ...
        if (PKCSObjectIdentifiers.id_PBKDF2.equals((ASN1Primitive) aSN1ObjectIdentifier)) {
            return new KeyDerivationFunc(PKCSObjectIdentifiers.id_PBKDF2, new PBKDF2Params(bArr, AlphaProtocolHandlerBase.DEFAULT_MAX_FRAGMENT_SIZE_UPPER_BOUND, i, new AlgorithmIdentifier(PKCSObjectIdentifiers.id_hmacWithSHA512, DERNull.INSTANCE)));
        }
        throw new IllegalStateException(GeneratedOutlineSupport1.outline79("unknown derivation algorithm: ", aSN1ObjectIdentifier));
    }
        ...
        if (objectData != null) {
            if (!objectData.getType().equals(PRIVATE_KEY) && !objectData.getType().equals(PROTECTED_PRIVATE_KEY)) {
                if (!objectData.getType().equals(SECRET_KEY) && !objectData.getType().equals(PROTECTED_SECRET_KEY)) {
                    throw new UnrecoverableKeyException(GeneratedOutlineSupport1.outline75("BCFKS KeyStore unable to recover secret key (", str, "): type not recognized"));
                }
                ...
                try {
                    ...
                    throw new UnrecoverableKeyException(GeneratedOutlineSupport1.outline41(e, GeneratedOutlineSupport1.outline115("BCFKS KeyStore unable to recover secret key (", str, "): ")));
                }
            }
            ...
            try {
                ...
                throw new UnrecoverableKeyException(GeneratedOutlineSupport1.outline41(e2, GeneratedOutlineSupport1.outline115("BCFKS KeyStore unable to recover private key (", str, "): ")));
            }
        }
        return null;
    }
            ...
            if (integrityCheck.getType() == 0) {
                ...
                try {
                    ...
                    if (this.validator == null) {
                        ...
                        CertificateFactory createCertificateFactory = this.helper.createCertificateFactory(KeyUtils.X509_CERITIFATE_FACTORY);
                    ...
                    throw new IOException(GeneratedOutlineSupport1.outline99(e2, GeneratedOutlineSupport1.outline107("error verifying signature: ")), e2);
                }
            }
    ...
    public void engineLoad(KeyStore.LoadStoreParameter loadStoreParameter) throws CertificateException, NoSuchAlgorithmException, IOException {
        if (loadStoreParameter != null) {
            if (!(loadStoreParameter instanceof BCFKSLoadStoreParameter)) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("no support for 'parameter' of type ");
                outline107.append(loadStoreParameter.getClass().getName());
                throw new IllegalArgumentException(outline107.toString());
            }
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) throws KeyStoreException {
        ...
        if (objectData == null) {
            ...
            throw new KeyStoreException(GeneratedOutlineSupport1.outline72("BCFKS KeyStore already has a key entry with alias ", str));
        } else {
        ...
        try {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("BCFKS KeyStore unable to handle certificate: ");
            outline107.append(e.getMessage());
            throw new ExtKeyStoreException(outline107.toString(), e);
        }
    }
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(GeneratedOutlineSupport1.outline42(e, GeneratedOutlineSupport1.outline107("BCFKS KeyStore exception storing private key: ")), e);
            }
            ...
            try {
                ...
                throw new ExtKeyStoreException(GeneratedOutlineSupport1.outline42(e2, GeneratedOutlineSupport1.outline107("BCFKS KeyStore exception storing private key: ")), e2);
            }
        }
        this.lastModifiedDate = date;
    }
        ...
        if (certificateArr != null) {
            try {
                ...
                try {
                    ...
                    throw new ExtKeyStoreException(GeneratedOutlineSupport1.outline42(e, GeneratedOutlineSupport1.outline107("BCFKS KeyStore exception storing protected private key: ")), e);
                }
            } catch (Exception e2) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(GeneratedOutlineSupport1.outline42(e3, GeneratedOutlineSupport1.outline107("BCFKS KeyStore exception storing protected private key: ")), e3);
            }
        }
        this.lastModifiedDate = date;
    }
    ...
    public void engineStore(OutputStream outputStream, char[] cArr) throws IOException, NoSuchAlgorithmException, CertificateException {
        ...
        if (this.creationDate != null) {
            ...
            try {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("cannot calculate mac: ");
                outline107.append(e.getMessage());
                throw new IOException(outline107.toString());
            }
        }
        ...
        if (loadStoreParameter != null) {
            if (loadStoreParameter instanceof BCFKSStoreParameter) {
                ...
                try {
                    ...
                    throw new IOException(GeneratedOutlineSupport1.outline99(e, GeneratedOutlineSupport1.outline107("error creating signature: ")), e);
                }
            }
        }
        throw new IllegalArgumentException("'parameter' arg cannot be null");

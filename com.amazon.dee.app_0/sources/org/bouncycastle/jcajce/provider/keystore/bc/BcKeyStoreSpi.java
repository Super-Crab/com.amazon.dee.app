...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    public Key decodeKey(DataInputStream dataInputStream) throws IOException {
        ...
        } else if (!readUTF.equals(KeyUtils.X509_CERITIFATE_FACTORY) && !readUTF.equals("X509")) {
            if (!readUTF.equals("RAW")) {
                throw new IOException(GeneratedOutlineSupport1.outline75("Key format ", readUTF, " not recognised!"));
            }
        ...
        try {
            ...
            throw new IOException(GeneratedOutlineSupport1.outline42(e, GeneratedOutlineSupport1.outline107("Exception creating key: ")));
        }
    }
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) throws KeyStoreException {
        ...
        throw new KeyStoreException(GeneratedOutlineSupport1.outline72("key store already has a key entry with alias ", str));
    }
    ...
    protected Cipher makePBECipher(String str, int i, char[] cArr, byte[] bArr, int i2) throws IOException {
        try {
            ...
            throw new IOException(GeneratedOutlineSupport1.outline68("Error initialising store of key store: ", e));
        }
    }

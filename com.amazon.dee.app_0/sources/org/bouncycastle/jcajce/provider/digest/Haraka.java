...
public class Haraka {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            GeneratedOutlineSupport1.outline182(GeneratedOutlineSupport1.outline117(new StringBuilder(), PREFIX, "$Digest256", configurableProvider, "MessageDigest.HARAKA-256"), PREFIX, "$Digest512", configurableProvider, "MessageDigest.HARAKA-512");
        }
    }

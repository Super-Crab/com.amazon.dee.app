...
public class Skein {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int i, int i2) {
            String outline53 = GeneratedOutlineSupport1.outline53("Skein-MAC-", i, ProcessIdUtil.DEFAULT_PROCESSID, i2);
            configurableProvider.addAlgorithm("Mac." + outline53, PREFIX + "$SkeinMac_" + i + "_" + i2);
            configurableProvider.addAlgorithm("Alg.Alias.Mac.Skein-MAC" + i + "/" + i2, outline53);
            StringBuilder sb = new StringBuilder();
            sb.append("KeyGenerator.");
            sb.append(outline53);
            configurableProvider.addAlgorithm(sb.toString(), PREFIX + "$SkeinMacKeyGenerator_" + i + "_" + i2);
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.Skein-MAC" + i + "/" + i2, outline53);
        }

        @Override // org.bouncycastle.jcajce.provider.util.AlgorithmProvider
        public void configure(ConfigurableProvider configurableProvider) {
            addHMACAlgorithm(configurableProvider, "Skein-256-128", GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(GeneratedOutlineSupport1.outline117(new StringBuilder(), PREFIX, "$Digest_256_128", configurableProvider, "MessageDigest.Skein-256-128"), PREFIX, "$Digest_256_160", configurableProvider, "MessageDigest.Skein-256-160"), PREFIX, "$Digest_256_224", configurableProvider, "MessageDigest.Skein-256-224"), PREFIX, "$Digest_256_256", configurableProvider, "MessageDigest.Skein-256-256"), PREFIX, "$Digest_512_128", configurableProvider, "MessageDigest.Skein-512-128"), PREFIX, "$Digest_512_160", configurableProvider, "MessageDigest.Skein-512-160"), PREFIX, "$Digest_512_224", configurableProvider, "MessageDigest.Skein-512-224"), PREFIX, "$Digest_512_256", configurableProvider, "MessageDigest.Skein-512-256"), PREFIX, "$Digest_512_384", configurableProvider, "MessageDigest.Skein-512-384"), PREFIX, "$Digest_512_512", configurableProvider, "MessageDigest.Skein-512-512"), PREFIX, "$Digest_1024_384", configurableProvider, "MessageDigest.Skein-1024-384"), PREFIX, "$Digest_1024_512", configurableProvider, "MessageDigest.Skein-1024-512"), PREFIX, "$Digest_1024_1024", configurableProvider, "MessageDigest.Skein-1024-1024"), PREFIX, "$HashMac_256_128"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_256_128"));
            addHMACAlgorithm(configurableProvider, "Skein-256-160", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_256_160"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_256_160"));
            addHMACAlgorithm(configurableProvider, "Skein-256-224", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_256_224"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_256_224"));
            addHMACAlgorithm(configurableProvider, "Skein-256-256", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_256_256"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_256_256"));
            addHMACAlgorithm(configurableProvider, "Skein-512-128", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_512_128"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_512_128"));
            addHMACAlgorithm(configurableProvider, "Skein-512-160", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_512_160"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_512_160"));
            addHMACAlgorithm(configurableProvider, "Skein-512-224", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_512_224"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_512_224"));
            addHMACAlgorithm(configurableProvider, "Skein-512-256", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_512_256"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_512_256"));
            addHMACAlgorithm(configurableProvider, "Skein-512-384", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_512_384"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_512_384"));
            addHMACAlgorithm(configurableProvider, "Skein-512-512", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_512_512"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_512_512"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-384", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_1024_384"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_1024_384"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-512", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_1024_512"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_1024_512"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-1024", GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HashMac_1024_1024"), GeneratedOutlineSupport1.outline91(new StringBuilder(), PREFIX, "$HMacKeyGenerator_1024_1024"));

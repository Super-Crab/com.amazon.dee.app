    ...
    private BCPGKey getPublicBCPGKey(int i, PGPAlgorithmParameters pGPAlgorithmParameters, AsymmetricKeyParameter asymmetricKeyParameter, Date date) throws PGPException {
        if (asymmetricKeyParameter instanceof RSAKeyParameters) {
            ...
            if (i == 18) {
                ...
                return new ECDHPublicBCPGKey(eCNamedDomainParameters.getName(), eCPublicKeyParameters.getQ(), implGetKdfParameters.getHashAlgorithm(), implGetKdfParameters.getSymmetricWrapAlgorithm());
            } else if (i != 19) {

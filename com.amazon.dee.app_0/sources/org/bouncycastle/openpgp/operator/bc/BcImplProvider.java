...
class BcImplProvider {
    ...
    public static Signer createSigner(int i, int i2) throws PGPException {
        ...
        if (i != 22) {
            throw new PGPException(GeneratedOutlineSupport1.outline49("cannot recognise keyAlgorithm: ", i));
        }
    ...
    public static Wrapper createWrapper(int i) throws PGPException {
        switch (i) {
            ...
            case 10:
            default:
                throw new PGPException(GeneratedOutlineSupport1.outline49("unknown wrap algorithm: ", i));
            case 11:
            case 12:
            case 13:

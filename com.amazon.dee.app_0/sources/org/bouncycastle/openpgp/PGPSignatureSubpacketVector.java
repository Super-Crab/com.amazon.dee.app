...
public class PGPSignatureSubpacketVector {
    ...
    public PGPSignatureList getEmbeddedSignatures() throws PGPException {
        ...
        for (SignatureSubpacket signatureSubpacket : subpackets) {
            try {
                ...
                throw new PGPException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("Unable to parse signature packet: ")), e);
            }
        }
    ...
    public SignatureSubpacket[] toArray() {
        SignatureSubpacket[] signatureSubpacketArr = this.packets;
        SignatureSubpacket[] signatureSubpacketArr2 = new SignatureSubpacket[signatureSubpacketArr.length];
        System.arraycopy(signatureSubpacketArr, 0, signatureSubpacketArr2, 0, signatureSubpacketArr2.length);

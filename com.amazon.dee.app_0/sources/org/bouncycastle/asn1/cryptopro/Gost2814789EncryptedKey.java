...
public class Gost2814789EncryptedKey extends ASN1Object {
    ...
    private Gost2814789EncryptedKey(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 2) {
            this.encryptedKey = GeneratedOutlineSupport1.outline194(aSN1Sequence, 0);
            this.macKey = GeneratedOutlineSupport1.outline194(aSN1Sequence, 1);
            this.maskKey = null;
            ...
            this.macKey = GeneratedOutlineSupport1.outline194(aSN1Sequence, 2);
        }
    }

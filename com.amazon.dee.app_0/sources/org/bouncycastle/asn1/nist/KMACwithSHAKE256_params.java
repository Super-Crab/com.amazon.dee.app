    ...
    private KMACwithSHAKE256_params(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() <= 2) {
            if (aSN1Sequence.size() == 2) {
                ...
                this.customizationString = GeneratedOutlineSupport1.outline194(aSN1Sequence, 1);
                return;
                ...
                this.outputLength = 512;
                this.customizationString = GeneratedOutlineSupport1.outline194(aSN1Sequence, 0);
                return;
            }
        }

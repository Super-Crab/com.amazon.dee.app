...
public class BasicConstraints extends ASN1Object {
    ...
    public String toString() {
        ...
        if (this.pathLenConstraint == null) {
            outline107 = GeneratedOutlineSupport1.outline107("BasicConstraints: isCa(");
            outline107.append(isCA());
            outline107.append(")");
        } else {
            outline107 = GeneratedOutlineSupport1.outline107("BasicConstraints: isCa(");
            outline107.append(isCA());
            outline107.append("), pathLenConstraint = ");
            outline107.append(this.pathLenConstraint.getValue());
        }

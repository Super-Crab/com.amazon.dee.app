...
public class X509Name extends ASN1Object {
    ...
    private void addEntry(Hashtable hashtable, String str, Boolean bool) {
        X509NameTokenizer x509NameTokenizer = new X509NameTokenizer(str, Chars.EQ);
        String nextToken = x509NameTokenizer.nextToken();
    ...
    private ASN1ObjectIdentifier decodeOID(String str, Hashtable hashtable) {
        ...
        if (aSN1ObjectIdentifier == null) {
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("Unknown object id - ", trim, " - passed to distinguished name"));
        }

        ...
        if (size != 1) {
            if (size == 2) {
                ...
                if (aSN1TaggedObject2.getTagNo() != 0) {
                    throw new IllegalArgumentException(GeneratedOutlineSupport1.outline101(aSN1TaggedObject2, GeneratedOutlineSupport1.outline107("Bad tag number for 'minimum': ")));
                }
                ...
                if (aSN1TaggedObject.getTagNo() != 1) {
                    throw new IllegalArgumentException(GeneratedOutlineSupport1.outline101(aSN1TaggedObject, GeneratedOutlineSupport1.outline107("Bad tag number for 'maximum': ")));
                }
            }

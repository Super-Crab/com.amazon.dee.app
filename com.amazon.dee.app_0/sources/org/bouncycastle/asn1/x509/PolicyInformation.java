...
public class PolicyInformation extends ASN1Object {
    ...
    public String toString() {
        StringBuffer outline103 = GeneratedOutlineSupport1.outline103("Policy information: ");
        outline103.append(this.policyIdentifier);
        if (this.policyQualifiers != null) {
            ...
            for (int i = 0; i < this.policyQualifiers.size(); i++) {
                ...
                stringBuffer.append(PolicyQualifierInfo.getInstance(this.policyQualifiers.getObjectAt(i)));
            }
            outline103.append("[");

...
public class RoleSyntax extends ASN1Object {
    ...
    public String toString() {
        ...
        outline107.append(getRoleNameAsString());
        outline107.append(" - Auth: ");
        StringBuffer stringBuffer = new StringBuffer(outline107.toString());
        GeneralNames generalNames = this.roleAuthority;
        if (generalNames == null || generalNames.getNames().length == 0) {
            stringBuffer.append(CapabilityQueryConstants.TARGET_NOT_AVAILABLE);
        } else {

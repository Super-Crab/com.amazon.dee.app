    ...
    private POPOSigningKey(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1TaggedObject) {
            ...
            if (aSN1TaggedObject.getTagNo() != 0) {
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline101(aSN1TaggedObject, GeneratedOutlineSupport1.outline107("Unknown POPOSigningKeyInput tag: ")));
            }

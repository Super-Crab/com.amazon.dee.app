    ...
    public RSAPublicKey(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (tagNo == 1) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unknown DERTaggedObject :");
                outline107.append(unsignedInteger.getTagNo());
                outline107.append("-> not an Iso7816RSAPublicKeyStructure");

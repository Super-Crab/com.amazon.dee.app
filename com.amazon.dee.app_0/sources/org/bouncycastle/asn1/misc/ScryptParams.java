...
public class ScryptParams extends ASN1Object {
    ...
    private ScryptParams(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 4 || aSN1Sequence.size() == 5) {
            this.salt = GeneratedOutlineSupport1.outline194(aSN1Sequence, 0);
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline100(aSN1Sequence, GeneratedOutlineSupport1.outline107("invalid sequence: size = ")));
    }

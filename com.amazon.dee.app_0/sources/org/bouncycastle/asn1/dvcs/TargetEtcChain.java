...
public class TargetEtcChain extends ASN1Object {
    ...
    public String toString() {
        StringBuffer outline103 = GeneratedOutlineSupport1.outline103("TargetEtcChain {\n");
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("target: ");
        outline107.append(this.target);
        outline107.append("\n");
        outline103.append(outline107.toString());
        if (this.chain != null) {
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("chain: ");
            outline1072.append(this.chain);
            outline1072.append("\n");
            outline103.append(outline1072.toString());
        }
        if (this.pathProcInput != null) {
            StringBuilder outline1073 = GeneratedOutlineSupport1.outline107("pathProcInput: ");
            outline1073.append(this.pathProcInput);
            outline1073.append("\n");

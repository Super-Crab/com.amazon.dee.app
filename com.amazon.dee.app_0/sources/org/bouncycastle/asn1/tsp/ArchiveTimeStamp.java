        ...
        for (int i = 0; i < aSN1Sequence.size() - 1; i++) {
            ...
            if (objectAt instanceof ASN1TaggedObject) {
                ...
                if (tagNo == 0) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport1.outline101(aSN1TaggedObject, GeneratedOutlineSupport1.outline107("invalid tag no in constructor: ")));
                } else {

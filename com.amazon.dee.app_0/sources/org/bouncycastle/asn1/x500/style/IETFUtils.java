    ...
    public static RDN[] rDNsFromString(String str, X500NameStyle x500NameStyle) {
        ...
        while (x500NameTokenizer.hasMoreTokens()) {
            ...
            if (nextToken.indexOf(43) > 0) {
                ...
                X500NameTokenizer x500NameTokenizer3 = new X500NameTokenizer(x500NameTokenizer2.nextToken(), Chars.EQ);
                ...
                if (x500NameTokenizer2.hasMoreTokens()) {
                    ...
                    while (true) {
                        ...
                        X500NameTokenizer x500NameTokenizer4 = new X500NameTokenizer(x500NameTokenizer2.nextToken(), Chars.EQ);
                ...
                X500NameTokenizer x500NameTokenizer5 = new X500NameTokenizer(nextToken, Chars.EQ);

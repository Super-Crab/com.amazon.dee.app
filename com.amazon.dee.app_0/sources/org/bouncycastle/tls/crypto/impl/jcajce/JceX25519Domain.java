...
public class JceX25519Domain implements TlsECDomain {
    ...
    public PublicKey decodePublicKey(byte[] bArr) throws IOException {
        try {
            return this.crypto.getHelper().createKeyFactory(XDHParameterSpec.X25519).generatePublic(new X509EncodedKeySpec(new SubjectPublicKeyInfo(new AlgorithmIdentifier(EdECObjectIdentifiers.id_X25519), bArr).getEncoded("DER")));
        } catch (Exception e) {

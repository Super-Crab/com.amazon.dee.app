...
class X509Util {
    ...
    public static Implementation getImplementation(String str, String str2) throws NoSuchAlgorithmException {
        ...
        throw new NoSuchAlgorithmException(GeneratedOutlineSupport1.outline72("cannot find implementation ", str2));
    }
    ...
    public static Implementation getImplementation(String str, String str2, Provider provider) throws NoSuchAlgorithmException {
        ...
        if (property2 == null) {
            StringBuilder outline115 = GeneratedOutlineSupport1.outline115("cannot find implementation ", upperCase, " for provider ");
            outline115.append(provider.getName());
            throw new NoSuchAlgorithmException(outline115.toString());
        }
        try {
            ...
            StringBuilder outline1152 = GeneratedOutlineSupport1.outline115("algorithm ", upperCase, " in provider ");
            outline1152.append(provider.getName());
            outline1152.append(" but no class \"");
            outline1152.append(property2);
            outline1152.append("\" found!");
            throw new IllegalStateException(outline1152.toString());
        } catch (Exception unused2) {
            StringBuilder outline1153 = GeneratedOutlineSupport1.outline115("algorithm ", upperCase, " in provider ");
            outline1153.append(provider.getName());
            outline1153.append(" but class \"");
            outline1153.append(property2);
            outline1153.append("\" inaccessible!");
            throw new IllegalStateException(outline1153.toString());
        }
    }

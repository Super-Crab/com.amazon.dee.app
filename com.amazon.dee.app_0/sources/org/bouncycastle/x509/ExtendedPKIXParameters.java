    ...
    public void setAttrCertCheckers(Set set) {
        ...
        for (Object obj : set) {
            if (!(obj instanceof PKIXAttrCertChecker)) {
                throw new ClassCastException(GeneratedOutlineSupport1.outline40(PKIXAttrCertChecker.class, GeneratedOutlineSupport1.outline107("All elements of set must be of type "), "."));
            }
        }
        this.attrCertCheckers.clear();
    ...
    public void setTrustedACIssuers(Set set) {
        ...
        for (Object obj : set) {
            if (!(obj instanceof TrustAnchor)) {
                throw new ClassCastException(GeneratedOutlineSupport1.outline40(TrustAnchor.class, GeneratedOutlineSupport1.outline107("All elements of set must be of type "), "."));
            }
        }
        this.trustedACIssuers.clear();

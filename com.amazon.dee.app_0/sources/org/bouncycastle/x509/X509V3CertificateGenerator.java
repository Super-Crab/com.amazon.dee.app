...
public class X509V3CertificateGenerator {
    ...
    public void copyAndAddExtension(String str, boolean z, X509Certificate x509Certificate) throws CertificateParsingException {
        ...
        throw new CertificateParsingException(GeneratedOutlineSupport1.outline75("extension ", str, " not present"));
    }
    ...
    public void setIssuerDN(X500Principal x500Principal) {
        try {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline65("can't process principal: ", e));
        }
    }
    ...
    public void setPublicKey(PublicKey publicKey) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline42(e, GeneratedOutlineSupport1.outline107("unable to process key - ")));
        }
    }
    ...
    public void setSignatureAlgorithm(String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline72("Unknown signature type requested: ", str));
        }
    }

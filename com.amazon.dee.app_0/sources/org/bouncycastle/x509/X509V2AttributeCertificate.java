...
public class X509V2AttributeCertificate implements X509AttributeCertificate {
    ...
    private static AttributeCertificate getObject(InputStream inputStream) throws IOException {
        try {
            ...
            throw new IOException(GeneratedOutlineSupport1.outline42(e2, GeneratedOutlineSupport1.outline107("exception decoding certificate structure: ")));
        }
    }
    ...
    public byte[] getExtensionValue(String str) {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport1.outline42(e, GeneratedOutlineSupport1.outline107("error encoding ")));
        }
    }

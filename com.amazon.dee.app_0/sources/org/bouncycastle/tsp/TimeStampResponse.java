...
public class TimeStampResponse {
    ...
    public byte[] getEncoded(String str) throws IOException {
        return ("DL".equals(str) ? this.timeStampToken == null ? new DLSequence(this.resp.getStatus()) : new DLSequence(new ASN1Encodable[]{this.resp.getStatus(), this.timeStampToken.toCMSSignedData().toASN1Structure()}) : this.resp).getEncoded(str);
    }

...
public class CMSTimeStampedDataParser extends CMSContentInfoParser {
    ...
    private void initialize(ContentInfoParser contentInfoParser) throws CMSException {
        try {
            ...
            throw new CMSException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("parsing exception: ")), e);
        }
    }
    ...
    private void parseTimeStamps() throws CMSException {
        try {
            ...
            throw new CMSException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("unable to parse evidence block: ")), e);
        }
    }

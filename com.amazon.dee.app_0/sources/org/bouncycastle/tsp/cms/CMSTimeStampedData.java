...
public class CMSTimeStampedData {
    ...
    private void initialize(ContentInfo contentInfo) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Malformed content - type must be ");
        outline107.append(CMSObjectIdentifiers.timestampedData.getId());

...
public class PKMACBuilder {
    ...
    private void checkIterationCountCeiling(int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline86(GeneratedOutlineSupport1.outline109("iteration count exceeds limit (", i, " > "), this.maxIterations, ")"));
    }
        ...
        return new MacCalculator() { // from class: org.bouncycastle.cert.crmf.PKMACBuilder.1
            ...
            public byte[] getMac() {
                try {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("exception calculating mac: ");

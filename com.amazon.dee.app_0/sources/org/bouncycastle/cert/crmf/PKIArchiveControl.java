...
public class PKIArchiveControl implements Control {
    ...
    public CMSEnvelopedData getEnvelopedData() throws CRMFException {
        try {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("CMS parsing error: ");
            outline107.append(e.getMessage());
            throw new CRMFException(outline107.toString(), e.getCause());
        } catch (Exception e2) {
            throw new CRMFException(GeneratedOutlineSupport1.outline41(e2, GeneratedOutlineSupport1.outline107("CRMF parsing error: ")), e2);
        }
    }

        ...
        if (x500Name == null || x500Name.equals(x509CertificateHolder.getIssuer())) {
            ...
            if (subjectPublicKeyInfo != null) {
                try {
                    ...
                    throw new CertPathValidationException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("Unable to build public key: ")), e);
                } catch (CertException e2) {
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unable to validate signature: ");
                    outline107.append(e2.getMessage());
                    throw new CertPathValidationException(outline107.toString(), e2);
                } catch (OperatorCreationException e3) {
                    StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("Unable to create verifier: ");
                    outline1072.append(e3.getMessage());
                    throw new CertPathValidationException(outline1072.toString(), e3);
                }
            }

...
public class OCSPResp {
    ...
    private OCSPResp(ASN1InputStream aSN1InputStream) throws IOException {
        try {
            ...
            throw new CertIOException(GeneratedOutlineSupport1.outline43(e2, GeneratedOutlineSupport1.outline107("malformed response: ")), e2);
        } catch (ASN1Exception e3) {
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("malformed response: ");
    ...
    public Object getResponseObject() throws OCSPException {
        ...
        try {
            ...
            throw new OCSPException(GeneratedOutlineSupport1.outline68("problem decoding object: ", e), e);
        }
    }

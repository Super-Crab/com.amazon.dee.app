    ...
    public ProtectedPKIMessage build(ContentSigner contentSigner) throws CMPException {
        if (this.body != null) {
            ...
            try {
                ...
                throw new CMPException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("unable to encode signature input: ")), e);
            }
        }
    ...
    public ProtectedPKIMessage build(MacCalculator macCalculator) throws CMPException {
        if (this.body != null) {
            ...
            try {
                ...
                throw new CMPException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("unable to encode MAC input: ")), e);
            }
        }
        throw new IllegalStateException("body must be set before building");
    }

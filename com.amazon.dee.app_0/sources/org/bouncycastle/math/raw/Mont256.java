...
public abstract class Mont256 {
    ...
    public static void multAdd(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int i) {
        ...
        while (i2 < 8) {
            ...
            while (i6 < 8) {
                ...
                long j11 = (j9 & 4294967295L) + (j10 & 4294967295L) + (iArr3[i6] & 4294967295L) + j8;
                iArr3[i6 - 1] = (int) j11;
    ...
    public static void multAddXF(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
        ...
        while (true) {
            ...
            for (int i4 = 8; i3 < i4; i4 = 8) {
                ...
                long j9 = (j7 & 4294967295L) + (j8 & 4294967295L) + (iArr3[i3] & 4294967295L) + j6;
                iArr3[i3 - 1] = (int) j9;
    ...
    public static void reduce(int[] iArr, int[] iArr2, int i) {
        ...
        while (i3 < 8) {
            ...
            int i4 = 1;
            while (i4 < 8) {
                long j3 = ((iArr2[i4] & 4294967295L) * j) + (iArr[i4] & 4294967295L) + j2;
                iArr[i4 - 1] = (int) j3;
                j2 = j3 >>> 32;
                i4++;
                i3 = i3;

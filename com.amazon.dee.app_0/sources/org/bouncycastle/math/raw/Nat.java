...
public abstract class Nat {
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i4] = (int) j;
        int i5 = i3 + 1;
        long j2 = (4294967295L & iArr[i5]) + 1 + (j >>> 32);
        iArr[i5] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3, int i4) {
        ...
        iArr[i5] = (int) j;
        int i6 = i5 + 1;
        long j2 = (4294967295L & iArr[i6]) + 1 + (j >>> 32);
        iArr[i6] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            long j2 = (iArr[i2 + i6] & 4294967295L) + (iArr2[i3 + i6] & 4294967295L) + (4294967295L & iArr3[i5]) + j;
            iArr3[i4 + i6] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i3] = (int) j2;
        int i4 = i2 + 1;
        long j3 = (4294967295L & iArr[i4]) + (j >>> 32) + (j2 >>> 32);
        iArr[i4] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2, int i3) {
        ...
        iArr[i4] = (int) j2;
        int i5 = i4 + 1;
        long j3 = (4294967295L & iArr[i5]) + (j >>> 32) + (j2 >>> 32);
        iArr[i5] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i3 + i4;
            long j2 = (iArr[i2 + i4] & 4294967295L) + (4294967295L & iArr2[i5]) + j;
            iArr2[i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i3 + i5;
            long j2 = (iArr[i2 + i5] & 4294967295L) + (iArr2[i6] & 4294967295L) + j;
            iArr2[i6] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addToEachOther(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i2 + i4;
            int i6 = i3 + i4;
            long j2 = (iArr[i5] & 4294967295L) + (4294967295L & iArr2[i6]) + j;
            int i7 = (int) j2;
            iArr[i5] = i7;
            iArr2[i6] = i7;
            j = j2 >>> 32;
    ...
    public static int mul31BothAdd(int i, int i2, int[] iArr, int i3, int[] iArr2, int[] iArr3, int i4) {
        ...
        do {
            int i6 = i4 + i5;
            long j4 = ((iArr2[i5] & 4294967295L) * j2) + ((iArr[i5] & 4294967295L) * j) + (iArr3[i6] & 4294967295L) + j3;
            iArr3[i6] = (int) j4;
            j3 = j4 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordAddTo(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        do {
            int i6 = i4 + i5;
            long j3 = ((iArr[i3 + i5] & 4294967295L) * j) + (iArr2[i6] & 4294967295L) + j2;
            iArr2[i6] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordDwordAddAt(int i, int i2, long j, int[] iArr, int i3) {
        ...
        long j4 = j2 * (j >>> 32);
        int i5 = i3 + 1;
        long j5 = j4 + (iArr[i5] & 4294967295L) + (j3 >>> 32);
        iArr[i5] = (int) j5;
        long j6 = j5 >>> 32;
        int i6 = i3 + 2;
        long j7 = j6 + (iArr[i6] & 4294967295L);
        iArr[i6] = (int) j7;
        if ((j7 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int squareWordAdd(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        ...
        do {
            int i6 = i2 + i5;
            long j3 = ((iArr[i + i4] & 4294967295L) * j) + (iArr2[i6] & 4294967295L) + j2;
            iArr2[i6] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
            i4++;
    ...
    public static int squareWordAdd(int[] iArr, int i, int[] iArr2) {
        ...
        do {
            int i3 = i + i2;
            long j3 = ((iArr[i2] & 4294967295L) * j) + (iArr2[i3] & 4294967295L) + j2;
            iArr2[i3] = (int) j3;
            j2 = j3 >>> 32;
            i2++;
        } while (i2 < i);
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        long j = 0;
        for (int i6 = 0; i6 < i; i6++) {
            long j2 = (((iArr3[i5] & 4294967295L) - (iArr[i2 + i6] & 4294967295L)) - (4294967295L & iArr2[i3 + i6])) + j;
            iArr3[i4 + i6] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i3 + i4;
            long j2 = ((iArr2[i5] & 4294967295L) - (4294967295L & iArr[i2 + i4])) + j;
            iArr2[i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;

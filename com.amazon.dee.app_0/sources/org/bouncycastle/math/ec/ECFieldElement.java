        ...
        private BigInteger[] lucasSequence(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            ...
            for (int i = bitLength - 1; i >= lowestSetBit + 1; i--) {
                ...
                if (bigInteger3.testBit(i)) {
                    bigInteger10 = modMult(bigInteger6, bigInteger2);
                    bigInteger9 = modMult(bigInteger9, bigInteger7);
                    bigInteger8 = modReduce(bigInteger7.multiply(bigInteger8).subtract(bigInteger.multiply(bigInteger6)));
                    bigInteger7 = modReduce(bigInteger7.multiply(bigInteger7).subtract(bigInteger10.shiftLeft(1)));
                } else {
                    BigInteger modReduce = modReduce(bigInteger9.multiply(bigInteger8).subtract(bigInteger6));
                    BigInteger modReduce2 = modReduce(bigInteger7.multiply(bigInteger8).subtract(bigInteger.multiply(bigInteger6)));
                    bigInteger8 = modReduce(bigInteger8.multiply(bigInteger8).subtract(bigInteger6.shiftLeft(1)));
                    bigInteger7 = modReduce2;
                    bigInteger9 = modReduce;
                    bigInteger10 = bigInteger6;
                }
            }
            BigInteger modMult = modMult(bigInteger6, bigInteger10);
            BigInteger modMult2 = modMult(modMult, bigInteger2);
            BigInteger modReduce3 = modReduce(bigInteger9.multiply(bigInteger8).subtract(modMult));
            BigInteger modReduce4 = modReduce(bigInteger7.multiply(bigInteger8).subtract(bigInteger.multiply(modMult)));
            BigInteger modMult3 = modMult(modMult, modMult2);
            BigInteger bigInteger11 = modReduce4;
            for (int i2 = 1; i2 <= lowestSetBit; i2++) {
                modReduce3 = modMult(modReduce3, bigInteger11);
                bigInteger11 = modReduce(bigInteger11.multiply(bigInteger11).subtract(modMult3.shiftLeft(1)));
                modMult3 = modMult(modMult3, modMult3);
            }
            return new BigInteger[]{modReduce3, bigInteger11};
        }

...
public class DiscoverEndomorphisms {
    ...
    private static void printScalarDecompositionParameters(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        outline107.append(bigIntegerArr[0].toString(16));
        outline107.append(", ");
        outline107.append(bigIntegerArr[1].toString(16));
        outline107.append(" }");
        printProperty("v1", outline107.toString());
        StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("{ ");
        outline1072.append(chooseShortest[0].toString(16));
        outline1072.append(", ");
        outline1072.append(chooseShortest[1].toString(16));
        outline1072.append(" }");
        printProperty("v2", outline1072.toString());

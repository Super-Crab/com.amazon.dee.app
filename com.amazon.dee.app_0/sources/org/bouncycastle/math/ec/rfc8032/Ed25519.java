        ...
        synchronized (precompLock) {
            ...
            while (i2 < 8) {
                ...
                while (i11 > 0) {
                    ...
                    X25519Field.mul(create, pointExtArr2[i11].z, create);
                    i11 = i12;
                }
                X25519Field.copy(create, 0, createTable, 0);
                int i13 = i3;
                for (int i14 = 0; i14 < 8; i14++) {
                    PointExt pointExt6 = pointExtArr2[i14];
                    int[] create3 = X25519Field.create();
                    int[] create4 = X25519Field.create();
                    X25519Field.copy(createTable, i14 * 10, create4, 0);
                    ...
                    X25519Field.copy(pointPrecomp.ypx_h, 0, precompBase, i13);
                    int i15 = i13 + 10;
                    X25519Field.copy(pointPrecomp.ymx_h, 0, precompBase, i15);
                    int i16 = i15 + 10;
                    X25519Field.copy(pointPrecomp.xyd, 0, precompBase, i16);
                    i13 = i16 + 10;
                }
                i2++;
                i3 = i13;

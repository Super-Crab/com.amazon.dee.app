...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement outline139 = GeneratedOutlineSupport1.outline139(eCFieldElement2, multiply, eCFieldElement3);
        if (outline139.isZero()) {
            return new SecT163K1Point(curve, outline139, curve.getB());
        }
        ECFieldElement square = outline139.square();
        ECFieldElement multiply2 = isOne ? outline139 : outline139.multiply(eCFieldElement3);
        ECFieldElement square2 = eCFieldElement2.add(eCFieldElement).square();
        return new SecT163K1Point(curve, square, square2.add(outline139).add(eCFieldElement3).multiply(square2).add(square), new ECFieldElement[]{multiply2});
    }

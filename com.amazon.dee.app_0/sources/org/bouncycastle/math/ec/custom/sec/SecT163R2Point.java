...
public class SecT163R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement outline139 = GeneratedOutlineSupport1.outline139(eCFieldElement2, multiply, square);
        if (outline139.isZero()) {
            return new SecT163R2Point(curve, outline139, curve.getB().sqrt());
        }
        ...
        return new SecT163R2Point(curve, square2, eCFieldElement.squarePlusProduct(outline139, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }

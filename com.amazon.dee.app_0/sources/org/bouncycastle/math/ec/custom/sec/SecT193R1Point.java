...
public class SecT193R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (outline139.isZero()) {
            return new SecT193R1Point(curve, outline139, curve.getB().sqrt());
        }
        ...
        return new SecT193R1Point(curve, square2, eCFieldElement.squarePlusProduct(outline139, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }

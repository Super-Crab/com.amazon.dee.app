...
public class JcaPublicKeyConverter {
    ...
    private PublicKey getECPublicKeyPublicKey(ECDSAPublicKey eCDSAPublicKey) throws EACException, InvalidKeySpecException {
        try {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("cannot find algorithm ECDSA: ");
            outline107.append(e.getMessage());
            throw new EACException(outline107.toString(), e);
        } catch (NoSuchProviderException e2) {
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("cannot find provider: ");
            outline1072.append(e2.getMessage());
            throw new EACException(outline1072.toString(), e2);
        }
    }
    ...
    public PublicKey getKey(PublicKeyDataObject publicKeyDataObject) throws EACException, InvalidKeySpecException {
        ...
        try {
            return this.helper.createKeyFactory(KeyUtils.ALGORITHM_RSA).generatePublic(new RSAPublicKeySpec(rSAPublicKey.getModulus(), rSAPublicKey.getPublicExponent()));
        } catch (NoSuchAlgorithmException e) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("cannot find algorithm ECDSA: ");
            outline107.append(e.getMessage());
            throw new EACException(outline107.toString(), e);

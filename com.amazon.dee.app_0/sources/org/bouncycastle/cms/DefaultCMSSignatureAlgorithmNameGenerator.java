...
public class DefaultCMSSignatureAlgorithmNameGenerator implements CMSSignatureAlgorithmNameGenerator {
    ...
    public DefaultCMSSignatureAlgorithmNameGenerator() {
        ...
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_224, "SHA3-224", KeyUtils.ALGORITHM_RSA);
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_256, "SHA3-256", KeyUtils.ALGORITHM_RSA);
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_384, "SHA3-384", KeyUtils.ALGORITHM_RSA);
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_512, "SHA3-512", KeyUtils.ALGORITHM_RSA);
        ...
        addEntries(OIWObjectIdentifiers.md4WithRSA, "MD4", KeyUtils.ALGORITHM_RSA);
        addEntries(OIWObjectIdentifiers.md4WithRSAEncryption, "MD4", KeyUtils.ALGORITHM_RSA);
        addEntries(OIWObjectIdentifiers.md5WithRSA, MessageDigestAlgorithms.MD5, KeyUtils.ALGORITHM_RSA);
        addEntries(OIWObjectIdentifiers.sha1WithRSA, "SHA1", KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.md2WithRSAEncryption, MessageDigestAlgorithms.MD2, KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.md4WithRSAEncryption, "MD4", KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.md5WithRSAEncryption, MessageDigestAlgorithms.MD5, KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.sha1WithRSAEncryption, "SHA1", KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.sha224WithRSAEncryption, "SHA224", KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.sha256WithRSAEncryption, "SHA256", KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.sha384WithRSAEncryption, "SHA384", KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.sha512WithRSAEncryption, "SHA512", KeyUtils.ALGORITHM_RSA);
        addEntries(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd128, "RIPEMD128", KeyUtils.ALGORITHM_RSA);
        addEntries(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd160, "RIPEMD160", KeyUtils.ALGORITHM_RSA);
        addEntries(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd256, "RIPEMD256", KeyUtils.ALGORITHM_RSA);
        ...
        addEntries(EACObjectIdentifiers.id_TA_RSA_v1_5_SHA_1, "SHA1", KeyUtils.ALGORITHM_RSA);
        addEntries(EACObjectIdentifiers.id_TA_RSA_v1_5_SHA_256, "SHA256", KeyUtils.ALGORITHM_RSA);
        ...
        this.encryptionAlgs.put(PKCSObjectIdentifiers.rsaEncryption, KeyUtils.ALGORITHM_RSA);
        this.encryptionAlgs.put(TeleTrusTObjectIdentifiers.teleTrusTRSAsignatureAlgorithm, KeyUtils.ALGORITHM_RSA);
        this.encryptionAlgs.put(X509ObjectIdentifiers.id_ea_rsa, KeyUtils.ALGORITHM_RSA);
    ...
    public String getSignatureName(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2) {
        ...
        if (!digestAlgName.equals(algorithmIdentifier2.getAlgorithm().getId())) {
            StringBuilder outline113 = GeneratedOutlineSupport1.outline113(digestAlgName, JsonPOJOBuilder.DEFAULT_WITH_PREFIX);
            outline113.append(getEncryptionAlgName(algorithmIdentifier2.getAlgorithm()));

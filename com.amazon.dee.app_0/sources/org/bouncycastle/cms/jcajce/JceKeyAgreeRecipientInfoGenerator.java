...
public class JceKeyAgreeRecipientInfoGenerator extends KeyAgreeRecipientInfoGenerator {
    ...
    private void init(ASN1ObjectIdentifier aSN1ObjectIdentifier) throws CMSException {
        ...
        try {
            ...
            throw new CMSException(GeneratedOutlineSupport1.outline68("cannot determine MQV ephemeral key pair parameters from public key: ", e), e);
        }
    }
        ...
        if (!this.recipientIDs.isEmpty()) {
            ...
            for (int i = 0; i != this.recipientIDs.size(); i++) {
                ...
                try {
                    ...
                    throw new CMSException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("unable to encode wrapped key: ")), e);
                } catch (GeneralSecurityException e2) {
                    throw new CMSException(GeneratedOutlineSupport1.outline99(e2, GeneratedOutlineSupport1.outline107("cannot perform agreement step: ")), e2);
                }
            }
    ...
    protected byte[] getUserKeyingMaterial(AlgorithmIdentifier algorithmIdentifier) throws CMSException {
        ...
        if (keyPair != null) {
            ...
            try {
                ...
                throw new CMSException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("unable to encode user keying material: ")), e);
            }
        }

...
public class JceKTSKeyTransRecipientInfoGenerator extends KeyTransRecipientInfoGenerator {
    ...
    private static byte[] getEncodedRecipID(IssuerAndSerialNumber issuerAndSerialNumber) throws CertificateEncodingException {
        try {
            ...
            throw new CertificateEncodingException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("Cannot process extracted IssuerAndSerialNumber: "))) { // from class: org.bouncycastle.cms.jcajce.JceKTSKeyTransRecipientInfoGenerator.1
    ...
    private static byte[] getEncodedSubKeyId(byte[] bArr) {
        try {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("Cannot process subject key identifier: "))) { // from class: org.bouncycastle.cms.jcajce.JceKTSKeyTransRecipientInfoGenerator.2
                @Override // java.lang.Throwable
                public Throwable getCause() {
                    return e;
                }

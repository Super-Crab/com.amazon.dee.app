...
public class CMSSignedHelper {
    ...
    static {
        ...
        addEntries(OIWObjectIdentifiers.md4WithRSA, KeyUtils.ALGORITHM_RSA);
        addEntries(OIWObjectIdentifiers.md4WithRSAEncryption, KeyUtils.ALGORITHM_RSA);
        addEntries(OIWObjectIdentifiers.md5WithRSA, KeyUtils.ALGORITHM_RSA);
        addEntries(OIWObjectIdentifiers.sha1WithRSA, KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.md2WithRSAEncryption, KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.md4WithRSAEncryption, KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.md5WithRSAEncryption, KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.sha1WithRSAEncryption, KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.sha224WithRSAEncryption, KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.sha256WithRSAEncryption, KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.sha384WithRSAEncryption, KeyUtils.ALGORITHM_RSA);
        addEntries(PKCSObjectIdentifiers.sha512WithRSAEncryption, KeyUtils.ALGORITHM_RSA);
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_224, KeyUtils.ALGORITHM_RSA);
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_256, KeyUtils.ALGORITHM_RSA);
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_384, KeyUtils.ALGORITHM_RSA);
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_512, KeyUtils.ALGORITHM_RSA);
        ...
        addEntries(EACObjectIdentifiers.id_TA_RSA_v1_5_SHA_1, KeyUtils.ALGORITHM_RSA);
        addEntries(EACObjectIdentifiers.id_TA_RSA_v1_5_SHA_256, KeyUtils.ALGORITHM_RSA);
        ...
        addEntries(PKCSObjectIdentifiers.rsaEncryption, KeyUtils.ALGORITHM_RSA);
        addEntries(TeleTrusTObjectIdentifiers.teleTrusTRSAsignatureAlgorithm, KeyUtils.ALGORITHM_RSA);
        addEntries(X509ObjectIdentifiers.id_ea_rsa, KeyUtils.ALGORITHM_RSA);

...
public class Argon2BytesGenerator {
    ...
    private void doInit(Argon2Parameters argon2Parameters) {
        ...
        this.laneLength = i * 4;
        initMemory(argon2Parameters.getLanes() * 4 * i);
    }
    ...
    private void fillSegment(FillBlock fillBlock, Position position) {
        ...
        int outline3 = GeneratedOutlineSupport1.outline3(position.slice, this.segmentLength, position.lane * this.laneLength, startingIndex);
        int prevOffset = getPrevOffset(outline3);
        ...
        while (i < this.segmentLength) {
            long pseudoRandom = getPseudoRandom(fillBlock, i, block, block2, i3, isDataIndependentAddressing);
    ...
    private int getRefColumn(Position position, int i, long j, boolean z) {
        ...
        return ((int) (i6 + ((i3 - 1) - ((i3 * ((j2 * j2) >>> 32)) >>> 32)))) % this.laneLength;
    }
    ...
    private static void quarterRound(long[] jArr, int i, int i2, int i3, int i4) {
        ...
        long j2 = jArr[i2];
        long j3 = jArr[i3];
        long outline9 = GeneratedOutlineSupport1.outline9((j & 4294967295L) * 2, j2 & 4294967295L, j2, j);
        long rotateRight = Longs.rotateRight(j3 ^ outline9, i4);
        jArr[i] = outline9;
        jArr[i3] = rotateRight;
    }
    ...
    public void init(Argon2Parameters argon2Parameters) {
        ...
        if (argon2Parameters.getLanes() >= 1) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("memory is less than: ");
            outline107.append(argon2Parameters.getLanes() * 2);

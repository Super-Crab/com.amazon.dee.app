...
public class PKCS5S1ParametersGenerator extends PBEParametersGenerator {
    ...
    public CipherParameters generateDerivedParameters(int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("Can't generate a derived key ", i2, " bytes long."));
    }
    ...
    public CipherParameters generateDerivedParameters(int i, int i2) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("Can't generate a derived key ", i5, " bytes long."));
    }
}

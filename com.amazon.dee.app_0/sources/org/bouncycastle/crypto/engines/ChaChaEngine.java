...
public class ChaChaEngine extends Salsa20Engine {
    ...
    public String getAlgorithmName() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("ChaCha");
        outline107.append(this.rounds);
    ...
    protected void retreatCounter(long j) {
        ...
        if (i != 0) {
            int[] iArr = this.engineState;
            if ((iArr[13] & BodyPartID.bodyIdMax) < (i & BodyPartID.bodyIdMax)) {
                throw new IllegalStateException("attempt to reduce counter past zero.");
            }
            iArr[13] = iArr[13] - i;
        }
        int[] iArr2 = this.engineState;
        if ((iArr2[12] & BodyPartID.bodyIdMax) >= (BodyPartID.bodyIdMax & i2)) {
            iArr2[12] = iArr2[12] - i2;
        } else if (iArr2[13] == 0) {
            throw new IllegalStateException("attempt to reduce counter past zero.");
        } else {

    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                int i4 = i2 + 2;
                int i5 = i2 + 1;
                iArr[i] = (bArr3[i2] & 255) | (bArr3[i3] << 24) | ((bArr3[i4] << 16) & 16711680) | ((bArr3[i5] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK);
                int[] iArr2 = this.lfsr;
                byte[] bArr4 = this.workingIV;
                iArr2[i] = (bArr4[i2] & 255) | (bArr4[i3] << 24) | ((bArr4[i4] << 16) & 16711680) | ((bArr4[i5] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK);
                i2 += 4;
                i++;
            } else {
                return;

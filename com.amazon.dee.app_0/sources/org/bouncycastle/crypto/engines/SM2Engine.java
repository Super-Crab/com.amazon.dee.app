...
public class SM2Engine {
    ...
    private byte[] encrypt(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        return this.mode.ordinal() != 1 ? Arrays.concatenate(encoded, bArr2, bArr3) : Arrays.concatenate(encoded, bArr3, bArr2);
    }
    ...
    public int getOutputSize(int i) {
        return this.digest.getDigestSize() + GeneratedOutlineSupport1.outline3(this.curveLength, 2, 1, i);
    }

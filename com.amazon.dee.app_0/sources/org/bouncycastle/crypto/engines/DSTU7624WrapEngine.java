...
public class DSTU7624WrapEngine implements Wrapper {
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        if (!this.forWrapping) {
            if (i2 % this.engine.getBlockSize() != 0) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("unwrap data must be a multiple of ");
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        if (this.forWrapping) {
            if (i2 % this.engine.getBlockSize() != 0) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("wrap data must be a multiple of ");
                outline107.append(this.engine.getBlockSize());
                outline107.append(" bytes");
                throw new DataLengthException(outline107.toString());

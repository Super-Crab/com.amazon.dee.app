...
public class Salsa20Engine implements SkippingStreamCipher {
    ...
    public String getAlgorithmName() {
        if (this.rounds != 20) {
            StringBuilder outline113 = GeneratedOutlineSupport1.outline113("Salsa20", "/");
            outline113.append(this.rounds);
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (iv == null || iv.length != getNonceSize()) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline86(sb, getNonceSize(), " bytes of IV"));
        }
    ...
    protected void retreatCounter(long j) {
        ...
        if (i != 0) {
            int[] iArr = this.engineState;
            if ((iArr[9] & BodyPartID.bodyIdMax) < (i & BodyPartID.bodyIdMax)) {
                throw new IllegalStateException("attempt to reduce counter past zero.");
            }
            iArr[9] = iArr[9] - i;
        }
        int[] iArr2 = this.engineState;
        if ((iArr2[8] & BodyPartID.bodyIdMax) >= (BodyPartID.bodyIdMax & i2)) {
            iArr2[8] = iArr2[8] - i2;
        } else if (iArr2[9] == 0) {
            throw new IllegalStateException("attempt to reduce counter past zero.");
        } else {

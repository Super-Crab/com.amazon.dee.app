...
public class RC6Engine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i5 = 20;
        while (i5 >= 1) {
            int rotateLeft = rotateLeft(GeneratedOutlineSupport1.outline4(i4, 2, 1, i4), 5);
            int rotateLeft2 = rotateLeft(GeneratedOutlineSupport1.outline4(i3, 2, 1, i3), 5);
            int i6 = i5 * 2;
            i5--;
            int i7 = i4;
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i5 = 1;
        while (i5 <= 20) {
            int rotateLeft = rotateLeft(GeneratedOutlineSupport1.outline4(i3, 2, 1, i3), 5);
            int rotateLeft2 = rotateLeft(GeneratedOutlineSupport1.outline4(i4, 2, 1, i4), 5);
            int i6 = i5 * 2;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline102(cipherParameters, GeneratedOutlineSupport1.outline107("invalid parameter passed to RC6 init - ")));
    }

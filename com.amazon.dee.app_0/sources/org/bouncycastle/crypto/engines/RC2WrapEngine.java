...
public class RC2WrapEngine implements Wrapper {
    private static final byte[] IV2 = {74, -35, -94, 44, 121, -24, GenericAccessProfile.SERVICE_DATA_128BIT, 5};
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        if (!this.forWrapping) {
            ...
            if (i2 % this.engine.getBlockSize() != 0) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Ciphertext not multiple of ");
                outline107.append(this.engine.getBlockSize());
                throw new InvalidCipherTextException(outline107.toString());
            }
            ...
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("too many pad bytes (");
            outline1072.append(bArr6.length - ((bArr6[0] & 255) + 1));
            outline1072.append(")");

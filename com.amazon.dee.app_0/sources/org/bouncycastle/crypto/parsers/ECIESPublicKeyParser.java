    ...
    public AsymmetricKeyParameter readKey(InputStream inputStream) throws IOException {
        ...
        if (read != 0) {
            if (read == 2 || read == 3) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Sender's public key has invalid point encoding 0x");
                outline107.append(Integer.toString(read, 16));

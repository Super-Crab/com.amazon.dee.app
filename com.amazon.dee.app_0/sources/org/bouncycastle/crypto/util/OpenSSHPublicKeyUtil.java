        ...
        if (asymmetricKeyParameter != null) {
            if (asymmetricKeyParameter instanceof RSAKeyParameters) {
                ...
                if (nameForParameters == null) {
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("unable to derive ssh curve name for ");
                    outline107.append(eCPublicKeyParameters.getParameters().getCurve().getClass().getName());
                    throw new IllegalArgumentException(outline107.toString());
                }
                sSHBuilder2.writeString(GeneratedOutlineSupport1.outline72("ecdsa-sha2-", nameForParameters));
                ...
                StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("unable to convert ");
                outline1072.append(asymmetricKeyParameter.getClass().getName());
                outline1072.append(" to private key");
    ...
    public static AsymmetricKeyParameter parsePublicKey(SSHBuffer sSHBuffer) {
        ...
        if (RSA.equals(readString)) {
            ...
            if (DSS.equals(readString)) {
                ...
                if (parameters == null) {
                    throw new IllegalStateException(GeneratedOutlineSupport1.outline76("unable to find curve for ", readString, " using curve name ", readString2));
                }

            ...
            if (!(asymmetricKeyParameter instanceof RSAPrivateCrtKeyParameters) && !(asymmetricKeyParameter instanceof ECPrivateKeyParameters)) {
                if (asymmetricKeyParameter instanceof DSAPrivateKeyParameters) {
                    ...
                    try {
                        ...
                        throw new IllegalStateException(GeneratedOutlineSupport1.outline41(e, GeneratedOutlineSupport1.outline107("unable to encode DSAPrivateKeyParameters ")));
                    }
                } else if (!(asymmetricKeyParameter instanceof Ed25519PrivateKeyParameters)) {
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("unable to convert ");
                    outline107.append(asymmetricKeyParameter.getClass().getName());
                    outline107.append(" to openssh private key");
    ...
    public static AsymmetricKeyParameter parsePrivateKeyBlob(byte[] bArr) {
        ...
        if (bArr[0] == 48) {
            ...
            if ("ssh-ed25519".equals(readString)) {
                ...
                if (byName == null) {
                    throw new IllegalStateException(GeneratedOutlineSupport1.outline72("OID not found for: ", readString));
                }
                X9ECParameters byOID = NISTNamedCurves.getByOID(byName);
                if (byOID == null) {
                    throw new IllegalStateException(GeneratedOutlineSupport1.outline79("Curve not found for: ", byName));
                }
                sSHBuffer2.readBlock();

...
public class RIPEMD128Digest extends GeneralDigest {
    ...
    private int F2(int i, int i2, int i3, int i4, int i5, int i6) {
        return RL(GeneratedOutlineSupport1.outline1(i, f2(i2, i3, i4), i5, 1518500249), i6);
    }

    private int F3(int i, int i2, int i3, int i4, int i5, int i6) {
        return RL(GeneratedOutlineSupport1.outline1(i, f3(i2, i3, i4), i5, 1859775393), i6);
    }

    private int F4(int i, int i2, int i3, int i4, int i5, int i6) {
        return RL(GeneratedOutlineSupport1.outline1(i, f4(i2, i3, i4), i5, -1894007588), i6);
    }
    ...
    private int FF2(int i, int i2, int i3, int i4, int i5, int i6) {
        return RL(GeneratedOutlineSupport1.outline1(i, f2(i2, i3, i4), i5, 1836072691), i6);
    }

    private int FF3(int i, int i2, int i3, int i4, int i5, int i6) {
        return RL(GeneratedOutlineSupport1.outline1(i, f3(i2, i3, i4), i5, 1548603684), i6);
    }

    private int FF4(int i, int i2, int i3, int i4, int i5, int i6) {
        return RL(GeneratedOutlineSupport1.outline1(i, f4(i2, i3, i4), i5, 1352829926), i6);
    }

...
public class SHA224Digest extends GeneralDigest implements EncodableDigest {
    ...
    protected void processBlock() {
        ...
        for (int i18 = 0; i18 < 8; i18++) {
            int Sum1 = Sum1(i13) + Ch(i13, i12, i11) + K[i10] + this.X[i10] + i9;
            int i19 = i14 + Sum1;
            int Sum0 = Sum0(i17) + Maj(i17, i16, i15) + Sum1;
            int i20 = i10 + 1;
            int Sum12 = Sum1(i19) + Ch(i19, i13, i12) + K[i20] + this.X[i20] + i11;
            int i21 = i15 + Sum12;
            int Sum02 = Sum0(Sum0) + Maj(Sum0, i17, i16) + Sum12;
            int i22 = i20 + 1;
            int Sum13 = Sum1(i21) + Ch(i21, i19, i13) + K[i22] + this.X[i22] + i12;
            int i23 = i16 + Sum13;
            int Sum03 = Sum0(Sum02) + Maj(Sum02, Sum0, i17) + Sum13;
            int i24 = i22 + 1;
            int Sum14 = Sum1(i23) + Ch(i23, i21, i19) + K[i24] + this.X[i24] + i13;
            int i25 = i17 + Sum14;
            int Sum04 = Sum0(Sum03) + Maj(Sum03, Sum02, Sum0) + Sum14;
            int i26 = i24 + 1;
            int Sum15 = Sum1(i25) + Ch(i25, i23, i21) + K[i26] + this.X[i26] + i19;
            i9 = Sum0 + Sum15;
            i14 = Sum0(Sum04) + Maj(Sum04, Sum03, Sum02) + Sum15;
            int i27 = i26 + 1;
            int Sum16 = Sum1(i9) + Ch(i9, i25, i23) + K[i27] + this.X[i27] + i21;
            i11 = Sum02 + Sum16;
            i15 = Sum0(i14) + Maj(i14, Sum04, Sum03) + Sum16;
            int i28 = i27 + 1;
            int Sum17 = Sum1(i11) + Ch(i11, i9, i25) + K[i28] + this.X[i28] + i23;
            i12 = Sum03 + Sum17;
            i16 = Sum0(i15) + Maj(i15, i14, Sum04) + Sum17;
            int i29 = i28 + 1;
            int Sum18 = Sum1(i12) + Ch(i12, i11, i9) + K[i29] + this.X[i29] + i25;
            i13 = Sum04 + Sum18;
            i17 = Sum0(i16) + Maj(i16, i15, i14) + Sum18;
            i10 = i29 + 1;
        }
        this.H1 += i17;
        this.H2 += i16;

...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    protected void processBlock() {
        ...
        while (i2 < 10) {
            long j16 = j15;
            int i4 = i3 + 1;
            long Sum1 = Sum1(j15) + Ch(j15, j10, j9) + K[i3] + this.W[i3] + j8;
            long j17 = j13 + Sum1;
            long j18 = j12;
            long Sum0 = Sum0(j12) + Maj(j12, j11, j14) + Sum1;
            int i5 = i4 + 1;
            long Sum12 = Sum1(j17) + Ch(j17, j16, j10) + K[i4] + this.W[i4] + j9;
            long j19 = j14 + Sum12;
            int i6 = i2;
            long Sum02 = Sum0(Sum0) + Maj(Sum0, j18, j11) + Sum12;
            int i7 = i5 + 1;
            long Sum13 = Sum1(j19) + Ch(j19, j17, j16) + K[i5] + this.W[i5] + j10;
            long j20 = j11 + Sum13;
            long Sum03 = Sum0(Sum02) + Maj(Sum02, Sum0, j18) + Sum13;
            int i8 = i7 + 1;
            long Sum14 = Sum1(j20) + Ch(j20, j19, j17) + K[i7] + this.W[i7] + j16;
            long j21 = j18 + Sum14;
            long Sum04 = Sum0(Sum03) + Maj(Sum03, Sum02, Sum0) + Sum14;
            int i9 = i8 + 1;
            long Sum15 = Sum1(j21) + Ch(j21, j20, j19) + K[i8] + this.W[i8] + j17;
            long j22 = Sum0 + Sum15;
            long Sum05 = Sum0(Sum04) + Maj(Sum04, Sum03, Sum02) + Sum15;
            j8 = j22;
            int i10 = i9 + 1;
            long Sum16 = Sum1(j22) + Ch(j22, j21, j20) + K[i9] + this.W[i9] + j19;
            long j23 = Sum02 + Sum16;
            long Sum06 = Sum0(Sum05) + Maj(Sum05, Sum04, Sum03) + Sum16;
            int i11 = i10 + 1;
            long Sum17 = Sum1(j23) + Ch(j23, j8, j21) + K[i10] + this.W[i10] + j20;
            long j24 = Sum03 + Sum17;
            j11 = Sum0(Sum06) + Maj(Sum06, Sum05, Sum04) + Sum17;
            long Sum18 = Sum1(j24) + Ch(j24, j23, j8) + K[i11] + this.W[i11] + j21;
            long j25 = Sum04 + Sum18;
            long Sum07 = Sum0(j11) + Maj(j11, Sum06, Sum05) + Sum18;
            j14 = Sum06;
            j15 = j25;
            j9 = j23;
            i3 = i11 + 1;

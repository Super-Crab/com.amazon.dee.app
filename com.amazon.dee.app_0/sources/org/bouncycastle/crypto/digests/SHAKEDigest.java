...
public class SHAKEDigest extends KeccakDigest implements Xof {
    ...
    private static int checkBitLength(int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("'bitLength' ", i, " not supported for SHAKE"));
    }
    ...
    public String getAlgorithmName() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("SHAKE");

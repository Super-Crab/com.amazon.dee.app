    ...
    private byte[] derEncode(byte[] bArr) throws IOException {
        ...
        if (algorithmIdentifier == null) {
            try {
                ...
                throw new IOException(GeneratedOutlineSupport1.outline43(e, GeneratedOutlineSupport1.outline107("malformed DigestInfo for NONEwithRSA hash: ")));
            }
        }
    ...
    public byte[] generateSignature() throws CryptoException, DataLengthException {
        if (this.forSigning) {
            ...
            try {
                ...
                throw new CryptoException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("unable to encode signature: ")), e);
            }
        }

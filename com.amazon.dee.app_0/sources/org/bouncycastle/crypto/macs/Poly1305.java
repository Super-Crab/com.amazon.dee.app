...
public class Poly1305 implements Mac {
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        if (bArr.length == 32) {
            ...
            this.r4 = (littleEndianToInt4 >>> 8) & Channels.CHANNEL_FOR_ECHO_TEST;
            this.s1 = this.r1 * 5;
            this.s2 = this.r2 * 5;
            this.s3 = this.r3 * 5;
            this.s4 = this.r4 * 5;
    ...
    public int doFinal(byte[] bArr, int i) throws DataLengthException, IllegalStateException {
        if (i + 16 <= bArr.length) {
            ...
            int i28 = this.h0;
            int i29 = this.h1;
            long j = ((i28 | (i29 << 26)) & BodyPartID.bodyIdMax) + (this.k0 & BodyPartID.bodyIdMax);
            int i30 = i29 >>> 6;
            int i31 = this.h2;
            long j2 = ((i30 | (i31 << 20)) & BodyPartID.bodyIdMax) + (this.k1 & BodyPartID.bodyIdMax);
            int i32 = i31 >>> 12;
            int i33 = this.h3;
            long j3 = ((i32 | (i33 << 14)) & BodyPartID.bodyIdMax) + (this.k2 & BodyPartID.bodyIdMax);
            long j4 = (((i33 >>> 18) | (this.h4 << 8)) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & this.k3);
    ...
    public String getAlgorithmName() {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Poly1305-");
        outline107.append(this.cipher.getAlgorithmName());

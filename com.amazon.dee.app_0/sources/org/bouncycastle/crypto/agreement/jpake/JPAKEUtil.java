...
public class JPAKEUtil {
    ...
    public static void validateParticipantIdsDiffer(String str, String str2) throws CryptoException {
        ...
        throw new CryptoException(GeneratedOutlineSupport1.outline75("Both participants are using the same participantId (", str, "). This is not allowed. Each participant must use a unique participantId."));
    }
    ...
    public static void validateParticipantIdsEqual(String str, String str2) throws CryptoException {
        ...
        throw new CryptoException(GeneratedOutlineSupport1.outline77("Received payload from incorrect partner (", str2, "). Expected to receive payload from ", str, "."));
    }

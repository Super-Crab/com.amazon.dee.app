    ...
    private int encryptBlockWithIV(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        ...
        if (i + i5 <= bArr.length) {
            ...
            if (i6 != 0) {
                ...
                return this.blockSize;
            } else if (GeneratedOutlineSupport1.outline3(i5, 2, i2, 2) > bArr2.length) {
                throw new OutputLengthException("output buffer too short");
            } else {
                this.cipher.processBlock(this.FR, 0, this.FRE, 0);
                int i8 = 0;
                ...
                while (true) {
                    ...
                    if (i11 >= i12) {
                        ...
                        this.count = GeneratedOutlineSupport1.outline3(i14, 2, 2, i13);
                        return (i14 * 2) + 2;
                    }
                    bArr2[GeneratedOutlineSupport1.outline1(i12, i2, 2, i11)] = encryptByte(bArr[i + i11], i11);
                    i11++;
                }
            }
        } else {

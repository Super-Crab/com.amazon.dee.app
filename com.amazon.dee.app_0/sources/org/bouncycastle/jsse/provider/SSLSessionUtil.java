...
abstract class SSLSessionUtil {
    ...
    static {
        ...
        L2c:
            ...
            if (r5 == 0) goto L4e
            java.lang.reflect.Method[] r1 = org.bouncycastle.jsse.provider.ReflectionUtil.getMethods(r1)     // Catch: java.lang.Exception -> L4e
            if (r1 == 0) goto L4e
            boolean r0 = org.bouncycastle.jsse.provider.ReflectionUtil.hasMethod(r1, r0)     // Catch: java.lang.Exception -> L4e
            if (r0 == 0) goto L41
        ...
        L43:
            java.lang.Class[] r1 = new java.lang.Class[r4]     // Catch: java.lang.Exception -> L4e
            java.lang.Class<?> r4 = org.bouncycastle.jsse.provider.SSLSessionUtil.extendedSSLSessionClass     // Catch: java.lang.Exception -> L4e
            r1[r3] = r4     // Catch: java.lang.Exception -> L4e
            java.lang.reflect.Constructor r0 = org.bouncycastle.jsse.provider.ReflectionUtil.getDeclaredConstructor(r0, r1)     // Catch: java.lang.Exception -> L4e
            r2 = r0
        L4e:

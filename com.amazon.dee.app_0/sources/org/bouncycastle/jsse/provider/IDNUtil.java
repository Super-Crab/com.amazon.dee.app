...
public class IDNUtil {
    ...
    public static final Method toASCIIMethod = ReflectionUtil.getMethod(IDN_CLASSNAME, "toASCII", String.class, Integer.TYPE);
    public static final Method toUnicodeMethod = ReflectionUtil.getMethod(IDN_CLASSNAME, "toUnicode", String.class, Integer.TYPE);

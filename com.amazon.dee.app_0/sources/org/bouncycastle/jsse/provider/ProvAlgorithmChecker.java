...
class ProvAlgorithmChecker extends PKIXCertPathChecker {
    ...
    private static final String SIG_ALG_NAME_rsa_pss_rsae_sha256 = JsseUtils.getJcaSignatureAlgorithmBC("SHA256withRSAandMGF1", KeyUtils.ALGORITHM_RSA);
    private static final String SIG_ALG_NAME_rsa_pss_rsae_sha384 = JsseUtils.getJcaSignatureAlgorithmBC("SHA384withRSAandMGF1", KeyUtils.ALGORITHM_RSA);
    private static final String SIG_ALG_NAME_rsa_pss_rsae_sha512 = JsseUtils.getJcaSignatureAlgorithmBC("SHA512withRSAandMGF1", KeyUtils.ALGORITHM_RSA);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void checkChain(JcaJceHelper jcaJceHelper, BCAlgorithmConstraints bCAlgorithmConstraints, Set<X509Certificate> set, X509Certificate[] x509CertificateArr, KeyPurposeId keyPurposeId, int i) throws CertPathValidatorException {
    ...
    private static void checkEndEntity(JcaJceHelper jcaJceHelper, BCAlgorithmConstraints bCAlgorithmConstraints, X509Certificate x509Certificate, KeyPurposeId keyPurposeId, int i) throws CertPathValidatorException {
        if (keyPurposeId == null || supportsExtendedKeyUsage(x509Certificate, keyPurposeId)) {
            ...
            if (!supportsKeyUsage(x509Certificate, i)) {
                throw new CertPathValidatorException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("Certificate doesn't support '"), getKeyUsageName(i), "' KeyUsage"));
            }
            if (!bCAlgorithmConstraints.permits(getKeyUsagePrimitives(i), x509Certificate.getPublicKey())) {
                throw new CertPathValidatorException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("Public key not permitted for '"), getKeyUsageName(i), "' KeyUsage"));
            }
            return;
        }
        throw new CertPathValidatorException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("Certificate doesn't support '"), getExtendedKeyUsageName(keyPurposeId), "' ExtendedKeyUsage"));
    }
    ...
    static String getKeyUsageName(int i) {
        return i != 0 ? i != 2 ? i != 4 ? GeneratedOutlineSupport1.outline52("(", i, ")") : "keyAgreement" : "keyEncipherment" : "digitalSignature";
    }

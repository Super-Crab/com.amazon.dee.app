    ...
    public OutputEncryptor build() throws OperatorCreationException {
        ...
        try {
            ...
            if (PEMUtilities.isPKCS5Scheme2(this.algOID)) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("unknown algorithm: ");
                outline107.append(this.algOID);
                throw new OperatorCreationException(outline107.toString(), null);
            } else {

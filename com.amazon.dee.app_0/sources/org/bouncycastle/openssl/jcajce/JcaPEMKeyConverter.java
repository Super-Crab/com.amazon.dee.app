...
public class JcaPEMKeyConverter {
    ...
    static {
        ...
        algorithms.put(PKCSObjectIdentifiers.rsaEncryption, KeyUtils.ALGORITHM_RSA);
    ...
    private KeyFactory getKeyFactory(AlgorithmIdentifier algorithmIdentifier) throws NoSuchAlgorithmException, NoSuchProviderException {
        ...
        try {
            ...
            return this.helper.createKeyFactory(KeyUtils.ALGORITHM_EC);
        }
    }
    ...
    public KeyPair getKeyPair(PEMKeyPair pEMKeyPair) throws PEMException {
        try {
            ...
            throw new PEMException(GeneratedOutlineSupport1.outline41(e, GeneratedOutlineSupport1.outline107("unable to convert key pair: ")), e);
        }
    }

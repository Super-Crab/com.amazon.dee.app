...
public class MiscPEMGenerator implements PemObjectGenerator {
    ...
    private PemObject createPemObject(Object obj) throws IOException {
        ...
        StringBuilder outline113 = GeneratedOutlineSupport1.outline113(upperCase, ",");
        outline113.append(getHexEncoded(iv));
        arrayList.add(new PemHeader("DEK-Info", outline113.toString()));
    ...
    public PemObject generate() throws PemGenerationException {
        try {
            ...
            throw new PemGenerationException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("encoding exception: ")), e);
        }
    }
}

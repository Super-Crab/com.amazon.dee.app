...
public class VOMSAttribute {
    ...
    public class FQAN {
        ...
        public String getFQAN() {
            ...
            if (this.capability != null) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("/Capability=");
                outline107.append(this.capability);
                str3 = outline107.toString();
            }
            sb.append(str3);
        ...
        if (x509AttributeCertificateHolder != null) {
            ...
            for (int i = 0; i != attributes.length; i++) {
                try {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Badly encoded VOMS extension in AC issued by ");
                    outline107.append(x509AttributeCertificateHolder.getIssuer());
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("VO      :");
        outline107.append(this.myVo);
        outline107.append("\nHostPort:");
        outline107.append(this.myHostPort);
        outline107.append("\nFQANs   :");
        outline107.append(this.myFQANs);

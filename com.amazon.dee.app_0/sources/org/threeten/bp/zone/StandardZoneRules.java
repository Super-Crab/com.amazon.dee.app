...
public final class StandardZoneRules extends ZoneRules implements Serializable {
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("StandardZoneRules[currentStandardOffset=");
        ZoneOffset[] zoneOffsetArr = this.standardOffsets;
        outline107.append(zoneOffsetArr[zoneOffsetArr.length - 1]);
        outline107.append("]");

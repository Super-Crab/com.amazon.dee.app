...
public class ZoneRulesBuilder {
    ...
    public class TZRule implements Comparable<TZRule> {
        ...
        private LocalDate toLocalDate() {
            ...
            if (i < 0) {
                ...
                return dayOfWeek != null ? of.mo13061with(TemporalAdjusters.previousOrSame(dayOfWeek)) : of;
            }
            LocalDate of2 = LocalDate.of(this.year, this.month, i);
            DayOfWeek dayOfWeek2 = this.dayOfWeek;
            return dayOfWeek2 != null ? of2.mo13061with(TemporalAdjusters.nextOrSame(dayOfWeek2)) : of2;
        }
        ...
        public int compareTo(TZRule tZRule) {
            ...
            int i2 = (((this.adjustDays * DateTimeConstants.SECONDS_PER_DAY) + this.time.toSecondOfDay()) > ((tZRule.adjustDays * DateTimeConstants.SECONDS_PER_DAY) + tZRule.time.toSecondOfDay()) ? 1 : (((this.adjustDays * DateTimeConstants.SECONDS_PER_DAY) + this.time.toSecondOfDay()) == ((tZRule.adjustDays * DateTimeConstants.SECONDS_PER_DAY) + tZRule.time.toSecondOfDay()) ? 0 : -1));
            if (i2 < 0) {
                return -1;
            }
            return i2 > 0 ? 1 : 0;
    ...
    public class TZWindow {
        ...
        void validateWindowOrder(TZWindow tZWindow) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Windows must be added in date-time order: ");
            outline107.append(this.windowEnd);
            outline107.append(" < ");
            outline107.append(tZWindow.windowEnd);
    ...
    public ZoneRulesBuilder addWindow(ZoneOffset zoneOffset, LocalDateTime localDateTime, ZoneOffsetTransitionRule.TimeDefinition timeDefinition) {
        ...
        if (this.windowList.size() > 0) {
            tZWindow.validateWindowOrder((TZWindow) GeneratedOutlineSupport1.outline24(this.windowList, -1));
        }
    ...
    public ZoneRulesBuilder setFixedSavingsToWindow(int i) {
        if (!this.windowList.isEmpty()) {
            ((TZWindow) GeneratedOutlineSupport1.outline24(this.windowList, -1)).setFixedSavings(i);
            return this;
        }
    ...
    public ZoneRules toRules(String str, Map<Object, Object> map) {
        ...
        if (!this.windowList.isEmpty()) {
            ...
            Iterator<TZWindow> it3 = this.windowList.iterator();
            ...
            while (it3.hasNext()) {
                ...
                ZoneOffset zoneOffset4 = (ZoneOffset) deduplicate(ZoneOffset.ofTotalSeconds(num.intValue() + zoneOffset.getTotalSeconds()));
    ...
    public ZoneRulesBuilder addRuleToWindow(int i, int i2, Month month, int i3, DayOfWeek dayOfWeek, LocalTime localTime, boolean z, ZoneOffsetTransitionRule.TimeDefinition timeDefinition, int i4) {
        ...
        if (i3 >= -28 && i3 <= 31 && i3 != 0) {
            ...
            if (!this.windowList.isEmpty()) {
                ((TZWindow) GeneratedOutlineSupport1.outline24(this.windowList, -1)).addRule(i, i2, month, i3, dayOfWeek, localTime, z ? 1 : 0, timeDefinition, i4);
                return this;
            }
    ...
    public ZoneRulesBuilder addRuleToWindow(int i, int i2, Month month, int i3, DayOfWeek dayOfWeek, LocalTime localTime, int i4, ZoneOffsetTransitionRule.TimeDefinition timeDefinition, int i5) {
        ...
        if (i3 >= -28 && i3 <= 31 && i3 != 0) {
            if (!this.windowList.isEmpty()) {
                ((TZWindow) GeneratedOutlineSupport1.outline24(this.windowList, -1)).addRule(i, i2, month, i3, dayOfWeek, localTime, i4, timeDefinition, i5);
                return this;
            }
            throw new IllegalStateException("Must add a window before adding a rule");
        }

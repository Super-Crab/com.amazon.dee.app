    ...
    private enum Field implements TemporalField {
        ...
        public <R extends Temporal> R adjustInto(R r, long j) {
            if (range().isValidValue(j)) {
                return (R) r.mo13062with(ChronoField.EPOCH_DAY, Jdk8Methods.safeSubtract(j, this.offset));
            }
        ...
        public TemporalAccessor resolve(Map<TemporalField, Long> map, TemporalAccessor temporalAccessor, ResolverStyle resolverStyle) {
            return Chronology.from(temporalAccessor).mo13046dateEpochDay(Jdk8Methods.safeSubtract(map.remove(this).longValue(), this.offset));
        }

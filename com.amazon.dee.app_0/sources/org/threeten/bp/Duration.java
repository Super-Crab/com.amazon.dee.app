...
public final class Duration implements TemporalAmount, Comparable<Duration>, Serializable {
        ...
        if (temporal.isSupported(ChronoField.NANO_OF_SECOND) && temporal2.isSupported(ChronoField.NANO_OF_SECOND)) {
            try {
                ...
                if (i > 0 && j3 < 0) {
                    ...
                    try {
                        until = temporal.until(temporal2.mo13062with(ChronoField.NANO_OF_SECOND, j2), ChronoUnit.SECONDS);
    ...
    public static Duration parse(CharSequence charSequence) {
        ...
        if (matcher.matches() && !ExifInterface.GPS_DIRECTION_TRUE.equals(matcher.group(3))) {
            ...
            if (group != null || group2 != null || group3 != null || group4 != null) {
                ...
                long parseNumber4 = parseNumber(charSequence, group4, 1, BizMetricsConstants.DURATION_METADATA_NAME);
    ...
    private static long parseNumber(CharSequence charSequence, String str, int i, String str2) {
        ...
        try {
            ...
            throw ((DateTimeParseException) new DateTimeParseException(GeneratedOutlineSupport1.outline72("Text cannot be parsed to a Duration: ", str2), charSequence, 0).initCause(e));
        } catch (NumberFormatException e2) {
            throw ((DateTimeParseException) new DateTimeParseException(GeneratedOutlineSupport1.outline72("Text cannot be parsed to a Duration: ", str2), charSequence, 0).initCause(e2));
        }
    }
    ...
    public Temporal addTo(Temporal temporal) {
        long j = this.seconds;
        if (j != 0) {
            temporal = temporal.mo13060plus(j, ChronoUnit.SECONDS);
        }
        int i = this.nanos;
        return i != 0 ? temporal.mo13060plus(i, ChronoUnit.NANOS) : temporal;
    }
    ...
    public Duration plusDays(long j) {
        return plus(Jdk8Methods.safeMultiply(j, (int) DateTimeConstants.SECONDS_PER_DAY), 0L);
    }
    ...
    public Temporal subtractFrom(Temporal temporal) {
        long j = this.seconds;
        if (j != 0) {
            temporal = temporal.mo13056minus(j, ChronoUnit.SECONDS);
        }
        int i = this.nanos;
        return i != 0 ? temporal.mo13056minus(i, ChronoUnit.NANOS) : temporal;
    }
    ...
    public String toString() {
        ...
        int i = (int) ((j % 3600) / 60);
        int i2 = (int) (j % 60);
        StringBuilder outline105 = GeneratedOutlineSupport1.outline105(24, "PT");
        if (j2 != 0) {
            outline105.append(j2);
            outline105.append('H');
        }
        if (i != 0) {
            outline105.append(i);
        ...
        if (i2 == 0 && this.nanos == 0 && outline105.length() > 2) {
        ...
        if (i2 >= 0 || this.nanos <= 0) {
            ...
            outline105.append(i2 + 1);
        }
        if (this.nanos > 0) {
            int length = outline105.length();
            if (i2 < 0) {
                outline105.append(2000000000 - this.nanos);
            } else {
                outline105.append(this.nanos + 1000000000);
            }
            while (outline105.charAt(outline105.length() - 1) == '0') {
                outline105.setLength(outline105.length() - 1);
            }
            outline105.setCharAt(length, '.');
        }
        outline105.append('S');
        return outline105.toString();
    }

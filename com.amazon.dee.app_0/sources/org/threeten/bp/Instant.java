...
public final class Instant extends DefaultInterfaceTemporalAccessor implements Temporal, TemporalAdjuster, Comparable<Instant>, Serializable {
    ...
    public static final TemporalQuery<Instant> FROM = new TemporalQuery<Instant>() { // from class: org.threeten.bp.Instant.1
        ...
        public Instant mo13072queryFrom(TemporalAccessor temporalAccessor) {
    ...
    public Temporal adjustInto(Temporal temporal) {
        return temporal.mo13062with(ChronoField.INSTANT_SECONDS, this.seconds).mo13062with(ChronoField.NANO_OF_SECOND, this.nanos);
    }
    ...
    @Override // org.threeten.bp.temporal.Temporal
    /* renamed from: minus */
    public Instant mo13057minus(TemporalAmount temporalAmount) {
        return (Instant) temporalAmount.subtractFrom(this);
    }

    @Override // org.threeten.bp.temporal.Temporal
    /* renamed from: plus */
    public Instant mo13059plus(TemporalAmount temporalAmount) {
        return (Instant) temporalAmount.addTo(this);
    }

    @Override // org.threeten.bp.temporal.Temporal
    /* renamed from: with */
    public Instant mo13061with(TemporalAdjuster temporalAdjuster) {
    ...
    @Override // org.threeten.bp.temporal.Temporal
    /* renamed from: minus */
    public Instant mo13056minus(long j, TemporalUnit temporalUnit) {
        return j == Long.MIN_VALUE ? mo13060plus(Long.MAX_VALUE, temporalUnit).mo13060plus(1L, temporalUnit) : mo13060plus(-j, temporalUnit);
    }

    @Override // org.threeten.bp.temporal.Temporal
    /* renamed from: plus */
    public Instant mo13060plus(long j, TemporalUnit temporalUnit) {
        if (temporalUnit instanceof ChronoUnit) {
            switch (((ChronoUnit) temporalUnit).ordinal()) {
                case 0:
                    return plusNanos(j);
    ...
    @Override // org.threeten.bp.temporal.Temporal
    /* renamed from: with */
    public Instant mo13062with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {

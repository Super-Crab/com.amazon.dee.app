...
public final class MinguoChronology extends Chronology implements Serializable {
    ...
    public ChronoLocalDateTime<MinguoDate> mo12999localDateTime(TemporalAccessor temporalAccessor) {
    ...
    public ChronoZonedDateTime<MinguoDate> mo13002zonedDateTime(TemporalAccessor temporalAccessor) {
        return super.mo13002zonedDateTime(temporalAccessor);
    }

    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: dateEpochDay  reason: collision with other method in class */
    public MinguoDate mo13046dateEpochDay(long j) {
        return new MinguoDate(LocalDate.ofEpochDay(j));
    }

    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: eraOf  reason: collision with other method in class */
    public MinguoEra mo13052eraOf(int i) {
        return MinguoEra.of(i);
    }

    /* JADX WARN: Type inference failed for: r11v21, types: [org.threeten.bp.chrono.MinguoDate, org.threeten.bp.jdk8.DefaultInterfaceTemporalAccessor] */
    /* JADX WARN: Type inference failed for: r11v36, types: [org.threeten.bp.chrono.MinguoDate] */
    /* JADX WARN: Type inference failed for: r11v73, types: [org.threeten.bp.chrono.MinguoDate] */
    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: resolveDate  reason: collision with other method in class */
    public MinguoDate mo13053resolveDate(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        ...
        if (map.containsKey(ChronoField.MONTH_OF_YEAR)) {
            if (map.containsKey(ChronoField.DAY_OF_MONTH)) {
                ...
                if (map.containsKey(ChronoField.ALIGNED_DAY_OF_WEEK_IN_MONTH)) {
                    ...
                    MinguoDate mo13060plus = mo13043date(checkValidIntValue4, checkValidIntValue5, 1).mo13060plus((chronoField6.checkValidIntValue(map.remove(chronoField6).longValue()) - 1) + ((checkValidIntValue6 - 1) * 7), (TemporalUnit) ChronoUnit.DAYS);
                    ...
                    MinguoDate mo13061with = mo13043date(checkValidIntValue7, checkValidIntValue8, 1).mo13060plus(checkValidIntValue9 - 1, (TemporalUnit) ChronoUnit.WEEKS).mo13061with(TemporalAdjusters.nextOrSame(DayOfWeek.of(chronoField10.checkValidIntValue(map.remove(chronoField10).longValue()))));
        ...
        if (map.containsKey(ChronoField.DAY_OF_YEAR)) {
            ...
            if (map.containsKey(ChronoField.ALIGNED_DAY_OF_WEEK_IN_YEAR)) {
                ...
                MinguoDate mo13061with2 = mo13043date(checkValidIntValue13, 1, 1).mo13060plus(checkValidIntValue14 - 1, (TemporalUnit) ChronoUnit.WEEKS).mo13061with(TemporalAdjusters.nextOrSame(DayOfWeek.of(chronoField18.checkValidIntValue(map.remove(chronoField18).longValue()))));
    ...
    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: zonedDateTime */
    public ChronoZonedDateTime<MinguoDate> mo13001zonedDateTime(Instant instant, ZoneId zoneId) {
        return super.mo13001zonedDateTime(instant, zoneId);
    }

    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: dateYearDay  reason: collision with other method in class */
    public MinguoDate mo13051dateYearDay(Era era, int i, int i2) {
        return (MinguoDate) super.mo13051dateYearDay(era, i, i2);
    }

    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: date  reason: collision with other method in class */
    public MinguoDate mo13044date(Era era, int i, int i2, int i3) {
        return (MinguoDate) super.mo13044date(era, i, i2, i3);
    }

    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: dateNow  reason: collision with other method in class */
    public MinguoDate mo13047dateNow() {
        return (MinguoDate) super.mo13047dateNow();
    }

    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: dateYearDay  reason: collision with other method in class */
    public MinguoDate mo13050dateYearDay(int i, int i2) {
        return new MinguoDate(LocalDate.ofYearDay(i + YEARS_DIFFERENCE, i2));
    }

    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: date  reason: collision with other method in class */
    public MinguoDate mo13043date(int i, int i2, int i3) {
        return new MinguoDate(LocalDate.of(i + YEARS_DIFFERENCE, i2, i3));
    }

    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: dateNow  reason: collision with other method in class */
    public MinguoDate mo13049dateNow(ZoneId zoneId) {
        return (MinguoDate) super.mo13049dateNow(zoneId);
    }

    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: date  reason: collision with other method in class */
    public MinguoDate mo13045date(TemporalAccessor temporalAccessor) {
    ...
    @Override // org.threeten.bp.chrono.Chronology
    /* renamed from: dateNow  reason: collision with other method in class */
    public MinguoDate mo13048dateNow(Clock clock) {
        Jdk8Methods.requireNonNull(clock, "clock");
        return (MinguoDate) super.mo13048dateNow(clock);
    }
}

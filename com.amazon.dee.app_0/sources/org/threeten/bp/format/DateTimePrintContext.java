...
public final class DateTimePrintContext {
    ...
    private static TemporalAccessor adjust(final TemporalAccessor temporalAccessor, DateTimeFormatter dateTimeFormatter) {
        ...
        if (zone != null) {
            if (temporalAccessor.isSupported(ChronoField.INSTANT_SECONDS)) {
                ...
                return chronology3.mo13001zonedDateTime(Instant.from(temporalAccessor), zone);
            }
        ...
        if (chronology != null) {
            if (temporalAccessor.isSupported(ChronoField.EPOCH_DAY)) {
                chronoLocalDate = chronology3.mo13045date(temporalAccessor);
    ...
    public <R> R getValue(TemporalQuery<R> temporalQuery) {
        ...
        if (r == null && this.optional == 0) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unable to extract value: ");
            outline107.append(this.temporal.getClass());

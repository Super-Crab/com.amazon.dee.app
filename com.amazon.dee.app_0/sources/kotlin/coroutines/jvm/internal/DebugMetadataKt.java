...
public final class DebugMetadataKt {
    ...
    private static final void checkDebugMetadataVersion(int i, int i2) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport1.outline54("Debug metadata version mismatch. Expected: ", i, ", got ", i2, ". Please update the Kotlin standard library.").toString());
    }
    ...
    public static final StackTraceElement getStackTraceElement(@NotNull BaseContinuationImpl getStackTraceElementImpl) {
        ...
        if (debugMetadataAnnotation != null) {
            ...
            if (moduleName == null) {
                sb = debugMetadataAnnotation.c();
            } else {
                StringBuilder outline108 = GeneratedOutlineSupport1.outline108(moduleName, '/');
                outline108.append(debugMetadataAnnotation.c());
                sb = outline108.toString();
            }
            return new StackTraceElement(sb, debugMetadataAnnotation.m(), debugMetadataAnnotation.f(), i);
        }
        return null;
    }
}

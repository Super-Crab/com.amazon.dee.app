...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    public static final double log(double d, double d2) {
        if (d2 > FrostVideoEffectController.VIDEO_STRENGTH_CLEAR && d2 != 1.0d) {

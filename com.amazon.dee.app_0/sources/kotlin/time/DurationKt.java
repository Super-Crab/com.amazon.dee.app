...
public final class DurationKt {
    ...
    private static final double m12225timeskIfJnKk(double d, double d2) {
        return Duration.m12207timesimpl(d2, d);
    }
    ...
    private static final double m12226timesmvk6XK0(int i, double d) {
        return Duration.m12208timesimpl(d, i);
    }
    ...
    public static final double toDuration(double d, @NotNull TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m12181constructorimpl(DurationUnitKt__DurationUnitJvmKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}

...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double elapsedNow() {
        return Duration.m12204minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }
    ...
    public TimeMark mo12178plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m12205plusLRDsOJo(this.adjustment, d), null);
    }

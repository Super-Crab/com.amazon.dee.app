...
public class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public class Entry implements Comparable<SmallSortedMap<K, V>.Entry>, Map.Entry<K, V> {
        ...
        public String toString() {
            ...
            return GeneratedOutlineSupport1.outline92(new StringBuilder(valueOf2.length() + valueOf.length() + 1), valueOf, Config.Compare.EQUAL_TO, valueOf2);
        }
        ...
        public int compareTo(SmallSortedMap<K, V>.Entry entry) {
            return mo11999getKey().compareTo(entry.mo11999getKey());
        }

        @Override // java.util.Map.Entry
        /* renamed from: getKey */
        public K mo11999getKey() {
            return this.key;
        }
    ...
    private int binarySearchInArray(K k) {
        ...
        if (size >= 0) {
            int compareTo = k.compareTo(this.entryList.get(size).mo11999getKey());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = k.compareTo(this.entryList.get(i2).mo11999getKey());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public V put(K k, V v) {
        ...
        if (size == i2) {
            ...
            getOverflowEntriesMutable().put((K) remove.mo11999getKey(), remove.getValue());
        }

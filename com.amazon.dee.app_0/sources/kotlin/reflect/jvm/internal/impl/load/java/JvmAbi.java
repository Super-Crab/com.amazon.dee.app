...
public final class JvmAbi {
    ...
    public static String getterName(@NotNull String str) {
        ...
        if (!startsWithIsPrefix(str)) {
            ...
            outline107.append(CapitalizeDecapitalizeKt.capitalizeAsciiOnly(str));
    ...
    public static boolean hasJvmFieldAnnotation(@NotNull CallableMemberDescriptor callableMemberDescriptor) {
        ...
        if (!(callableMemberDescriptor instanceof PropertyDescriptor) || (backingField = ((PropertyDescriptor) callableMemberDescriptor).getBackingField()) == null || !backingField.mo12070getAnnotations().hasAnnotation(JVM_FIELD_ANNOTATION_FQ_NAME)) {
            return callableMemberDescriptor.mo12070getAnnotations().hasAnnotation(JVM_FIELD_ANNOTATION_FQ_NAME);
        }
        return true;
    }
    ...
    public static boolean isClassCompanionObjectWithBackingFieldsInOuter(@NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        return DescriptorUtils.isCompanionObject(declarationDescriptor) && DescriptorUtils.isClassOrEnumClass(declarationDescriptor.mo11607getContainingDeclaration()) && !isMappedIntrinsicCompanionObject((ClassDescriptor) declarationDescriptor);
    }
    ...
    public static boolean isGetterName(@NotNull String str) {
        ...
        return str.startsWith(MetricsConstants.Method.CACHE_GET) || str.startsWith("is");
    }
    ...
    public static boolean isPropertyWithBackingFieldInOuterClass(@NotNull PropertyDescriptor propertyDescriptor) {
        ...
        if (isClassCompanionObjectWithBackingFieldsInOuter(propertyDescriptor.mo11607getContainingDeclaration())) {
            return true;
        }
        return DescriptorUtils.isCompanionObject(propertyDescriptor.mo11607getContainingDeclaration()) && hasJvmFieldAnnotation(propertyDescriptor);
    }
    ...
    public static String setterName(@NotNull String str) {
        ...
        outline107.append(startsWithIsPrefix(str) ? str.substring(2) : CapitalizeDecapitalizeKt.capitalizeAsciiOnly(str));

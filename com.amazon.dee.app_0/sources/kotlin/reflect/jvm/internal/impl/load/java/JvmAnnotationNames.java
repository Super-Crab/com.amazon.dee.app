...
public final class JvmAnnotationNames {
    ...
    static {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("L");
        outline107.append(JvmClassName.byFqNameWithoutInnerClasses(METADATA_FQ_NAME).getInternalName());
        outline107.append(";");
        METADATA_DESC = outline107.toString();

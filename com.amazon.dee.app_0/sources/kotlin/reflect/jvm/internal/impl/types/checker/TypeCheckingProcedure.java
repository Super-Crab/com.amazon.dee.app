...
public class TypeCheckingProcedure {
    ...
    public boolean equalTypes(@NotNull KotlinType kotlinType, @NotNull KotlinType kotlinType2) {
        ...
        if (FlexibleTypesKt.isFlexible(kotlinType)) {
            ...
            TypeConstructor mo12131getConstructor = kotlinType.mo12131getConstructor();
            TypeConstructor mo12131getConstructor2 = kotlinType2.mo12131getConstructor();
            if (!this.constraints.assertEqualTypeConstructors(mo12131getConstructor, mo12131getConstructor2)) {
                return false;
            }
            List<TypeProjection> arguments = kotlinType.getArguments();
            List<TypeProjection> arguments2 = kotlinType2.getArguments();
            ...
            for (int i = 0; i < arguments.size(); i++) {
                ...
                if (!typeProjection.isStarProjection() || !typeProjection2.isStarProjection()) {
                    TypeParameterDescriptor typeParameterDescriptor = mo12131getConstructor.getParameters().get(i);
                    TypeParameterDescriptor typeParameterDescriptor2 = mo12131getConstructor2.getParameters().get(i);

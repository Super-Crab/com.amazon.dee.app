...
public class ErrorUtils {
    private static final ModuleDescriptor ERROR_MODULE = new ModuleDescriptor() { // from class: kotlin.reflect.jvm.internal.impl.types.ErrorUtils.1
        ...
        public DeclarationDescriptor mo11613getOriginal() {
            return this;
        }
    ...
    public static class ErrorClassDescriptor extends ClassDescriptorImpl {
        ...
        public MemberScope getMemberScope(@NotNull TypeSubstitution typeSubstitution, @NotNull KotlinTypeRefiner kotlinTypeRefiner) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Error scope for class ");
            outline107.append(getName());
            outline107.append(" with arguments: ");
            outline107.append(typeSubstitution);
            MemberScope createErrorScope = ErrorUtils.createErrorScope(outline107.toString());
    ...
    public static class ErrorScope implements MemberScope {
        ...
        */
        ...
        public ClassifierDescriptor mo12030getContributedClassifier(@NotNull Name name, @NotNull LookupLocation lookupLocation) {
            if (name == null) {
                $$$reportNull$$$0(1);
            }
        ...
        public String toString() {
            return GeneratedOutlineSupport1.outline89(GeneratedOutlineSupport1.outline107("ErrorScope{"), this.debugMessage, JsonReaderKt.END_OBJ);
        }
        ...
        @NotNull
        /* renamed from: getContributedFunctions  reason: collision with other method in class */
        public Set<? extends SimpleFunctionDescriptor> mo12099getContributedFunctions(@NotNull Name name, @NotNull LookupLocation lookupLocation) {
            if (name == null) {
                $$$reportNull$$$0(8);
            }
            if (lookupLocation == null) {
        ...
        @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope
        @NotNull
        /* renamed from: getContributedVariables  reason: collision with other method in class */
        public Set<? extends PropertyDescriptor> mo12100getContributedVariables(@NotNull Name name, @NotNull LookupLocation lookupLocation) {
            if (name == null) {
                $$$reportNull$$$0(5);
            }
            if (lookupLocation == null) {
    ...
    public static class ThrowingScope implements MemberScope {
        ...
        public String toString() {
            return GeneratedOutlineSupport1.outline89(GeneratedOutlineSupport1.outline107("ThrowingScope{"), this.debugMessage, JsonReaderKt.END_OBJ);
        }
    ...
    public static class UninferredParameterTypeConstructor implements TypeConstructor {
        ...
        public ClassifierDescriptor mo12085getDeclarationDescriptor() {
            return this.errorTypeConstructor.mo12085getDeclarationDescriptor();
        }
        ...
        public Collection<KotlinType> mo12135getSupertypes() {
            Collection<KotlinType> mo12135getSupertypes = this.errorTypeConstructor.mo12135getSupertypes();
            if (mo12135getSupertypes == null) {
                $$$reportNull$$$0(3);
            }
    ...
    public static ClassDescriptor createErrorClass(@NotNull String str) {
        ...
        return new ErrorClassDescriptor(Name.special("<ERROR CLASS: " + str + Config.Compare.GREATER_THAN));
    }
    ...
    public static SimpleFunctionDescriptor createErrorFunction(@NotNull ErrorScope errorScope) {
        ...
        errorSimpleFunctionDescriptorImpl.mo11596initialize((ReceiverParameterDescriptor) null, (ReceiverParameterDescriptor) null, Collections.emptyList(), Collections.emptyList(), (KotlinType) createErrorType("<ERROR FUNCTION RETURN TYPE>"), Modality.OPEN, Visibilities.PUBLIC);
    ...
    public static TypeConstructor createErrorTypeConstructor(@NotNull String str) {
        ...
        return createErrorTypeConstructorWithCustomDebugName(GeneratedOutlineSupport1.outline75("[ERROR : ", str, "]"), ERROR_CLASS);
    }
    ...
    public static boolean isError(@Nullable DeclarationDescriptor declarationDescriptor) {
        ...
        return isErrorClass(declarationDescriptor) || isErrorClass(declarationDescriptor.mo11607getContainingDeclaration()) || declarationDescriptor == ERROR_MODULE;
    }
    ...
    public static boolean isUninferredParameter(@Nullable KotlinType kotlinType) {
        return kotlinType != null && (kotlinType.mo12131getConstructor() instanceof UninferredParameterTypeConstructor);
    }

...
public class TypeParameterDescriptorImpl extends AbstractTypeParameterDescriptor {
    ...
    private void checkInitialized() {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Type parameter descriptor is not initialized: ");
        outline107.append(nameForAssertions());
    ...
    private void checkUninitialized() {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Type parameter descriptor is already initialized: ");
        outline107.append(nameForAssertions());
        throw new IllegalStateException(outline107.toString());
    }
    ...
    private String nameForAssertions() {
        return getName() + " declared in " + DescriptorUtils.getFqName(mo11607getContainingDeclaration());
    }
    ...
    protected void mo12071reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(27);
        }
        ...
        function1.mo12165invoke(kotlinType);
    }

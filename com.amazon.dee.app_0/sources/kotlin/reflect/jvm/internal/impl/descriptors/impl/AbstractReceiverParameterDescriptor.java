...
public abstract class AbstractReceiverParameterDescriptor extends DeclarationDescriptorImpl implements ReceiverParameterDescriptor {
    ...
    public ParameterDescriptor mo11613getOriginal() {
        return this;
    }
    ...
    public KotlinType getType() {
        KotlinType mo12036getType = getValue().mo12036getType();
        if (mo12036getType == null) {
            $$$reportNull$$$0(3);
        }
        return mo12036getType;
    }
    ...
    public ReceiverParameterDescriptor mo12098substitute(@NotNull TypeSubstitutor typeSubstitutor) {
        ...
        return substitute == getType() ? this : new ReceiverParameterDescriptorImpl(mo11607getContainingDeclaration(), new TransientReceiver(substitute), mo12070getAnnotations());
    }
}

...
public final class KTypeParameterImpl implements KTypeParameter, KClassifierImpl {
    ...
    public boolean equals(@Nullable Object obj) {
        return (obj instanceof KTypeParameterImpl) && Intrinsics.areEqual(mo11491getDescriptor(), ((KTypeParameterImpl) obj).mo11491getDescriptor());
    }

    @Override // kotlin.reflect.KTypeParameter
    @NotNull
    public String getName() {
        String asString = mo11491getDescriptor().getName().asString();
    ...
    public KVariance getVariance() {
        int i = WhenMappings.$EnumSwitchMapping$0[mo11491getDescriptor().getVariance().ordinal()];
        if (i != 1) {
            if (i == 2) {
                return KVariance.IN;
            }
    ...
    public int hashCode() {
        return mo11491getDescriptor().hashCode();
    }

    @Override // kotlin.reflect.KTypeParameter
    public boolean isReified() {
        return mo11491getDescriptor().isReified();
    }

    @NotNull
    public String toString() {
        return ReflectionObjectRenderer.INSTANCE.renderTypeParameter(mo11491getDescriptor());
    }

    @Override // kotlin.reflect.jvm.internal.KClassifierImpl
    @NotNull
    /* renamed from: getDescriptor  reason: collision with other method in class */
    public TypeParameterDescriptor mo11491getDescriptor() {

...
public class KProperty0Impl<R> extends KPropertyImpl<R> implements KProperty0<R> {
    ...
    public static final class Getter<R> extends KPropertyImpl.Getter<R> implements KProperty0.Getter<R> {
        ...
        /* renamed from: invoke */
        public R mo12560invoke() {
            return mo11473getProperty().get();
        }

        @Override // kotlin.reflect.jvm.internal.KPropertyImpl.Accessor, kotlin.reflect.KProperty.Accessor
        @NotNull
        /* renamed from: getProperty  reason: collision with other method in class */
        public KProperty0Impl<R> mo11473getProperty() {
    ...
    public KProperty0Impl(@NotNull KDeclarationContainerImpl container, @NotNull PropertyDescriptor descriptor) {
        ...
        ReflectProperties.LazyVal<Getter<R>> lazy2 = ReflectProperties.lazy(new KProperty0Impl$_getter$1(this));
        Intrinsics.checkExpressionValueIsNotNull(lazy2, "ReflectProperties.lazy { Getter(this) }");
        this._getter = lazy2;
        lazy = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new KProperty0Impl$delegateFieldValue$1(this));
        this.delegateFieldValue = lazy;
    }
    ...
    public Getter<R> mo11472getGetter() {

...
public final class KParameterImpl implements KParameter {
    ...
    public String getName() {
        ...
        if (valueParameterDescriptor == null || valueParameterDescriptor.mo11607getContainingDeclaration().hasSynthesizedParameterNames()) {
            return null;
        }
    ...
    public int hashCode() {
        return getDescriptor().hashCode() + (this.callable.hashCode() * 31);
    }

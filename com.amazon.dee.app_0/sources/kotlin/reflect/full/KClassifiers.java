...
public final class KClassifiers {
    ...
    public static final KType createType(@NotNull KClassifier createType, @NotNull List<KTypeProjection> arguments, boolean z, @NotNull List<? extends Annotation> annotations) {
        ClassifierDescriptor mo11491getDescriptor;
        ...
        if (kClassifierImpl != null && (mo11491getDescriptor = kClassifierImpl.mo11491getDescriptor()) != null) {
            TypeConstructor mo11528getTypeConstructor = mo11491getDescriptor.mo11528getTypeConstructor();
            ...
            if (parameters.size() == arguments.size()) {
                return new KTypeImpl(createKotlinType(annotations.isEmpty() ? Annotations.Companion.getEMPTY() : Annotations.Companion.getEMPTY(), mo11528getTypeConstructor, arguments, z), new KClassifiers$createType$1(createType));
            }
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Class declares ");
            outline107.append(parameters.size());
            outline107.append(" type parameters, but ");
            outline107.append(arguments.size());
            outline107.append(" were provided.");

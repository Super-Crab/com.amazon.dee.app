...
public class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static void forEachLine(@NotNull File forEachLine, @NotNull Charset charset, @NotNull Function1<? super String, Unit> action) {
                ...
                if (i > 0) {
                    ...
                    if (read2 != -1) {
                        ...
                        if (length2 >= 0) {
                            ...
                            bArr = ArraysKt___ArraysJvmKt.copyInto(buffer, copyOf, bArr.length, 0, exposingBufferByteArrayOutputStream.size());
                        } else {
    ...
    public static final <T> T useLines(@NotNull File useLines, @NotNull Charset charset, @NotNull Function1<? super Sequence<String>, ? extends T> block) {
        ...
        try {
            T mo12165invoke = block.mo12165invoke(TextStreamsKt.lineSequence(bufferedReader));
    ...
    public static /* synthetic */ Object useLines$default(File useLines, Charset charset, Function1 block, int i, Object obj) {
        ...
        BufferedReader bufferedReader = inputStreamReader instanceof BufferedReader ? (BufferedReader) inputStreamReader : new BufferedReader(inputStreamReader, 8192);
        try {
            Object mo12165invoke = block.mo12165invoke(TextStreamsKt.lineSequence(bufferedReader));
            InlineMarker.finallyStart(1);
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(bufferedReader, null);
            } else {
    ...
    public static final void forEachBlock(@NotNull File forEachBlock, int i, @NotNull Function2<? super byte[], ? super Integer, Unit> action) {
        ...
        while (true) {
            try {
                ...
                action.mo12248invoke(r2, Integer.valueOf(read));
            } finally {
            }
        }
    }

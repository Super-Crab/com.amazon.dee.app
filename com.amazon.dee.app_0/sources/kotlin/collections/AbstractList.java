...
@Metadata(bv = {1, 0, 3}, d1 = {"\u00008\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\b\n\u0002\u0010(\n\u0002\b\u0002\n\u0002\u0010*\n\u0002\b\b\b'\u0018\u0000 \u001c*\u0006\b\u0000\u0010\u0001 \u00012\b\u0012\u0004\u0012\u0002H\u00010\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0003:\u0004\u001c\u001d\u001e\u001fB\u0007\b\u0004¢\u0006\u0002\u0010\u0004J\u0013\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\fH\u0096\u0002J\u0016\u0010\r\u001a\u00028\u00002\u0006\u0010\u000e\u001a\u00020\u0006H¦\u0002¢\u0006\u0002\u0010\u000fJ\b\u0010\u0010\u001a\u00020\u0006H\u0016J\u0015\u0010\u0011\u001a\u00020\u00062\u0006\u0010\u0012\u001a\u00028\u0000H\u0016¢\u0006\u0002\u0010\u0013J\u000f\u0010\u0014\u001a\b\u0012\u0004\u0012\u00028\u00000\u0015H\u0096\u0002J\u0015\u0010\u0016\u001a\u00020\u00062\u0006\u0010\u0012\u001a\u00028\u0000H\u0016¢\u0006\u0002\u0010\u0013J\u000e\u0010\u0017\u001a\b\u0012\u0004\u0012\u00028\u00000\u0018H\u0016J\u0016\u0010\u0017\u001a\b\u0012\u0004\u0012\u00028\u00000\u00182\u0006\u0010\u000e\u001a\u00020\u0006H\u0016J\u001e\u0010\u0019\u001a\b\u0012\u0004\u0012\u00028\u00000\u00032\u0006\u0010\u001a\u001a\u00020\u00062\u0006\u0010\u001b\u001a\u00020\u0006H\u0016R\u0012\u0010\u0005\u001a\u00020\u0006X¦\u0004¢\u0006\u0006\u001a\u0004\b\u0007\u0010\b¨\u0006 "}, d2 = {"Lkotlin/collections/AbstractList;", ExifInterface.LONGITUDE_EAST, "Lkotlin/collections/AbstractCollection;", "", "()V", "size", "", "getSize", "()I", "equals", "", "other", "", MetricsConstants.Method.CACHE_GET, "index", "(I)Ljava/lang/Object;", "hashCode", "indexOf", "element", "(Ljava/lang/Object;)I", "iterator", "", "lastIndexOf", "listIterator", "", "subList", "fromIndex", "toIndex", "Companion", "IteratorImpl", "ListIteratorImpl", "SubList", "kotlin-stdlib"}, k = 1, mv = {1, 1, 16})
...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final void checkBoundsIndexes$kotlin_stdlib(int i, int i2, int i3) {
            if (i < 0 || i2 > i3) {
                StringBuilder outline110 = GeneratedOutlineSupport1.outline110("startIndex: ", i, ", endIndex: ", i2, ", size: ");
                outline110.append(i3);
                throw new IndexOutOfBoundsException(outline110.toString());
            } else if (i > i2) {
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline53("startIndex: ", i, " > endIndex: ", i2));
            }
        }

        public final void checkElementIndex$kotlin_stdlib(int i, int i2) {
            if (i < 0 || i >= i2) {
                throw new IndexOutOfBoundsException(GeneratedOutlineSupport1.outline53("index: ", i, ", size: ", i2));
            }
        }
        ...
        public final void checkRangeIndexes$kotlin_stdlib(int i, int i2, int i3) {
            if (i < 0 || i2 > i3) {
                StringBuilder outline110 = GeneratedOutlineSupport1.outline110("fromIndex: ", i, ", toIndex: ", i2, ", size: ");
                outline110.append(i3);
                throw new IndexOutOfBoundsException(outline110.toString());
            } else if (i > i2) {
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline53("fromIndex: ", i, " > toIndex: ", i2));
            }
        }
    ...
    public class IteratorImpl implements Iterator<E>, KMappedMarker {
        ...
        public E next() {
            if (hasNext()) {
                ...
                int i = this.index;
                this.index = i + 1;
                return (E) abstractList.mo12625get(i);
            }
    ...
    private class ListIteratorImpl extends AbstractList<E>.IteratorImpl implements ListIterator<E>, KMappedMarker {
        ...
        public E previous() {
            if (hasPrevious()) {
                AbstractList abstractList = AbstractList.this;
                setIndex(getIndex() - 1);
                return (E) abstractList.mo12625get(getIndex());
            }
            throw new NoSuchElementException();
        }
    ...
    private static final class SubList<E> extends AbstractList<E> implements RandomAccess {
        ...
        /* renamed from: get */
        public E mo12625get(int i) {
            AbstractList.Companion.checkElementIndex$kotlin_stdlib(i, this._size);
            return this.list.mo12625get(this.fromIndex + i);
        }
    ...
    @Override // java.util.List
    /* renamed from: get */
    public abstract E mo12625get(int i);

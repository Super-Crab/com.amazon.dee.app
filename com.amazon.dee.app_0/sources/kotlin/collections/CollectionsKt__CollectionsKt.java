...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    private static final <T> List<T> List(int i, Function1<? super Integer, ? extends T> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(function1.mo12165invoke(Integer.valueOf(i2)));
        }
        return arrayList;
    }
    ...
    private static final <E> List<E> buildList(@BuilderInference Function1<? super List<E>, Unit> function1) {
        ...
        function1.mo12165invoke(arrayList);
        return arrayList;
    }
    ...
    private static final Object ifEmpty(Collection collection, Function0 function0) {
        return collection.isEmpty() ? function0.mo12560invoke() : collection;
    }
    ...
    private static final void rangeCheck$CollectionsKt__CollectionsKt(int i, int i2, int i3) {
        if (i2 <= i3) {
            if (i2 < 0) {
                throw new IndexOutOfBoundsException(GeneratedOutlineSupport1.outline52("fromIndex (", i2, ") is less than zero."));
            }
            if (i3 > i) {
                throw new IndexOutOfBoundsException(GeneratedOutlineSupport1.outline54("toIndex (", i3, ") is greater than size (", i, ")."));
            }
            return;
        }
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline54("fromIndex (", i2, ") is greater than toIndex (", i3, ")."));
    }
    ...
    public static final <T> int binarySearch(@NotNull List<? extends T> binarySearch, int i, int i2, @NotNull Function1<? super T, Integer> comparison) {
        ...
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
            int intValue = comparison.mo12165invoke((T) binarySearch.get(i4)).intValue();
            if (intValue < 0) {
                i = i4 + 1;
            } else if (intValue <= 0) {
                return i4;

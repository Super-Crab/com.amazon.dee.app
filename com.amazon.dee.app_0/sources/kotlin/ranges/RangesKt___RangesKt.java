...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final long coerceIn(long j, long j2, long j3) {
        ...
        StringBuilder outline111 = GeneratedOutlineSupport1.outline111("Cannot coerce value to an empty range: maximum ", j3, " is less than minimum ");
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(@NotNull T coerceIn, @NotNull ClosedFloatingPointRange<T> range) {
        ...
        if (!range.isEmpty()) {
            return (!range.lessThanOrEquals(coerceIn, range.mo11373getStart()) || range.lessThanOrEquals(range.mo11373getStart(), coerceIn)) ? (!range.lessThanOrEquals(range.mo11372getEndInclusive(), coerceIn) || range.lessThanOrEquals(coerceIn, range.mo11372getEndInclusive())) ? coerceIn : range.mo11372getEndInclusive() : range.mo11373getStart();
        }
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(@NotNull T coerceIn, @NotNull ClosedRange<T> range) {
        ...
        if (!range.isEmpty()) {
            return coerceIn.compareTo(range.mo11373getStart()) < 0 ? range.mo11373getStart() : coerceIn.compareTo(range.mo11372getEndInclusive()) > 0 ? range.mo11372getEndInclusive() : coerceIn;
        }
        throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
    }
    ...
    public static final int coerceIn(int i, @NotNull ClosedRange<Integer> range) {
        ...
        if (!range.isEmpty()) {
            return i < range.mo11373getStart().intValue() ? range.mo11373getStart().intValue() : i > range.mo11372getEndInclusive().intValue() ? range.mo11372getEndInclusive().intValue() : i;
        }
        throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
    }
    ...
    public static final long coerceIn(long j, @NotNull ClosedRange<Long> range) {
        ...
        if (!range.isEmpty()) {
            return j < range.mo11373getStart().longValue() ? range.mo11373getStart().longValue() : j > range.mo11372getEndInclusive().longValue() ? range.mo11372getEndInclusive().longValue() : j;
        }
        throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
    }
}

...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            try {
                $SwitchMap$io$reactivex$rxjava3$core$BackpressureStrategy[BackpressureStrategy.DROP.ordinal()] = 1;
    ...
    public static Observable<Integer> range(int start, int count) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("count >= 0 required but it was ", count));
    }
    ...
    public static Observable<Long> rangeLong(long start, long count) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline56("count >= 0 required but it was ", count));
    }
    ...
    public final Observable<T> doOnError(@NonNull Consumer<? super Throwable> onError) {
        ...
        return doOnEach(emptyConsumer, onError, action, action);
    }
    ...
    public final Observable<T> doOnNext(@NonNull Consumer<? super T> onNext) {
        ...
        Action action = Functions.EMPTY_ACTION;
        return doOnEach(onNext, emptyConsumer, action, action);
    }
    ...
    public final Maybe<T> elementAt(long index) {
        ...
        throw new IndexOutOfBoundsException(GeneratedOutlineSupport1.outline56("index >= 0 required but it was ", index));
    }
    ...
    public final Observable<T> skip(long count) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline56("count >= 0 expected but it was ", count));
    }
    ...
    public final void blockingForEach(@NonNull Consumer<? super T> onNext, int capacityHint) {
        Objects.requireNonNull(onNext, "onNext is null");
        Iterator<T> it2 = blockingIterable(capacityHint).iterator();
        while (it2.hasNext()) {
            try {
    ...
    public final <R> Observable<R> concatMap(@NonNull Function<? super T, ? extends ObservableSource<? extends R>> mapper, int bufferSize) {
        ...
        if (this instanceof ScalarSupplier) {
            Object mo10365get = ((ScalarSupplier) this).mo10365get();
            if (mo10365get == null) {
                return empty();
            }
            return ObservableScalarXMap.scalarXMap(mo10365get, mapper);
        }
    ...
    public final Observable<T> repeat(long times) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline56("times >= 0 required but it was ", times));
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public final <U, V> Observable<V> flatMapIterable(@NonNull Function<? super T, ? extends Iterable<? extends U>> mapper, @NonNull BiFunction<? super T, ? super U, ? extends V> combiner) {
        Objects.requireNonNull(mapper, "mapper is null");
        Objects.requireNonNull(combiner, "combiner is null");
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    public final Observable<List<T>> buffer(long timespan, long timeskip, @NonNull TimeUnit unit) {
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Observable<List<T>> buffer(long timespan, long timeskip, @NonNull TimeUnit unit, @NonNull Scheduler scheduler) {
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Observable<List<T>> buffer(long timespan, @NonNull TimeUnit unit, @NonNull Scheduler scheduler, int count) {
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Observable<List<T>> buffer(long timespan, @NonNull TimeUnit unit, @NonNull Scheduler scheduler) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public final <TOpening, TClosing> Observable<List<T>> buffer(@NonNull ObservableSource<? extends TOpening> openingIndicator, @NonNull Function<? super TOpening, ? extends ObservableSource<? extends TClosing>> closingIndicator) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public final <B> Observable<List<T>> buffer(@NonNull ObservableSource<B> boundaryIndicator) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public final <B> Observable<List<T>> buffer(@NonNull ObservableSource<B> boundaryIndicator, int initialCapacity) {
        ObjectHelper.verifyPositive(initialCapacity, "initialCapacity");

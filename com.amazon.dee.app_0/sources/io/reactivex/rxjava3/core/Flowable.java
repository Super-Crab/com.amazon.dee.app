...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    <R> Flowable<R> switchMap0(Function<? super T, ? extends Publisher<? extends R>> mapper, int bufferSize, boolean delayError) {
        ...
        if (this instanceof ScalarSupplier) {
            ...
            return FlowableScalarXMap.scalarXMap(mo10365get, mapper);
        }
    ...
    public final void blockingForEach(@NonNull Consumer<? super T> onNext, int bufferSize) {
        Objects.requireNonNull(onNext, "onNext is null");
        Iterator<T> it2 = blockingIterable(bufferSize).iterator();
        while (it2.hasNext()) {
            try {
    ...
    public final Stream<T> blockingStream(int prefetch) {
        Iterator<T> it2 = blockingIterable(prefetch).iterator();
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <U, V> Flowable<V> flatMapIterable(@NonNull Function<? super T, ? extends Iterable<? extends U>> mapper, @NonNull BiFunction<? super T, ? super U, ? extends V> combiner) {
        Objects.requireNonNull(mapper, "mapper is null");
        Objects.requireNonNull(combiner, "combiner is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <U, V> Flowable<V> flatMapIterable(@NonNull Function<? super T, ? extends Iterable<? extends U>> mapper, @NonNull BiFunction<? super T, ? super U, ? extends V> combiner, int prefetch) {
        Objects.requireNonNull(mapper, "mapper is null");
        Objects.requireNonNull(combiner, "combiner is null");
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @SchedulerSupport("none")
    public final <TOpening, TClosing> Flowable<List<T>> buffer(@NonNull Publisher<? extends TOpening> openingIndicator, @NonNull Function<? super TOpening, ? extends Publisher<? extends TClosing>> closingIndicator) {

...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public final Maybe<T> doOnComplete(@NonNull Action onComplete) {
        ...
        return RxJavaPlugins.onAssembly(new MaybePeek(this, Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.emptyConsumer(), (Action) Objects.requireNonNull(onComplete, "onComplete is null"), action, action));
    }
    ...
    public final Maybe<T> doOnDispose(@NonNull Action onDispose) {
        ...
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new MaybePeek(this, emptyConsumer, emptyConsumer2, emptyConsumer3, action, action, (Action) Objects.requireNonNull(onDispose, "onDispose is null")));
    }
    ...
    public final Maybe<T> doOnError(@NonNull Consumer<? super Throwable> onError) {
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new MaybePeek(this, Functions.emptyConsumer(), Functions.emptyConsumer(), (Consumer) Objects.requireNonNull(onError, "onError is null"), action, action, action));
    }
    ...
    public final Maybe<T> doOnSubscribe(@NonNull Consumer<? super Disposable> onSubscribe) {
        ...
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new MaybePeek(this, (Consumer) Objects.requireNonNull(onSubscribe, "onSubscribe is null"), emptyConsumer, emptyConsumer2, action, action, action));
    }
    ...
    public final Maybe<T> doOnSuccess(@NonNull Consumer<? super T> onSuccess) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new MaybePeek(this, Functions.emptyConsumer(), (Consumer) Objects.requireNonNull(onSuccess, "onSuccess is null"), emptyConsumer, action, action, action));
    }

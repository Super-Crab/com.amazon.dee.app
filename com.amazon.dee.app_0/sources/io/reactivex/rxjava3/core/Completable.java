...
public abstract class Completable implements CompletableSource {
    ...
    public final Completable doAfterTerminate(@NonNull Action onAfterTerminate) {
        ...
        return doOnLifecycle(emptyConsumer, emptyConsumer2, action, action, onAfterTerminate, action);
    }
    ...
    public final Completable doOnComplete(@NonNull Action onComplete) {
        ...
        Consumer<? super Throwable> emptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return doOnLifecycle(emptyConsumer, emptyConsumer2, onComplete, action, action, action);
    }
    ...
    public final Completable doOnDispose(@NonNull Action onDispose) {
        ...
        Consumer<? super Throwable> emptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return doOnLifecycle(emptyConsumer, emptyConsumer2, action, action, action, onDispose);
    }
    ...
    public final Completable doOnError(@NonNull Consumer<? super Throwable> onError) {
        Consumer<? super Disposable> emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return doOnLifecycle(emptyConsumer, onError, action, action, action, action);
    }
    ...
    public final Completable doOnLifecycle(@NonNull Consumer<? super Disposable> onSubscribe, @NonNull Action onDispose) {
        ...
        Action action = Functions.EMPTY_ACTION;
        return doOnLifecycle(onSubscribe, emptyConsumer, action, action, action, onDispose);
    }
    ...
    public final Completable doOnSubscribe(@NonNull Consumer<? super Disposable> onSubscribe) {
        Consumer<? super Throwable> emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return doOnLifecycle(onSubscribe, emptyConsumer, action, action, action, action);
    }
    ...
    public final Completable doOnTerminate(@NonNull Action onTerminate) {
        ...
        Consumer<? super Throwable> emptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return doOnLifecycle(emptyConsumer, emptyConsumer2, action, onTerminate, action, action);
    }

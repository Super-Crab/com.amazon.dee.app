...
public final class CompletableUsing<R> extends Completable {
    ...
    protected void subscribeActual(CompletableObserver observer) {
        try {
            R mo10365get = this.resourceSupplier.mo10365get();
            try {
                ((CompletableSource) Objects.requireNonNull(this.completableFunction.mo10358apply(mo10365get), "The completableFunction returned a null CompletableSource")).subscribe(new UsingObserver(observer, mo10365get, this.disposer, this.eager));
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
                if (this.eager) {
                    try {

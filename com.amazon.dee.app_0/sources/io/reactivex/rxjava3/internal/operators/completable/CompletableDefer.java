...
public final class CompletableDefer extends Completable {
    ...
    protected void subscribeActual(CompletableObserver observer) {
        try {
            ((CompletableSource) Objects.requireNonNull(this.completableSupplier.mo10365get(), "The completableSupplier returned a null CompletableSource")).subscribe(observer);
        } catch (Throwable th) {

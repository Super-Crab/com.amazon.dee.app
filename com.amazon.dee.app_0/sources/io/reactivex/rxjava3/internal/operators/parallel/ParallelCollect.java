...
public final class ParallelCollect<T, C> extends ParallelFlowable<C> {
    ...
    public void subscribe(Subscriber<? super C>[] subscribers) {
        ...
        for (int i = 0; i < length; i++) {
            try {
                subscriberArr[i] = new ParallelCollectSubscriber(subscribers[i], Objects.requireNonNull(this.initialCollection.mo10365get(), "The initialSupplier returned a null value"), this.collector);
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);

...
public final class ParallelReduce<T, R> extends ParallelFlowable<R> {
    ...
    public void subscribe(Subscriber<? super R>[] subscribers) {
        ...
        for (int i = 0; i < length; i++) {
            try {
                subscriberArr[i] = new ParallelReduceSubscriber(subscribers[i], Objects.requireNonNull(this.initialSupplier.mo10365get(), "The initialSupplier returned a null value"), this.reducer);
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);

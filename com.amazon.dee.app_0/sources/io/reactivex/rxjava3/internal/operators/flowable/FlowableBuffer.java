...
public final class FlowableBuffer<T, C extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, C> {
    ...
    static final class PublisherBufferExactSubscriber<T, C extends Collection<? super T>> implements FlowableSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            ...
            if (c == null) {
                try {
                    c = (C) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The bufferSupplier returned a null buffer");
                    this.buffer = c;
                } catch (Throwable th) {
    ...
    static final class PublisherBufferOverlappingSubscriber<T, C extends Collection<? super T>> extends AtomicLong implements FlowableSubscriber<T>, Subscription, BooleanSupplier {
        ...
        public void onNext(T t) {
            ...
            if (i == 0) {
                try {
                    arrayDeque.offer((Collection) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The bufferSupplier returned a null buffer"));
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
                    cancel();
                    onError(th);
    ...
    public void subscribeActual(Subscriber<? super C> s) {
        ...
        if (i == i2) {
            ...
            this.source.subscribe((FlowableSubscriber) new PublisherBufferSkipSubscriber(s, i, i2, this.bufferSupplier));
        } else {
            this.source.subscribe((FlowableSubscriber) new PublisherBufferOverlappingSubscriber(s, i, i2, this.bufferSupplier));
        }
    }
}

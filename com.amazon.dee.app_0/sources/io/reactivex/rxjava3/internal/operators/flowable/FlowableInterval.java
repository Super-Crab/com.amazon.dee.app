    ...
    static final class IntervalSubscriber extends AtomicLong implements Subscription, Runnable {
        ...
        public void run() {
            if (this.resource.get() != DisposableHelper.DISPOSED) {
                ...
                this.downstream.onError(new MissingBackpressureException(GeneratedOutlineSupport1.outline87(GeneratedOutlineSupport1.outline107("Can't deliver value "), this.count, " due to lack of requests")));
                DisposableHelper.dispose(this.resource);
            }
        }

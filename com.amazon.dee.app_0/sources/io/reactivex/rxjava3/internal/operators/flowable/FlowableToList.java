...
public final class FlowableToList<T, U extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, U> {
    ...
    protected void subscribeActual(Subscriber<? super U> s) {
        try {
            this.source.subscribe((FlowableSubscriber) new ToListSubscriber(s, (Collection) ExceptionHelper.nullCheck(this.collectionSupplier.mo10365get(), "The collectionSupplier returned a null Collection.")));
        } catch (Throwable th) {

...
public final class FlowableTimeout<T, U, V> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class TimeoutFallbackSubscriber<T> extends SubscriptionArbiter implements FlowableSubscriber<T>, TimeoutSelectorSupport {
        ...
        public void onNext(T t) {
            ...
            if (j != Long.MAX_VALUE) {
                ...
                try {
                    Publisher publisher = (Publisher) Objects.requireNonNull(this.itemTimeoutIndicator.mo10358apply(t), "The itemTimeoutIndicator returned a null Publisher.");
    ...
    protected void subscribeActual(Subscriber<? super T> s) {
        ...
        TimeoutFallbackSubscriber timeoutFallbackSubscriber = new TimeoutFallbackSubscriber(s, this.itemTimeoutIndicator, publisher);

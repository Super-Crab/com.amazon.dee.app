...
public final class FlowableBufferTimed<T, U extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, U> {
    ...
    static final class BufferExactBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable, Disposable {
        ...
        public void onNext(T t) {
            synchronized (this) {
                ...
                try {
                    U u2 = (U) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The supplied buffer is null");
                    synchronized (this) {
                        this.buffer = u2;
                        this.consumerIndex++;
                    }
        ...
        public void onSubscribe(Subscription s) {
            ...
            this.upstream = s;
            try {
                this.buffer = (U) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The supplied buffer is null");
        ...
        public void run() {
            try {
                U u = (U) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The supplied buffer is null");
                synchronized (this) {
                    U u2 = this.buffer;
    ...
    static final class BufferSkipBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable {
        ...
        public void onSubscribe(Subscription s) {
            ...
            this.upstream = s;
            try {
                Collection collection = (Collection) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The supplied buffer is null");

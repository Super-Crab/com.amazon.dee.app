...
public final class FlowableWindow<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
        ...
        */
        void drain() {
            ...
            Lf:
                ...
                if (r4 == 0) goto L1f
            L13:
                java.lang.Object r4 = r1.mo10355poll()
            ...
            L28:
                ...
                java.lang.Object r12 = r1.mo10355poll()
    ...
    public void subscribeActual(Subscriber<? super Flowable<T>> s) {
        ...
        long j2 = this.size;
        if (j == j2) {
            this.source.subscribe((FlowableSubscriber) new WindowExactSubscriber(s, j2, this.bufferSize));
        } else if (j > j2) {
            this.source.subscribe((FlowableSubscriber) new WindowSkipSubscriber(s, j2, j, this.bufferSize));
        } else {
            this.source.subscribe((FlowableSubscriber) new WindowOverlapSubscriber(s, j2, j, this.bufferSize));
        }
    }
}

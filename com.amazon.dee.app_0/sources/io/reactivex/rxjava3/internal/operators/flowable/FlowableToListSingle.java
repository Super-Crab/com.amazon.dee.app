...
public final class FlowableToListSingle<T, U extends Collection<? super T>> extends Single<U> implements FuseToFlowable<U> {
    ...
    protected void subscribeActual(SingleObserver<? super U> observer) {
        try {
            this.source.subscribe((FlowableSubscriber) new ToListSubscriber(observer, (Collection) ExceptionHelper.nullCheck(this.collectionSupplier.mo10365get(), "The collectionSupplier returned a null Collection.")));
        } catch (Throwable th) {

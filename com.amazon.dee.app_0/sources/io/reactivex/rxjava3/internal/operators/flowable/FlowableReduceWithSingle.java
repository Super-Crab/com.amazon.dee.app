...
public final class FlowableReduceWithSingle<T, R> extends Single<R> {
    ...
    protected void subscribeActual(SingleObserver<? super R> observer) {
        try {
            this.source.subscribe(new FlowableReduceSeedSingle.ReduceSeedObserver(observer, this.reducer, Objects.requireNonNull(this.seedSupplier.mo10365get(), "The seedSupplier returned a null value")));
        } catch (Throwable th) {

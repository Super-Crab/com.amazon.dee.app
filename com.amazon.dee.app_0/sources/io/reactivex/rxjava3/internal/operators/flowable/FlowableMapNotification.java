...
public final class FlowableMapNotification<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static final class MapNotificationSubscriber<T, R> extends SinglePostCompleteSubscriber<T, R> {
        ...
        public void onComplete() {
            try {
                complete(Objects.requireNonNull(this.onCompleteSupplier.mo10365get(), "The onComplete publisher returned is null"));
            } catch (Throwable th) {
        ...
        public void onError(Throwable t) {
            try {
                complete(Objects.requireNonNull(this.onErrorMapper.mo10358apply(t), "The onError publisher returned is null"));
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
        ...
        public void onNext(T t) {
            try {
                Object requireNonNull = Objects.requireNonNull(this.onNextMapper.mo10358apply(t), "The onNext publisher returned is null");
                this.produced++;

                                ...
                                try {
                                    ...
                                    if (publisher instanceof Supplier) {
                                        ...
                                        if (obj == null) {
                                            ...
                                            concatMapInner.setSubscription(new SimpleScalarSubscription(obj, concatMapInner));
                                        }
                                    } else {
                                        this.active = true;
                                    ...
                                    if (publisher instanceof Supplier) {
                                        try {
                                            ...
                                            if (mo10365get == null) {
                                                ...
                                                if (!HalfSerializer.onNext(this.downstream, mo10365get, this, this.errors)) {
                                                    return;
                                                }
                                            } else {
                                                this.active = true;
                                                ConcatMapInner<R> concatMapInner = this.inner;
                                                concatMapInner.setSubscription(new SimpleScalarSubscription(mo10365get, concatMapInner));
                                            }
                                        } catch (Throwable th) {
                                            Exceptions.throwIfFatal(th);
                                            this.upstream.cancel();

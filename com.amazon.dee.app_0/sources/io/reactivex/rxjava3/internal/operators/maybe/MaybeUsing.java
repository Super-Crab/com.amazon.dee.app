...
public final class MaybeUsing<T, D> extends Maybe<T> {
    ...
    protected void subscribeActual(MaybeObserver<? super T> observer) {
        try {
            ...
            try {
                ((MaybeSource) Objects.requireNonNull(this.sourceSupplier.mo10358apply(mo10365get), "The sourceSupplier returned a null MaybeSource")).subscribe(new UsingObserver(observer, mo10365get, this.resourceDisposer, this.eager));
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
                if (this.eager) {
                    try {
                        this.resourceDisposer.accept(mo10365get);
                    } catch (Throwable th2) {

...
public final class MaybeFlatMapNotification<T, R> extends AbstractMaybeWithUpstream<T, R> {
    ...
    static final class FlatMapMaybeObserver<T, R> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        public void onComplete() {
            try {
                MaybeSource maybeSource = (MaybeSource) Objects.requireNonNull(this.onCompleteSupplier.mo10365get(), "The onCompleteSupplier returned a null MaybeSource");
                if (isDisposed()) {
                    return;
                }
        ...
        public void onError(Throwable e) {
            try {
                MaybeSource maybeSource = (MaybeSource) Objects.requireNonNull(this.onErrorMapper.mo10358apply(e), "The onErrorMapper returned a null MaybeSource");
                if (isDisposed()) {
                    return;
                }
                maybeSource.subscribe(new InnerObserver());
        ...
        public void onSuccess(T value) {
            try {
                MaybeSource maybeSource = (MaybeSource) Objects.requireNonNull(this.onSuccessMapper.mo10358apply(value), "The onSuccessMapper returned a null MaybeSource");
                if (isDisposed()) {
                    return;
                }
                maybeSource.subscribe(new InnerObserver());

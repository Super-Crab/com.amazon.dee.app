...
public final class SingleZipIterable<T, R> extends Single<R> {
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R mo10358apply(T t) throws Throwable {
            return (R) Objects.requireNonNull(SingleZipIterable.this.zipper.mo10358apply(new Object[]{t}), "The zipper returned a null value");
        }
    }
    ...
    protected void subscribeActual(SingleObserver<? super R> observer) {
        ...
        try {
            ...
            if (i == 0) {
                ...
                singleSourceArr2[0].subscribe(new SingleMap.MapSingleObserver(observer, new SingletonArrayFunc()));
            } else {

...
public final class SingleResumeNext<T> extends Single<T> {
    ...
    static final class ResumeMainSingleObserver<T> extends AtomicReference<Disposable> implements SingleObserver<T>, Disposable {
        ...
        public void onError(Throwable e) {
            try {
                ((SingleSource) Objects.requireNonNull(this.nextFunction.mo10358apply(e), "The nextFunction returned a null SingleSource.")).subscribe(new ResumeSingleObserver(this, this.downstream));
            } catch (Throwable th) {

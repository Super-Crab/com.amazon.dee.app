...
public final class SingleUsing<T, U> extends Single<T> {
    ...
    protected void subscribeActual(final SingleObserver<? super T> observer) {
        try {
            U mo10365get = this.resourceSupplier.mo10365get();
            try {
                ((SingleSource) Objects.requireNonNull(this.singleFunction.mo10358apply(mo10365get), "The singleFunction returned a null SingleSource")).subscribe(new UsingSingleObserver(observer, mo10365get, this.eager, this.disposer));
            } catch (Throwable th) {
                th = th;
                Exceptions.throwIfFatal(th);
                if (this.eager) {

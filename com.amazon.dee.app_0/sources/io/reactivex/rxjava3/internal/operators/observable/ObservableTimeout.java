    ...
    static final class TimeoutFallbackObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable, TimeoutSelectorSupport {
        ...
        public void onNext(T t) {
            ...
            if (j != Long.MAX_VALUE) {
                ...
                try {
                    ObservableSource observableSource = (ObservableSource) Objects.requireNonNull(this.itemTimeoutIndicator.mo10358apply(t), "The itemTimeoutIndicator returned a null ObservableSource.");

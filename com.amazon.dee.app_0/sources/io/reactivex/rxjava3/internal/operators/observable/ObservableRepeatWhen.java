...
public final class ObservableRepeatWhen<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    protected void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) Objects.requireNonNull(this.handler.mo10358apply(serialized), "The handler returned a null ObservableSource");

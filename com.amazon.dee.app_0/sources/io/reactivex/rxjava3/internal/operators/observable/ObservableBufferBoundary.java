    ...
    static final class BufferBoundaryObserver<T, C extends Collection<? super T>, Open, Close> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                C mo10355poll = spscLinkedArrayQueue.mo10355poll();
        ...
        void open(Open token) {
            try {
                ...
                ObservableSource observableSource = (ObservableSource) Objects.requireNonNull(this.bufferClose.mo10358apply(token), "The bufferClose returned a null ObservableSource");
                long j = this.index;
                this.index = 1 + j;
                synchronized (this) {
                    Map<Long, C> map = this.buffers;

...
public final class ObservableFlatMapCompletable<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class FlatMapCompletableMainObserver<T> extends BasicIntQueueDisposable<T> implements Observer<T> {
        ...
        public void onNext(T value) {
            try {
                CompletableSource completableSource = (CompletableSource) Objects.requireNonNull(this.mapper.mo10358apply(value), "The mapper returned a null CompletableSource");
                getAndIncrement();

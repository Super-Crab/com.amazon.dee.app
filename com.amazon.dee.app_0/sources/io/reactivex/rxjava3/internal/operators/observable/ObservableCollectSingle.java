...
public final class ObservableCollectSingle<T, U> extends Single<U> implements FuseToObservable<U> {
    ...
    protected void subscribeActual(SingleObserver<? super U> t) {
        try {
            this.source.subscribe(new CollectObserver(t, Objects.requireNonNull(this.initialSupplier.mo10365get(), "The initialSupplier returned a null value"), this.collector));
        } catch (Throwable th) {
            Exceptions.throwIfFatal(th);

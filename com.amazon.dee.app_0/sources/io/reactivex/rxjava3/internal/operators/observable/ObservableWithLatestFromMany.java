...
public final class ObservableWithLatestFromMany<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R mo10358apply(T t) throws Throwable {
            return (R) Objects.requireNonNull(ObservableWithLatestFromMany.this.combiner.mo10358apply(new Object[]{t}), "The combiner returned a null value");
        }
    }
    ...
    static final class WithLatestFromObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                HalfSerializer.onNext(this.downstream, Objects.requireNonNull(this.combiner.mo10358apply(objArr), "combiner returned a null value"), this, this.error);
            } catch (Throwable th) {

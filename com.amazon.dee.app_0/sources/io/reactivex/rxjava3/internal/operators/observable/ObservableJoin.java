            ...
            while (!this.cancelled) {
                ...
                if (z && z2) {
                    ...
                    if (num == LEFT_VALUE) {
                        ...
                        this.leftIndex = i2 + 1;
                        this.lefts.put(Integer.valueOf(i2), mo10355poll);
                        try {
                            ...
                            for (TRight tright : this.rights.values()) {
                                try {
                                    observer.onNext((Object) Objects.requireNonNull(this.resultSelector.apply(mo10355poll, tright), "The resultSelector returned a null value"));
                                } catch (Throwable th) {
                        ...
                        try {
                            ...
                            for (TLeft tleft : this.lefts.values()) {
                                try {
                                    observer.onNext((Object) Objects.requireNonNull(this.resultSelector.apply(tleft, mo10355poll), "The resultSelector returned a null value"));
                                } catch (Throwable th3) {
                        ...
                        ObservableGroupJoin.LeftRightEndObserver leftRightEndObserver3 = (ObservableGroupJoin.LeftRightEndObserver) mo10355poll;
                        this.lefts.remove(Integer.valueOf(leftRightEndObserver3.index));
                        this.disposables.remove(leftRightEndObserver3);
                    } else {
                        ObservableGroupJoin.LeftRightEndObserver leftRightEndObserver4 = (ObservableGroupJoin.LeftRightEndObserver) mo10355poll;

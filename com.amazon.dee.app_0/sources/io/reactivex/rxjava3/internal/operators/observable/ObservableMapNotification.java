...
public final class ObservableMapNotification<T, R> extends AbstractObservableWithUpstream<T, ObservableSource<? extends R>> {
    ...
    static final class MapNotificationObserver<T, R> implements Observer<T>, Disposable {
        ...
        public void onComplete() {
            try {
                this.downstream.onNext((ObservableSource) Objects.requireNonNull(this.onCompleteSupplier.mo10365get(), "The onComplete ObservableSource returned is null"));
        ...
        public void onError(Throwable t) {
            try {
                this.downstream.onNext((ObservableSource) Objects.requireNonNull(this.onErrorMapper.mo10358apply(t), "The onError ObservableSource returned is null"));
                this.downstream.onComplete();
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
        ...
        public void onNext(T t) {
            try {
                this.downstream.onNext((ObservableSource) Objects.requireNonNull(this.onNextMapper.mo10358apply(t), "The onNext ObservableSource returned is null"));
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
                this.downstream.onError(th);
            }

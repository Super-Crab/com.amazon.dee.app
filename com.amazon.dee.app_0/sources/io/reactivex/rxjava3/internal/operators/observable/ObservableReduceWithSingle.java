...
public final class ObservableReduceWithSingle<T, R> extends Single<R> {
    ...
    protected void subscribeActual(SingleObserver<? super R> observer) {
        try {
            this.source.subscribe(new ObservableReduceSeedSingle.ReduceSeedObserver(observer, this.reducer, Objects.requireNonNull(this.seedSupplier.mo10365get(), "The seedSupplier returned a null value")));
        } catch (Throwable th) {

...
public final class ObservableToListSingle<T, U extends Collection<? super T>> extends Single<U> implements FuseToObservable<U> {
    ...
    public void subscribeActual(SingleObserver<? super U> t) {
        try {
            this.source.subscribe(new ToListObserver(t, (Collection) ExceptionHelper.nullCheck(this.collectionSupplier.mo10365get(), "The collectionSupplier returned a null Collection.")));
        } catch (Throwable th) {

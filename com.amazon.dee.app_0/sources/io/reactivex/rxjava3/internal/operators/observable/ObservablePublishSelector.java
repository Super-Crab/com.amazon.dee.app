...
public final class ObservablePublishSelector<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    protected void subscribeActual(Observer<? super R> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) Objects.requireNonNull(this.selector.mo10358apply(create), "The selector returned a null ObservableSource");

...
public final class ObservableBufferTimed<T, U extends Collection<? super T>> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class BufferExactBoundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Runnable, Disposable {
        ...
        public void onNext(T t) {
            synchronized (this) {
                ...
                try {
                    U u2 = (U) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The buffer supplied is null");
                    synchronized (this) {
                        this.buffer = u2;
                        this.consumerIndex++;
                    }
        ...
        public void onSubscribe(Disposable d) {
            if (DisposableHelper.validate(this.upstream, d)) {
                this.upstream = d;
                try {
                    this.buffer = (U) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The buffer supplied is null");
        ...
        public void run() {
            try {
                U u = (U) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The bufferSupplier returned a null buffer");
                synchronized (this) {
                    U u2 = this.buffer;
    ...
    static final class BufferExactUnboundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Runnable, Disposable {
        ...
        public void run() {
            U u;
            try {
                U u2 = (U) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The bufferSupplier returned a null buffer");
                synchronized (this) {
                    u = this.buffer;
                    if (u != null) {
                        this.buffer = u2;
    ...
    static final class BufferSkipBoundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Runnable, Disposable {
        ...
        public void onSubscribe(Disposable d) {
            if (DisposableHelper.validate(this.upstream, d)) {
                this.upstream = d;
                try {
                    Collection collection = (Collection) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The buffer supplied is null");
        ...
        public void run() {
            ...
            try {
                Collection collection = (Collection) Objects.requireNonNull(this.bufferSupplier.mo10365get(), "The bufferSupplier returned a null buffer");
                synchronized (this) {
                    if (this.cancelled) {
                        return;
                    }

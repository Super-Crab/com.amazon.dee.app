        ...
        */
        void drain() {
            ...
            L7a:
                boolean r9 = r5.done
                r10 = 0
                java.lang.Object r11 = r7.mo10355poll()     // Catch: java.lang.Throwable -> L82
                goto La0
            L82:
                r8 = move-exception
        ...
        public void onNext(T t) {
            ...
            try {
                ObservableSource observableSource = (ObservableSource) Objects.requireNonNull(this.mapper.mo10358apply(t), "The ObservableSource returned is null");

...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
    ...
    public static final class MulticastReplay<R, U> extends Observable<R> {
        ...
        protected void subscribeActual(Observer<? super R> child) {
            try {
                ConnectableObservable connectableObservable = (ConnectableObservable) Objects.requireNonNull(this.connectableFactory.mo10365get(), "The connectableFactory returned a null ConnectableObservable");
                ObservableSource observableSource = (ObservableSource) Objects.requireNonNull(this.selector.mo10358apply(connectableObservable), "The selector returned a null ObservableSource");

...
final class HttpClientCallKt$call$2 extends SuspendLambda implements Function2<HttpRequestBuilder, Continuation<? super Unit>, Object> {
    int label;
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        HttpClientCallKt$call$2 httpClientCallKt$call$2 = new HttpClientCallKt$call$2(completion);
    ...
    public final Object mo12248invoke(HttpRequestBuilder httpRequestBuilder, Continuation<? super Unit> continuation) {
        return ((HttpClientCallKt$call$2) create(httpRequestBuilder, continuation)).invokeSuspend(Unit.INSTANCE);
    }

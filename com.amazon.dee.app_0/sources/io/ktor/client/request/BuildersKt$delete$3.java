...
public final class BuildersKt$delete$3 extends Lambda implements Function1<HttpRequestBuilder, Unit> {
    public static final BuildersKt$delete$3 INSTANCE = new BuildersKt$delete$3();

    public BuildersKt$delete$3() {
        super(1);
    }

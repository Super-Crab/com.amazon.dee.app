...
public final class CoroutineScheduler implements Executor, Closeable {
        ...
        if (this.corePoolSize >= 1) {
            if (this.maxPoolSize >= this.corePoolSize) {
                if (this.maxPoolSize <= 2097150) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport1.outline87(GeneratedOutlineSupport1.outline107("Idle worker keep alive time "), this.idleWorkerKeepAliveNs, " must be positive").toString());
                }
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline86(GeneratedOutlineSupport1.outline107("Max pool size "), this.maxPoolSize, " should not exceed maximal supported number of threads 2097150").toString());
            }
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Max pool size ");
            outline107.append(this.maxPoolSize);
            outline107.append(" should be greater than or equals to core pool size ");
            outline107.append(this.corePoolSize);
            throw new IllegalArgumentException(outline107.toString().toString());
        }
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline86(GeneratedOutlineSupport1.outline107("Core pool size "), this.corePoolSize, " should be at least 1").toString());
    }
    ...
    public final void dispatch(@NotNull Runnable runnable, @NotNull TaskContext taskContext, boolean z) {
        ...
        if (submitToLocalQueue != null && !addToGlobalQueue(submitToLocalQueue)) {
            throw new RejectedExecutionException(GeneratedOutlineSupport1.outline91(new StringBuilder(), this.schedulerName, " was terminated"));
        }

...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public final CoroutineDispatcher blocking(int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Expected positive parallelism level, but have ", i).toString());
    }
    ...
    public void mo12302dispatch(@NotNull CoroutineContext coroutineContext, @NotNull Runnable runnable) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo12302dispatch(coroutineContext, runnable);
        }
    }
    ...
    public final CoroutineDispatcher limited(int i) {
        ...
        if (i > 0) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Expected parallelism level lesser than core pool size (");
            outline107.append(this.corePoolSize);
            outline107.append("), but have ");
            outline107.append(i);
    ...
    public String toString() {
        return super.toString() + "[scheduler = " + this.coroutineScheduler + JsonReaderKt.END_LIST;
    }

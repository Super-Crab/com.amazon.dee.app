...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1 implements Flow<R> {
    ...
    public static final class AnonymousClass2 implements FlowCollector<T> {
        ...
        public Object emit(Object obj, @NotNull Continuation continuation) {
            ...
            Object emit = this.$this_unsafeFlow$inlined.emit(this.this$0.$transform$inlined$1.mo12248invoke(obj, continuation), continuation);
        ...
        public Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
            ...
            Object mo12248invoke = this.this$0.$transform$inlined$1.mo12248invoke(obj, continuation);
            InlineMarker.mark(0);
            Object emit = flowCollector.emit(mo12248invoke, continuation);
            InlineMarker.mark(2);
            InlineMarker.mark(1);
            return emit;
        }

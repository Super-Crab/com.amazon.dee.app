...
public final class SafeCollector_commonKt {
    ...
    public static final void checkContext(@NotNull SafeCollector<?> safeCollector, @NotNull CoroutineContext coroutineContext) {
        ...
        StringBuilder outline113 = GeneratedOutlineSupport1.outline113("Flow invariant is violated:\n", "\t\tFlow was collected in ");
        outline113.append(safeCollector.collectContext);
        outline113.append(",\n");
        outline113.append("\t\tbut emission happened in ");
        outline113.append(coroutineContext);
        throw new IllegalStateException(GeneratedOutlineSupport1.outline91(outline113, ".\n", "\t\tPlease refer to 'flow' documentation or use 'flowOn' instead").toString());
    }

...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m12263catch(@NotNull Flow<? extends T> flow, @NotNull Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m12268catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m12264debounce8GFy2Ro(@NotNull Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m12266debounce8GFy2Ro(flow, d);
    }
    ...
    public static final <T> Flow<T> m12265sample8GFy2Ro(@NotNull Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m12267sample8GFy2Ro(flow, d);
    }

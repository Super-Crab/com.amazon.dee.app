    ...
    */
    public java.lang.Object emit(java.lang.Object r6, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation r7) {
        ...
        L3f:
            ...
            java.lang.Object r7 = r7.mo12165invoke(r6)
            ...
            java.lang.Object r2 = r4.mo12248invoke(r2, r7)
    ...
    public Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        ?? mo12165invoke = this.this$0.$keySelector$inlined.mo12165invoke(obj);
        T t = this.$previousKey$inlined.element;
        if (t == NullSurrogateKt.NULL || !((Boolean) this.this$0.$areEquivalent$inlined.mo12248invoke(t, mo12165invoke)).booleanValue()) {
            this.$previousKey$inlined.element = mo12165invoke;

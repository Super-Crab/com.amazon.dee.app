...
public final class ValueOrClosed<T> {
    ...
    public static final class Closed {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Closed(");
    ...
    /* compiled from: Channel.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0002\b\u0006\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J)\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00050\u0004\"\u0004\b\u0001\u0010\u00052\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007H\u0080\bø\u0001\u0000¢\u0006\u0004\b\b\u0010\tJ'\u0010\n\u001a\b\u0012\u0004\u0012\u0002H\u00050\u0004\"\u0004\b\u0001\u0010\u00052\u0006\u0010\n\u001a\u0002H\u0005H\u0080\bø\u0001\u0000¢\u0006\u0004\b\u000b\u0010\f\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\r"}, d2 = {"Lkotlinx/coroutines/channels/ValueOrClosed$Companion;", "", "()V", "closed", "Lkotlinx/coroutines/channels/ValueOrClosed;", ExifInterface.LONGITUDE_EAST, "cause", "", "closed$kotlinx_coroutines_core", "(Ljava/lang/Throwable;)Ljava/lang/Object;", "value", "value$kotlinx_coroutines_core", "(Ljava/lang/Object;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 1, 16})
    /* loaded from: classes4.dex */
    public static final class Companion {
        ...
        public final <E> Object closed$kotlinx_coroutines_core(@Nullable Throwable th) {
            return ValueOrClosed.m12253constructorimpl(new Closed(th));
        }

        @NotNull
        public final <E> Object value$kotlinx_coroutines_core(E e) {
            return ValueOrClosed.m12253constructorimpl(e);
        }
    ...
    public static final /* synthetic */ ValueOrClosed m12252boximpl(@Nullable Object obj) {
    ...
    public static Object m12253constructorimpl(@Nullable Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m12254equalsimpl(Object obj, @Nullable Object obj2) {
        return (obj2 instanceof ValueOrClosed) && Intrinsics.areEqual(obj, ((ValueOrClosed) obj2).m12262unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m12255equalsimpl0(@Nullable Object obj, @Nullable Object obj2) {
        return Intrinsics.areEqual(obj, obj2);
    }

    @Nullable
    /* renamed from: getCloseCause-impl  reason: not valid java name */
    public static final Throwable m12256getCloseCauseimpl(Object obj) {
    ...
    public static final T m12257getValueimpl(Object obj) {
        if (!(obj instanceof Closed)) {
            return obj;
        }
    ...
    public static final T m12258getValueOrNullimpl(Object obj) {
        if (obj instanceof Closed) {
            return null;
        }
        return obj;
    ...
    public static int m12259hashCodeimpl(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
    ...
    public static final boolean m12260isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m12261toStringimpl(Object obj) {
        if (obj instanceof Closed) {
            return obj.toString();
        }
        return "Value(" + obj + ')';
    ...
    public boolean equals(Object obj) {
        return m12254equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m12259hashCodeimpl(this.holder);
    }

    @NotNull
    public String toString() {
        return m12261toStringimpl(this.holder);
    }

    @Nullable
    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Object m12262unboximpl() {
        return this.holder;
    }
}

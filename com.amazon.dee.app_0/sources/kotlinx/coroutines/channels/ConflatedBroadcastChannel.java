...
import com.amazon.alexa.location.phase3.sensor.alexageofence.AlexaGeofenceState;
...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        do {
            ...
            if (!(obj instanceof State)) {
                throw new IllegalStateException(GeneratedOutlineSupport1.outline70("Invalid state ", obj).toString());
            }
    ...
    public void invokeOnClose(@NotNull Function1<? super Throwable, Unit> function1) {
        ...
        function1.mo12165invoke(((Closed) obj2).closeCause);
    }
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!_state$FU.compareAndSet(this, obj, new State(obj2, addSubscriber(((State) obj).subscribers, subscriber))));
        return subscriber;
    }

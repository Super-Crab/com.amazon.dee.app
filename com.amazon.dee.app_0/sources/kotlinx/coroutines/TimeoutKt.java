...
public final class TimeoutKt {
    ...
    public static final TimeoutCancellationException TimeoutCancellationException(long j, @NotNull Job job) {
        return new TimeoutCancellationException(GeneratedOutlineSupport1.outline57("Timed out waiting for ", j, " ms"), job);
    }
    ...
    public static final <T> Object m12244withTimeoutlwyi7ZQ(double d, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m12236toDelayMillisLRDsOJo(d), function2, continuation);
    }
    ...
    */
    public static final <T> java.lang.Object withTimeoutOrNull(long r7, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super T> r10) {
        ...
        L4a:
            ...
            r10.<init>()
            r10.element = r4
            r0.J$0 = r7     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L71
            r0.L$0 = r9     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L71
            r0.L$1 = r10     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L71
            ...
            r10.element = r2     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L71
            java.lang.Object r7 = setupTimeout(r2, r9)     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L71
            java.lang.Object r8 = kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L71
            if (r7 != r8) goto L6d
            kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineSuspended(r0)     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L71
        L6d:
            if (r7 != r1) goto L70
            return r1
        L70:
    ...
    public static final <T> Object m12245withTimeoutOrNulllwyi7ZQ(double d, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m12236toDelayMillisLRDsOJo(d), function2, continuation);
    }
}

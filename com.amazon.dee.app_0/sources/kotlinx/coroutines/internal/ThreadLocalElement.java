...
public final class ThreadLocalElement<T> implements ThreadContextElement<T> {
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("ThreadLocal(value=");
        outline107.append(this.value);
        outline107.append(", threadLocal = ");
        outline107.append(this.threadLocal);
        outline107.append(')');

...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            str = Result.m10378constructorimpl(Class.forName(str4).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            str = Result.m10378constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m10381exceptionOrNullimpl(str) == null) {
            str4 = str;
        }
        baseContinuationImplClassName = str4;
        try {
            Result.Companion companion3 = Result.Companion;
            str2 = Result.m10378constructorimpl(Class.forName(str3).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            str2 = Result.m10378constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m10381exceptionOrNullimpl(str2) == null) {
            str3 = str2;
        }
    ...
    public static final StackTraceElement artificialFrame(@NotNull String str) {
        return new StackTraceElement(GeneratedOutlineSupport1.outline72("\b\b\b(", str), "\b", "\b", -1);
    }

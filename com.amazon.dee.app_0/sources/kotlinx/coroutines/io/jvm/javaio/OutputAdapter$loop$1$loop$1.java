...
@DebugMetadata(c = "kotlinx.coroutines.io.jvm.javaio.OutputAdapter$loop$1", f = "Blocking.kt", i = {0, 0, 0, 1, 1}, l = {282, 82}, m = "loop", n = {"this", "this_$iv", "rc$iv", "this", "task"}, s = {"L$0", "L$1", "I$0", "L$0", "L$1"})
...
public final class OutputAdapter$loop$1$loop$1 extends ContinuationImpl {
    ...
    public OutputAdapter$loop$1$loop$1(OutputAdapter$loop$1 outputAdapter$loop$1, Continuation continuation) {
        super(continuation);

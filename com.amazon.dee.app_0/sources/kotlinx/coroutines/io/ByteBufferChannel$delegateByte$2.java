...
@DebugMetadata(c = "kotlinx.coroutines.io.ByteBufferChannel$delegateByte$2", f = "ByteBufferChannel.kt", i = {}, l = {881}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes4.dex */
public final class ByteBufferChannel$delegateByte$2 extends SuspendLambda implements Function2<ByteBufferChannel, Continuation<? super Unit>, Object> {
    ...
    public ByteBufferChannel$delegateByte$2(byte b, Continuation continuation) {
    ...
    public final Object mo12248invoke(ByteBufferChannel byteBufferChannel, Continuation<? super Unit> continuation) {
        return ((ByteBufferChannel$delegateByte$2) create(byteBufferChannel, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            byte b = this.$b;
            this.label = 1;
            if (byteBufferChannel.writeByte(b, this) == coroutine_suspended) {

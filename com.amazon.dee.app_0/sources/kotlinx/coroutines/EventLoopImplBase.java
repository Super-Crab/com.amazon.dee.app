...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public static abstract class DelayedTask implements Runnable, Comparable<DelayedTask>, DisposableHandle, ThreadSafeHeapNode {
        ...
        @NotNull
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Delayed[nanos=");
            outline107.append(this.nanoTime);
    ...
    public final void mo12302dispatch(@NotNull CoroutineContext coroutineContext, @NotNull Runnable runnable) {
        enqueue(runnable);
    }
    ...
    */
    public long processNextEvent() {
        ...
        L26:
            monitor-enter(r0)
            kotlinx.coroutines.internal.ThreadSafeHeapNode r3 = r0.firstImpl()     // Catch: java.lang.Throwable -> L4c
            r4 = 0
            if (r3 == 0) goto L46
            kotlinx.coroutines.EventLoopImplBase$DelayedTask r3 = (kotlinx.coroutines.EventLoopImplBase.DelayedTask) r3     // Catch: java.lang.Throwable -> L4c
            boolean r5 = r3.timeToExecute(r1)     // Catch: java.lang.Throwable -> L4c
            r6 = 0
            if (r5 == 0) goto L3c
            boolean r3 = r7.enqueueImpl(r3)     // Catch: java.lang.Throwable -> L4c
            goto L3d
        L3c:
            r3 = r6
        L3d:
            if (r3 == 0) goto L44
            kotlinx.coroutines.internal.ThreadSafeHeapNode r3 = r0.removeAtImpl(r6)     // Catch: java.lang.Throwable -> L4c
            r4 = r3
        L44:
            monitor-exit(r0)
            goto L47

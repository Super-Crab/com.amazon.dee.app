...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m10378constructorimpl = Result.m10378constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), "Main"));
        } catch (Throwable th) {
        ...
        Main = (HandlerDispatcher) m10378constructorimpl;
    }
    ...
    public static final Object awaitFrame(@NotNull Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo12302dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$special$$inlined$Runnable$1
    ...
    @JvmOverloads
    @JvmName(name = ADMConstants.EXTRA_FROM)
    @NotNull

...
public final class TestCoroutineContext implements CoroutineContext {
    ...
    private final class Dispatcher extends EventLoop implements Delay {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Dispatcher(");
            outline107.append(TestCoroutineContext.this);
            outline107.append(')');
    ...
    public final void assertAllUnhandledExceptions(@NotNull String str, @NotNull Function1<? super Throwable, Boolean> function1) {
        ...
        if (!(list instanceof Collection) || !list.isEmpty()) {
            ...
            while (true) {
                if (it2.hasNext()) {
                    if (!function1.mo12165invoke(it2.next()).booleanValue()) {
                        z = false;
                        break;
                    }
                } else {
    ...
    public final void assertExceptions(@NotNull String str, @NotNull Function1<? super List<? extends Throwable>, Boolean> function1) {
        if (function1.mo12165invoke(this.uncaughtExceptions).booleanValue()) {
            this.uncaughtExceptions.clear();
            return;
        }
        throw new AssertionError(str);
    ...
    public final void assertUnhandledException(@NotNull String str, @NotNull Function1<? super Throwable, Boolean> function1) {
        if (this.uncaughtExceptions.size() == 1 && function1.mo12165invoke(this.uncaughtExceptions.get(0)).booleanValue()) {
            this.uncaughtExceptions.clear();
            return;
        }
        throw new AssertionError(str);
    ...
    public <R> R fold(R r, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
        return function2.mo12248invoke((R) function2.mo12248invoke(r, this.ctxDispatcher), this.ctxHandler);
    }
    ...
    public String toString() {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("TestCoroutineContext@");

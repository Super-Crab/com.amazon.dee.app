...
final class PairSerializer$descriptor$1 extends Lambda implements Function1<SerialDescriptorBuilder, Unit> {
    ...
    public final void invoke2(@NotNull SerialDescriptorBuilder receiver) {
        ...
        SerialDescriptorBuilder.element$default(receiver, DefaultPreloadManager.METRIC_PATH_FIRST, this.$keySerializer.getDescriptor(), null, false, 12, null);
        SerialDescriptorBuilder.element$default(receiver, "second", this.$valueSerializer.getDescriptor(), null, false, 12, null);
    }
}

...
public final class ReferenceArraySerializer<ElementKlass, Element extends ElementKlass> extends ListLikeSerializer<Element, Element[], ArrayList<Element>> {
    ...
    public ArrayList<Element> mo12398builder() {
        return new ArrayList<>();
    }

    protected int builderSize(@NotNull ArrayList<Element> builderSize) {
        Intrinsics.checkParameterIsNotNull(builderSize, "$this$builderSize");
        return builderSize.size();
    }

    protected void checkCapacity(@NotNull ArrayList<Element> checkCapacity, int i) {
    ...
    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    @NotNull
    public Iterator<Element> collectionIterator(@NotNull Element[] collectionIterator) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public int collectionSize(@NotNull Element[] collectionSize) {
        Intrinsics.checkParameterIsNotNull(collectionSize, "$this$collectionSize");
        return collectionSize.length;
    }

    public void insert(@NotNull ArrayList<Element> insert, int i, Element element) {
    ...
    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    @NotNull
    public ArrayList<Element> toBuilder(@NotNull Element[] toBuilder) {
        List asList;
    ...
    @NotNull
    protected Element[] toResult(@NotNull ArrayList<Element> toResult) {
        Intrinsics.checkParameterIsNotNull(toResult, "$this$toResult");
        return (Element[]) SerializationKt.toNativeArrayImpl(toResult, this.kClass);
    }
}

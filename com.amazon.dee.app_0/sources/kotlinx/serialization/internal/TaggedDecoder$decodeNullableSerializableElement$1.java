...
final class TaggedDecoder$decodeNullableSerializableElement$1 extends Lambda implements Function0<T> {
    ...
    public TaggedDecoder$decodeNullableSerializableElement$1(TaggedDecoder taggedDecoder, DeserializationStrategy deserializationStrategy) {
        super(0);
    ...
    public final T mo12560invoke() {
        return this.this$0.decodeNullableSerializableValue(this.$deserializer);
    }
}

...
@Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in the favour of Float.serializer() extension", replaceWith = @ReplaceWith(expression = "Float.serializer()", imports = {"kotlinx.serialization.builtins.serializer"}))
...
public final class FloatSerializer implements KSerializer<Float> {
    ...
    @NotNull
    public Float patch(@NotNull Decoder decoder, float f) {
        Intrinsics.checkParameterIsNotNull(decoder, "decoder");
        return (Float) KSerializer.DefaultImpls.patch(this, decoder, Float.valueOf(f));
    }
    ...
    public Float mo12413deserialize(@NotNull Decoder decoder) {
        Intrinsics.checkParameterIsNotNull(decoder, "decoder");
    ...
    public /* bridge */ /* synthetic */ Object patch(Decoder decoder, Object obj) {
        return patch(decoder, ((Number) obj).floatValue());
    }

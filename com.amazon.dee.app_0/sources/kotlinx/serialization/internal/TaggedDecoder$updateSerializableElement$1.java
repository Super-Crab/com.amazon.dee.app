...
final class TaggedDecoder$updateSerializableElement$1 extends Lambda implements Function0<T> {
    ...
    public TaggedDecoder$updateSerializableElement$1(TaggedDecoder taggedDecoder, DeserializationStrategy deserializationStrategy, Object obj) {
        super(0);
    ...
    public final T mo12560invoke() {
        return this.this$0.updateSerializableValue(this.$deserializer, this.$old);
    }
}

...
@Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in the favour of Long.serializer() extension", replaceWith = @ReplaceWith(expression = "Long.serializer()", imports = {"kotlinx.serialization.builtins.serializer"}))

...
public final class ByteSerializer implements KSerializer<Byte> {
    ...
    @NotNull
    public Byte patch(@NotNull Decoder decoder, byte b) {
        Intrinsics.checkParameterIsNotNull(decoder, "decoder");
        return (Byte) KSerializer.DefaultImpls.patch(this, decoder, Byte.valueOf(b));
    }
    ...
    public Byte mo12413deserialize(@NotNull Decoder decoder) {
        Intrinsics.checkParameterIsNotNull(decoder, "decoder");
    ...
    public /* bridge */ /* synthetic */ Object patch(Decoder decoder, Object obj) {
        return patch(decoder, ((Number) obj).byteValue());
    }

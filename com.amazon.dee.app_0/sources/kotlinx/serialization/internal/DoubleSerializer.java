...
public final class DoubleSerializer implements KSerializer<Double> {
    ...
    @NotNull
    public Double patch(@NotNull Decoder decoder, double d) {
        Intrinsics.checkParameterIsNotNull(decoder, "decoder");
        return (Double) KSerializer.DefaultImpls.patch(this, decoder, Double.valueOf(d));
    }
    ...
    public Double mo12413deserialize(@NotNull Decoder decoder) {
        Intrinsics.checkParameterIsNotNull(decoder, "decoder");

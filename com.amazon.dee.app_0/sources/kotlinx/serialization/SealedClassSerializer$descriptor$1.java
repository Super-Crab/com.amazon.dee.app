...
public final class SealedClassSerializer$descriptor$1 extends Lambda implements Function1<SerialDescriptorBuilder, Unit> {
    ...
    public final void invoke2(@NotNull SerialDescriptorBuilder receiver) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("kotlinx.serialization.Sealed<");
        outline107.append(this.this$0.getBaseClass().getSimpleName());
        outline107.append(Typography.greater);
        SerialDescriptorBuilder.element$default(receiver, "value", SerialDescriptorBuilderKt.SerialDescriptor(outline107.toString(), UnionKind.CONTEXTUAL.INSTANCE, new SealedClassSerializer$descriptor$1$elementDescriptor$1(this)), null, false, 12, null);
    }
}

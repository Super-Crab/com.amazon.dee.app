...
public final class JsonPrimitiveSerializer implements KSerializer<JsonPrimitive> {
    ...
    @NotNull
    private static final SerialDescriptor descriptor = SerialDescriptorBuilderKt.SerialDescriptor$default("kotlinx.serialization.json.JsonPrimitive", PrimitiveKind.STRING.INSTANCE, null, 4, null);
    ...
    public JsonPrimitive mo12413deserialize(@NotNull Decoder decoder) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unexpected JSON element, expected JsonPrimitive, had ");
    ...
    @NotNull
    public JsonPrimitive patch(@NotNull Decoder decoder, @NotNull JsonPrimitive old) {
        Intrinsics.checkParameterIsNotNull(decoder, "decoder");

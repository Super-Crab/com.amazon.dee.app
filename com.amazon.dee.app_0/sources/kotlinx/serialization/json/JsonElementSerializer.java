...
public final class JsonElementSerializer implements KSerializer<JsonElement> {
    ...
    @NotNull
    private static final SerialDescriptor descriptor = SerialDescriptorBuilderKt.SerialDescriptor("kotlinx.serialization.json.JsonElement", PolymorphicKind.SEALED.INSTANCE, JsonElementSerializer$descriptor$1.INSTANCE);
    ...
    public JsonElement mo12413deserialize(@NotNull Decoder decoder) {
    ...
    public JsonElement patch(@NotNull Decoder decoder, @NotNull JsonElement old) {
        ...
        return (JsonElement) KSerializer.DefaultImpls.patch(this, decoder, old);
    }

...
public final class JsonReaderKt {
    ...
    static {
        ...
        initC2TC(bArr, (char) COMMA, (byte) 4);
        initC2TC(bArr, (char) COLON, (byte) 5);
        initC2TC(bArr, (char) BEGIN_OBJ, (byte) 6);
        initC2TC(bArr, (char) END_OBJ, (byte) 7);
        initC2TC(bArr, (char) BEGIN_LIST, (byte) 8);
        initC2TC(bArr, (char) END_LIST, (byte) 9);
    ...
    private static final void initC2TC(@NotNull byte[] bArr, int i, byte b) {
        bArr[i] = b;
    }
    ...
    private static final void initC2TC(@NotNull byte[] bArr, char c, byte b) {

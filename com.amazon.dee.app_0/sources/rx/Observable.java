...
public class Observable<T> {
    ...
    public <R> Observable<R> compose(Transformer<? super T, ? extends R> transformer) {
        return (Observable) transformer.mo13102call(this);
    }
    ...
    public <R> R extend(Func1<? super OnSubscribe<T>, ? extends R> func1) {
        return func1.mo13102call(new OnSubscribeExtend(this));
    }
    ...
    public final Subscription unsafeSubscribe(Subscriber<? super T> subscriber) {
        try {
            ...
            try {
                ...
                OnErrorFailedException onErrorFailedException = new OnErrorFailedException(outline107.toString(), th2);
    ...
    public final <R> Observable<R> concatMapEager(Func1<? super T, ? extends Observable<? extends R>> func1, int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("capacityHint > 0 required but it was ", i));
    }
    ...
    public final Observable<Observable<T>> window(int i, int i2) {
        if (i > 0) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("skip > 0 required but it was ", i2));
        }
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("count > 0 required but it was ", i));
    }

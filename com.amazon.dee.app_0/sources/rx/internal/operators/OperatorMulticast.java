...
public final class OperatorMulticast<T, R> extends ConnectableObservable<R> {
    ...
    public void connect(Action1<? super Subscription> action1) {
        ...
        synchronized (this.guard) {
            ...
            Subject<? super T, ? extends R> mo13098call = this.subjectFactory.mo13098call();
            this.subscription = Subscribers.from(mo13098call);
            ...
            for (final Subscriber<? super R> subscriber2 : this.waitingForConnect) {
                mo13098call.unsafeSubscribe(new Subscriber<R>(subscriber2) { // from class: rx.internal.operators.OperatorMulticast.3
            ...
            this.connectedSubject.set(mo13098call);
            action1.call(this.guardedSubscription);
            synchronized (this.guard) {

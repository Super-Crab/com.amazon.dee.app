    ...
    public Subscriber<? super T> call(Subscriber<? super T> subscriber) {
        ...
        return (Subscriber<T>) new Subscriber<T>(subscriber) { // from class: rx.internal.operators.OperatorDelayWithSelector.1
            ...
            public void onNext(final T t) {
                try {
                    create.onNext(OperatorDelayWithSelector.this.itemDelay.mo13102call(t).take(1).defaultIfEmpty(null).map((Func1<V, T>) new Func1<V, T>() { // from class: rx.internal.operators.OperatorDelayWithSelector.1.1
                        @Override // rx.functions.Func1
                        /* renamed from: call */
                        public T mo13102call(V v) {
                            return (T) t;
                        }
                    }));
                } catch (Throwable th) {

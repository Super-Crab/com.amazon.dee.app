...
public final class OperatorReplay<T> extends ConnectableObservable<T> {
            ...
            synchronized (innerProducer) {
                ...
                while (!innerProducer.isUnsubscribed()) {
                    ...
                    while (j2 != j && (node = node2.get()) != null) {
                        ...
                        try {
                            if (this.nl.accept(subscriber, leaveTransform)) {
                            ...
                            subscriber.onError(OnErrorThrowable.addValueAsLastCause(th, this.nl.getValue(leaveTransform)));
                            return;
                        }
                    }
                    if (j2 != 0) {
            ...
            synchronized (innerProducer) {
                ...
                while (!innerProducer.isUnsubscribed()) {
                    ...
                    while (j2 != j && intValue < i) {
                        ...
                        try {
                            if (this.nl.accept(subscriber, obj) || innerProducer.isUnsubscribed()) {
                                return;
                            }
                            intValue++;
                            j2++;
                            ...
                            subscriber.onError(OnErrorThrowable.addValueAsLastCause(th, this.nl.getValue(obj)));
                            return;
                        }
                    }
                    if (j2 != 0) {
    ...
    public static <T, U, R> Observable<R> multicastSelector(final Func0<? extends ConnectableObservable<U>> func0, final Func1<? super Observable<U>, ? extends Observable<R>> func1) {
        return Observable.create(new Observable.OnSubscribe<R>() { // from class: rx.internal.operators.OperatorReplay.2
            ...
            public void call(final Subscriber<? super R> subscriber) {
                try {
                    ConnectableObservable connectableObservable = (ConnectableObservable) Func0.this.mo13098call();
                    ((Observable) func1.mo13102call(connectableObservable)).subscribe((Subscriber) subscriber);
    ...
    public void connect(Action1<? super Subscription> action1) {
        ...
        while (true) {
            ...
            ReplaySubscriber<T> replaySubscriber2 = new ReplaySubscriber<>(this.bufferFactory.mo13098call());
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> observable, final int i) {
        ...
        return create(observable, new Func0<ReplayBuffer<T>>() { // from class: rx.internal.operators.OperatorReplay.5
            ...
            public ReplayBuffer<T> mo13098call() {
        ...
        return new OperatorReplay(new Observable.OnSubscribe<T>() { // from class: rx.internal.operators.OperatorReplay.7
            ...
            public void call(Subscriber<? super T> subscriber) {
                ...
                while (true) {
                    ...
                    ReplaySubscriber replaySubscriber2 = new ReplaySubscriber((ReplayBuffer) func0.mo13098call());
                    replaySubscriber2.init();

...
public final class OperatorEagerConcatMap<T, R> implements Observable.Operator<R, T> {
    ...
    public static final class EagerOuterProducer extends AtomicLong implements Producer {
        ...
        public void request(long j) {
            ...
            throw new IllegalStateException(GeneratedOutlineSupport1.outline56("n >= 0 required but it was ", j));
        }
    }
    ...
    public static final class EagerOuterSubscriber<T, R> extends Subscriber<T> {
        ...
        public void onNext(T t) {
            try {
                Observable<? extends R> mo13102call = this.mapper.mo13102call(t);
                if (this.cancelled) {
                    return;
                }
                ...
                synchronized (this.subscribers) {
                    ...
                    mo13102call.unsafeSubscribe(eagerInnerSubscriber);
                    drain();
                }
            } catch (Throwable th) {

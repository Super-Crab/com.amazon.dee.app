        ...
        public final class LeftObserver extends Subscriber<T1> {
            ...
            public void onNext(T1 t1) {
                ...
                try {
                    ...
                    OnSubscribeGroupJoin.this.leftDuration.mo13102call(t1).unsafeSubscribe(leftDurationObserver);
                    R mo13094call = OnSubscribeGroupJoin.this.resultSelector.mo13094call(t1, create2);
                    synchronized (ResultManager.this.guard) {
                        arrayList = new ArrayList(ResultManager.this.rightMap.values());
                    }
                    ResultManager.this.subscriber.onNext(mo13094call);
        ...
        public final class RightObserver extends Subscriber<T2> {
            ...
            public void onNext(T2 t2) {
                ...
                try {
                    ...
                    OnSubscribeGroupJoin.this.rightDuration.mo13102call(t2).unsafeSubscribe(rightDurationObserver);
                    synchronized (ResultManager.this.guard) {
                        arrayList = new ArrayList(ResultManager.this.leftMap.values());
                    }

...
public final class OnSubscribeUsing<T, Resource> implements Observable.OnSubscribe<T> {
    ...
    public void call(Subscriber<? super T> subscriber) {
        ...
        try {
            Resource mo13098call = this.resourceFactory.mo13098call();
            DisposeAction disposeAction = new DisposeAction(this.dispose, mo13098call);
            subscriber.add(disposeAction);
            Observable<? extends T> mo13102call = this.observableFactory.mo13102call(mo13098call);
            if (this.disposeEagerly) {
                doAfterTerminate = mo13102call.doOnTerminate(disposeAction);
            } else {
                doAfterTerminate = mo13102call.doAfterTerminate(disposeAction);
            }

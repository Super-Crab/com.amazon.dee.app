...
public class Completable {
    ...
    public static Completable complete() {
        CompletableOnSubscribe onCreate = RxJavaHooks.onCreate(COMPLETE.onSubscribe);
    ...
    public static Completable defer(final Func0<? extends Completable> func0) {
        ...
        return create(new CompletableOnSubscribe() { // from class: rx.Completable.5
            ...
            public void call(CompletableSubscriber completableSubscriber) {
                try {
                    Completable completable = (Completable) Func0.this.mo13098call();
                    if (completable == null) {
                        completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
    ...
    public static Completable error(final Func0<? extends Throwable> func0) {
        ...
        return create(new CompletableOnSubscribe() { // from class: rx.Completable.6
            ...
            public void call(CompletableSubscriber completableSubscriber) {
                completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
                try {
                    th = (Throwable) Func0.this.mo13098call();
                } catch (Throwable th) {
                    th = th;
                }
                if (th == null) {
    ...
    protected static Completable merge0(Observable<? extends Completable> observable, int i, boolean z) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("maxConcurrency > 0 required but it was ", i));
    }
    ...
    public static Completable never() {
        CompletableOnSubscribe onCreate = RxJavaHooks.onCreate(NEVER.onSubscribe);
    ...
    public final Completable lift(final CompletableOperator completableOperator) {
        ...
        return create(new CompletableOnSubscribe() { // from class: rx.Completable.21
            ...
            public void call(CompletableSubscriber completableSubscriber) {
                try {
                    Completable.this.unsafeSubscribe(RxJavaHooks.onCompletableLift(completableOperator).mo13102call(completableSubscriber));
                } catch (NullPointerException e) {
                    throw e;
                } catch (Throwable th) {
        ...
        return create(new CompletableOnSubscribe() { // from class: rx.Completable.24
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.24.1
                    ...
                    public void onError(Throwable th) {
                        try {
                            Completable completable = (Completable) func1.mo13102call(th);
                            if (completable == null) {
    ...
    public static <R> Completable using(final Func0<R> func0, final Func1<? super R, ? extends Completable> func1, final Action1<? super R> action1, final boolean z) {
        ...
        return create(new CompletableOnSubscribe() { // from class: rx.Completable.13
            ...
            public void call(CompletableSubscriber completableSubscriber) {
                try {
                    Object mo13098call = Func0.this.mo13098call();
                    try {
                        Completable completable = (Completable) func1.mo13102call(mo13098call);
                        if (completable == null) {
                            try {
                                action1.call(mo13098call);
                                completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
                        ...
                        completable.unsafeSubscribe(new AnonymousClass1(new AtomicBoolean(), mo13098call, completableSubscriber));
                    } catch (Throwable th2) {
                        try {
                            action1.call(mo13098call);
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.23.1
                    ...
                    public void onError(Throwable th) {
                        boolean z = false;
                        try {
                            z = ((Boolean) func1.mo13102call(th)).booleanValue();
                        } catch (Throwable th2) {
                            Exceptions.throwIfFatal(th2);
                            th = new CompositeException(Arrays.asList(th, th2));
                        }
    ...
    private Completable(CompletableOnSubscribe completableOnSubscribe, boolean z) {
        this.onSubscribe = z ? RxJavaHooks.onCreate(completableOnSubscribe) : completableOnSubscribe;
    }
    ...
    public static Completable concat(Observable<? extends Completable> observable, int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("prefetch > 0 required but it was ", i));
    }

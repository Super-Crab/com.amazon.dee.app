    ...
    public String toString() {
        ...
        if (!getParameters().isEmpty()) {
            ...
            for (String str : getParameters().keySet()) {
                GeneratedOutlineSupport1.outline181(sb, str, RealTimeTextConstants.COLON_SPACE, getParameters().get(str), ", ");
            }
            sb.append(") ");
        }
        if (!getHeaders().isEmpty()) {
            ...
            for (String str2 : getHeaders().keySet()) {
                GeneratedOutlineSupport1.outline181(sb, str2, RealTimeTextConstants.COLON_SPACE, getHeaders().get(str2), ", ");
            }
            sb.append(") ");
        }
        return sb.toString();

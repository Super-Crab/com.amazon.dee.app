...
public class JsonPolicyReader {
    ...
    private Principal createPrincipal(String str, String str2) {
        ...
        throw new AmazonClientException(GeneratedOutlineSupport1.outline75("Schema ", str, " is not a valid value for the principal."));
    }
    ...
    private List<Principal> principalOf(AwsJsonReader awsJsonReader) throws IOException {
        ...
        if (awsJsonReader.isContainer()) {
            ...
            if ("*".equals(nextString)) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline72("Invalid principals: ", nextString));
            }
        }
        return linkedList;
    }

...
class Base16Codec implements Codec {
    ...
    public byte[] decode(byte[] bArr, int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Input is expected to be encoded in multiple of 2 bytes but found: ", i));
    }
    ...
    protected int pos(byte b) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Invalid base 16 character: '");

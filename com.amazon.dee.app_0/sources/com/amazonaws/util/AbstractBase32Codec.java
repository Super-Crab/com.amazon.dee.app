...
abstract class AbstractBase32Codec implements Codec {
    ...
    public final byte[] decode(byte[] bArr, int i) {
                ...
                if (i4 != 1) {
                    if (i4 != 3) {
                        if (i4 == 4) {
                            ...
                            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Invalid number of paddings ", i4));
                        } else {
                            i2 = 1;
                        }
                    }
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Input is expected to be encoded in multiple of 8 bytes but found: ", i));
    }

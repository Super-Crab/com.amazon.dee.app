...
public class ListScheduledAuditsRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if ((listScheduledAuditsRequest.getNextToken() == null) ^ (getNextToken() == null)) {
            return false;
        }
        if (listScheduledAuditsRequest.getNextToken() != null && !listScheduledAuditsRequest.getNextToken().equals(getNextToken())) {
            return false;
        }
        if ((listScheduledAuditsRequest.getMaxResults() == null) ^ (getMaxResults() == null)) {
            return false;
        }
        return listScheduledAuditsRequest.getMaxResults() == null || listScheduledAuditsRequest.getMaxResults().equals(getMaxResults());
    }
    ...
    public ListScheduledAuditsRequest withMaxResults(Integer num) {
        this.maxResults = num;
        return this;
    }

    public ListScheduledAuditsRequest withNextToken(String str) {
        this.nextToken = str;
        return this;
    }
}

...
public enum CACertificateStatus {
    ...
    private static final Map<String, CACertificateStatus> enumMap = new HashMap();
    ...
    CACertificateStatus(String str) {
        this.value = str;
    }

    public static CACertificateStatus fromValue(String str) {

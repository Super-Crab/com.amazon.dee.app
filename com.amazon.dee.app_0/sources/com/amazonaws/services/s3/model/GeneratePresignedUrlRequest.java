...
public class GeneratePresignedUrlRequest extends AmazonWebServiceRequest implements SSECustomerKeyProvider, Serializable {
        ...
        if (this.bucketName != null) {
            if (this.method != null) {
                if (this.sseCustomerKey != null) {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("For KMS server side encryption, the SSE algorithm must be set to ");
                    outline107.append(SSEAlgorithm.KMS);
    ...
    public void setSSECustomerKeyAlgorithm(SSEAlgorithm sSEAlgorithm) {
        if (sSEAlgorithm == null) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Currently the only supported Server Side Encryption algorithm is ");
            outline107.append(SSEAlgorithm.AES256);
            throw new IllegalArgumentException(outline107.toString());
        }
    }

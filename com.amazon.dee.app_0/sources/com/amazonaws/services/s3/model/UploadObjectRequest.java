...
public class UploadObjectRequest extends AbstractPutObjectRequest implements MaterialsDescriptionProvider, Serializable {
    ...
    /* renamed from: clone */
    public UploadObjectRequest mo6742clone() {
        UploadObjectRequest uploadObjectRequest = (UploadObjectRequest) super.mo6742clone();
        ...
        if (uploadPartMetadata != null) {
            objectMetadata = uploadPartMetadata.m6723clone();
        }

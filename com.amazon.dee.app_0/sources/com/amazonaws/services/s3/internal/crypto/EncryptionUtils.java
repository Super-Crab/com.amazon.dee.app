...
public class EncryptionUtils {
    ...
    public static S3Object adjustOutputToDesiredRange(S3Object s3Object, long[] jArr) {
        ...
        try {
            ...
            throw new AmazonClientException(GeneratedOutlineSupport1.outline37(e, GeneratedOutlineSupport1.outline107("Error adjusting output to desired byte range: ")));
        }
    }
    ...
    private static Map<String, String> convertJSONToMap(String str) {
        ...
        try {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unable to parse encryption materials description from metadata :");
    ...
    private static SecretKey getDecryptedSymmetricKey(byte[] bArr, EncryptionMaterials encryptionMaterials, Provider provider) {
        ...
        try {
            ...
            throw new AmazonClientException(GeneratedOutlineSupport1.outline41(e, GeneratedOutlineSupport1.outline107("Unable to decrypt symmetric key from object metadata : ")), e);
        }
    }
    ...
    private static InputStream getEncryptedInputStream(PutObjectRequest putObjectRequest, CipherFactory cipherFactory, long j) {
        try {
            ...
            throw new AmazonClientException(GeneratedOutlineSupport1.outline41(e, GeneratedOutlineSupport1.outline107("Unable to create cipher input stream: ")), e);
        }
    }
    ...
    public static byte[] getEncryptedSymmetricKey(SecretKey secretKey, EncryptionMaterials encryptionMaterials, Provider provider) {
        ...
        try {
            ...
            throw new AmazonClientException(GeneratedOutlineSupport1.outline41(e, GeneratedOutlineSupport1.outline107("Unable to encrypt symmetric key: ")), e);
        }
    }
    ...
    private static Map<String, String> parseJSONInstruction(S3Object s3Object) {
        try {
            ...
            throw new AmazonClientException(GeneratedOutlineSupport1.outline41(e, GeneratedOutlineSupport1.outline107("Error parsing JSON instruction file: ")));
        }
    }
    ...
    public static PutObjectRequest createInstructionPutRequest(String str, String str2, EncryptionInstruction encryptionInstruction) {
        ...
        return new PutObjectRequest(str, GeneratedOutlineSupport1.outline72(str2, INSTRUCTION_SUFFIX), byteArrayInputStream, objectMetadata);
    }
}

...
public class AmazonS3URI {
    ...
    private static void appendDecoded(StringBuilder sb, String str, int i) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport1.outline75("Invalid percent-encoded string:\"", str, "\"."));
    }
    ...
    private static int fromHex(char c) {
        if (c >= '0') {
            ...
            char c2 = 'A';
            if (c < 'A') {
                throw new IllegalStateException(GeneratedOutlineSupport1.outline48("Invalid percent-encoded string: bad character '", c, "' in escape sequence."));
            }
            if (c > 'F') {
                c2 = 'a';
                if (c < 'a') {
            ...
            if (host != null) {
                ...
                if (matcher.find()) {
                    ...
                    if (group != null && !group.isEmpty()) {
                        this.isPathStyle = false;
                        this.bucket = GeneratedOutlineSupport1.outline51(group, 1, 0);

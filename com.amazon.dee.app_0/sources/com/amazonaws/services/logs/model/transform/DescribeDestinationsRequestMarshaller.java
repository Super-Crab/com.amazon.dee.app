...
public class DescribeDestinationsRequestMarshaller implements Marshaller<Request<DescribeDestinationsRequest>, DescribeDestinationsRequest> {
    ...
    public Request<DescribeDestinationsRequest> marshall(DescribeDestinationsRequest describeDestinationsRequest) {
        if (describeDestinationsRequest != null) {
            DefaultRequest defaultRequest = new DefaultRequest(describeDestinationsRequest, "AmazonCloudWatchLogs");
            defaultRequest.addHeader("X-Amz-Target", "Logs_20140328.DescribeDestinations");
            ...
            try {
                ...
                if (describeDestinationsRequest.getDestinationNamePrefix() != null) {
                    String destinationNamePrefix = describeDestinationsRequest.getDestinationNamePrefix();
        ...
        throw new AmazonClientException("Invalid argument passed to marshall(DescribeDestinationsRequest)");
    }
}

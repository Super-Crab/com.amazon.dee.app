...
public class DeleteLogGroupRequestMarshaller implements Marshaller<Request<DeleteLogGroupRequest>, DeleteLogGroupRequest> {
    ...
    public Request<DeleteLogGroupRequest> marshall(DeleteLogGroupRequest deleteLogGroupRequest) {
        if (deleteLogGroupRequest != null) {
            DefaultRequest defaultRequest = new DefaultRequest(deleteLogGroupRequest, "AmazonCloudWatchLogs");
            defaultRequest.addHeader("X-Amz-Target", "Logs_20140328.DeleteLogGroup");
        ...
        throw new AmazonClientException("Invalid argument passed to marshall(DeleteLogGroupRequest)");
    }
}

...
public class CreateLogStreamRequestMarshaller implements Marshaller<Request<CreateLogStreamRequest>, CreateLogStreamRequest> {
    ...
    public Request<CreateLogStreamRequest> marshall(CreateLogStreamRequest createLogStreamRequest) {
        if (createLogStreamRequest != null) {
            DefaultRequest defaultRequest = new DefaultRequest(createLogStreamRequest, "AmazonCloudWatchLogs");
            defaultRequest.addHeader("X-Amz-Target", "Logs_20140328.CreateLogStream");
        ...
        throw new AmazonClientException("Invalid argument passed to marshall(CreateLogStreamRequest)");
    }
}

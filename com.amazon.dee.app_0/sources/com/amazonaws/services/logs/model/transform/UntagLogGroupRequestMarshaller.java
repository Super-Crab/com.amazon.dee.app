...
public class UntagLogGroupRequestMarshaller implements Marshaller<Request<UntagLogGroupRequest>, UntagLogGroupRequest> {
    ...
    public Request<UntagLogGroupRequest> marshall(UntagLogGroupRequest untagLogGroupRequest) {
        if (untagLogGroupRequest != null) {
            DefaultRequest defaultRequest = new DefaultRequest(untagLogGroupRequest, "AmazonCloudWatchLogs");
            defaultRequest.addHeader("X-Amz-Target", "Logs_20140328.UntagLogGroup");
            ...
            try {
                ...
                if (untagLogGroupRequest.getTags() != null) {
                    List<String> tags = untagLogGroupRequest.getTags();
        ...
        throw new AmazonClientException("Invalid argument passed to marshall(UntagLogGroupRequest)");
    }
}

...
public class CancelExportTaskRequestMarshaller implements Marshaller<Request<CancelExportTaskRequest>, CancelExportTaskRequest> {
    ...
    public Request<CancelExportTaskRequest> marshall(CancelExportTaskRequest cancelExportTaskRequest) {
        if (cancelExportTaskRequest != null) {
            DefaultRequest defaultRequest = new DefaultRequest(cancelExportTaskRequest, "AmazonCloudWatchLogs");
            defaultRequest.addHeader("X-Amz-Target", "Logs_20140328.CancelExportTask");
        ...
        throw new AmazonClientException("Invalid argument passed to marshall(CancelExportTaskRequest)");
    }
}

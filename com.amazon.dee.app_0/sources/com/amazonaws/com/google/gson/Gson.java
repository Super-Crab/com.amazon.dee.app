...
public final class Gson {
    ...
    public static class FutureTypeAdapter<T> extends TypeAdapter<T> {
        ...
        public T mo6687read(JsonReader jsonReader) throws IOException {
            ...
            if (typeAdapter != null) {
                return typeAdapter.mo6687read(jsonReader);
            }
    ...
    private TypeAdapter<Number> doubleAdapter(boolean z) {
        ...
        return new TypeAdapter<Number>() { // from class: com.amazonaws.com.google.gson.Gson.3
            @Override // com.amazonaws.com.google.gson.TypeAdapter
            /* renamed from: read */
    ...
    private TypeAdapter<Number> floatAdapter(boolean z) {
        ...
        return new TypeAdapter<Number>() { // from class: com.amazonaws.com.google.gson.Gson.4
            @Override // com.amazonaws.com.google.gson.TypeAdapter
            /* renamed from: read */
            public Number mo6687read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
    ...
    private TypeAdapter<Number> longAdapter(LongSerializationPolicy longSerializationPolicy) {
        ...
        return new TypeAdapter<Number>() { // from class: com.amazonaws.com.google.gson.Gson.5
    ...
    public Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy, Map<Type, InstanceCreator<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> list) {
        ...
        this.deserializationContext = new JsonDeserializationContext() { // from class: com.amazonaws.com.google.gson.Gson.1
            @Override // com.amazonaws.com.google.gson.JsonDeserializationContext
            public <T> T deserialize(JsonElement jsonElement, Type type) throws JsonParseException {
                return (T) Gson.this.fromJson(jsonElement, type);
            }
        };
        this.serializationContext = new JsonSerializationContext() { // from class: com.amazonaws.com.google.gson.Gson.2
        ...
        try {
            try {
                try {
                    jsonReader.peek();
                    z = false;
                    T mo6687read = getAdapter(TypeToken.get(type)).mo6687read(jsonReader);

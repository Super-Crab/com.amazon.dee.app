...
public final class Excluder implements TypeAdapterFactory, Cloneable {
        ...
        if (excludeClass || excludeClass2) {
            return new TypeAdapter<T>() { // from class: com.amazonaws.com.google.gson.internal.Excluder.1
                ...
                public T mo6687read(JsonReader jsonReader) throws IOException {
                    ...
                    return delegate().mo6687read(jsonReader);
                }
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder m6655clone = m6655clone();
        m6655clone.serializeInnerClasses = false;
        return m6655clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        Excluder m6655clone = m6655clone();
        if (z) {
            m6655clone.serializationStrategies = new ArrayList(this.serializationStrategies);
            m6655clone.serializationStrategies.add(exclusionStrategy);
        }
        if (z2) {
            m6655clone.deserializationStrategies = new ArrayList(this.deserializationStrategies);
            m6655clone.deserializationStrategies.add(exclusionStrategy);
        }
        return m6655clone;
    }
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder m6655clone = m6655clone();
        m6655clone.modifiers = 0;
        for (int i : iArr) {
            m6655clone.modifiers = i | m6655clone.modifiers;
        }
        return m6655clone;
    }
    ...
    public Excluder withVersion(double d) {
        Excluder m6655clone = m6655clone();
        m6655clone.version = d;
        return m6655clone;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: clone */
    public Excluder m6655clone() {
        try {

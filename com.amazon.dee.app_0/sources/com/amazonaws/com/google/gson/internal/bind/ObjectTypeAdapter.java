...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    ...
    /* renamed from: com.amazonaws.com.google.gson.internal.bind.ObjectTypeAdapter$2  reason: invalid class name */
    /* loaded from: classes13.dex */
    ...
    public Object mo6687read(JsonReader jsonReader) throws IOException {
        ...
        if (ordinal == 0) {
            ...
            while (jsonReader.hasNext()) {
                arrayList.add(mo6687read(jsonReader));
            }
            jsonReader.endArray();
            return arrayList;
        } else if (ordinal == 2) {
            ...
            while (jsonReader.hasNext()) {
                linkedTreeMap.put(jsonReader.nextName(), mo6687read(jsonReader));
            }

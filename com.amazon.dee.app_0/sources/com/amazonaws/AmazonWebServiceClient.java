...
public abstract class AmazonWebServiceClient {
    ...
    private String computeServiceName() {
        ...
        if (indexOf == -1 && (indexOf = simpleName.indexOf("Client")) == -1) {
            throw new IllegalStateException(GeneratedOutlineSupport1.outline72("Unrecognized suffix for the AWS http client class name ", simpleName));
        }
        int indexOf2 = simpleName.indexOf("Amazon");
        if (indexOf2 == -1) {
            indexOf2 = simpleName.indexOf(AWS);
            if (indexOf2 == -1) {
                throw new IllegalStateException(GeneratedOutlineSupport1.outline72("Unrecognized prefix for the AWS http client class name ", simpleName));
            }
            i = 3;
        } else {
            i = 6;
        ...
        throw new IllegalStateException(GeneratedOutlineSupport1.outline72("Unrecognized AWS http client class name ", simpleName));
    }

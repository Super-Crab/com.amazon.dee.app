package com.amazonaws.org.eclipse.paho.client.mqttv3.internal.security;

import com.amazonaws.org.eclipse.paho.client.mqttv3.MqttSecurityException;
...
public class SSLSocketFactoryFactory {
    private static final String CLASS_NAME = "com.amazonaws.org.eclipse.paho.client.mqttv3.internal.security.SSLSocketFactoryFactory";
    ...
    private SSLContext getSSLContext(String str) throws MqttSecurityException {
        ...
        try {
            ...
            if (this.logger != null) {
                ...
                objArr3[1] = property != null ? property : str3;
            ...
            if (this.logger != null) {
                ...
                objArr4[1] = keyStorePassword != null ? obfuscate(keyStorePassword) : str3;
            ...
            if (this.logger != null) {
                ...
                objArr5[1] = keyStoreType != null ? keyStoreType : str3;
            ...
            if (this.logger != null) {
                ...
                objArr8[1] = trustStore != null ? trustStore : str3;
            ...
            if (this.logger != null) {
                ...
                objArr9[1] = trustStorePassword != null ? obfuscate(trustStorePassword) : str3;

...
public class MqttOutputStream extends OutputStream {
    ...
    static {
        ...
        if (cls == null) {
            try {
                cls = Class.forName("com.amazonaws.org.eclipse.paho.client.mqttv3.internal.wire.MqttOutputStream");
                class$0 = cls;
    ...
    public void write(MqttWireMessage mqttWireMessage) throws IOException, MqttException {
        ...
        log.fine(CLASS_NAME, "write", PlaceCategory.ACCOMODATION, new Object[]{mqttWireMessage});
    }
}

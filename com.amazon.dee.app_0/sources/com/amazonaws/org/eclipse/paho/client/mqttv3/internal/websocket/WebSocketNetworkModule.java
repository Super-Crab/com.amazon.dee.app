...
public class WebSocketNetworkModule extends TCPNetworkModule {
    ...
    static {
        ...
        if (cls == null) {
            try {
                cls = Class.forName("com.amazonaws.org.eclipse.paho.client.mqttv3.internal.websocket.WebSocketNetworkModule");
                class$0 = cls;
    ...
    public WebSocketNetworkModule(SocketFactory socketFactory, String str, String str2, int i, String str3) {
        ...
        this.outputStream = new ByteArrayOutputStream() { // from class: com.amazonaws.org.eclipse.paho.client.mqttv3.internal.websocket.WebSocketNetworkModule.1

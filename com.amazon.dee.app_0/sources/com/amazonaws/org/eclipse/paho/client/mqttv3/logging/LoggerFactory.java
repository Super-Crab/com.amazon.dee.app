...
public class LoggerFactory {
    ...
    public static final String MQTT_CLIENT_MSG_CAT = "com.amazonaws.org.eclipse.paho.client.mqttv3.internal.nls.logcat";
    ...
    static {
        ...
        if (cls == null) {
            try {
                cls = Class.forName("com.amazonaws.org.eclipse.paho.client.mqttv3.logging.LoggerFactory");
                class$0 = cls;
        ...
        if (cls2 == null) {
            try {
                cls2 = Class.forName("com.amazonaws.org.eclipse.paho.client.mqttv3.logging.JSR47Logger");
                class$1 = cls2;

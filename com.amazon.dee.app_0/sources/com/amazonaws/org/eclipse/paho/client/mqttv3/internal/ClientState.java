...
import com.amazonaws.org.eclipse.paho.client.mqttv3.internal.wire.MqttPingReq;
import com.amazonaws.org.eclipse.paho.client.mqttv3.internal.wire.MqttPingResp;
...
import com.amazonaws.org.eclipse.paho.client.mqttv3.internal.wire.MqttPubRec;
import com.amazonaws.org.eclipse.paho.client.mqttv3.internal.wire.MqttPubRel;
...
public class ClientState {
    ...
    static {
        ...
        if (cls == null) {
            try {
                cls = Class.forName("com.amazonaws.org.eclipse.paho.client.mqttv3.internal.ClientState");
                class$0 = cls;
            ...
            if (this.connected && this.keepAlive > 0) {
                ...
                synchronized (this.pingOutstandingLock) {
                    if (this.pingOutstanding > 0 && currentTimeMillis - this.lastInboundActivity >= this.keepAlive + 100) {
                        ...
                        throw ExceptionHelper.createMqttException((int) Trace.PAYLOAD_DATA_MAX_LENGTH);
                    }
    ...
    protected void clearState() throws MqttException {
        log.fine(CLASS_NAME, "clearState", Config.Compare.GREATER_THAN);
    ...
    public void disconnected(MqttException mqttException) {
        log.fine(CLASS_NAME, ModeConstants.DRIVE_MODE_DISCONNECTED_STATUS, "633", new Object[]{mqttException});
        ...
        synchronized (this.queueLock) {
            ...
            while (mqttWireMessage == null) {
                if ((this.pendingMessages.isEmpty() && this.pendingFlows.isEmpty()) || (this.pendingFlows.isEmpty() && this.actualInFlight >= this.maxInflight)) {
                    try {
                        log.fine(CLASS_NAME, MetricsConstants.Method.CACHE_GET, "644");
                        this.queueLock.wait();
                        log.fine(CLASS_NAME, MetricsConstants.Method.CACHE_GET, "647");
                    } catch (InterruptedException unused) {
                    }
                }
                if (!this.connected && (this.pendingFlows.isEmpty() || !(((MqttWireMessage) this.pendingFlows.elementAt(0)) instanceof MqttConnect))) {
                    log.fine(CLASS_NAME, MetricsConstants.Method.CACHE_GET, "621");
                    return null;
                } else if (!this.pendingFlows.isEmpty()) {
                    mqttWireMessage = (MqttWireMessage) this.pendingFlows.remove(0);
                    if (mqttWireMessage instanceof MqttPubRel) {
                        this.inFlightPubRels++;
                        log.fine(CLASS_NAME, MetricsConstants.Method.CACHE_GET, "617", new Object[]{new Integer(this.inFlightPubRels)});
                    }
                    checkQuiesceLock();
                    ...
                    if (this.actualInFlight < this.maxInflight) {
                        ...
                        this.actualInFlight++;
                        log.fine(CLASS_NAME, MetricsConstants.Method.CACHE_GET, "623", new Object[]{new Integer(this.actualInFlight)});
                    } else {
                        log.fine(CLASS_NAME, MetricsConstants.Method.CACHE_GET, "622");
                    }
                }
            }
            return mqttWireMessage;
    ...
    protected void restoreState() throws MqttException {
        ...
        log.fine(CLASS_NAME, "restoreState", PlaceCategory.SHOPPING);
        while (keys.hasMoreElements()) {

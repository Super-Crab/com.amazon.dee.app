...
public class QuickTimeDictionary {
    ...
    static {
        ...
        _videoCompressionTypes.put(TtmlNode.RUBY_BASE, "Base");
        ...
        _videoCompressionTypes.put(RouteParameter.PATH, "Vector");
        ...
        _majorBrands.put("isom", "MP4Â  Base Media v1 [IS0 14496-12:2003]");
        ...
        _majorBrands.put("mqt ", "Sony / Mobile QuickTime (.MQV)Â  US Patent 7,477,830 (Sony Corp)");
        ...
        _majorBrands.put("opx2", "OMA PDCFÂ DRM + XBS extensions (OMA-TS-DRM_XBS-V1_0-20070529-C)");
    ...
    public static String lookup(int i, String str) {
        return (!_dictionary.containsKey(Integer.valueOf(i)) || !_dictionary.get(Integer.valueOf(i)).containsKey(str)) ? "Unknown" : _dictionary.get(Integer.valueOf(i)).get(str);
    }

...
public class PhotoshopDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf((int) TAG_MAC_NSPRINTINFO), "Mac NSPrintInfo");
        _tagNameMap.put(Integer.valueOf((int) TAG_WIN_DEVMODE), "Win DEVMODE");
        _tagNameMap.put(Integer.valueOf((int) TAG_AUTO_SAVE_FILE_PATH), "Auto Save File Subpath");
        _tagNameMap.put(Integer.valueOf((int) TAG_AUTO_SAVE_FORMAT), "Auto Save Format");
        _tagNameMap.put(Integer.valueOf((int) TAG_PATH_SELECTION_STATE), "Subpath Selection State");
        ...
        _tagNameMap.put(Integer.valueOf((int) TAG_IMAGE_READY_SELECTED_STATE), "Image Ready Selected State");
        _tagNameMap.put(Integer.valueOf((int) TAG_IMAGE_READY_7_ROLLOVER), "Image Ready 7 Rollover Expanded State");
        _tagNameMap.put(Integer.valueOf((int) TAG_IMAGE_READY_ROLLOVER), "Image Ready Rollover Expanded State");
        _tagNameMap.put(Integer.valueOf((int) TAG_IMAGE_READY_SAVE_LAYER_SETTINGS), "Image Ready Save Layer Settings");
        _tagNameMap.put(Integer.valueOf((int) TAG_IMAGE_READY_VERSION), "Image Ready Version");
    ...
    public byte[] getThumbnailBytes() {
        byte[] byteArray = getByteArray(1036);
        if (byteArray == null) {
            byteArray = getByteArray(1033);
        }

...
public class IptcDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf((int) TAG_OBJECT_CYCLE), "Object Cycle");
        ...
        _tagNameMap.put(Integer.valueOf((int) TAG_SOURCE), AlexaMetricsConstants.EventConstants.SOURCE);
        _tagNameMap.put(Integer.valueOf((int) TAG_COPYRIGHT_NOTICE), "Copyright Notice");
        _tagNameMap.put(Integer.valueOf((int) TAG_CONTACT), SipHeaders.SIP_HEADER_CONTACT);

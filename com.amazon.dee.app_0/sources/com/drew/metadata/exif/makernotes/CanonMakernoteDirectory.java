...
public class CanonMakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf((int) CameraSettings.TAG_CONTRAST), ExifInterface.TAG_CONTRAST);
        ...
        _tagNameMap.put(Integer.valueOf((int) CameraSettings.TAG_SATURATION), ExifInterface.TAG_SATURATION);
        _tagNameMap.put(Integer.valueOf((int) CameraSettings.TAG_SELF_TIMER_DELAY), "Self Timer Delay");
        _tagNameMap.put(Integer.valueOf((int) CameraSettings.TAG_SHARPNESS), ExifInterface.TAG_SHARPNESS);

...
public class SonyType1MakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf((int) TAG_CONTRAST), ExifInterface.TAG_CONTRAST);
        _tagNameMap.put(Integer.valueOf((int) TAG_SATURATION), ExifInterface.TAG_SATURATION);
        _tagNameMap.put(Integer.valueOf((int) TAG_SHARPNESS), ExifInterface.TAG_SHARPNESS);

...
public class SonyType1MakernoteDescriptor extends TagDescriptor<SonyType1MakernoteDirectory> {
    ...
    public String getAFIlluminatorDescription() {
        ...
        return intValue != 0 ? intValue != 1 ? intValue != 65535 ? GeneratedOutlineSupport1.outline69("Unknown (", integer, ")") : "n/a" : "Auto" : BucketVersioningConfiguration.OFF;
    }
    ...
    public String getAFModeDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 1 ? intValue != 2 ? intValue != 3 ? intValue != 4 ? intValue != 6 ? intValue != 65535 ? intValue != 14 ? intValue != 15 ? GeneratedOutlineSupport1.outline69("Unknown (", integer, ")") : "Face Detected" : "Manual Focus" : "n/a" : "Touch" : "Flexible Spot" : "Spot" : "Center" : "Multi" : "Default";
    }
    ...
    public String getAntiBlurDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 1 ? intValue != 2 ? intValue != 65535 ? String.format("Unknown (%d)", integer) : CapabilityQueryConstants.TARGET_NOT_AVAILABLE : "On (Shooting)" : "On (Continuous)" : BucketVersioningConfiguration.OFF;
    }
            ...
            default:
                switch (intValue) {
                    ...
                    case 14:
                        return "Deep";
                    case 15:
                        return DriveModeMetrics.Theme.LIGHT;
                    case 16:
                        return "Autumn";
                    case 17:
                        return "Sepia";
    ...
    public String getDistortionCorrectionDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != -1 ? intValue != 0 ? intValue != 2 ? String.format("Unknown (%d)", integer) : "Auto" : BucketVersioningConfiguration.OFF : CapabilityQueryConstants.TARGET_NOT_AVAILABLE;
    }
    ...
    public String getHighIsoNoiseReductionDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 1 ? intValue != 2 ? intValue != 3 ? intValue != 256 ? intValue != 65535 ? String.format("Unknown (%d)", integer) : CapabilityQueryConstants.TARGET_NOT_AVAILABLE : "Auto" : DCMEndpoint.Priority.HIGH : DCMEndpoint.Priority.NORMAL : "On" : BucketVersioningConfiguration.OFF;
    }
    ...
    public String getImageStabilizationDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 1 ? CapabilityQueryConstants.TARGET_NOT_AVAILABLE : "On" : BucketVersioningConfiguration.OFF;
    }
    ...
    public String getJpegQualityDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 1 ? intValue != 2 ? intValue != 65535 ? String.format("Unknown (%d)", integer) : CapabilityQueryConstants.TARGET_NOT_AVAILABLE : "Extra Fine" : "Fine" : DCMEndpoint.Priority.NORMAL;
    }
    ...
    public String getLongExposureNoiseReductionDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 1 ? intValue != 65535 ? String.format("Unknown (%d)", integer) : CapabilityQueryConstants.TARGET_NOT_AVAILABLE : "On" : BucketVersioningConfiguration.OFF;
    }
    ...
    public String getMacroDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 1 ? intValue != 2 ? intValue != 65535 ? String.format("Unknown (%d)", integer) : CapabilityQueryConstants.TARGET_NOT_AVAILABLE : "Magnifying Glass/Super Macro" : "On" : BucketVersioningConfiguration.OFF;
    }
    ...
    public String getReleaseModeDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 2 ? intValue != 65535 ? intValue != 5 ? intValue != 6 ? GeneratedOutlineSupport1.outline69("Unknown (", integer, ")") : "White Balance Bracketing" : "Exposure Bracketing" : "n/a" : "Continuous" : DCMEndpoint.Priority.NORMAL;
    }
    ...
    public String getSequenceNumberDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 65535 ? integer.toString() : "n/a" : "Single";
    }

    @Nullable
    public String getSoftSkinEffectDescription() {
        return getIndexedDescription(SonyType1MakernoteDirectory.TAG_SOFT_SKIN_EFFECT, BucketVersioningConfiguration.OFF, "Low", "Mid", DCMEndpoint.Priority.HIGH);
    }
    ...
    public String getTeleconverterDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 72 ? intValue != 80 ? intValue != 96 ? intValue != 136 ? intValue != 144 ? intValue != 160 ? GeneratedOutlineSupport1.outline69("Unknown (", integer, ")") : "Minolta AF 1.4x APO" : "Minolta AF 1.4x APO II" : "Minolta/Sony AF 1.4x APO (D)" : "Minolta AF 2x APO" : "Minolta AF 2x APO II" : "Minolta/Sony AF 2x APO (D)" : "None";
    }
    ...
    public String getWhiteBalanceDescription() {
        ...
        int intValue = integer.intValue();
        return intValue != 0 ? intValue != 1 ? intValue != 16 ? intValue != 32 ? intValue != 48 ? intValue != 64 ? intValue != 80 ? intValue != 96 ? intValue != 112 ? GeneratedOutlineSupport1.outline69("Unknown (", integer, ")") : "Custom" : "Fluorescent" : ExifInterface.TAG_FLASH : "Tungsten" : "Shade" : "Cloudy" : "Daylight" : "Color Temperature/Color Filter" : "Auto";
    }

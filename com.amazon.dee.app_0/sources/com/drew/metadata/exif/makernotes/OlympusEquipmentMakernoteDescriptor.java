...
public class OlympusEquipmentMakernoteDescriptor extends TagDescriptor<OlympusEquipmentMakernoteDirectory> {
    ...
    public String getBodyFirmwareVersionDescription() {
        ...
        String format = String.format("%04X", integer);
        return String.format("%s.%s", GeneratedOutlineSupport1.outline50(format, -3, 0), format.substring(format.length() - 3));
    }
    ...
    public String getExtenderDescription() {
        ...
        try {
            return _olympusExtenderTypes.get(String.format("%X %02X", Integer.valueOf(Integer.parseInt(split[0])), Integer.valueOf(Integer.parseInt(split[2]))));
    ...
    public String getLensTypeDescription() {
        ...
        try {
            return _olympusLensTypes.get(String.format("%X %02X %02X", Integer.valueOf(Integer.parseInt(split[0])), Integer.valueOf(Integer.parseInt(split[2])), Integer.valueOf(Integer.parseInt(split[3]))));
        } catch (NumberFormatException unused) {
            return null;
        }
    }

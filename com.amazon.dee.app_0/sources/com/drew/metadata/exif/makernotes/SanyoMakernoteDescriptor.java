...
public class SanyoMakernoteDescriptor extends TagDescriptor<SanyoMakernoteDirectory> {
    ...
    private String getColorAdjustmentModeDescription() {
        return getIndexedDescription(528, BucketVersioningConfiguration.OFF, "On");
    }
    ...
    private String getDigitalZoomOnDescription() {
        return getIndexedDescription(539, BucketVersioningConfiguration.OFF, "On");
    }

    @Nullable
    private String getFlashModeDescription() {
        return getIndexedDescription(549, "Auto", "Force", BucketLifecycleConfiguration.DISABLED, "Red eye");
    }

    @Nullable
    private String getFlickerReduceDescription() {
        return getIndexedDescription(SanyoMakernoteDirectory.TAG_FLICKER_REDUCE, BucketVersioningConfiguration.OFF, "On");
    }

    @Nullable
    private String getLightSourceSpecialDescription() {
        return getIndexedDescription(SanyoMakernoteDirectory.TAG_LIGHT_SOURCE_SPECIAL, BucketVersioningConfiguration.OFF, "On");
    }

    @Nullable
    private String getMacroDescription() {
        return getIndexedDescription(514, DCMEndpoint.Priority.NORMAL, "Macro", "View", "Manual");
    }

    @Nullable
    private String getOptimalZoomOnDescription() {
        return getIndexedDescription(537, BucketVersioningConfiguration.OFF, "On");
    }

    @Nullable
    private String getQuickShotDescription() {
        return getIndexedDescription(531, BucketVersioningConfiguration.OFF, "On");
    }
    ...
    private String getSceneSelectDescription() {
        return getIndexedDescription(SanyoMakernoteDirectory.TAG_SCENE_SELECT, BucketVersioningConfiguration.OFF, "Sport", "TV", "Night", "User 1", "User 2", "Lamp");
    }

    @Nullable
    private String getSelfTimerDescription() {
        return getIndexedDescription(532, BucketVersioningConfiguration.OFF, "On");
    }
    ...
    private String getVoiceMemoDescription() {
        return getIndexedDescription(534, BucketVersioningConfiguration.OFF, "On");
    }

    @Nullable
    private String getWideRangeDescription() {
        return getIndexedDescription(527, BucketVersioningConfiguration.OFF, "On");
    }

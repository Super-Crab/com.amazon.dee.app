...
public abstract class ExifDirectoryBase extends Directory {
    ...
    public static void addExifTagNames(HashMap<Integer, String> hashMap) {
        GeneratedOutlineSupport1.outline141(1, hashMap, "Interoperability Index", 2, "Interoperability Version", 254, "New Subfile Type", 255, "Subfile Type");
        GeneratedOutlineSupport1.outline141(256, hashMap, "Image Width", 257, "Image Height", 258, "Bits Per Sample", 259, ExifInterface.TAG_COMPRESSION);
        GeneratedOutlineSupport1.outline141(262, hashMap, "Photometric Interpretation", 263, "Thresholding", 266, "Fill Order", 269, "Document Name");
        GeneratedOutlineSupport1.outline141(270, hashMap, "Image Description", 271, ExifInterface.TAG_MAKE, 272, ExifInterface.TAG_MODEL, 273, "Strip Offsets");
        GeneratedOutlineSupport1.outline141(274, hashMap, ExifInterface.TAG_ORIENTATION, 277, "Samples Per Pixel", 278, "Rows Per Strip", 279, "Strip Byte Counts");
        GeneratedOutlineSupport1.outline141(280, hashMap, "Minimum Sample Value", 281, "Maximum Sample Value", 282, "X Resolution", 283, "Y Resolution");
        GeneratedOutlineSupport1.outline141(284, hashMap, "Planar Configuration", 285, "Page Name", 296, "Resolution Unit", TAG_PAGE_NUMBER, "Page Number");
        GeneratedOutlineSupport1.outline141(301, hashMap, "Transfer Function", 305, ExifInterface.TAG_SOFTWARE, 306, "Date/Time", TAG_ARTIST, ExifInterface.TAG_ARTIST);
        GeneratedOutlineSupport1.outline141(TAG_PREDICTOR, hashMap, "Predictor", 316, "Host Computer", TAG_WHITE_POINT, "White Point", TAG_PRIMARY_CHROMATICITIES, "Primary Chromaticities");
        GeneratedOutlineSupport1.outline141(TAG_TILE_WIDTH, hashMap, "Tile Width", TAG_TILE_LENGTH, "Tile Length", TAG_TILE_OFFSETS, "Tile Offsets", TAG_TILE_BYTE_COUNTS, "Tile Byte Counts");
        GeneratedOutlineSupport1.outline141(TAG_SUB_IFD_OFFSET, hashMap, "Sub IFD Pointer(s)", TAG_TRANSFER_RANGE, "Transfer Range", TAG_JPEG_TABLES, "JPEG Tables", 512, "JPEG Proc");
        GeneratedOutlineSupport1.outline141(515, hashMap, "JPEG Restart Interval", 517, "JPEG Lossless Predictors", 518, "JPEG Point Transforms", 519, "JPEGQ Tables");
        GeneratedOutlineSupport1.outline141(520, hashMap, "JPEGDC Tables", 521, "JPEGAC Tables", 529, "YCbCr Coefficients", 530, "YCbCr Sub-Sampling");
        GeneratedOutlineSupport1.outline141(531, hashMap, "YCbCr Positioning", 532, "Reference Black/White", 559, "Strip Row Counts", 700, "Application Notes");
        GeneratedOutlineSupport1.outline141(4096, hashMap, "Related Image File Format", 4097, "Related Image Width", 4098, "Related Image Height", TAG_RATING, "Rating");
        GeneratedOutlineSupport1.outline141(TAG_CFA_REPEAT_PATTERN_DIM, hashMap, "CFA Repeat Pattern Dim", TAG_CFA_PATTERN_2, "CFA Pattern", TAG_BATTERY_LEVEL, "Battery Level", TAG_COPYRIGHT, ExifInterface.TAG_COPYRIGHT);
        GeneratedOutlineSupport1.outline141(TAG_EXPOSURE_TIME, hashMap, "Exposure Time", TAG_FNUMBER, "F-Number", TAG_IPTC_NAA, "IPTC/NAA", TAG_INTER_COLOR_PROFILE, "Inter Color Profile");
        GeneratedOutlineSupport1.outline141(TAG_EXPOSURE_PROGRAM, hashMap, "Exposure Program", TAG_SPECTRAL_SENSITIVITY, "Spectral Sensitivity", TAG_ISO_EQUIVALENT, "ISO Speed Ratings", TAG_OPTO_ELECTRIC_CONVERSION_FUNCTION, "Opto-electric Conversion Function (OECF)");
        hashMap.put(Integer.valueOf((int) TAG_INTERLACE), "Interlace");
        hashMap.put(34858, "Time Zone Offset");
        hashMap.put(34859, "Self Timer Mode");
        hashMap.put(Integer.valueOf((int) TAG_SENSITIVITY_TYPE), "Sensitivity Type");
        hashMap.put(Integer.valueOf((int) TAG_STANDARD_OUTPUT_SENSITIVITY), "Standard Output Sensitivity");
        hashMap.put(Integer.valueOf((int) TAG_RECOMMENDED_EXPOSURE_INDEX), "Recommended Exposure Index");
        hashMap.put(34858, "Time Zone Offset");
        hashMap.put(34859, "Self Timer Mode");
        hashMap.put(36864, "Exif Version");
        hashMap.put(Integer.valueOf((int) TAG_DATETIME_ORIGINAL), "Date/Time Original");
        GeneratedOutlineSupport1.outline141(TAG_DATETIME_DIGITIZED, hashMap, "Date/Time Digitized", TAG_COMPONENTS_CONFIGURATION, "Components Configuration", TAG_COMPRESSED_AVERAGE_BITS_PER_PIXEL, "Compressed Bits Per Pixel", TAG_SHUTTER_SPEED, "Shutter Speed Value");
        GeneratedOutlineSupport1.outline141(TAG_APERTURE, hashMap, "Aperture Value", TAG_BRIGHTNESS_VALUE, "Brightness Value", TAG_EXPOSURE_BIAS, "Exposure Bias Value", TAG_MAX_APERTURE, "Max Aperture Value");
        GeneratedOutlineSupport1.outline141(TAG_SUBJECT_DISTANCE, hashMap, "Subject Distance", TAG_METERING_MODE, "Metering Mode", 37384, "White Balance", TAG_FLASH, ExifInterface.TAG_FLASH);
        GeneratedOutlineSupport1.outline141(TAG_FOCAL_LENGTH, hashMap, "Focal Length", TAG_FLASH_ENERGY_TIFF_EP, "Flash Energy", TAG_SPATIAL_FREQ_RESPONSE_TIFF_EP, "Spatial Frequency Response", TAG_NOISE, "Noise");
        GeneratedOutlineSupport1.outline141(TAG_FOCAL_PLANE_X_RESOLUTION_TIFF_EP, hashMap, "Focal Plane X Resolution", TAG_FOCAL_PLANE_Y_RESOLUTION_TIFF_EP, "Focal Plane Y Resolution", TAG_IMAGE_NUMBER, "Image Number", TAG_SECURITY_CLASSIFICATION, "Security Classification");
        GeneratedOutlineSupport1.outline141(TAG_IMAGE_HISTORY, hashMap, "Image History", TAG_SUBJECT_LOCATION_TIFF_EP, "Subject Location", TAG_EXPOSURE_INDEX_TIFF_EP, "Exposure Index", TAG_STANDARD_ID_TIFF_EP, "TIFF/EP Standard ID");
        GeneratedOutlineSupport1.outline141(TAG_MAKERNOTE, hashMap, "Makernote", TAG_USER_COMMENT, "User Comment", TAG_SUBSECOND_TIME, "Sub-Sec Time", TAG_SUBSECOND_TIME_ORIGINAL, "Sub-Sec Time Original");
        GeneratedOutlineSupport1.outline141(TAG_SUBSECOND_TIME_DIGITIZED, hashMap, "Sub-Sec Time Digitized", TAG_WIN_TITLE, "Windows XP Title", TAG_WIN_COMMENT, "Windows XP Comment", TAG_WIN_AUTHOR, "Windows XP Author");
        GeneratedOutlineSupport1.outline141(TAG_WIN_KEYWORDS, hashMap, "Windows XP Keywords", TAG_WIN_SUBJECT, "Windows XP Subject", TAG_FLASHPIX_VERSION, "FlashPix Version", 40961, "Color Space");
        GeneratedOutlineSupport1.outline141(TAG_EXIF_IMAGE_WIDTH, hashMap, "Exif Image Width", TAG_EXIF_IMAGE_HEIGHT, "Exif Image Height", TAG_RELATED_SOUND_FILE, "Related Sound File", TAG_FLASH_ENERGY, "Flash Energy");
        GeneratedOutlineSupport1.outline141(TAG_SPATIAL_FREQ_RESPONSE, hashMap, "Spatial Frequency Response", TAG_FOCAL_PLANE_X_RESOLUTION, "Focal Plane X Resolution", TAG_FOCAL_PLANE_Y_RESOLUTION, "Focal Plane Y Resolution", TAG_FOCAL_PLANE_RESOLUTION_UNIT, "Focal Plane Resolution Unit");
        GeneratedOutlineSupport1.outline141(TAG_SUBJECT_LOCATION, hashMap, "Subject Location", TAG_EXPOSURE_INDEX, "Exposure Index", TAG_SENSING_METHOD, "Sensing Method", TAG_FILE_SOURCE, "File Source");
        GeneratedOutlineSupport1.outline141(TAG_SCENE_TYPE, hashMap, "Scene Type", TAG_CFA_PATTERN, "CFA Pattern", TAG_CUSTOM_RENDERED, "Custom Rendered", TAG_EXPOSURE_MODE, "Exposure Mode");
        GeneratedOutlineSupport1.outline141(TAG_WHITE_BALANCE_MODE, hashMap, "White Balance Mode", TAG_DIGITAL_ZOOM_RATIO, "Digital Zoom Ratio", TAG_35MM_FILM_EQUIV_FOCAL_LENGTH, "Focal Length 35", TAG_SCENE_CAPTURE_TYPE, "Scene Capture Type");
        GeneratedOutlineSupport1.outline141(TAG_GAIN_CONTROL, hashMap, "Gain Control", TAG_CONTRAST, ExifInterface.TAG_CONTRAST, TAG_SATURATION, ExifInterface.TAG_SATURATION, TAG_SHARPNESS, ExifInterface.TAG_SHARPNESS);
        GeneratedOutlineSupport1.outline141(TAG_DEVICE_SETTING_DESCRIPTION, hashMap, "Device Setting Description", TAG_SUBJECT_DISTANCE_RANGE, "Subject Distance Range", TAG_IMAGE_UNIQUE_ID, "Unique Image ID", TAG_CAMERA_OWNER_NAME, "Camera Owner Name");
        GeneratedOutlineSupport1.outline141(TAG_BODY_SERIAL_NUMBER, hashMap, "Body Serial Number", TAG_LENS_SPECIFICATION, "Lens Specification", TAG_LENS_MAKE, "Lens Make", TAG_LENS_MODEL, "Lens Model");
        GeneratedOutlineSupport1.outline141(TAG_LENS_SERIAL_NUMBER, hashMap, "Lens Serial Number", TAG_GAMMA, ExifInterface.TAG_GAMMA, TAG_PRINT_IMAGE_MATCHING_INFO, "Print Image Matching (PIM) Info", TAG_PANASONIC_TITLE, "Panasonic Title");
        hashMap.put(Integer.valueOf((int) TAG_PANASONIC_TITLE_2), "Panasonic Title (2)");
        hashMap.put(Integer.valueOf((int) TAG_PADDING), "Padding");
        hashMap.put(Integer.valueOf((int) TAG_LENS), "Lens");
    }
}

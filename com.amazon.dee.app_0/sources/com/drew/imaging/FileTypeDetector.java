...
public class FileTypeDetector {
    ...
    static {
        ...
        _root.addPath(FileType.Tiff, "II".getBytes(), new byte[]{GenericAccessProfile.MESH_MESSAGE, 0});
        _root.addPath(FileType.Tiff, "MM".getBytes(), new byte[]{0, GenericAccessProfile.MESH_MESSAGE});
        _root.addPath(FileType.Psd, "8BPS".getBytes());
        _root.addPath(FileType.Png, new byte[]{-119, 80, 78, 71, 13, 10, Ascii.SUB, 10, 0, 0, 0, 13, 73, 72, 68, 82});
        ...
        _root.addPath(FileType.Arw, "II".getBytes(), new byte[]{GenericAccessProfile.MESH_MESSAGE, 0, 8, 0});
        _root.addPath(FileType.Crw, "II".getBytes(), new byte[]{Ascii.SUB, 0, 0, 0}, "HEAPCCDR".getBytes());
        _root.addPath(FileType.Cr2, "II".getBytes(), new byte[]{GenericAccessProfile.MESH_MESSAGE, 0, 16, 0, 0, 0, 67, 82});
        ...
        _root.addPath(FileType.Asf, new byte[]{48, GenericAccessProfile.TRANSPORT_DISCOVERY_DATA, -78, 117, -114, 102, -49, 17, -90, -39, 0, -86, 0, 98, -50, 108});
        _root.addPath(FileType.Cfbf, new byte[]{-48, -49, 17, -32, -95, -79, Ascii.SUB, -31, 0});
        _root.addPath(FileType.Flv, new byte[]{70, 76, 86});
        _root.addPath(FileType.Indd, new byte[]{6, 6, -19, -11, -40, 29, 70, -27, -67, 49, ByteSourceJsonBootstrapper.UTF8_BOM_1, -25, -2, 116, -73, 29});
        _root.addPath(FileType.Mxf, new byte[]{6, 14, GenericAccessProfile.MESH_BEACON, 52, 2, 5, 1, 1, 13, 1, 2, 1, 1, 2});
        ...
        _root.addPath(FileType.Sit, new byte[]{83, 73, 84, GenericAccessProfile.SERVICE_DATA_128BIT, 0});
        _root.addPath(FileType.Sit, new byte[]{83, 116, 117, 102, 102, 73, 116, 32, GenericAccessProfile.CHANNEL_MAP_UPDATE_INDICATION, 99, GenericAccessProfile.PB_ADV, 49, 57, 57, 55, MultipartStream.DASH});
        _root.addPath(FileType.Sitx, new byte[]{83, 116, 117, 102, 102, 73, 116, GenericAccessProfile.SERVICE_DATA_128BIT});
    ...
    public static FileType detectFileType(@NotNull BufferedInputStream bufferedInputStream) throws IOException {
        if (bufferedInputStream.markSupported()) {
            ...
            if (find == FileType.Unknown) {
                ...
                return fileType != null ? fileType : find;
            } else if (find != FileType.Riff) {
                return find;
            } else {
                String str = new String(bArr, 8, 4);
                return str.equals(WavDirectory.FORMAT) ? FileType.Wav : str.equals(AviDirectory.FORMAT) ? FileType.Avi : str.equals(WebpDirectory.FORMAT) ? FileType.WebP : find;
            }
        }

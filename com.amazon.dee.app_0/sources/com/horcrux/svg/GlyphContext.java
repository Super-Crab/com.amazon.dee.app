...
public class GlyphContext {
    ...
    private double[] mRs = {FrostVideoEffectController.VIDEO_STRENGTH_CLEAR};
    ...
    private void reset() {
        ...
        this.mYIndex = -1;
        this.mXIndex = -1;
        this.mDY = FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
        this.mDX = FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
        this.mY = FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
        this.mX = FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
    }
    ...
    public double nextDeltaX() {
        ...
        if (i < sVGLengthArr.length) {
            this.mDXIndex = i;
            this.mDX += PropHelper.fromRelative(sVGLengthArr[i], this.mWidth, FrostVideoEffectController.VIDEO_STRENGTH_CLEAR, this.mScale, this.mFontSize);
        }
        return this.mDX;
    }
    ...
    public double nextDeltaY() {
        ...
        if (i < sVGLengthArr.length) {
            this.mDYIndex = i;
            this.mDY += PropHelper.fromRelative(sVGLengthArr[i], this.mHeight, FrostVideoEffectController.VIDEO_STRENGTH_CLEAR, this.mScale, this.mFontSize);
        }
        return this.mDY;
    }
    ...
    public double nextX(double d) {
        ...
        if (i < sVGLengthArr.length) {
            this.mDX = FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
            this.mXIndex = i;
            this.mX = PropHelper.fromRelative(sVGLengthArr[i], this.mWidth, FrostVideoEffectController.VIDEO_STRENGTH_CLEAR, this.mScale, this.mFontSize);
        }
        this.mX += d;
        return this.mX;
    }
    ...
    public double nextY() {
        ...
        if (i < sVGLengthArr.length) {
            this.mDY = FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
            this.mYIndex = i;
            this.mY = PropHelper.fromRelative(sVGLengthArr[i], this.mHeight, FrostVideoEffectController.VIDEO_STRENGTH_CLEAR, this.mScale, this.mFontSize);
        }
        return this.mY;
    }

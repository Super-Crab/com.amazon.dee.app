...
class RNSVGRenderableManager extends ReactContextBaseJavaModule {
    ...
    public WritableMap getBBox(int i, ReadableMap readableMap) {
        ...
        try {
            ...
            createMap.putDouble(ReactProperties.HereMapMarker.X, rectF.left / f);
            createMap.putDouble(ReactProperties.HereMapMarker.Y, rectF.top / f);
    ...
    public WritableMap getPointAtLength(int i, ReadableMap readableMap) {
        ...
        try {
            ...
            WritableMap createMap = Arguments.createMap();
            createMap.putDouble(ReactProperties.HereMapMarker.X, fArr[0] / f2);
            createMap.putDouble(ReactProperties.HereMapMarker.Y, fArr[1] / f2);
    ...
    public boolean isPointInFill(int i, ReadableMap readableMap) {
        ...
        float f = renderableViewByTag.mScale;
        return renderableViewByTag.hitTest(new float[]{((float) readableMap.getDouble(ReactProperties.HereMapMarker.X)) * f, ((float) readableMap.getDouble(ReactProperties.HereMapMarker.Y)) * f}) != -1;
    }
    ...
    public boolean isPointInStroke(int i, ReadableMap readableMap) {
        ...
        try {
            ...
            int i2 = (int) (readableMap.getDouble(ReactProperties.HereMapMarker.X) * d);
            int i3 = (int) (readableMap.getDouble(ReactProperties.HereMapMarker.Y) * d);

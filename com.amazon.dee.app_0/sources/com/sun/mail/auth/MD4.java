...
public final class MD4 {
    ...
    private static int GG(int i, int i2, int i3, int i4, int i5, int i6) {
        int outline1 = GeneratedOutlineSupport1.outline1((i2 & i4) | (i2 & i3) | (i3 & i4), i5, 1518500249, i);
        return (outline1 >>> (32 - i6)) | (outline1 << i6);
    }

    private static int HH(int i, int i2, int i3, int i4, int i5, int i6) {
        int outline1 = GeneratedOutlineSupport1.outline1((i2 ^ i3) ^ i4, i5, 1859775393, i);
        return (outline1 >>> (32 - i6)) | (outline1 << i6);
    }

...
public final class XMPSchemaRegistryImpl implements XMPSchemaRegistry, XMPConst {
    ...
    private void registerStandardAliases() throws XMPException {
        ...
        registerAlias(XMPConst.NS_PNG, DatabaseHelper.authorizationToken_CreationTime, "http://ns.adobe.com/xap/1.0/", "CreateDate", null);
    ...
    private void registerStandardNamespaces() throws XMPException {
        ...
        registerNamespace(XMPConst.NS_X, ReactProperties.HereMapMarker.X);
        ...
        registerNamespace(XMPConst.NS_PNG, ImageType.PNG);
        ...
        registerNamespace(XMPConst.NS_SWF, ServiceAbbreviations.SimpleWorkflow);

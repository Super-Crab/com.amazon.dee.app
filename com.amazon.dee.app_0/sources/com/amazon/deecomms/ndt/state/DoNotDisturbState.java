...
public class DoNotDisturbState extends DeviceState {
    /* JADX INFO: Access modifiers changed from: package-private */
    public DoNotDisturbState() {
        ...
        this.deviceStatusText = Utils.getStringFromResource(R.string.device_targeting_do_not_disturb);
    ...
    public boolean checkMainCondition(@NonNull DeviceModel deviceModel) {
        return deviceModel.getDeviceStatus().isDnd();
    }
    ...
    public boolean checkPreConditions(@NonNull DeviceModel deviceModel) {
        ...
        return !deviceStatus.getDeviceDropInAvailability().equals(DropInAvailability.OFF) && deviceStatus.isRegistered();
    }
}

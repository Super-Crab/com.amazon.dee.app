...
public class SpeakerNotSupported extends DeviceState {
    /* JADX INFO: Access modifiers changed from: package-private */
    public SpeakerNotSupported() {
        ...
        this.deviceStatusText = Utils.getStringFromResource(R.string.device_targeting_Speaker_Not_Supported);

...
public class NotRegistered extends DeviceState {
    /* JADX INFO: Access modifiers changed from: package-private */
    public NotRegistered() {
        ...
        this.deviceStatusText = Utils.getStringFromResource(R.string.device_targeting_unregistered);
    ...
    public boolean checkMainCondition(@NonNull DeviceModel deviceModel) {
        return !deviceModel.getDeviceStatus().isRegistered();
    }
    ...
    public boolean checkPreConditions(@NonNull DeviceModel deviceModel) {
        ...
        return !deviceStatus.getDeviceDropInAvailability().equals(DropInAvailability.OFF) && deviceStatus.isOnline();
    }
}

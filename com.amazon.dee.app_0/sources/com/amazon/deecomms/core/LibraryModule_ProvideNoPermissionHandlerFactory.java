...
public final class LibraryModule_ProvideNoPermissionHandlerFactory implements Factory<NoCallPermissionHandler> {
    ...
    public LibraryModule_ProvideNoPermissionHandlerFactory(LibraryModule libraryModule, Provider<AlexaServicesConnection> provider, Provider<CapabilitiesManager> provider2, Provider<CommsEventSender> provider3, Provider<CommsAlexaServicesConnectionListener> provider4, Provider<PCCContextProvider> provider5, Provider<Context> provider6, Provider<PCCQueuedEvents> provider7, Provider<PCCConnectionEndpointHandler> provider8) {
    ...
    public static LibraryModule_ProvideNoPermissionHandlerFactory create(LibraryModule libraryModule, Provider<AlexaServicesConnection> provider, Provider<CapabilitiesManager> provider2, Provider<CommsEventSender> provider3, Provider<CommsAlexaServicesConnectionListener> provider4, Provider<PCCContextProvider> provider5, Provider<Context> provider6, Provider<PCCQueuedEvents> provider7, Provider<PCCConnectionEndpointHandler> provider8) {
        return new LibraryModule_ProvideNoPermissionHandlerFactory(libraryModule, provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8);
    }

    public static NoCallPermissionHandler provideInstance(LibraryModule libraryModule, Provider<AlexaServicesConnection> provider, Provider<CapabilitiesManager> provider2, Provider<CommsEventSender> provider3, Provider<CommsAlexaServicesConnectionListener> provider4, Provider<PCCContextProvider> provider5, Provider<Context> provider6, Provider<PCCQueuedEvents> provider7, Provider<PCCConnectionEndpointHandler> provider8) {
        return (NoCallPermissionHandler) Preconditions.checkNotNull(libraryModule.provideNoPermissionHandler(provider.mo10268get(), provider2.mo10268get(), provider3.mo10268get(), provider4.mo10268get(), provider5.mo10268get(), provider6.mo10268get(), provider7.mo10268get(), provider8.mo10268get()), "Cannot return null from a non-@Nullable @Provides method");
    }

    public static NoCallPermissionHandler proxyProvideNoPermissionHandler(LibraryModule libraryModule, AlexaServicesConnection alexaServicesConnection, CapabilitiesManager capabilitiesManager, CommsEventSender commsEventSender, CommsAlexaServicesConnectionListener commsAlexaServicesConnectionListener, PCCContextProvider pCCContextProvider, Context context, PCCQueuedEvents pCCQueuedEvents, PCCConnectionEndpointHandler pCCConnectionEndpointHandler) {
        return (NoCallPermissionHandler) Preconditions.checkNotNull(libraryModule.provideNoPermissionHandler(alexaServicesConnection, capabilitiesManager, commsEventSender, commsAlexaServicesConnectionListener, pCCContextProvider, context, pCCQueuedEvents, pCCConnectionEndpointHandler), "Cannot return null from a non-@Nullable @Provides method");
    }

    @Override // javax.inject.Provider
    /* renamed from: get */
    public NoCallPermissionHandler mo10268get() {

...
public final class AutosavePreferenceChangeListener$applyPreferences$7 extends Lambda implements Function0<Boolean> {
    final /* synthetic */ AutosavePreferenceChangeListener this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AutosavePreferenceChangeListener$applyPreferences$7(AutosavePreferenceChangeListener autosavePreferenceChangeListener) {
        super(0);
    ...
    public final Boolean mo12560invoke() {
        ...
        return defaultAutosavePreferences.isAllFoldersEnabled();
    }
}

...
final class ContentSignatureProvider$computeMd5$1 implements MetricName {
    public static final ContentSignatureProvider$computeMd5$1 INSTANCE = new ContentSignatureProvider$computeMd5$1();

    ContentSignatureProvider$computeMd5$1() {
    }

...
public class ListChildrenExtendedResponse extends PaginatedCloudDriveResponse implements NodeListingResponse<NodeExtended> {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ListChildrenExtendedResponse) && compareTo((CloudDriveResponse) ((ListChildrenExtendedResponse) obj)) == 0;
    }
    ...
    public int compareTo(CloudDriveResponse cloudDriveResponse) {
        ...
        if (!(cloudDriveResponse instanceof ListChildrenExtendedResponse)) {
            return 1;
        }
        int compare = ObjectComparator.compare(getData(), ((ListChildrenExtendedResponse) cloudDriveResponse).getData());

...
public class MoveNodeToTrashExtendedResponse extends NodeExtended {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof MoveNodeToTrashExtendedResponse) && compareTo((EditableNode) ((MoveNodeToTrashExtendedResponse) obj)) == 0;
    }
    ...
    public int compareTo(EditableNode editableNode) {
        ...
        if (!(editableNode instanceof MoveNodeToTrashExtendedResponse)) {
            return 1;
        }
        int compare = ObjectComparator.compare(getLocation(), ((MoveNodeToTrashExtendedResponse) editableNode).getLocation());

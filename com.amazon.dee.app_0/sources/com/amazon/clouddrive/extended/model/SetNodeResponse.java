...
public class SetNodeResponse extends NodeExtended {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SetNodeResponse) && compareTo((EditableNode) ((SetNodeResponse) obj)) == 0;
    }
    ...
    public int compareTo(EditableNode editableNode) {
        ...
        if (!(editableNode instanceof SetNodeResponse)) {
            return 1;
        }
        String location = getLocation();
        String location2 = ((SetNodeResponse) editableNode).getLocation();

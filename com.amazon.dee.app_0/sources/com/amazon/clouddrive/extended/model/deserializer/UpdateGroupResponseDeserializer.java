...
public class UpdateGroupResponseDeserializer extends AbstractDeserializer<Group, UpdateGroupResponse> {
    public static final JsonDeserializer<UpdateGroupResponse> INSTANCE = new UpdateGroupResponseDeserializer();

    /* loaded from: classes11.dex */
    static class UpdateGroupResponseFieldDeserializer extends GroupDeserializer.GroupFieldDeserializer {
        UpdateGroupResponseFieldDeserializer() {
        }
    ...
    public UpdateGroupResponseDeserializer() {
        super(new UpdateGroupResponseFieldDeserializer());
    }
    ...
    public UpdateGroupResponse mo3156createValue() {

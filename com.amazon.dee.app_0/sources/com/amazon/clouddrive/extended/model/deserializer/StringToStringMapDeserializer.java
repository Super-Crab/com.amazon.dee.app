...
public class StringToStringMapDeserializer implements JsonDeserializer<Map<String, String>> {
    public static final JsonDeserializer<Map<String, String>> INSTANCE = new StringToStringMapDeserializer();

    private StringToStringMapDeserializer() {
    }

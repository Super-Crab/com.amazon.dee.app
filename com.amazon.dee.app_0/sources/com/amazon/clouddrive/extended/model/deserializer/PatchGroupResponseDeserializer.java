...
public class PatchGroupResponseDeserializer extends AbstractDeserializer<Group, PatchGroupResponse> {
    public static final JsonDeserializer<PatchGroupResponse> INSTANCE = new PatchGroupResponseDeserializer();

    /* loaded from: classes11.dex */
    static class PatchGroupResponseFieldDeserializer extends GroupDeserializer.GroupFieldDeserializer {
        PatchGroupResponseFieldDeserializer() {
        }
    ...
    public PatchGroupResponseDeserializer() {
        super(new PatchGroupResponseFieldDeserializer());
    }
    ...
    public PatchGroupResponse mo3156createValue() {

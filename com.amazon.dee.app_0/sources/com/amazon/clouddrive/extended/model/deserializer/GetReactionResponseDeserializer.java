...
public class GetReactionResponseDeserializer implements JsonDeserializer<GetReactionResponse> {
    public static final JsonDeserializer<GetReactionResponse> INSTANCE = new GetReactionResponseDeserializer();
    ...
    public GetReactionResponse mo3229deserialize(JsonParser jsonParser) throws IOException {
        JsonToken currentToken = jsonParser.getCurrentToken();
        if (currentToken == JsonToken.VALUE_NULL) {
            return null;
        }
        if (currentToken == JsonToken.START_OBJECT) {
            GetReactionResponse.Builder builder = new GetReactionResponse.Builder();

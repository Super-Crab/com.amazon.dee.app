...
public class UploadFileExtendedResponse extends NodeExtended {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UploadFileExtendedResponse) && compareTo((EditableNode) ((UploadFileExtendedResponse) obj)) == 0;
    }
    ...
    public int compareTo(EditableNode editableNode) {
        ...
        int compare = ObjectComparator.compare(getLocation(), ((UploadFileExtendedResponse) editableNode).getLocation());

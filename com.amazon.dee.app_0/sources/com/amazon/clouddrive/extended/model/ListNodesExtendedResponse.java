...
public class ListNodesExtendedResponse extends PaginatedCloudDriveResponse implements NodeListingResponse<NodeExtended> {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ListNodesExtendedResponse) && compareTo((CloudDriveResponse) ((ListNodesExtendedResponse) obj)) == 0;
    }
    ...
    public int compareTo(CloudDriveResponse cloudDriveResponse) {
        ...
        int compare = ObjectComparator.compare(getData(), ((ListNodesExtendedResponse) cloudDriveResponse).getData());

...
public class UpdateNodeExtendedResponse extends NodeExtended {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UpdateNodeExtendedResponse) && compareTo((EditableNode) ((UpdateNodeExtendedResponse) obj)) == 0;
    }
    ...
    public int compareTo(EditableNode editableNode) {
        ...
        if (!(editableNode instanceof UpdateNodeExtendedResponse)) {
            return 1;
        }
        int compare = ObjectComparator.compare(getLocation(), ((UpdateNodeExtendedResponse) editableNode).getLocation());

...
public class EditableNodeRequest implements IEditableNode, CloudDriveRequest {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof EditableNodeRequest) && compareTo((CloudDriveRequest) ((EditableNodeRequest) obj)) == 0;
    }
    ...
    public int compareTo(CloudDriveRequest cloudDriveRequest) {
        ...
        String name = getName();
        String name2 = editableNodeRequest.getName();
        if (name != name2) {
            if (name == null) {
                return -1;
            }
        ...
        String description2 = editableNodeRequest.getDescription();
        ...
        List<String> parents2 = editableNodeRequest.getParents();
        if (parents != parents2) {
            if (parents == null) {
                return -1;
            }
        ...
        String id = getId();
        String id2 = editableNodeRequest.getId();
        if (id != id2) {
            if (id == null) {
                return -1;
            }
        ...
        ContentProperties contentProperties2 = editableNodeRequest.getContentProperties();
        ...
        Map<String, Map<String, String>> properties2 = editableNodeRequest.getProperties();
        ...
        Map<String, Map<String, String>> subKindProperties2 = editableNodeRequest.getSubKindProperties();
        ...
        String kind = getKind();
        String kind2 = editableNodeRequest.getKind();
        if (kind != kind2) {
            if (kind == null) {
                return -1;
            }
        ...
        List<String> subKinds2 = editableNodeRequest.getSubKinds();
        ...
        List<String> labels2 = editableNodeRequest.getLabels();
        if (labels != labels2) {
            if (labels == null) {
                return -1;
            }
        ...
        String status2 = editableNodeRequest.getStatus();
        if (status != status2) {
            if (status == null) {
                return -1;
            }
        ...
        CollectionProperties collectionProperties2 = editableNodeRequest.getCollectionProperties();
        ...
        Map<String, List<String>> parentMap2 = editableNodeRequest.getParentMap();
        ...
        Settings settings2 = editableNodeRequest.getSettings();
        ...
        List<String> transforms2 = editableNodeRequest.getTransforms();
        ...
        String symbolicNodeHeroId2 = editableNodeRequest.getSymbolicNodeHeroId();

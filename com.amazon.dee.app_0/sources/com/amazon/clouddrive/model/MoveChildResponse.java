...
public class MoveChildResponse extends Node {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof MoveChildResponse) && compareTo((EditableNode) ((MoveChildResponse) obj)) == 0;
    }
    ...
    public int compareTo(EditableNode editableNode) {
        ...
        if (!(editableNode instanceof MoveChildResponse)) {
            return 1;
        }
        String location = getLocation();
        String location2 = ((MoveChildResponse) editableNode).getLocation();

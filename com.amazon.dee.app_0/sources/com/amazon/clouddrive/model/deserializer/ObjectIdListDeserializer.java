...
public class ObjectIdListDeserializer implements JsonDeserializer<List<String>> {
    public static final JsonDeserializer<List<String>> INSTANCE = new ObjectIdListDeserializer();

...
public class MediaTypeUploadStatusMapDeserializer implements JsonDeserializer<Map<String, MediaTypeUploadStatus>> {
    ...
    public Map<String, MediaTypeUploadStatus> mo3229deserialize(JsonParser jsonParser) throws IOException {
            ...
            while (jsonParser.nextToken() != JsonToken.END_OBJECT) {
                if (jsonParser.getCurrentToken() == JsonToken.FIELD_NAME) {
                    ...
                    if (jsonParser.nextToken() != null) {
                        hashMap.put(currentName, MediaTypeUploadStatusDeserializer.INSTANCE.mo3229deserialize(jsonParser));
                    } else {

...
public class SubKindPropertyMapDeserializer implements JsonDeserializer<Map<String, String>> {
    public static final JsonDeserializer<Map<String, String>> INSTANCE = new SubKindPropertyMapDeserializer();

    private SubKindPropertyMapDeserializer() {
    }

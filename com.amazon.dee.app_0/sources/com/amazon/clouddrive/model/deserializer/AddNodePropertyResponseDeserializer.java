...
public class AddNodePropertyResponseDeserializer implements JsonDeserializer<AddNodePropertyResponse> {
    ...
    public static class AddNodePropertyResponseFieldDeserializer implements JsonFieldDeserializer<AddNodePropertyResponse> {
        ...
        public /* bridge */ /* synthetic */ boolean handleField(JsonParser jsonParser, String str, Object obj) throws IOException {
            return handleField(jsonParser, str, (String) ((AddNodePropertyResponse) obj));
        }

        public <U extends AddNodePropertyResponse> boolean handleField(JsonParser jsonParser, String str, U u) throws IOException {
            if ("value".equals(str)) {
    ...
    public AddNodePropertyResponse mo3229deserialize(JsonParser jsonParser) throws IOException {
            ...
            while (jsonParser.nextToken() != JsonToken.END_OBJECT) {
                if (jsonParser.getCurrentToken() == JsonToken.FIELD_NAME) {
                    ...
                    if (jsonParser.nextToken() != null) {
                        if (!this.mFieldHandler.handleField(jsonParser, currentName, (String) addNodePropertyResponse)) {

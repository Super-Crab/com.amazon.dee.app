...
public class MoveChildResponseDeserializer implements JsonDeserializer<MoveChildResponse> {
    ...
    public static class MoveChildResponseFieldDeserializer extends NodeDeserializer.NodeFieldDeserializer {
        ...
        public <U extends IEditableNode> boolean handleField(JsonParser jsonParser, String str, U u) throws IOException {
            ...
            if (!(u instanceof MoveChildResponse) || !"location".equals(str)) {
                return false;
            }
            ((MoveChildResponse) u).setLocation(SimpleDeserializers.deserializeString(jsonParser));
            return true;
        }
    }
    ...
    public MoveChildResponse mo3229deserialize(JsonParser jsonParser) throws IOException {

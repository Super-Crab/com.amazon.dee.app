...
public class LabelListDeserializer implements JsonDeserializer<List<String>> {
    public static final JsonDeserializer<List<String>> INSTANCE = new LabelListDeserializer();

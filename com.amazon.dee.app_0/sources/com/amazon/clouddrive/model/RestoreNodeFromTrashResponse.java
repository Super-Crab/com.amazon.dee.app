...
public class RestoreNodeFromTrashResponse extends Node {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof RestoreNodeFromTrashResponse) && compareTo((EditableNode) ((RestoreNodeFromTrashResponse) obj)) == 0;
    }
    ...
    public int compareTo(EditableNode editableNode) {
        ...
        if (!(editableNode instanceof RestoreNodeFromTrashResponse)) {
            return 1;
        }
        String location = getLocation();
        String location2 = ((RestoreNodeFromTrashResponse) editableNode).getLocation();

...
public class ListChildrenResponse extends PaginatedCloudDriveResponse implements NodeListingResponse<Node> {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ListChildrenResponse) && compareTo((CloudDriveResponse) ((ListChildrenResponse) obj)) == 0;
    }
    ...
    public int compareTo(CloudDriveResponse cloudDriveResponse) {
        ...
        List<Node> data2 = ((ListChildrenResponse) cloudDriveResponse).getData();
        if (data != data2) {
            if (data == null) {
                return -1;
            }

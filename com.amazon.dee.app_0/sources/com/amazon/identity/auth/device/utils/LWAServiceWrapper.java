...
public abstract class LWAServiceWrapper<Result> {
    ...
    /* renamed from: doWork */
    protected abstract Result mo4073doWork(Context context, AmazonAuthorizationServiceInterface amazonAuthorizationServiceInterface) throws AuthError, RemoteException;
    ...
    public final Result execute(Context context, ThirdPartyServiceHelper thirdPartyServiceHelper) throws AuthError {
        ...
        while (i <= 3) {
            ...
            if (remoteAndroidService != null) {
                result = mo4073doWork(context, remoteAndroidService);
                ThirdPartyServiceHelper.unbind(context);
                return result;
            }
            continue;

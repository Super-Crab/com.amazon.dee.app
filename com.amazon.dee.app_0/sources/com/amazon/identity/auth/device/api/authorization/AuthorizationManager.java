        ...
        for (int i = 0; i < size; i++) {
            ...
            if (scope.getScopeData() != null) {
                try {
                    ...
                    MAPLog.pii(LOG_TAG, GeneratedOutlineSupport1.outline75("Unable to serialize scope data for scope \"", name, EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED), scope.getScopeData().toString(), e);
                }
            }
        }

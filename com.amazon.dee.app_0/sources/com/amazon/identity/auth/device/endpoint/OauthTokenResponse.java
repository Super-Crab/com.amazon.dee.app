...
class OauthTokenResponse extends AbstractJSONTokenResponse {
    ...
    public void logRequestId(JSONObject jSONObject) {
        ...
        Header firstHeader = getResponse().getFirstHeader(REQUEST_ID_HEADER);
        if (firstHeader != null) {
            String str = LOG_TAG;
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("requestId=");
            outline107.append(firstHeader.getValue());
            MAPLog.pii(str, "ExchangeRepsonse", outline107.toString());
            return;
        }

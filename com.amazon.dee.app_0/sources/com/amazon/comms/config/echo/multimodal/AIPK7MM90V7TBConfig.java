...
public class AIPK7MM90V7TBConfig extends MultiModalConfig {
    private static final int RENDER_TRACK_BUFFER_SIZE_BYTES = 1536;
    private static final String WEBRTC_FIELD_TRIALS = "WebRTC-MTKH264/Enabled-NoAdjust/WebRTC-MTKH264-LowLatency/Enabled/WebRTC-AVSync-AudioDelayEstimateMs/Enabled-240/WebRTC-Rfc5389StunRetransmissions/Enabled/VideoFrameEmit/Enabled/WebRTC-Audio-SendSideBwe/Enabled/";
    private static AIPK7MM90V7TBConfig aIPK7MM90V7TBConfig = new AIPK7MM90V7TBConfig();

    public static AIPK7MM90V7TBConfig getDeviceConfigInstance() {
        return aIPK7MM90V7TBConfig;
    }
    ...
    public VideoConstraints getMaxVideoConstraintsToRequestFromRemote() {
        return new VideoConstraints(1280, 800, 24);
    }
    ...
    public int getVideoMaxBitrate() {
        return DeviceConfigConstants.VIDEO_BITRATE_3200_KBPS;
    }

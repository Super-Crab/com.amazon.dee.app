...
public final class AutoValue_LaunchConfig extends C$AutoValue_LaunchConfig {
    ...
    public static final class GsonTypeAdapter extends TypeAdapter<LaunchConfig> {
        ...
        public LaunchConfig mo8353read(JsonReader jsonReader) throws IOException {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    if (hashCode != -1919563434) {
                        if (hashCode == -1424816527 && nextName.equals("isStoreLink")) {
                            c = 1;
                        }
                    } else if (nextName.equals("mustLaunchTargetInGivenApp")) {
                        c = 0;
                    }
                    if (c == 0) {
        ...
        public void write(JsonWriter jsonWriter, LaunchConfig launchConfig) throws IOException {
            ...
            jsonWriter.name("mustLaunchTargetInGivenApp");
    ...
    public AutoValue_LaunchConfig(@Nullable final Boolean bool, @Nullable final Boolean bool2) {
        new LaunchConfig(bool, bool2) { // from class: com.amazon.alexa.sendtoapp.notification.actions.$AutoValue_LaunchConfig
            private final Boolean isStoreLink;
            private final Boolean mustLaunchTargetInGivenApp;

            /* renamed from: com.amazon.alexa.sendtoapp.notification.actions.$AutoValue_LaunchConfig$Builder */
            /* loaded from: classes10.dex */
            static final class Builder extends LaunchConfig.Builder {
                ...
                @Override // com.amazon.alexa.sendtoapp.notification.actions.LaunchConfig.Builder
                public LaunchConfig build() {
                    return new AutoValue_LaunchConfig(this.mustLaunchTargetInGivenApp, this.isStoreLink);
                }

                @Override // com.amazon.alexa.sendtoapp.notification.actions.LaunchConfig.Builder
                public LaunchConfig.Builder setIsStoreLink(@Nullable Boolean bool) {
                    this.isStoreLink = bool;
                    return this;
                }

                @Override // com.amazon.alexa.sendtoapp.notification.actions.LaunchConfig.Builder
                public LaunchConfig.Builder setMustLaunchTargetInGivenApp(@Nullable Boolean bool) {
            ...
            @Override // com.amazon.alexa.sendtoapp.notification.actions.LaunchConfig
            @Nullable

...
/* synthetic */ class eYN {
    ...
    static {
        ...
        try {
            zZm[UiEventName.NAVIGATION_TO_EXTERNAL_LINK.ordinal()] = 7;
        } catch (NoSuchFieldError unused7) {
        }
        try {
            zZm[UiEventName.NAVIGATION_TO_INTERNAL_CARD.ordinal()] = 8;
        } catch (NoSuchFieldError unused8) {
        }
        try {
            zZm[UiEventName.FOUND_CARD_FACTORY.ordinal()] = 9;
        } catch (NoSuchFieldError unused9) {
        }
        try {
            zZm[UiEventName.MISSING_CARD_FACTORY.ordinal()] = 10;
        } catch (NoSuchFieldError unused10) {
        }
        try {
            zZm[UiEventName.CARD_CONTROLLER_CREATION_ERROR.ordinal()] = 11;
        } catch (NoSuchFieldError unused11) {
        }
        try {
            zZm[UiEventName.CARD_CREATION_ERROR.ordinal()] = 12;
        } catch (NoSuchFieldError unused12) {
        }
        try {
            zZm[UiEventName.JSON_PARSING_ERROR.ordinal()] = 13;

...
public class DJs extends QIr {
    public static final String LPk = "DJs";
    public final pRk Mlj;
    public final long lOf;
    public final DialogRequestIdentifier yPL;
    public final Map<String, String> zzR;

    public DJs(AtomicReference<WSC> atomicReference, AlexaClientEventBus alexaClientEventBus, IUt iUt, Lazy<PersistentStorage> lazy, TimeProvider timeProvider, DialogRequestIdentifier dialogRequestIdentifier, pRk prk, @Nullable Map<String, String> map, long j, Map<XWx, WSC> map2, Map<DialogRequestIdentifier, XWx> map3) {

...
public final class ContentLayout extends FrameLayout {
    ...
    static final Property<ViewOffsetHelper, Integer> OFFSET_Y = new Property<ViewOffsetHelper, Integer>(Integer.class, "topAndBottomOffset") { // from class: com.amazon.alexa.voice.ui.internal.widget.ContentLayout.2
    ...
    public static class SimpleOnContentListener implements OnContentListener {
        @Override // com.amazon.alexa.voice.ui.internal.widget.ContentLayout.OnContentListener
    ...
    public void animateSettle(int i, int i2, float f, final boolean z) {
        ...
        ofInt.addListener(new AnimatorListenerAdapter() { // from class: com.amazon.alexa.voice.ui.internal.widget.ContentLayout.1
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, R.styleable.ContentLayout, 0, 0);
        try {
            this.drawShadow = obtainStyledAttributes.getBoolean(R.styleable.ContentLayout_drawShadowOnDrag, false);
            obtainStyledAttributes.recycle();
            setImportantForAccessibility(2);
            this.minFlingVelocity = ViewConfiguration.get(context).getScaledMinimumFlingVelocity();
            this.shadowDrawable = ContextCompat.getDrawable(context, R.drawable.voice_ui_content_layout_shadow);
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        if (this.content == null) {
            this.content = view;
            this.content.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.amazon.alexa.voice.ui.internal.widget.-$$Lambda$ContentLayout$zbIhf9DfnsQK4gCFiq8msLHQSKM
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.backgroundPaint.setColor(Color.argb(((i - this.content.getTop()) * 230) / i, 21, 25, 32));

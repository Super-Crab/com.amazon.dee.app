...
public class ThinkingStateLoadingView extends View {
    ...
    public ThinkingStateLoadingView(Context context) {
        super(context);
        this.animationRunnable = new Runnable() { // from class: com.amazon.alexa.voice.ui.onedesign.widget.ThinkingStateLoadingView.1
            @Override // java.lang.Runnable
            public void run() {
                if (ThinkingStateLoadingView.this.getVisibility() != 0) {
                    ThinkingStateLoadingView.this.isAnimating = false;
                    return;
                }
                if (ThinkingStateLoadingView.access$008(ThinkingStateLoadingView.this) == 48) {
                    ThinkingStateLoadingView.this.resetSteps();
                }
                ThinkingStateLoadingView.this.invalidate();
                ThinkingStateLoadingView.this.handler.postDelayed(this, ThinkingStateLoadingView.this.animationDuration);
            }
        };
    ...
    static /* synthetic */ int access$008(ThinkingStateLoadingView thinkingStateLoadingView) {
        int i = thinkingStateLoadingView.currentStep;
        thinkingStateLoadingView.currentStep = i + 1;
        return i;
    }
    ...
    public ThinkingStateLoadingView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ThinkingStateLoadingView);
        this.fillColor = obtainStyledAttributes.getColor(R.styleable.ThinkingStateLoadingView_fillColor, DEFAULT_CIRCLE_COLOR);
        this.startRadius = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ThinkingStateLoadingView_minRadius, 12);
        this.endRadius = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ThinkingStateLoadingView_maxRadius, 24);
        this.animationDuration = obtainStyledAttributes.getInt(R.styleable.ThinkingStateLoadingView_animDuration, 30);
        this.dotPadding = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ThinkingStateLoadingView_dotPadding, 30);
        init();

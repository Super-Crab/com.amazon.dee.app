...
public final class AggregateEventProcessor$Builder$isEqualTo$$inlined$where$2 extends Lambda implements Function1<T, Boolean> {
    ...
    public final boolean invoke(@NotNull TtaEvent event) {
        ...
        return ((Boolean) this.$oldPredicate.mo12165invoke(event)).booleanValue() && Intrinsics.areEqual(event, this.$item$inlined);
    }
}

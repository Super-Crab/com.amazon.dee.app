...
public final class AggregateEventProcessor$Builder$where$$inlined$apply$lambda$2 extends Lambda implements Function1<T, Boolean> {
    final /* synthetic */ Function1 $oldPredicate;
    final /* synthetic */ Function1 $predicate$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AggregateEventProcessor$Builder$where$$inlined$apply$lambda$2(Function1 function1, Function1 function12) {
        super(1);

...
final class InAppSearchStateMachineBuilder$with$6 extends Lambda implements Function1<SCXMLContext<InAppSearchContext>, Unit> {
    final /* synthetic */ NativeInvocations $nativeInvocations;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InAppSearchStateMachineBuilder$with$6(NativeInvocations nativeInvocations) {
        super(1);
    ...
    public final void invoke2(@NotNull SCXMLContext<InAppSearchContext> c) {
        ...
        this.$nativeInvocations.tryRenderCardDirective(c);
    }
}

...
final class InAppSearchStateMachineBuilder$with$1 extends Lambda implements Function1<SCXMLContext<InAppSearchContext>, Boolean> {
    final /* synthetic */ NativeEvaluators $nativeEvaluators;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InAppSearchStateMachineBuilder$with$1(NativeEvaluators nativeEvaluators) {
        super(1);
    ...
    public final boolean invoke2(@NotNull SCXMLContext<InAppSearchContext> c) {
        ...
        return this.$nativeEvaluators.isMultiturnFlagSet(c);
    }
}

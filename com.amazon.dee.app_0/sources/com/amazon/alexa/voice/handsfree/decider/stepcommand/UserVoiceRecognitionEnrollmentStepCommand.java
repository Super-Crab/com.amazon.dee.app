...
public class UserVoiceRecognitionEnrollmentStepCommand extends StepCommand {
    public UserVoiceRecognitionEnrollmentStepCommand(@NonNull Context context) {
        this(context, StepType.USER_VOICE_RECOGNITION_ENROLLMENT, MetricsBuilderProvider.getInstance(context), NotificationMetadata.USER_VERIFICATION_ENROLLMENT, MetricType.USER_VOICE_RECOGNITION_ENROLLMENT_NOTIFICATION_METADATA_CALLED);
    }

    @Override // com.amazon.alexa.voice.handsfree.decider.stepcommand.StepCommand
    public Intent getStepIntent() {
        return new Intent(getContext(), EnrollmentActivity.class);
    }

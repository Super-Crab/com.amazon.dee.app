...
public final class FeatureDao_Impl implements FeatureDao {
    ...
    public FeatureDao_Impl(RoomDatabase roomDatabase) {
        ...
        this.__insertionAdapterOfFeature = new EntityInsertionAdapter<Feature>(roomDatabase) { // from class: com.amazon.alexa.featureservice.dao.FeatureDao_Impl.1
        ...
        this.__deletionAdapterOfFeature = new EntityDeletionOrUpdateAdapter<Feature>(roomDatabase) { // from class: com.amazon.alexa.featureservice.dao.FeatureDao_Impl.2
        ...
        this.__preparedStmtOfDeleteAll = new SharedSQLiteStatement(roomDatabase) { // from class: com.amazon.alexa.featureservice.dao.FeatureDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.amazon.alexa.featureservice.dao.FeatureDao
    ...
    public void insert(Feature feature) {
        ...
        this.__db.beginTransaction();
        try {
            this.__insertionAdapterOfFeature.insert((EntityInsertionAdapter<Feature>) feature);
            this.__db.setTransactionSuccessful();
        } finally {
            this.__db.endTransaction();
        }

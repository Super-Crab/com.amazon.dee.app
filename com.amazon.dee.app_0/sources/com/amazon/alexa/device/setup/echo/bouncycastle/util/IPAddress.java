...
public class IPAddress {
    ...
    public static boolean isValidIPv4(String str) {
        ...
        int i = 0;
        int i2 = 0;
        while (i < outline72.length() && (indexOf = outline72.indexOf(46, i)) > i) {
            if (i2 == 4) {
                return false;
            }
            try {
                int parseInt = Integer.parseInt(outline72.substring(i, indexOf));
    ...
    public static boolean isValidIPv6(String str) {
        ...
        int i2 = 0;
        boolean z = false;
        while (i < outline72.length() && (indexOf = outline72.indexOf(58, i)) >= i) {
            if (i2 == 8) {
                return false;
            }
            if (i != indexOf) {
                String substring = outline72.substring(i, indexOf);
                if (indexOf == outline72.length() - 1 && substring.indexOf(46) > 0) {
                    ...
                    try {
                        int parseInt = Integer.parseInt(outline72.substring(i, indexOf), 16);
            ...
            } else if (indexOf != 1 && indexOf != outline72.length() - 1 && z) {
                return false;
            } else {
                z = true;
            }

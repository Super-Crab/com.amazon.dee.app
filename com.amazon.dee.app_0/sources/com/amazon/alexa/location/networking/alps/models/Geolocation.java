...
import com.amazon.alexa.location.networking.alps.models.C$AutoValue_Geolocation;
...
public abstract class Geolocation {
    ...
    static abstract class Builder {
        ...
        abstract Builder setAltitude(Altitude altitude);

        /* JADX INFO: Access modifiers changed from: package-private */
        public abstract Builder setCoordinate(Coordinate coordinate);

        abstract Builder setHeading(Heading heading);

        abstract Builder setSpeed(Speed speed);
    }

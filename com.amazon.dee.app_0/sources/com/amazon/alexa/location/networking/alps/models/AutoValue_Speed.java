...
import com.amazon.alexa.location.networking.alps.models.Speed;
...
public final class AutoValue_Speed extends C$AutoValue_Speed {
    ...
    public AutoValue_Speed(final double d, final double d2) {
        new Speed(d, d2) { // from class: com.amazon.alexa.location.networking.alps.models.$AutoValue_Speed
            private final double accuracyInMetersPerSecond;
            private final double speedInMetersPerSecond;

            /* renamed from: com.amazon.alexa.location.networking.alps.models.$AutoValue_Speed$Builder */
            /* loaded from: classes9.dex */
            static final class Builder extends Speed.Builder {
                private Double accuracyInMetersPerSecond;
                private Double speedInMetersPerSecond;

                @Override // com.amazon.alexa.location.networking.alps.models.Speed.Builder
                Speed build() {
                    String str = "";
                ...
                @Override // com.amazon.alexa.location.networking.alps.models.Speed.Builder
                Speed.Builder setAccuracyInMetersPerSecond(double d) {
                    this.accuracyInMetersPerSecond = Double.valueOf(d);
                    return this;
                }

                @Override // com.amazon.alexa.location.networking.alps.models.Speed.Builder
                Speed.Builder setSpeedInMetersPerSecond(double d) {
            ...
            /* JADX INFO: Access modifiers changed from: package-private */
            @Override // com.amazon.alexa.location.networking.alps.models.Speed

...
import com.amazon.alexa.location.networking.alps.models.Heading;
...
public final class AutoValue_Heading extends C$AutoValue_Heading {
    ...
    public AutoValue_Heading(final double d, final double d2) {
        new Heading(d, d2) { // from class: com.amazon.alexa.location.networking.alps.models.$AutoValue_Heading
            private final double accuracyInDegrees;
            private final double directionInDegrees;

            /* renamed from: com.amazon.alexa.location.networking.alps.models.$AutoValue_Heading$Builder */
            /* loaded from: classes9.dex */
            static final class Builder extends Heading.Builder {
                private Double accuracyInDegrees;
                private Double directionInDegrees;

                @Override // com.amazon.alexa.location.networking.alps.models.Heading.Builder
                Heading build() {
                    String str = "";
                ...
                @Override // com.amazon.alexa.location.networking.alps.models.Heading.Builder
                Heading.Builder setAccuracyInDegrees(double d) {
                    this.accuracyInDegrees = Double.valueOf(d);
                    return this;
                }

                @Override // com.amazon.alexa.location.networking.alps.models.Heading.Builder
                Heading.Builder setDirectionInDegrees(double d) {
            ...
            /* JADX INFO: Access modifiers changed from: package-private */
            @Override // com.amazon.alexa.location.networking.alps.models.Heading

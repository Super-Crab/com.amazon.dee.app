...
public final class ProvisioningConstants {
    ...
    public static final String DEVICE_DISTRESSED = "distressed";
    public static final String DEVICE_DISTRESSED_ERROR = "distressedError";
    public static final String DEVICE_IDENTITY = "deviceIdentity";
    public static final String DEVICE_PRODUCT_INDEX = "productIndex";
    public static final String DEVICE_SETUP_AUTH_MATERIAL_IDENTIFIER = "authMaterialIdentifier";
    public static final String DEVICE_SETUP_AUTH_MATERIAL_INDEX = "authMaterialIndex";
    public static final String DEVICE_SETUP_DEVICE_SERIAL_NUMBER = "dsn";
    public static final String DEVICE_SETUP_DEVICE_TYPE = "deviceType";
    public static final String DEVICE_SETUP_INFO = "deviceSetupInfo";
    public static final String DEVICE_SETUP_PROVISIONER_INFORMATION = "provisionerInformation";
    public static final String DEVICE_SETUP_PROVISIONING_METHOD = "provisioningMethod";
    public static final String DEVICE_SETUP_PROVISIONING_STATE = "provisioningState";
    public static final String DEVICE_SETUP_PROVISIONING_STATUS = "provisioningStatus";
    public static final String DISCOVERED_DEVICES = "discoveredDevices";
    public static final String ERROR = "error";
    public static final String ERROR_TYPE = "errorType";
    public static final String EVENT_AUTHENTICATED_DEVICES = "ffs::AutoDiscoveryAuthDevices";
    public static final String EVENT_AUTO_DISCOVERY_FAILURE = "ffs::AutoDiscoveryFailure";
    ...
    public static final String EVENT_PROVISIONING_EVENT_WORKFLOW_MESSAGE = "workflowMessage";
    public static final String EVENT_PROVISIONING_EVENT_WORKFLOW_STEP = "workflowStep";
    public static final String EVENT_RECENTLY_SETUP_DEVICES = "ffs::RecentlySetupDevices";
    ...
    public static final String EVENT_UNAUTHENTICATED_DEVICES = "ffs::AutoDiscoveryUnAuthDevices";
    ...
    public static final String PROVISIONABLE_DEVICE_DETAILS_HAS_LAST_CONNECTED_WIFI_DETAILS = "hasLastConnectionWifiDetails";
    public static final String PROVISIONABLE_DEVICE_DETAILS_LAST_CONNECTED_WIFI_DETAILS = "lastConnectionWifiDetails";
    public static final String PROVISIONABLE_DEVICE_DETAILS_MANUFACTURER = "manufacturer";
    public static final String PROVISIONABLE_DEVICE_DETAILS_STATE = "state";
    public static final String PROVISIONABLE_DEVICE_DETAILS_WIFI_KEY_MANAGEMENT = "wifiKeyManagement";

...
public final class AutoValue_ReportLocationsResponse extends C$AutoValue_ReportLocationsResponse {
    ...
    public AutoValue_ReportLocationsResponse(@Nullable final String str, @Nullable final String str2) {
        new ReportLocationsResponse(str, str2) { // from class: com.amazon.alexa.drive.navigation.location.$AutoValue_ReportLocationsResponse
            private final String message;
            private final String type;

            /* JADX INFO: Access modifiers changed from: package-private */
            /* renamed from: com.amazon.alexa.drive.navigation.location.$AutoValue_ReportLocationsResponse$Builder */
            /* loaded from: classes7.dex */
            public static final class Builder extends ReportLocationsResponse.Builder {
                private String message;
                private String type;

                @Override // com.amazon.alexa.drive.navigation.location.ReportLocationsResponse.Builder
            ...
            /* JADX INFO: Access modifiers changed from: package-private */
            @Override // com.amazon.alexa.drive.navigation.location.ReportLocationsResponse
            @Nullable

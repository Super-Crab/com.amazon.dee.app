...
public final class AutoValue_ReportLocationsRequest extends C$AutoValue_ReportLocationsRequest {
    ...
    public AutoValue_ReportLocationsRequest(final List<TrackableDevicesLocation> list) {
        new ReportLocationsRequest(list) { // from class: com.amazon.alexa.drive.navigation.location.$AutoValue_ReportLocationsRequest
            ...
            @Override // com.amazon.alexa.drive.navigation.location.ReportLocationsRequest

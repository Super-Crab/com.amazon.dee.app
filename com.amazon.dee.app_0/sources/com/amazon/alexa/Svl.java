...
/* compiled from: AutoValue_ApiCallEvent_Text_RegisterTextResponseListenerEvent.java */
/* loaded from: classes.dex */
public final class Svl extends Kkr {
    ...
    public Svl(eOP eop, ExtendedClient extendedClient, ApiCallback apiCallback, AlexaTextResponseListener alexaTextResponseListener) {
        if (eop != null) {
            this.BIo = eop;
    ...
    public boolean equals(Object obj) {
        ...
        Svl svl = (Svl) obj;
        return this.BIo.equals(svl.BIo) && this.zQM.equals(svl.zQM) && this.zyO.equals(svl.zyO) && this.jiA.equals(svl.jiA);
    }
    ...
    public String toString() {
        StringBuilder zZm = C0179Pya.zZm("RegisterTextResponseListenerEvent{apiCallMetadata=");
        zZm.append(this.BIo);
        zZm.append(", client=");
        zZm.append(this.zQM);

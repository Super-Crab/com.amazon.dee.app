...
public class AlertConfigurationApi {
    ...
    private CoralService.Request getAlertConfigurationsRequest(String str, String str2, Integer num) {
        StringBuilder sb = new StringBuilder("/api/biloba/v1/alertConfigurations");
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("?cachebreak=");
        outline107.append(System.currentTimeMillis());
        if (str != null) {
            if (outline107.length() == 0) {
                outline107.append(WebConstants.UriConstants.QUESTIONMARK_KEY);
            } else {
            ...
            outline107.append(StringUtil.parameterToString(str));
        }
        if (str2 != null) {
            if (outline107.length() == 0) {
                outline107.append(WebConstants.UriConstants.QUESTIONMARK_KEY);
            ...
            outline107.append(Config.Compare.EQUAL_TO);
            outline107.append(StringUtil.parameterToString(str2));
        }
        if (num != null) {
            if (outline107.length() == 0) {
                outline107.append(WebConstants.UriConstants.QUESTIONMARK_KEY);
            ...
            outline107.append(Config.Compare.EQUAL_TO);
            outline107.append(StringUtil.parameterToString(num));
        }
        sb.append((CharSequence) outline107);
        return this.coralService.request(sb.toString()).withHeader("X-Amzn-OperatorId", this.personIdProvider.getPersonId());
    }

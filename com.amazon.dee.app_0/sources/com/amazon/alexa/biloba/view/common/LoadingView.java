...
public class LoadingView extends View {
    ...
    public LoadingView(Context context) {
        super(context);
        this.animationRunnable = new Runnable() { // from class: com.amazon.alexa.biloba.view.common.LoadingView.1
            ...
            public void run() {
                ...
                if (LoadingView.access$008(LoadingView.this) == 48) {
                    LoadingView.this.resetSteps();
                }
                LoadingView.this.invalidate();
                LoadingView.this.handler.postDelayed(this, LoadingView.this.animationDuration);
            }
        };
        this.startRadius = 12;
        this.endRadius = 24;
    ...
    static /* synthetic */ int access$008(LoadingView loadingView) {
        int i = loadingView.currentStep;
        loadingView.currentStep = i + 1;
        return i;
    }
    ...
    public LoadingView(Context context, AttributeSet attributeSet) {
        ...
        this.fillColor = obtainStyledAttributes.getColorStateList(R.styleable.LoadingView_fillColor);
        this.startRadius = obtainStyledAttributes.getDimensionPixelSize(R.styleable.LoadingView_minRadius, 12);
        this.endRadius = obtainStyledAttributes.getDimensionPixelSize(R.styleable.LoadingView_maxRadius, 24);
        this.animationDuration = obtainStyledAttributes.getInt(R.styleable.LoadingView_animDuration, 30);
        this.dotPadding = obtainStyledAttributes.getDimensionPixelSize(R.styleable.LoadingView_dotPadding, 30);
        init();

...
public class RecentActivityViewControllerFactory implements ViewControllerFactory<ViewController> {
    private static final String TAG = "RecentActivityViewControllerFactory";
    ...
    public ViewController mo1459createView(@NonNull Context context, @NonNull RouteContext routeContext, @NonNull ViewManagerEventNotifier viewManagerEventNotifier) {
        ...
        LogUtils.d(TAG, "creating BilobaActivitiesView");
        BilobaActivitiesView bilobaActivitiesView = new BilobaActivitiesView(context, (Bundle) routeContext.get(RouteArgumentKeys.BUNDLE));
        viewManagerEventNotifier.onLoadingComplete();
        return bilobaActivitiesView;
    }
}

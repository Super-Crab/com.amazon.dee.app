...
public class TipsPageBindingImpl extends TipsPageBinding implements OnClickListener.Listener {
    @Nullable
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tips_page, 4);
    }

    public TipsPageBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    protected void executeBindings() {
        ...
        if (i4 != 0) {
            ...
            if (i6 != 0) {
                liveData = tipsViewModel != null ? tipsViewModel.getError() : null;
            ...
            LiveData<Boolean> isLoading = tipsViewModel != null ? tipsViewModel.getIsLoading() : null;
        ...
        if ((j & PlaybackStateCompat.ACTION_PLAY_FROM_URI) != 0) {
            if (tipsViewModel != null) {
                liveData = tipsViewModel.getError();
            }
            updateLiveDataRegistration(0, liveData);
            if (liveData != null) {
        ...
        String errorViewMetricName = ((j & 512) == 0 || tipsViewModel == null) ? null : tipsViewModel.getErrorViewMetricName();
        ...
        if (i8 != 0) {
            ...
            this.tipsPageContainer.setVisibility(i);
        }
        if ((14 & j) != 0) {
            ViewBindingAdapter.setOnClick(this.errorView, this.mCallback10, z2);
        }
        if ((j & 15) != 0) {
    ...
    @Override // com.amazon.alexa.biloba.databinding.TipsPageBinding
    public void setViewmodel(@Nullable TipsViewModel tipsViewModel) {
    ...
    private TipsPageBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (ErrorView) objArr[2], (View) objArr[3], (RecyclerView) objArr[4], (LinearLayout) objArr[1]);
        this.mDirtyFlags = -1L;
        this.errorView.setTag(null);
        this.mboundView0 = (FrameLayout) objArr[0];
        this.mboundView0.setTag(null);
        this.tipsPageContainer.setTag(null);
        setRootTag(view);

...
public final class Configuration_ProvideAlertConfigurationApiFactory implements Factory<AlertConfigurationApi> {
    ...
    public Configuration_ProvideAlertConfigurationApiFactory(Provider<CoralService> provider, Provider<PersonIdProvider> provider2, Provider<SchedulerProvider> provider3) {
        this.coralServiceProvider = provider;
        this.personIdProvider = provider2;
        this.schedulerProvider = provider3;
    }

    public static Configuration_ProvideAlertConfigurationApiFactory create(Provider<CoralService> provider, Provider<PersonIdProvider> provider2, Provider<SchedulerProvider> provider3) {
        return new Configuration_ProvideAlertConfigurationApiFactory(provider, provider2, provider3);
    }
    ...
    public static AlertConfigurationApi proxyProvideAlertConfigurationApi(CoralService coralService, PersonIdProvider personIdProvider, SchedulerProvider schedulerProvider) {
        return (AlertConfigurationApi) Preconditions.checkNotNull(Configuration.provideAlertConfigurationApi(coralService, personIdProvider, schedulerProvider), "Cannot return null from a non-@Nullable @Provides method");
    }

...
public class DevicesApi {
    public static final String TAG = "DevicesApi";
    ...
    private CoralService.Request getDevicesRequest(String str, List<String> list) {
        StringBuilder sb = new StringBuilder("/api/biloba/v1/devices");
    ...
    public Observable<DevicesResponse> getDevicesObservable(String str, List<String> list) {
        return getDevicesRequest(str, list).get().as(DevicesResponse.class).toObservable().observeOn(this.schedulerProvider.ui()).subscribeOn(this.schedulerProvider.io());
    }
    ...
    public DevicesApi(CoralService coralService, PersonIdProvider personIdProvider, SchedulerProvider schedulerProvider) {
        this.coralService = coralService;
        this.personIdProvider = personIdProvider;
        this.schedulerProvider = schedulerProvider;
    }

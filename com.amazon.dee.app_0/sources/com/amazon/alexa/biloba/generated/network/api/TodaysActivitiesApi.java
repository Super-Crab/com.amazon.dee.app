...
public class TodaysActivitiesApi {
    public static final String TAG = "TodaysActivitiesApi";
    CoralService coralService;
    PersonIdProvider personIdProvider;
    SchedulerProvider schedulerProvider;

    public TodaysActivitiesApi() {
    }

    private CoralService.Request getTodaysActivitiesRequest(String str) {
        StringBuilder sb = new StringBuilder("/api/biloba/v1/todaysActivities");
    ...
    public Observable<TodaysActivitiesResponse> getTodaysActivitiesObservable(String str) {
        return getTodaysActivitiesRequest(str).get().as(TodaysActivitiesResponse.class).toObservable().observeOn(this.schedulerProvider.ui()).subscribeOn(this.schedulerProvider.io());
    }
    ...
    public TodaysActivitiesApi(CoralService coralService, PersonIdProvider personIdProvider, SchedulerProvider schedulerProvider) {
        this.coralService = coralService;
        this.personIdProvider = personIdProvider;
        this.schedulerProvider = schedulerProvider;
    }

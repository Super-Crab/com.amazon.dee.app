...
/* compiled from: AutoValue_ProcessMessageEvent.java */
/* loaded from: classes.dex */
public final class Cuq extends wVP {
    public final Message BIo;
    public final MessageProcessingCallbacks zQM;

    public Cuq(Message message, MessageProcessingCallbacks messageProcessingCallbacks) {
        if (message != null) {
            this.BIo = message;
    ...
    public boolean equals(Object obj) {
        ...
        Cuq cuq = (Cuq) obj;
        return this.BIo.equals(cuq.BIo) && this.zQM.equals(cuq.zQM);
    }
    ...
    public String toString() {
        StringBuilder zZm = C0179Pya.zZm("ProcessMessageEvent{message=");
        zZm.append(this.BIo);

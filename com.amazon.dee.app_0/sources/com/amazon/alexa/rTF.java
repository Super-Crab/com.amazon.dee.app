...
public final class rTF implements Factory<DavsClient> {
    public final Provider<NetworkManager> BIo;
    public final Provider<ArtifactManager> zQM;
    public final iPU zZm;

    public rTF(iPU ipu, Provider<NetworkManager> provider, Provider<ArtifactManager> provider2) {
        this.zZm = ipu;
        this.BIo = provider;
        this.zQM = provider2;
    }
    ...
    public Object mo10268get() {
        return (DavsClient) Preconditions.checkNotNull(this.zZm.zZm(this.BIo.mo10268get(), this.zQM.mo10268get()), "Cannot return null from a non-@Nullable @Provides method");
    }
}

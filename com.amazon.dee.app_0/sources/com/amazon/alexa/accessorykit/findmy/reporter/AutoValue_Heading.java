...
public final class AutoValue_Heading extends C$AutoValue_Heading {
    ...
    public AutoValue_Heading(final double d, final double d2) {
        new Heading(d, d2) { // from class: com.amazon.alexa.accessorykit.findmy.reporter.$AutoValue_Heading
            private final double accuracyInDegrees;
            private final double directionInDegrees;

            /* JADX INFO: Access modifiers changed from: package-private */
            /* renamed from: com.amazon.alexa.accessorykit.findmy.reporter.$AutoValue_Heading$Builder */
            /* loaded from: classes6.dex */
            public static final class Builder extends Heading.Builder {
                ...
                /* JADX INFO: Access modifiers changed from: package-private */
                @Override // com.amazon.alexa.accessorykit.findmy.reporter.Heading.Builder
            ...
            /* JADX INFO: Access modifiers changed from: package-private */
            @Override // com.amazon.alexa.accessorykit.findmy.reporter.Heading

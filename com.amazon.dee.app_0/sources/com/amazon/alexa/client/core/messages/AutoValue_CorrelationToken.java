...
public final class AutoValue_CorrelationToken extends C$AutoValue_CorrelationToken {
    ...
    public static final class GsonTypeAdapter extends TypeAdapter<CorrelationToken> {
        ...
        public GsonTypeAdapter(Gson gson) {
            ...
            this.gson = gson;
            this.realFieldNames = Util.renameFields(C$AutoValue_CorrelationToken.class, outline126, gson.fieldNamingStrategy());
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // com.google.gson.TypeAdapter
        /* renamed from: read */
        public CorrelationToken mo8353read(JsonReader jsonReader) throws IOException {
            String str = null;
    ...
    public AutoValue_CorrelationToken(final String str) {
        new CorrelationToken(str) { // from class: com.amazon.alexa.client.core.messages.$AutoValue_CorrelationToken
            ...
            public String toString() {
                return GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("CorrelationToken{value="), this.value, EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE);
            }
        };
    }
}

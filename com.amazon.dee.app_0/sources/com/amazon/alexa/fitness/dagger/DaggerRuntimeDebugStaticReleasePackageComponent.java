...
public final class DaggerRuntimeDebugStaticReleasePackageComponent implements RuntimeDebugStaticReleasePackageComponent {
    ...
    private final class AFCAS_SubComponentImpl implements AlexaFitnessCapabilityAgentService.SubComponent {
        ...
        public AlexaFitnessContextManager alexaFitnessContextManager() {
            return (AlexaFitnessContextManager) DaggerRuntimeDebugStaticReleasePackageComponent.this.alexaFitnessContextManagerImplProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public AlexaFitnessContextsProvider alexaFitnessContextsProvider() {
            return (AlexaFitnessContextsProvider) DaggerRuntimeDebugStaticReleasePackageComponent.this.alexaFitnessContextsProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public AlexaFitnessCapabilityAgentServiceConfigurationProvider configurationProvider() {
            return DaggerRuntimeDebugStaticReleasePackageComponent.this.getLocalResourcesConfigurationProvider();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public FeatureService featureService() {
            return (FeatureService) DaggerRuntimeDebugStaticReleasePackageComponent.this.featureServiceImplProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public FitnessSessionEventEmitter fitnessSessionEventEmitter() {
            return (FitnessSessionEventEmitter) DaggerRuntimeDebugStaticReleasePackageComponent.this.providerFitnessSessionEventEmitterProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public FitnessSessionOrchestrator fitnessSessionOrchestrator() {
            return (FitnessSessionOrchestrator) DaggerRuntimeDebugStaticReleasePackageComponent.this.provideFitnessSessionOrchestratorProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public FitnessSessionStateService fitnessSessionStateManager() {
            return (FitnessSessionStateService) DaggerRuntimeDebugStaticReleasePackageComponent.this.fitnessSessionStateServiceImplProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public ILog iLog() {
            return (ILog) DaggerRuntimeDebugStaticReleasePackageComponent.this.provideILogProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public IdentityManager identityManager() {
            return (IdentityManager) DaggerRuntimeDebugStaticReleasePackageComponent.this.identityManagerImplProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public InstrumentedAlexaServicesConnection instrumentedAlexaServicesConnection() {
            return (InstrumentedAlexaServicesConnection) DaggerRuntimeDebugStaticReleasePackageComponent.this.instrumentedAlexaServicesConnectionImplProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public MetricEventFactory metricEventFactory() {
            return (MetricEventFactory) DaggerRuntimeDebugStaticReleasePackageComponent.this.defaultMetricEventFactoryProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public MetricEventRecorder metricEventRecorder() {
            return (MetricEventRecorder) DaggerRuntimeDebugStaticReleasePackageComponent.this.defaultMetricEventRecorderProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public RoutingService routingService() {
            return (RoutingService) DaggerRuntimeDebugStaticReleasePackageComponent.this.provideRoutingServiceProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public SpeechletEventEmitter speechletEventEmitter() {
            return (SpeechletEventEmitter) DaggerRuntimeDebugStaticReleasePackageComponent.this.speechletEventEmitterImplProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessCapabilityAgentService.SubComponent
        public UserProfileRepository userProfileRepository() {
            return (UserProfileRepository) DaggerRuntimeDebugStaticReleasePackageComponent.this.userProfileCacheImplProvider.mo10268get();
        }
    ...
    private final class AFMI_SubComponentImpl implements AlexaFitnessManagerImpl.SubComponent {
        ...
        public AfitsClient afitsClient() {
            return (AfitsClient) DaggerRuntimeDebugStaticReleasePackageComponent.this.provideAfitsClientProvider.mo10268get();
        }
        ...
        public HdsRetryHandler hdsRetryHandler() {
            return (HdsRetryHandler) DaggerRuntimeDebugStaticReleasePackageComponent.this.hdsRetryHandlerImplProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessManagerImpl.SubComponent
        public HomeCardDataProvider homeCardDataProvider() {
            return (HomeCardDataProvider) DaggerRuntimeDebugStaticReleasePackageComponent.this.homeCardDataProvider.mo10268get();
        }
        ...
        public RoutingRegistry routingRegistry() {
            return (RoutingRegistry) DaggerRuntimeDebugStaticReleasePackageComponent.this.provideRoutingRegistryProvider.mo10268get();
        }
        ...
        public UserPreferenceStore userPreferenceStore() {
            return (UserPreferenceStore) DaggerRuntimeDebugStaticReleasePackageComponent.this.userPreferenceStoreImplProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessManagerImpl.SubComponent
        public UserProfileService userProfileService() {
            return (UserProfileService) DaggerRuntimeDebugStaticReleasePackageComponent.this.userProfileServiceImplProvider.mo10268get();
        }

        @Override // com.amazon.alexa.fitness.service.AlexaFitnessManagerImpl.SubComponent
        public WorkoutSessionDeleteHandler workoutSessionDeleteHandler() {
            return new WorkoutSessionDeleteHandler((SessionSummaryCache) DaggerRuntimeDebugStaticReleasePackageComponent.this.sessionSummaryCacheImplProvider.mo10268get(), (SampleStore) DaggerRuntimeDebugStaticReleasePackageComponent.this.sampleStoreImplProvider.mo10268get(), (ILog) DaggerRuntimeDebugStaticReleasePackageComponent.this.provideILogProvider.mo10268get());
        }
    ...
    public static final class Builder {
        ...
        public RuntimeDebugStaticReleasePackageComponent build() {
            Preconditions.checkBuilderRequirement(this.runtimeDebugStaticReleasePackageModule, RuntimeDebugStaticReleasePackageModule.class);
    ...
    private final class FS_SubComponentImpl implements FitnessSdk.SubComponent {
        ...
        public SessionManager sessionManager() {
            return (SessionManager) DaggerRuntimeDebugStaticReleasePackageComponent.this.provideSessionManagerProvider.mo10268get();
        }
    ...
    private void initialize(Builder builder) {
        this.provideApplicationContextProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideApplicationContextFactory.create(builder.runtimeDebugStaticReleasePackageModule));
        ...
        this.provideComponentRegistryProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideComponentRegistryFactory.create(builder.runtimeDebugStaticReleasePackageModule));
        this.provideMobilyticsProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideMobilyticsFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideComponentRegistryProvider));
        ...
        this.provideMetricsAggregatorProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideMetricsAggregatorFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideMobilyticsProvider, this.metricsAggregatorCacheImplProvider));
        this.provideMetricsServiceV2Provider = DoubleCheck.provider(StaticReleasePackageModule_ProvideMetricsServiceV2Factory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideComponentRegistryProvider));
        ...
        this.provideAfxMessageProcessorProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideAfxMessageProcessorFactory.create(builder.runtimeDebugStaticReleasePackageModule));
        ...
        this.provideEventBusProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideEventBusFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideComponentRegistryProvider));
        this.provideIdentityServiceProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideIdentityServiceFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideComponentRegistryProvider));
        ...
        this.provideFeatureServiceV2Provider = DoubleCheck.provider(StaticReleasePackageModule_ProvideFeatureServiceV2Factory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideComponentRegistryProvider));
        ...
        this.provideFitnessDatabaseProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideFitnessDatabaseFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideApplicationContextProvider));
        ...
        RuntimeDebugStaticReleasePackageModule runtimeDebugStaticReleasePackageModule = builder.runtimeDebugStaticReleasePackageModule;
        ...
        this.provideTimeoutHandlerProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideTimeoutHandlerFactory.create(runtimeDebugStaticReleasePackageModule, localResourcesConfigurationProvider_Factory, localResourcesConfigurationProvider_Factory, this.defaultMetricEventFactoryProvider, this.defaultMetricEventRecorderProvider, this.provideILogProvider));
        ...
        this.provideSessionManagerProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideSessionManagerFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideAfxMessageProcessorProvider, this.provideMetricsAggregatorProvider, this.metricsAggregatorRecoveryImplProvider, this.fitnessAlgorithmsManagerImplProvider, this.sessionRecoveryManagerImplProvider, this.provideILogProvider, this.sampleStoreImplProvider, this.provideTimeoutHandlerProvider, this.userPreferenceStoreImplProvider));
        this.provideAccessoriesProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideAccessoriesFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideApplicationContextProvider));
        ...
        this.provideFusedLocationProviderClientProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideFusedLocationProviderClientFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideApplicationContextProvider));
        this.provideLocationServiceConfigurationProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideLocationServiceConfigurationFactory.create(builder.runtimeDebugStaticReleasePackageModule));
        ...
        this.provideStepToDistanceAlgorithmProvider = StaticReleasePackageModule_ProvideStepToDistanceAlgorithmFactory.create(builder.runtimeDebugStaticReleasePackageModule);
        ...
        this.providesCaloriesAlgorithmV2Provider = StaticReleasePackageModule_ProvidesCaloriesAlgorithmV2Factory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideILogProvider);
        ...
        this.provideRoutingServiceProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideRoutingServiceFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideComponentRegistryProvider));
        ...
        this.providerFitnessSessionEventEmitterProvider = DoubleCheck.provider(StaticReleasePackageModule_ProviderFitnessSessionEventEmitterFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.speechletEventEmitterImplProvider));
        this.provideNetworkServiceProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideNetworkServiceFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideComponentRegistryProvider));
        ...
        this.provideHomeCardViewModelProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideHomeCardViewModelFactory.create(builder.runtimeDebugStaticReleasePackageModule));
        ...
        this.provideRoutingRegistryProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideRoutingRegistryFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideComponentRegistryProvider));
        ...
        this.provideHttpCoralServiceProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideHttpCoralServiceFactory.create(builder.runtimeDebugStaticReleasePackageModule));
        this.provideCookieManagerProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideCookieManagerFactory.create(builder.runtimeDebugStaticReleasePackageModule));
        this.provideAfitsHeaderUtilProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideAfitsHeaderUtilFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideEnvironmentServiceProvider, this.provideCookieManagerProvider, this.identityManagerImplProvider));
        this.provideAfitsClientProvider = DoubleCheck.provider(StaticReleasePackageModule_ProvideAfitsClientFactory.create(builder.runtimeDebugStaticReleasePackageModule, this.provideComponentRegistryProvider, this.provideMetricsServiceV2Provider, this.provideHttpCoralServiceProvider, this.provideAfitsHeaderUtilProvider));
    }

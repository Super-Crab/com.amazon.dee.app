...
public final class MetricWithCalories {
    ...
    public MetricWithCalories(@NotNull Steps steps, @NotNull Cadence cadence, @NotNull Distance distanceInFeet, @NotNull Speed speedInMph, @NotNull String activityType, @NotNull Duration durationInSecs, @NotNull Calories calories) {
    ...
    public static /* synthetic */ MetricWithCalories copy$default(MetricWithCalories metricWithCalories, Steps steps, Cadence cadence, Distance distance, Speed speed, String str, Duration duration, Calories calories, int i, Object obj) {
        if ((i & 1) != 0) {
            steps = metricWithCalories.steps;
        }
        if ((i & 2) != 0) {
            cadence = metricWithCalories.cadence;
        }
        Cadence cadence2 = cadence;
        if ((i & 4) != 0) {
            distance = metricWithCalories.distanceInFeet;
        }
        Distance distance2 = distance;
        if ((i & 8) != 0) {
            speed = metricWithCalories.speedInMph;
        }
        Speed speed2 = speed;
        if ((i & 16) != 0) {
            str = metricWithCalories.activityType;
        }
        String str2 = str;
        if ((i & 32) != 0) {
            duration = metricWithCalories.durationInSecs;
        }
        Duration duration2 = duration;
        if ((i & 64) != 0) {
            calories = metricWithCalories.calories;
        }
        return metricWithCalories.copy(steps, cadence2, distance2, speed2, str2, duration2, calories);
    }
    ...
    @NotNull
    public final Calories component7() {
        return this.calories;
    }

    @NotNull
    public final MetricWithCalories copy(@NotNull Steps steps, @NotNull Cadence cadence, @NotNull Distance distanceInFeet, @NotNull Speed speedInMph, @NotNull String activityType, @NotNull Duration durationInSecs, @NotNull Calories calories) {
        Intrinsics.checkParameterIsNotNull(steps, "steps");
        Intrinsics.checkParameterIsNotNull(cadence, "cadence");
        Intrinsics.checkParameterIsNotNull(distanceInFeet, "distanceInFeet");
        Intrinsics.checkParameterIsNotNull(speedInMph, "speedInMph");
        ...
        Intrinsics.checkParameterIsNotNull(durationInSecs, "durationInSecs");
        Intrinsics.checkParameterIsNotNull(calories, "calories");
        return new MetricWithCalories(steps, cadence, distanceInFeet, speedInMph, activityType, durationInSecs, calories);
    }

    public boolean equals(@Nullable Object obj) {
        if (this != obj) {
            if (!(obj instanceof MetricWithCalories)) {
                return false;
            }
            MetricWithCalories metricWithCalories = (MetricWithCalories) obj;
            return Intrinsics.areEqual(this.steps, metricWithCalories.steps) && Intrinsics.areEqual(this.cadence, metricWithCalories.cadence) && Intrinsics.areEqual(this.distanceInFeet, metricWithCalories.distanceInFeet) && Intrinsics.areEqual(this.speedInMph, metricWithCalories.speedInMph) && Intrinsics.areEqual(this.activityType, metricWithCalories.activityType) && Intrinsics.areEqual(this.durationInSecs, metricWithCalories.durationInSecs) && Intrinsics.areEqual(this.calories, metricWithCalories.calories);
        }
        return true;
    }
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("MetricWithCalories(steps=");

...
public final class FitnessNotificationService$handleWorkoutButtonClick$1$1 extends Lambda implements Function2<FitnessSessionOrchestrator.CommandProcessingError, FitnessSessionState, Unit> {
    public static final FitnessNotificationService$handleWorkoutButtonClick$1$1 INSTANCE = new FitnessNotificationService$handleWorkoutButtonClick$1$1();

    FitnessNotificationService$handleWorkoutButtonClick$1$1() {
        super(2);
    }
    ...
    public final void invoke2(@Nullable FitnessSessionOrchestrator.CommandProcessingError commandProcessingError, @NotNull FitnessSessionState fitnessSessionState) {
        ...
        if (commandProcessingError != null) {
            Log.e("AFX-Notification", "error processing resume " + commandProcessingError);
        }
    }
}

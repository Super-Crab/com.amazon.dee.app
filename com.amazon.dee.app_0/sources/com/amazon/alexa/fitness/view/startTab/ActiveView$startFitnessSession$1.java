...
final class ActiveView$startFitnessSession$1 extends Lambda implements Function2<FitnessSessionOrchestrator.CommandProcessingError, FitnessSessionState, Unit> {
    public static final ActiveView$startFitnessSession$1 INSTANCE = new ActiveView$startFitnessSession$1();

    ActiveView$startFitnessSession$1() {
        super(2);
    }
    ...
    public final void invoke2(@Nullable FitnessSessionOrchestrator.CommandProcessingError commandProcessingError, @NotNull FitnessSessionState currentState) {
        ...
        if (commandProcessingError != null) {
            Log.e("AFX-InProgressView", "error starting - " + commandProcessingError + ", currentState = " + currentState);

...
final class CustomStopButtonView$onDraw$1$1 extends Lambda implements Function2<FitnessSessionOrchestrator.CommandProcessingError, FitnessSessionState, Unit> {
    public static final CustomStopButtonView$onDraw$1$1 INSTANCE = new CustomStopButtonView$onDraw$1$1();

    CustomStopButtonView$onDraw$1$1() {
        super(2);
    }
    ...
    public final void invoke2(@Nullable FitnessSessionOrchestrator.CommandProcessingError commandProcessingError, @NotNull FitnessSessionState currentState) {
        ...
        if (commandProcessingError != null) {
            Log.e("AFX-CustomStopButtonView", "error stopping - " + commandProcessingError + ", currentState = " + currentState);
        }
    }
}

...
final class ActiveView$setupPauseButton$1$2 implements View.OnClickListener {
    public static final ActiveView$setupPauseButton$1$2 INSTANCE = new ActiveView$setupPauseButton$1$2();
    ...
    /* renamed from: com.amazon.alexa.fitness.view.startTab.ActiveView$setupPauseButton$1$2$1  reason: invalid class name */
    /* loaded from: classes8.dex */
    static final class AnonymousClass1 extends Lambda implements Function2<FitnessSessionOrchestrator.CommandProcessingError, FitnessSessionState, Unit> {
        ...
        public final void invoke2(@Nullable FitnessSessionOrchestrator.CommandProcessingError commandProcessingError, @NotNull FitnessSessionState currentState) {
            ...
            if (commandProcessingError != null) {
                Log.e("AFX-InProgressView", "error pausing - " + commandProcessingError + ", currentState = " + currentState);
            }
        }
    }

    ActiveView$setupPauseButton$1$2() {
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        view.performHapticFeedback(16);
        MetricHelperKt.recordUserInteractionEvent(FullScreenUtil.Companion.getMetricHelper(), ActivityViewMetrics.Companion.getPAUSE_BUTTON(), EventType.TAP);
        FullScreenUtil.Companion.getFitnessSessionOrchestrator().receive(new Command.Pause(SessionCommandSource.GUI), AnonymousClass1.INSTANCE);
    }
}

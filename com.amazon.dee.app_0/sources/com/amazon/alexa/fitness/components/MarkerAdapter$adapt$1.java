...
final class MarkerAdapter$adapt$1 extends Lambda implements Function1<Location, Unit> {
    final /* synthetic */ MarkerAdapter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MarkerAdapter$adapt$1(MarkerAdapter markerAdapter) {
        super(1);
    ...
    public final void invoke2(@Nullable Location location) {
        if (location != null) {
            this.this$0.addMarker(new GeoCoordinates(location.getLatitude(), location.getLongitude()));
        }
    }
}

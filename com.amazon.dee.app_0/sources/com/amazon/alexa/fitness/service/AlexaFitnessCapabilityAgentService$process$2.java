...
final class AlexaFitnessCapabilityAgentService$process$2 extends Lambda implements Function2<FitnessSessionOrchestrator.CommandProcessingError, FitnessSessionState, Unit> {
    final /* synthetic */ Command.Stop $command;
    ...
    public AlexaFitnessCapabilityAgentService$process$2(AlexaFitnessCapabilityAgentService alexaFitnessCapabilityAgentService, DirectiveSession directiveSession, Command.Stop stop) {
        super(2);

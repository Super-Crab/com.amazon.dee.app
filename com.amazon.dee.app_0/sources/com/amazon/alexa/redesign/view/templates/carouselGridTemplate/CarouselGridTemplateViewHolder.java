...
public class CarouselGridTemplateViewHolder extends BaseCardViewHolder<CarouselGridTemplateViewItem> {
    @VisibleForTesting
    final AnimationPlayer animationPlayer;
    @VisibleForTesting
    CarouselView carouselView;

    public CarouselGridTemplateViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup, Context context, @NonNull HomeMetricsRecorder homeMetricsRecorder, @NonNull ViewTypeFactory viewTypeFactory, @NonNull HomeContract.Presenter presenter, AnimationPlayer animationPlayer) {
        super(layoutInflater, viewGroup, layoutInflater.inflate(R.layout.amahc_template_grid_carousel, viewGroup, false), viewTypeFactory, homeMetricsRecorder, presenter, new int[]{R.id.slot0, R.id.slot1}, context);
    ...
    @Override // com.amazon.alexa.redesign.view.homeFeed.BaseCardViewHolder
    public void bind(CarouselGridTemplateViewItem carouselGridTemplateViewItem, int i, boolean z) {
        super.bind((CarouselGridTemplateViewHolder) carouselGridTemplateViewItem, i, z);
        CarouselGridTemplateModel mo2390getModel = carouselGridTemplateViewItem.mo2390getModel();

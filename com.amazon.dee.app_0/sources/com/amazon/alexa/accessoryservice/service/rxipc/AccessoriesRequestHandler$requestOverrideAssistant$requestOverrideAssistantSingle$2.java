...
final class AccessoriesRequestHandler$requestOverrideAssistant$requestOverrideAssistantSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$requestOverrideAssistant$requestOverrideAssistantSingle$2 INSTANCE = new AccessoriesRequestHandler$requestOverrideAssistant$requestOverrideAssistantSingle$2();

    AccessoriesRequestHandler$requestOverrideAssistant$requestOverrideAssistantSingle$2() {
    }

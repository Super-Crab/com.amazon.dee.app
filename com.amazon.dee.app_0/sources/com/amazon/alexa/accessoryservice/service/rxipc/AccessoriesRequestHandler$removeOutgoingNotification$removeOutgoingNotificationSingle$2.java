...
final class AccessoriesRequestHandler$removeOutgoingNotification$removeOutgoingNotificationSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$removeOutgoingNotification$removeOutgoingNotificationSingle$2 INSTANCE = new AccessoriesRequestHandler$removeOutgoingNotification$removeOutgoingNotificationSingle$2();

    AccessoriesRequestHandler$removeOutgoingNotification$removeOutgoingNotificationSingle$2() {
    }

...
final class AccessoriesRequestHandler$observeSessionCreated$observeSessionCreatedObservable$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$observeSessionCreated$observeSessionCreatedObservable$2 INSTANCE = new AccessoriesRequestHandler$observeSessionCreated$observeSessionCreatedObservable$2();

    AccessoriesRequestHandler$observeSessionCreated$observeSessionCreatedObservable$2() {
    }

...
final class AccessoriesRequestHandler$requestUpdateDeviceInformation$requestUpdateDeviceInformationSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$requestUpdateDeviceInformation$requestUpdateDeviceInformationSingle$2 INSTANCE = new AccessoriesRequestHandler$requestUpdateDeviceInformation$requestUpdateDeviceInformationSingle$2();

    AccessoriesRequestHandler$requestUpdateDeviceInformation$requestUpdateDeviceInformationSingle$2() {
    }

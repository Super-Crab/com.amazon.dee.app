...
final class AccessoriesRequestHandler$observeSessionDisconnected$observeSessionDisconnectedObservable$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$observeSessionDisconnected$observeSessionDisconnectedObservable$2 INSTANCE = new AccessoriesRequestHandler$observeSessionDisconnected$observeSessionDisconnectedObservable$2();

    AccessoriesRequestHandler$observeSessionDisconnected$observeSessionDisconnectedObservable$2() {
    }

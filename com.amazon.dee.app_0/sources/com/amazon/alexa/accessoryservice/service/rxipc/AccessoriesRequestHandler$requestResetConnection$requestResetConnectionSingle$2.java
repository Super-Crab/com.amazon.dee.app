...
final class AccessoriesRequestHandler$requestResetConnection$requestResetConnectionSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$requestResetConnection$requestResetConnectionSingle$2 INSTANCE = new AccessoriesRequestHandler$requestResetConnection$requestResetConnectionSingle$2();

    AccessoriesRequestHandler$requestResetConnection$requestResetConnectionSingle$2() {
    }

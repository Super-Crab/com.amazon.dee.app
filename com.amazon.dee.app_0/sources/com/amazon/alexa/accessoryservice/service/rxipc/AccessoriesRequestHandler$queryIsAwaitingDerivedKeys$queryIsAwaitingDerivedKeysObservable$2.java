...
final class AccessoriesRequestHandler$queryIsAwaitingDerivedKeys$queryIsAwaitingDerivedKeysObservable$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$queryIsAwaitingDerivedKeys$queryIsAwaitingDerivedKeysObservable$2 INSTANCE = new AccessoriesRequestHandler$queryIsAwaitingDerivedKeys$queryIsAwaitingDerivedKeysObservable$2();

    AccessoriesRequestHandler$queryIsAwaitingDerivedKeys$queryIsAwaitingDerivedKeysObservable$2() {
    }

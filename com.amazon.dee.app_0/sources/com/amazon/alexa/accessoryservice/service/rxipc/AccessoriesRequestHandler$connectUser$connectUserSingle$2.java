...
final class AccessoriesRequestHandler$connectUser$connectUserSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$connectUser$connectUserSingle$2 INSTANCE = new AccessoriesRequestHandler$connectUser$connectUserSingle$2();

    AccessoriesRequestHandler$connectUser$connectUserSingle$2() {
    }

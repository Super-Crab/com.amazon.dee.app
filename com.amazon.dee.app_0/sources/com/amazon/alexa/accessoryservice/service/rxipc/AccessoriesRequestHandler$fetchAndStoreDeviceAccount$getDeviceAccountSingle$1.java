...
final class AccessoriesRequestHandler$fetchAndStoreDeviceAccount$getDeviceAccountSingle$1<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$fetchAndStoreDeviceAccount$getDeviceAccountSingle$1 INSTANCE = new AccessoriesRequestHandler$fetchAndStoreDeviceAccount$getDeviceAccountSingle$1();

    AccessoriesRequestHandler$fetchAndStoreDeviceAccount$getDeviceAccountSingle$1() {
    }

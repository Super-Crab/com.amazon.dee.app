...
final class AccessoriesRequestHandler$getDeviceIdentifier$getDeviceIdentifierSingle$1<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$getDeviceIdentifier$getDeviceIdentifierSingle$1 INSTANCE = new AccessoriesRequestHandler$getDeviceIdentifier$getDeviceIdentifierSingle$1();

    AccessoriesRequestHandler$getDeviceIdentifier$getDeviceIdentifierSingle$1() {
    }

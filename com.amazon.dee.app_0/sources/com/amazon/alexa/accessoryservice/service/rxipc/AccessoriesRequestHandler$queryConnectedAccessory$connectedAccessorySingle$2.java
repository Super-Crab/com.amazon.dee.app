...
final class AccessoriesRequestHandler$queryConnectedAccessory$connectedAccessorySingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$queryConnectedAccessory$connectedAccessorySingle$2 INSTANCE = new AccessoriesRequestHandler$queryConnectedAccessory$connectedAccessorySingle$2();

    AccessoriesRequestHandler$queryConnectedAccessory$connectedAccessorySingle$2() {
    }

...
final class AccessoriesRequestHandler$observeSessionConnected$observeSessionConnectedObservable$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$observeSessionConnected$observeSessionConnectedObservable$2 INSTANCE = new AccessoriesRequestHandler$observeSessionConnected$observeSessionConnectedObservable$2();

    AccessoriesRequestHandler$observeSessionConnected$observeSessionConnectedObservable$2() {
    }

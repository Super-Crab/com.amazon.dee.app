...
final class AccessoriesRequestHandler$observeSessionReleased$observeSessionReleasedObservable$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$observeSessionReleased$observeSessionReleasedObservable$2 INSTANCE = new AccessoriesRequestHandler$observeSessionReleased$observeSessionReleasedObservable$2();

    AccessoriesRequestHandler$observeSessionReleased$observeSessionReleasedObservable$2() {
    }

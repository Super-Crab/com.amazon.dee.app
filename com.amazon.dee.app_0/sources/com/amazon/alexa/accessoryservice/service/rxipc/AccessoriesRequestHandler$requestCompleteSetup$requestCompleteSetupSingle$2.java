...
final class AccessoriesRequestHandler$requestCompleteSetup$requestCompleteSetupSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$requestCompleteSetup$requestCompleteSetupSingle$2 INSTANCE = new AccessoriesRequestHandler$requestCompleteSetup$requestCompleteSetupSingle$2();

    AccessoriesRequestHandler$requestCompleteSetup$requestCompleteSetupSingle$2() {
    }

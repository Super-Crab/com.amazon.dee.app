...
final class AccessoriesRequestHandler$updateOutgoingNotification$updateOutgoingNotificationSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$updateOutgoingNotification$updateOutgoingNotificationSingle$2 INSTANCE = new AccessoriesRequestHandler$updateOutgoingNotification$updateOutgoingNotificationSingle$2();

    AccessoriesRequestHandler$updateOutgoingNotification$updateOutgoingNotificationSingle$2() {
    }

...
final class AccessoriesRequestHandler$requestStartSetup$requestStartSetupSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$requestStartSetup$requestStartSetupSingle$2 INSTANCE = new AccessoriesRequestHandler$requestStartSetup$requestStartSetupSingle$2();

    AccessoriesRequestHandler$requestStartSetup$requestStartSetupSingle$2() {
    }

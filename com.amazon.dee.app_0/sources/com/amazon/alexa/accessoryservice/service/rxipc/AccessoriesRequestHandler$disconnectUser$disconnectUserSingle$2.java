...
final class AccessoriesRequestHandler$disconnectUser$disconnectUserSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$disconnectUser$disconnectUserSingle$2 INSTANCE = new AccessoriesRequestHandler$disconnectUser$disconnectUserSingle$2();

    AccessoriesRequestHandler$disconnectUser$disconnectUserSingle$2() {
    }

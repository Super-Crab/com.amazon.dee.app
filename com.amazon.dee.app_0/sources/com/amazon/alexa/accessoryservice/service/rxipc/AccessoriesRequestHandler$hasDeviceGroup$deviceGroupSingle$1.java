...
final class AccessoriesRequestHandler$hasDeviceGroup$deviceGroupSingle$1<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$hasDeviceGroup$deviceGroupSingle$1 INSTANCE = new AccessoriesRequestHandler$hasDeviceGroup$deviceGroupSingle$1();

    AccessoriesRequestHandler$hasDeviceGroup$deviceGroupSingle$1() {
    }

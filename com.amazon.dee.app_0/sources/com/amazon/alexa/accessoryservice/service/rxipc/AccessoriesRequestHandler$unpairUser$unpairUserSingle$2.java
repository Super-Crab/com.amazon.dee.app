...
final class AccessoriesRequestHandler$unpairUser$unpairUserSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$unpairUser$unpairUserSingle$2 INSTANCE = new AccessoriesRequestHandler$unpairUser$unpairUserSingle$2();

    AccessoriesRequestHandler$unpairUser$unpairUserSingle$2() {
    }

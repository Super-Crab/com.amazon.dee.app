...
final class AccessoriesRequestHandler$isCompanionDevice$isCompanionDeviceSingle$1<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$isCompanionDevice$isCompanionDeviceSingle$1 INSTANCE = new AccessoriesRequestHandler$isCompanionDevice$isCompanionDeviceSingle$1();

    AccessoriesRequestHandler$isCompanionDevice$isCompanionDeviceSingle$1() {
    }

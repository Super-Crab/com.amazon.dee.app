...
final class AccessoriesRequestHandler$updateCallInfo$updateCallStateSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$updateCallInfo$updateCallStateSingle$2 INSTANCE = new AccessoriesRequestHandler$updateCallInfo$updateCallStateSingle$2();

    AccessoriesRequestHandler$updateCallInfo$updateCallStateSingle$2() {
    }

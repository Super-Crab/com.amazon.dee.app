...
final class AccessoriesRequestHandler$forwardAtCommand$atCommandSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$forwardAtCommand$atCommandSingle$2 INSTANCE = new AccessoriesRequestHandler$forwardAtCommand$atCommandSingle$2();

    AccessoriesRequestHandler$forwardAtCommand$atCommandSingle$2() {
    }

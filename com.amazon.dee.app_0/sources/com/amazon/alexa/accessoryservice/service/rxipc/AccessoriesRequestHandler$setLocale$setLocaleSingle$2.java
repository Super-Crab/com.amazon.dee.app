...
final class AccessoriesRequestHandler$setLocale$setLocaleSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$setLocale$setLocaleSingle$2 INSTANCE = new AccessoriesRequestHandler$setLocale$setLocaleSingle$2();

    AccessoriesRequestHandler$setLocale$setLocaleSingle$2() {
    }

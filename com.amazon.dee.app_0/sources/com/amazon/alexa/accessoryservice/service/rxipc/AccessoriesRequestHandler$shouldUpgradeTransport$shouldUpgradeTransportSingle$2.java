...
final class AccessoriesRequestHandler$shouldUpgradeTransport$shouldUpgradeTransportSingle$2<T, R> implements Function<T, R> {
    public static final AccessoriesRequestHandler$shouldUpgradeTransport$shouldUpgradeTransportSingle$2 INSTANCE = new AccessoriesRequestHandler$shouldUpgradeTransport$shouldUpgradeTransportSingle$2();

    AccessoriesRequestHandler$shouldUpgradeTransport$shouldUpgradeTransportSingle$2() {
    }

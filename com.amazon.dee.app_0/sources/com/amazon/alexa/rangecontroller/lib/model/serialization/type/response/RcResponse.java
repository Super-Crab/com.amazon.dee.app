...
public final class RcResponse extends Response<NamespaceName, HeaderName, EmptyInstance, JsonElement> {
    protected RcResponse(Event<NamespaceName, HeaderName, EmptyInstance, JsonElement> event, Context context) {
        super(event, context);
    }
}

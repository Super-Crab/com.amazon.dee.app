...
public class TimeBasedNotifierService extends NotifierService {
    ...
    public static void enqueueWork(@NonNull Context context, @NonNull Intent intent) {
        JobIntentService.enqueueWork(context, TimeBasedNotifierService.class, (int) JOB_ID, intent);
    }

    @Override // androidx.core.app.JobIntentService
    protected void onHandleWork(@NonNull Intent intent) {
        onHandleWork(((FalcoProtocolComponent) AhfComponentsProvider.getComponent(this, FalcoProtocolComponent.class)).alexaAppSignInContractLazy(), new NotifierPriorityResolver(this, intent).getTimeBasedNotifier(), new NotificationScheduler(NotificationType.TIME_BASED, this, new TimeIntervalConfigHandler(this)));
    }

...
public class ShowOnLockscreenNotification extends NotificationView {
    private static final int NOTIFICATION_ID = 1003;

    public ShowOnLockscreenNotification(@NonNull String str) {
        this(str, new ShowOnLockscreenNotificationPresenter(), 1003);
    }
    ...
    @Inject
    @VisibleForTesting
    public ShowOnLockscreenNotification(@NonNull String str, @NonNull ShowOnLockscreenNotificationPresenter showOnLockscreenNotificationPresenter, int i) {
        super(str, showOnLockscreenNotificationPresenter, i);
    }
}

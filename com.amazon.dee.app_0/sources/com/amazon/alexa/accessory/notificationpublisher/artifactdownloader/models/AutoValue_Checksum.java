...
public final class AutoValue_Checksum extends C$AutoValue_Checksum {
    ...
    public AutoValue_Checksum(final String str) {
        new Checksum(str) { // from class: com.amazon.alexa.accessory.notificationpublisher.artifactdownloader.models.$AutoValue_Checksum
            ...
            @Override // com.amazon.alexa.accessory.notificationpublisher.artifactdownloader.models.Checksum

...
final class ClientCallingRepository$forwardAtCommand$1<T, R> implements Function<T, R> {
    public static final ClientCallingRepository$forwardAtCommand$1 INSTANCE = new ClientCallingRepository$forwardAtCommand$1();

    ClientCallingRepository$forwardAtCommand$1() {
    }

...
final class ClientCompanionDeviceModule$isCompanionDevice$1<T, R> implements Function<T, R> {
    public static final ClientCompanionDeviceModule$isCompanionDevice$1 INSTANCE = new ClientCompanionDeviceModule$isCompanionDevice$1();

    ClientCompanionDeviceModule$isCompanionDevice$1() {
    }

...
final class ClientCompanionDeviceModule$queryNewCompanionDevices$1<T, R> implements Function<T, R> {
    public static final ClientCompanionDeviceModule$queryNewCompanionDevices$1 INSTANCE = new ClientCompanionDeviceModule$queryNewCompanionDevices$1();

    ClientCompanionDeviceModule$queryNewCompanionDevices$1() {
    }

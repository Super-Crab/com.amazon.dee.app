...
final class ClientDeviceAccountSupplier$getDeviceAccount$1<T, R> implements Function<T, R> {
    public static final ClientDeviceAccountSupplier$getDeviceAccount$1 INSTANCE = new ClientDeviceAccountSupplier$getDeviceAccount$1();

    ClientDeviceAccountSupplier$getDeviceAccount$1() {
    }

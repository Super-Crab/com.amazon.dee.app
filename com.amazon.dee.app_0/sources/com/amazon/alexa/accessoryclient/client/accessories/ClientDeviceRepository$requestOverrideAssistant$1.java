...
final class ClientDeviceRepository$requestOverrideAssistant$1<T, R> implements Function<T, R> {
    public static final ClientDeviceRepository$requestOverrideAssistant$1 INSTANCE = new ClientDeviceRepository$requestOverrideAssistant$1();

    ClientDeviceRepository$requestOverrideAssistant$1() {
    }

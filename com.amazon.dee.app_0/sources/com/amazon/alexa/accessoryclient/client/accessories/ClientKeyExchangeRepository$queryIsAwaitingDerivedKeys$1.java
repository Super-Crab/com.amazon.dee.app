...
final class ClientKeyExchangeRepository$queryIsAwaitingDerivedKeys$1<T, R> implements Function<T, R> {
    public static final ClientKeyExchangeRepository$queryIsAwaitingDerivedKeys$1 INSTANCE = new ClientKeyExchangeRepository$queryIsAwaitingDerivedKeys$1();

    ClientKeyExchangeRepository$queryIsAwaitingDerivedKeys$1() {
    }

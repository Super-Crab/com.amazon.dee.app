...
final class ClientDeviceRepository$requestCompleteSetup$1<T, R> implements Function<T, R> {
    public static final ClientDeviceRepository$requestCompleteSetup$1 INSTANCE = new ClientDeviceRepository$requestCompleteSetup$1();

    ClientDeviceRepository$requestCompleteSetup$1() {
    }

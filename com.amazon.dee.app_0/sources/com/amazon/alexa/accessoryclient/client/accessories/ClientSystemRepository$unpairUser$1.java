...
final class ClientSystemRepository$unpairUser$1<T, R> implements Function<T, R> {
    public static final ClientSystemRepository$unpairUser$1 INSTANCE = new ClientSystemRepository$unpairUser$1();

    ClientSystemRepository$unpairUser$1() {
    }

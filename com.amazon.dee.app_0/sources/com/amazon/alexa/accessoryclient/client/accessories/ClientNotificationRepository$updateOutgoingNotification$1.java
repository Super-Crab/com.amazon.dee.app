...
final class ClientNotificationRepository$updateOutgoingNotification$1<T, R> implements Function<T, R> {
    public static final ClientNotificationRepository$updateOutgoingNotification$1 INSTANCE = new ClientNotificationRepository$updateOutgoingNotification$1();

    ClientNotificationRepository$updateOutgoingNotification$1() {
    }

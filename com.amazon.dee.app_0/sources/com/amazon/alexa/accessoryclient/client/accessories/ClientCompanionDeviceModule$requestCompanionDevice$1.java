...
final class ClientCompanionDeviceModule$requestCompanionDevice$1<T, R> implements Function<T, R> {
    public static final ClientCompanionDeviceModule$requestCompanionDevice$1 INSTANCE = new ClientCompanionDeviceModule$requestCompanionDevice$1();

    ClientCompanionDeviceModule$requestCompanionDevice$1() {
    }

...
final class ClientNonHfpCallingRepository$updateCallInfo$1<T, R> implements Function<T, R> {
    public static final ClientNonHfpCallingRepository$updateCallInfo$1 INSTANCE = new ClientNonHfpCallingRepository$updateCallInfo$1();

    ClientNonHfpCallingRepository$updateCallInfo$1() {
    }

...
final class ClientDeviceSupplier$hasDeviceGroup$1<T, R> implements Function<T, R> {
    public static final ClientDeviceSupplier$hasDeviceGroup$1 INSTANCE = new ClientDeviceSupplier$hasDeviceGroup$1();

    ClientDeviceSupplier$hasDeviceGroup$1() {
    }

...
final class ClientSystemRepository$disconnectUser$1<T, R> implements Function<T, R> {
    public static final ClientSystemRepository$disconnectUser$1 INSTANCE = new ClientSystemRepository$disconnectUser$1();

    ClientSystemRepository$disconnectUser$1() {
    }

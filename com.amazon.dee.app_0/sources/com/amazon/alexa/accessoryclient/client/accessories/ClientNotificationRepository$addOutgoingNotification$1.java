...
final class ClientNotificationRepository$addOutgoingNotification$1<T, R> implements Function<T, R> {
    public static final ClientNotificationRepository$addOutgoingNotification$1 INSTANCE = new ClientNotificationRepository$addOutgoingNotification$1();

    ClientNotificationRepository$addOutgoingNotification$1() {
    }

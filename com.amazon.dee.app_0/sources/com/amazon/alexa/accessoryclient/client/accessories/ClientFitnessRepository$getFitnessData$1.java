...
final class ClientFitnessRepository$getFitnessData$1<T, R> implements Function<T, R> {
    public static final ClientFitnessRepository$getFitnessData$1 INSTANCE = new ClientFitnessRepository$getFitnessData$1();

    ClientFitnessRepository$getFitnessData$1() {
    }

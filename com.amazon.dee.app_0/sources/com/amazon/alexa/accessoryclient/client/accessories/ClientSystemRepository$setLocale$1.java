...
final class ClientSystemRepository$setLocale$1<T, R> implements Function<T, R> {
    public static final ClientSystemRepository$setLocale$1 INSTANCE = new ClientSystemRepository$setLocale$1();

    ClientSystemRepository$setLocale$1() {
    }

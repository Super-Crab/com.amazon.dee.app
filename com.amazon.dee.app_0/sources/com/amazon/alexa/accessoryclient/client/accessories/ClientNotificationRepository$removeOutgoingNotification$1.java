...
final class ClientNotificationRepository$removeOutgoingNotification$1<T, R> implements Function<T, R> {
    public static final ClientNotificationRepository$removeOutgoingNotification$1 INSTANCE = new ClientNotificationRepository$removeOutgoingNotification$1();

    ClientNotificationRepository$removeOutgoingNotification$1() {
    }

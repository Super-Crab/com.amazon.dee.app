...
final class ClientDeviceRepository$requestUpdateDeviceInformation$1<T, R> implements Function<T, R> {
    public static final ClientDeviceRepository$requestUpdateDeviceInformation$1 INSTANCE = new ClientDeviceRepository$requestUpdateDeviceInformation$1();

    ClientDeviceRepository$requestUpdateDeviceInformation$1() {
    }

...
final class ClientSystemRepository$requestResetConnection$1<T, R> implements Function<T, R> {
    public static final ClientSystemRepository$requestResetConnection$1 INSTANCE = new ClientSystemRepository$requestResetConnection$1();

    ClientSystemRepository$requestResetConnection$1() {
    }

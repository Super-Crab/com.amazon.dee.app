...
final class ClientRegistrationSupplier$getDeviceRegistration$1<T, R> implements Function<T, R> {
    public static final ClientRegistrationSupplier$getDeviceRegistration$1 INSTANCE = new ClientRegistrationSupplier$getDeviceRegistration$1();

    ClientRegistrationSupplier$getDeviceRegistration$1() {
    }

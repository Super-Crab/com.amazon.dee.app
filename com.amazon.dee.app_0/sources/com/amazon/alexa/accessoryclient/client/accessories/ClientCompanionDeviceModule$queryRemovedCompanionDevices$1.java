...
final class ClientCompanionDeviceModule$queryRemovedCompanionDevices$1<T, R> implements Function<T, R> {
    public static final ClientCompanionDeviceModule$queryRemovedCompanionDevices$1 INSTANCE = new ClientCompanionDeviceModule$queryRemovedCompanionDevices$1();

    ClientCompanionDeviceModule$queryRemovedCompanionDevices$1() {
    }

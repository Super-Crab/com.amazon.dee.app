...
final class ClientDeviceRepository$requestStartSetup$1<T, R> implements Function<T, R> {
    public static final ClientDeviceRepository$requestStartSetup$1 INSTANCE = new ClientDeviceRepository$requestStartSetup$1();

    ClientDeviceRepository$requestStartSetup$1() {
    }

...
public final class AbstractAlexaAccessoryClient$prepareInputAndOutputStreams$1 extends Lambda implements Function1<RemoteException, Unit> {
    final /* synthetic */ AbstractAlexaAccessoryClient this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AbstractAlexaAccessoryClient$prepareInputAndOutputStreams$1(AbstractAlexaAccessoryClient abstractAlexaAccessoryClient) {
        super(1);
    ...
    public final void invoke2(@NotNull RemoteException it2) {
        ...
        this.this$0.accessoryMetricsService.recordOccurrence(MetricsConstants.CLIENT_OUTPUT_STREAM, MetricsConstants.CLIENT_OUTPUT_STREAM_INITIALIZE_EXCEPTION, true, null);
        AbstractAlexaAccessoryClient abstractAlexaAccessoryClient = this.this$0;
        abstractAlexaAccessoryClient.reconnect("OutputStream channel 0 failed to write with exception " + it2);
    }
}

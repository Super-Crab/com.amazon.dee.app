...
public class HGC extends UeS {
    public static final String LPk = "HGC";
    public final long Mlj;
    public final DialogRequestIdentifier yPL;

    public HGC(AtomicReference<WSC> atomicReference, AlexaClientEventBus alexaClientEventBus, IUt iUt, Lazy<PersistentStorage> lazy, TimeProvider timeProvider, DialogRequestIdentifier dialogRequestIdentifier, long j, Map<XWx, WSC> map, Map<DialogRequestIdentifier, XWx> map2) {

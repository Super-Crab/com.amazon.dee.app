...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public Map<K, V> mo4010read(JsonReader jsonReader) throws IOException {
            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    jsonReader.beginArray();
                    K mo4010read = this.keyTypeAdapter.mo4010read(jsonReader);
                    if (construct.put(mo4010read, this.valueTypeAdapter.mo4010read(jsonReader)) == null) {
                        jsonReader.endArray();
                    } else {
                        throw new JsonSyntaxException(GeneratedOutlineSupport1.outline70("duplicate key: ", mo4010read));
                    }
                }
                jsonReader.endArray();
            } else {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K mo4010read2 = this.keyTypeAdapter.mo4010read(jsonReader);
                    if (construct.put(mo4010read2, this.valueTypeAdapter.mo4010read(jsonReader)) != null) {
                        throw new JsonSyntaxException(GeneratedOutlineSupport1.outline70("duplicate key: ", mo4010read2));
                    }
                }

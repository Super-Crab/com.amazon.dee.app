...
public final class ArrayTypeAdapter<E> extends TypeAdapter<Object> {
    public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() { // from class: com.amazon.deviceevents.com.google.gson.internal.bind.ArrayTypeAdapter.1
    ...
    public Object mo4010read(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            arrayList.add(this.componentTypeAdapter.mo4010read(jsonReader));
        }
        jsonReader.endArray();

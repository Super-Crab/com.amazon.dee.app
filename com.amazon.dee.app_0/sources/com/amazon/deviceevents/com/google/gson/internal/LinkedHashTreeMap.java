...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new Comparator<Comparable>() { // from class: com.amazon.deviceevents.com.google.gson.internal.LinkedHashTreeMap.1
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            return new LinkedHashTreeMap<K, V>.LinkedTreeMapIterator<Map.Entry<K, V>>() { // from class: com.amazon.deviceevents.com.google.gson.internal.LinkedHashTreeMap.EntrySet.1
                {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return new LinkedHashTreeMap<K, V>.LinkedTreeMapIterator<K>() { // from class: com.amazon.deviceevents.com.google.gson.internal.LinkedHashTreeMap.KeySet.1
                {
                    LinkedHashTreeMap linkedHashTreeMap = LinkedHashTreeMap.this;
                }
    ...
    Node<K, V> find(K k, boolean z) {
        ...
        if (node4 == null) {
            if (comparator == NATURAL_ORDER && !(k instanceof Comparable)) {
                throw new ClassCastException(GeneratedOutlineSupport1.outline46(k, new StringBuilder(), " is not Comparable"));
            }

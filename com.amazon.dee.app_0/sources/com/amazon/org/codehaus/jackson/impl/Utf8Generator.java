...
public class Utf8Generator extends JsonGeneratorBase {
                ...
                if (i7 > 0) {
                    ...
                    if (i7 == -2) {
                        ...
                        if (escapeSequence2 != null) {
                            ...
                            throw new JsonGenerationException(GeneratedOutlineSupport1.outline33(c, GeneratedOutlineSupport1.outline107("Invalid custom escape definitions; custom escape not found for character code 0x"), ", although was supposed to have one"));
                        }
                    } else {
                        _outputMultiByteChar = _writeGenericEscape(c, i3);
                    }
    ...
    */
    private final void _writeSegmentedRaw(char[] r7, int r8, int r9) throws java.io.IOException, com.amazon.org.codehaus.jackson.JsonGenerationException {
        /*
            r6 = this;
        ...
        L52:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amazon.org.codehaus.jackson.impl.Utf8Generator._writeSegmentedRaw(char[], int, int):void");
    }
    ...
    protected final int _decodeSurrogate(int i, int i2) throws IOException {
        if (i2 < 56320 || i2 > 57343) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Incomplete surrogate pair: first char 0x");
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void writeRaw(char[] r5, int r6, int r7) throws java.io.IOException, com.amazon.org.codehaus.jackson.JsonGenerationException {
        /*
            r4 = this;
            int r0 = r7 + r7
            int r0 = r0 + r7
        ...
        L55:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amazon.org.codehaus.jackson.impl.Utf8Generator.writeRaw(char[], int, int):void");
    }

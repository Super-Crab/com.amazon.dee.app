...
public final class UTF8Writer extends Writer {
    ...
    private void throwIllegal(int i) throws IOException {
        if (i <= 1114111) {
            if (i < 55296) {
                throw new IOException(GeneratedOutlineSupport1.outline33(i, GeneratedOutlineSupport1.outline107("Illegal character point (0x"), ") to output"));
            }
            if (i <= 56319) {
                throw new IOException(GeneratedOutlineSupport1.outline33(i, GeneratedOutlineSupport1.outline107("Unmatched first part of surrogate pair (0x"), ")"));
            }
            throw new IOException(GeneratedOutlineSupport1.outline33(i, GeneratedOutlineSupport1.outline107("Unmatched second part of surrogate pair (0x"), ")"));
        }
        throw new IOException(GeneratedOutlineSupport1.outline33(i, GeneratedOutlineSupport1.outline107("Illegal character point (0x"), ") to output; max is 0x10FFFF as per RFC 4627"));
    }
    ...
    /* renamed from: append */
    public Writer mo4098append(char c) throws IOException {
        write(c);
        return this;
    }
    ...
    */
    public void write(char[] r8, int r9, int r10) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amazon.org.codehaus.jackson.io.UTF8Writer.write(char[], int, int):void");
    }
    ...
    */
    public void write(java.lang.String r8, int r9, int r10) throws java.io.IOException {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amazon.org.codehaus.jackson.io.UTF8Writer.write(java.lang.String, int, int):void");
    }
}

...
public abstract class JavaType {
    ...
    public JavaType forcedNarrowBy(Class<?> cls) {
        ...
        if (this._valueHandler != _narrow.getValueHandler()) {
            _narrow = _narrow.mo4250withValueHandler(this._valueHandler);
        }
        return this._typeHandler != _narrow.getTypeHandler() ? _narrow.mo4249withTypeHandler(this._typeHandler) : _narrow;
    }
    ...
    public abstract JavaType mo4242withContentTypeHandler(Object obj);

    /* renamed from: withContentValueHandler */
    public JavaType mo4248withContentValueHandler(Object obj) {
        getContentType().setValueHandler(obj);
        return this;
    }

    /* renamed from: withTypeHandler */
    public abstract JavaType mo4249withTypeHandler(Object obj);

    /* renamed from: withValueHandler */
    public JavaType mo4250withValueHandler(Object obj) {
        setValueHandler(obj);
        return this;
    }
}

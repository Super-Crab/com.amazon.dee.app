...
public class StdDateFormat extends DateFormat {
    ...
    protected static final String[] ALL_FORMATS = {DATE_FORMAT_STR_ISO8601, "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", DATE_FORMAT_STR_RFC1123, DATE_FORMAT_STR_PLAIN};
    ...
    protected Date parseAsISO8601(String str, ParsePosition parsePosition) {
        ...
        if (length <= 10 && Character.isDigit(charAt)) {
            ...
            if (charAt2 == ':') {
                ...
                str = GeneratedOutlineSupport1.outline72(str, "00");
            }
    ...
    /* renamed from: clone */
    public StdDateFormat mo4251clone() {

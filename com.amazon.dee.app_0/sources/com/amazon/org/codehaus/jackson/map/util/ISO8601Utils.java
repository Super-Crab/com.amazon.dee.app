...
public class ISO8601Utils {
    ...
    public static Date parse(String str) {
        ...
        try {
            ...
            checkOffset(str, 13, JsonReaderKt.COLON);
            int parseInt5 = parseInt(str, 14, 16);
            checkOffset(str, 16, JsonReaderKt.COLON);
            int i2 = 19;
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline72("Failed to parse date ", str), e);
        } catch (NumberFormatException e2) {
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline72("Failed to parse date ", str), e2);
        } catch (IllegalArgumentException e3) {
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline72("Failed to parse date ", str), e3);
        }
    }

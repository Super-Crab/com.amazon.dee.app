...
public final class ProvisioningModule_ProvidesFFSWhiteListPolicyCoordinatorFactory implements Factory<WhiteListPolicyCoordinator> {
    ...
    public static ProvisioningModule_ProvidesFFSWhiteListPolicyCoordinatorFactory create(ProvisioningModule provisioningModule, Provider<Context> provider, Provider<JobScheduler> provider2, Provider<JobInfoProvider> provider3, Provider<SharedPreferencesProvider> provider4, Provider<Clock> provider5, Provider<DSSClient> provider6, Provider<ProvisionerClientData> provider7) {
    ...
    public static WhiteListPolicyCoordinator provideInstance(ProvisioningModule provisioningModule, Provider<Context> provider, Provider<JobScheduler> provider2, Provider<JobInfoProvider> provider3, Provider<SharedPreferencesProvider> provider4, Provider<Clock> provider5, Provider<DSSClient> provider6, Provider<ProvisionerClientData> provider7) {
        return proxyProvidesFFSWhiteListPolicyCoordinator(provisioningModule, provider.mo10268get(), provider2.mo10268get(), provider3.mo10268get(), provider4.mo10268get(), provider5.mo10268get(), provider6.mo10268get(), provider7.mo10268get());
    }
    ...
    public static WhiteListPolicyCoordinator proxyProvidesFFSWhiteListPolicyCoordinator(ProvisioningModule provisioningModule, Context context, JobScheduler jobScheduler, JobInfoProvider jobInfoProvider, SharedPreferencesProvider sharedPreferencesProvider, Clock clock, DSSClient dSSClient, ProvisionerClientData provisionerClientData) {
        return (WhiteListPolicyCoordinator) Preconditions.checkNotNull(provisioningModule.providesFFSWhiteListPolicyCoordinator(context, jobScheduler, jobInfoProvider, sharedPreferencesProvider, clock, dSSClient, provisionerClientData), "Cannot return null from a non-@Nullable @Provides method");
    }

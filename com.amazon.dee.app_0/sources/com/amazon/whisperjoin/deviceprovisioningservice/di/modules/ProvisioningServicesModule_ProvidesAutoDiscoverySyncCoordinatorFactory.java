...
public final class ProvisioningServicesModule_ProvidesAutoDiscoverySyncCoordinatorFactory implements Factory<CustomerProvisioneesSetupStatusSyncCoordinator> {
    ...
    public ProvisioningServicesModule_ProvidesAutoDiscoverySyncCoordinatorFactory(ProvisioningServicesModule provisioningServicesModule, Provider<Context> provider, Provider<ProvisionerInfo> provider2, Provider<DSSClient> provider3, Provider<JobScheduler> provider4, Provider<JobInfoProvider> provider5, Provider<Clock> provider6, Provider<SharedPreferencesProvider> provider7) {
    ...
    public static ProvisioningServicesModule_ProvidesAutoDiscoverySyncCoordinatorFactory create(ProvisioningServicesModule provisioningServicesModule, Provider<Context> provider, Provider<ProvisionerInfo> provider2, Provider<DSSClient> provider3, Provider<JobScheduler> provider4, Provider<JobInfoProvider> provider5, Provider<Clock> provider6, Provider<SharedPreferencesProvider> provider7) {
        return new ProvisioningServicesModule_ProvidesAutoDiscoverySyncCoordinatorFactory(provisioningServicesModule, provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }

    public static CustomerProvisioneesSetupStatusSyncCoordinator provideInstance(ProvisioningServicesModule provisioningServicesModule, Provider<Context> provider, Provider<ProvisionerInfo> provider2, Provider<DSSClient> provider3, Provider<JobScheduler> provider4, Provider<JobInfoProvider> provider5, Provider<Clock> provider6, Provider<SharedPreferencesProvider> provider7) {
        return proxyProvidesAutoDiscoverySyncCoordinator(provisioningServicesModule, provider.mo10268get(), provider2.mo10268get(), provider3.mo10268get(), provider4.mo10268get(), provider5.mo10268get(), provider6.mo10268get(), provider7.mo10268get());
    }

    public static CustomerProvisioneesSetupStatusSyncCoordinator proxyProvidesAutoDiscoverySyncCoordinator(ProvisioningServicesModule provisioningServicesModule, Context context, ProvisionerInfo provisionerInfo, DSSClient dSSClient, JobScheduler jobScheduler, JobInfoProvider jobInfoProvider, Clock clock, SharedPreferencesProvider sharedPreferencesProvider) {
        return (CustomerProvisioneesSetupStatusSyncCoordinator) Preconditions.checkNotNull(provisioningServicesModule.providesAutoDiscoverySyncCoordinator(context, provisionerInfo, dSSClient, jobScheduler, jobInfoProvider, clock, sharedPreferencesProvider), "Cannot return null from a non-@Nullable @Provides method");
    }

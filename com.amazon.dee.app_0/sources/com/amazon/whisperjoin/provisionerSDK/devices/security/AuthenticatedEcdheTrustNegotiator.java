...
public class AuthenticatedEcdheTrustNegotiator extends BaseEcdheTrustNegotiator implements TrustNegotiator {
    ...
    public EncryptionProvider start(PeripheralDevice peripheralDevice) throws TrustProviderInitializationFailedException {
        return start(peripheralDevice, new SecureChannelImpl(), Command.EXCHANGE_AUTHENTICATED_ECDHE_KEY);
    }
}

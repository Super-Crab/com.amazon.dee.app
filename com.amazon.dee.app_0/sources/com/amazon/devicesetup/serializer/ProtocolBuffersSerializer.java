...
import com.amazon.devicesetup.protobuf.ble.ProtoStartProvisioningRequest;
import com.amazon.devicesetup.protobuf.ble.ProtoStartProvisioningResponse;
import com.amazon.devicesetup.protobuf.ble.ProtoWhisperJoinBlePacket;
import com.amazon.devicesetup.protobuf.ble.command.ProtoProvisioningCommand;
import com.amazon.devicesetup.protobuf.ble.command.ProtoProvisioningCommandResponse;
import com.amazon.devicesetup.protobuf.ble.events.ProtoCBLRegistrationUpdatedEvent;
import com.amazon.devicesetup.protobuf.ble.events.ProtoProvisionableCommandInterfaceUpdatedEvent;
import com.amazon.devicesetup.protobuf.ble.events.ProtoProvisionableEventInterfaceUpdatedEvent;
import com.amazon.devicesetup.protobuf.ble.events.ProtoProvisionableEventNotification;
import com.amazon.devicesetup.protobuf.ble.events.ProtoProvisioningDoneFailureEvent;
import com.amazon.devicesetup.protobuf.ble.events.ProtoProvisioningStatus;
import com.amazon.devicesetup.protobuf.data.ProtoBoolean;
import com.amazon.devicesetup.protobuf.data.ProtoInteger;
import com.amazon.devicesetup.protobuf.data.ProtoString;
import com.amazon.devicesetup.protobuf.data.configuration.ProtoConfigurationKeySet;
import com.amazon.devicesetup.protobuf.data.configuration.ProtoDataMap;
import com.amazon.devicesetup.protobuf.data.crypto.ProtoAuthenticatedEcdheKeyExchangeRequest;
import com.amazon.devicesetup.protobuf.data.crypto.ProtoAuthenticatedEcdheKeyExchangeResponse;
import com.amazon.devicesetup.protobuf.data.crypto.ProtoProvisionableDeviceAuthenticationData;
import com.amazon.devicesetup.protobuf.data.crypto.ProtoSecureMessage;
import com.amazon.devicesetup.protobuf.data.crypto.ProtoUnauthenticatedEcdheKeyExchangeRequest;
import com.amazon.devicesetup.protobuf.data.crypto.ProtoUnauthenticatedEcdheKeyExchangeResponse;
import com.amazon.devicesetup.protobuf.data.device.ProtoDeviceDetails;
...
import com.amazon.devicesetup.protobuf.data.registration.ProtoCBLRegistrationRequest;
import com.amazon.devicesetup.protobuf.data.wifi.ProtoWifiConfiguration;
import com.amazon.devicesetup.protobuf.data.wifi.ProtoWifiConnectionDetails;
import com.amazon.devicesetup.protobuf.data.wifi.ProtoWifiNetwork;
import com.amazon.devicesetup.protobuf.data.wifi.ProtoWifiScanResultCollection;
...
import com.amazon.devicesetup.provisioning.data.wifi.WifiConfiguration;
...
public class ProtocolBuffersSerializer implements Serializer {
    ...
    private final TypeSerializer<DeviceDetails> mDeviceDetailsSerializer = new ProtoDeviceDetails((ProtoDataMap) this.mDataMapTypeSerializer, (ProtoWifiConnectionDetails) this.mWifiConnectionDetailsSerializer);
    ...
    @Override // com.amazon.devicesetup.serializer.Serializer
    public <T> T deserialize(byte[] bArr, TypeToken<T> typeToken) {
        if (typeToken.equals(TypeToken.of(WifiConfiguration.class))) {
            return (T) this.mWifiConfigurationSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(WifiNetwork.class))) {
            return (T) this.mWifiNetworkSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(WifiScanResultCollection.class))) {
            return (T) this.mWifiScanResultCollectionSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(WifiConnectionDetails.class))) {
            return (T) this.mWifiConnectionDetailsSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(SecureMessage.class))) {
            return (T) this.mSecureMessageSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(Boolean.class))) {
            return (T) this.mBooleanSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(Integer.class))) {
            return (T) this.mIntegerSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(String.class))) {
            return (T) this.mStringSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(UuidCollection.class))) {
            return (T) this.mUuidCollectionSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(CBLRegistrationDetails.class))) {
            return (T) this.mCBLRegistrationDetailsSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(CBLRegistrationRequest.class))) {
            return (T) this.mCBLRegistrationRequestSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ProvisionableEventTypeCollection.class))) {
            return (T) this.mProvisionableEventTypeCollectionSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(CBLRegistrationUpdatedEvent.class))) {
            return (T) this.mCBLRegistrationUpdatedEventSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ProvisionableCommandInterfaceUpdatedEvent.class))) {
            return (T) this.mProvisionableCommandInterfaceUpdatedEventSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ProvisionableEventInterfaceUpdatedEvent.class))) {
            return (T) this.mProvisionableEventInterfaceUpdatedEventSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ProvisioningFailure.class))) {
            return (T) this.mProvisioningFailureTypeSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ProvisioningDoneFailureEvent.class))) {
            return (T) this.mProvisioningDoneFailureEventSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ProvisioningStatus.class))) {
            return (T) this.mProvisioningStatusSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.getType().equals(UnauthenticatedEcdheKeyExchangeRequest.class)) {
            return (T) this.mUnauthenticatedEcdheKeyExchangeRequestSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.getType().equals(UnauthenticatedEcdheKeyExchangeResponse.class)) {
            return (T) this.mUnauthenticatedEcdheKeyExchangeResponseSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.getType().equals(AuthenticatedEcdheKeyExchangeRequest.class)) {
            return (T) this.mAuthenticatedEcdheKeyExchangeRequestSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.getType().equals(AuthenticatedEcdheKeyExchangeResponse.class)) {
            return (T) this.mAuthenticatedEcdheKeyExchangeResponseSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ConfigurationKeySet.class))) {
            return (T) this.mConfigurationKeySetSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(DataMap.class))) {
            return (T) this.mDataMapTypeSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(DeviceDetails.class))) {
            return (T) this.mDeviceDetailsSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ProvisioningCommand.class))) {
            return (T) this.mProvisioningCommandSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ProvisioningCommandResponse.class))) {
            return (T) this.mProvisioningCommandResponseSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(StartProvisioningRequest.class))) {
            return (T) this.mStartProvisioningRequestSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(WhisperJoinBlePacket.class))) {
            return (T) this.mWhisperJoinBlePacketSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(StartProvisioningResponse.class))) {
            return (T) this.mStartProvisioningResponseSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ProvisionableEventNotification.class))) {
            return (T) this.mProvisionableEventNotificationSerializer.mo4042deserialize(bArr);
        }
        if (typeToken.equals(TypeToken.of(ProvisionableDeviceAuthenticationData.class))) {
            return (T) this.mProvisionableDeviceAuthenticationDataTypeSerializer.mo4042deserialize(bArr);
        }
    ...
    public <T> byte[] serialize(T t) {
        ...
        if (t instanceof DeviceDetails) {
            return this.mDeviceDetailsSerializer.serialize((DeviceDetails) t);
        }

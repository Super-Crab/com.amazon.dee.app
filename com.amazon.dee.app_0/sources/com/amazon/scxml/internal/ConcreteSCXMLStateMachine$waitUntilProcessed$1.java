...
final class ConcreteSCXMLStateMachine$waitUntilProcessed$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Semaphore $sem;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConcreteSCXMLStateMachine$waitUntilProcessed$1(Semaphore semaphore) {
        super(0);
        this.$sem = semaphore;
    }

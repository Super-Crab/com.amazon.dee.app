...
public class DeviceToDeviceNotificationMessageHandler implements MessageHandler {
    private static final DPLogger log = new DPLogger("TComm:DeviceToDeviceNotificationMessageHandler");
    private final DeviceD2DApplicationProtocol mD2DProtocol;

    public DeviceToDeviceNotificationMessageHandler(DeviceD2DApplicationProtocol deviceD2DApplicationProtocol) {

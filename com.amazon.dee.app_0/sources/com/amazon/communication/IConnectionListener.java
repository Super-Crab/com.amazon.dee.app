...
public interface IConnectionListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IConnectionListener {
        private static final String DESCRIPTOR = "com.amazon.communication.IConnectionListener";
        ...
        public static IConnectionListener asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IConnectionListener)) {
                return (IConnectionListener) queryLocalInterface;
            }
    ...
    void onConnectionSetInitialState(int i) throws RemoteException;

    void onConnectionStateChanged(int i, int i2, String str) throws RemoteException;
}

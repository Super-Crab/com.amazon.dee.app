...
public class LoadingView extends View {
    ...
    public LoadingView(Context context) {
        super(context);
        this.animationRunnable = new Runnable() { // from class: com.amazon.dee.app.ui.view.LoadingView.1
    ...
    public LoadingView(Context context, AttributeSet attributeSet) {
        ...
        this.fillColor = obtainStyledAttributes.getColor(2, DEFAULT_CIRCLE_COLOR);
        this.startRadius = obtainStyledAttributes.getDimensionPixelSize(4, 12);
        this.endRadius = obtainStyledAttributes.getDimensionPixelSize(3, 24);
        this.animationDuration = obtainStyledAttributes.getInt(0, 30);
        this.dotPadding = obtainStyledAttributes.getDimensionPixelSize(1, 30);
        init();

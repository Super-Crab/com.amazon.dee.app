...
final class TarazedController$encounteredLaunchRequestSet$1<T> implements Comparator<E> {
    public static final TarazedController$encounteredLaunchRequestSet$1 INSTANCE = new TarazedController$encounteredLaunchRequestSet$1();

    TarazedController$encounteredLaunchRequestSet$1() {
    }

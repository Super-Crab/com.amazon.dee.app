...
public final class SessionEndedAgentDialog extends SessionEndedDialog {
    ...
    public SessionEndedAgentDialog(@NotNull Context context, @NotNull DeviceInfoUtility deviceInfoUtility, @NotNull TarazedSessionNotifier sessionNotifier, @NotNull TarazedSessionLogger logger, @NotNull TarazedMetricsHelper metricsHelper, @NotNull BizMetricsHelper bizMetricsHelper) {
        ...
        this.tag = "EndedAssociateDialog";
        listOf = CollectionsKt__CollectionsJVMKt.listOf(Integer.valueOf(R.string.dialog_ended_agent));

...
public final class SessionEndedCustomerDialog extends SessionEndedDialog {
    ...
    public SessionEndedCustomerDialog(@NotNull Context context, @NotNull DeviceInfoUtility deviceInfoUtility, @NotNull TarazedSessionNotifier sessionNotifier, @NotNull TarazedSessionLogger logger, @NotNull TarazedMetricsHelper metricsHelper, @NotNull BizMetricsHelper bizMetricsHelper) {
        ...
        this.tag = "EndedCustomerDialog";
        listOf = CollectionsKt__CollectionsJVMKt.listOf(Integer.valueOf(R.string.dialog_ended_customer));

...
public final class AskStartSessionPermissionDialog extends AbstractAskPermissionDialog implements SessionAskPermissionDialog {
    ...
    /* compiled from: AskStartSessionPermissionDialog.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0006\b\u0082\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lcom/amazon/tarazed/session/dialog/AskStartSessionPermissionDialog$Companion;", "", "()V", "METRIC_START_DIALOG_DURATION", "", "PERMISSION_CUSTOMER_ACCEPT", "PERMISSION_CUSTOMER_DECLINE", "PERMISSION_DIALOGUE_SHOWN", "PERMISSION_TIMEOUT", "TAG", "TarazedAndroidLibrary_release"}, k = 1, mv = {1, 1, 16})
    /* loaded from: classes13.dex */
    ...
    public AskStartSessionPermissionDialog(@NotNull Context context, @NotNull DeviceInfoUtility deviceInfoUtility, @NotNull TarazedSessionNotifier sessionNotifier, @NotNull TarazedSessionLogger logger, @NotNull TarazedMetricsHelper metricsHelper, @NotNull BizMetricsHelper bizMetricsHelper) {
        ...
        this.tag = "StartSessionPermDialog";
        ...
        this.dialogPositiveButtonLabel = R.string.accept_capital;
        this.dialogNegativeButtonLabel = R.string.decline_capital;
        listOf = CollectionsKt__CollectionsJVMKt.listOf(Integer.valueOf(R.string.permission_request));
        this.dialogMessage = listOf;
        this.dialogShownMetric = PERMISSION_DIALOGUE_SHOWN;
        this.dialogAcceptedMetric = PERMISSION_CUSTOMER_ACCEPT;
        this.dialogDeclinedOrCanceledMetric = PERMISSION_CUSTOMER_DECLINE;
    }

    @Override // com.amazon.tarazed.dialog.AbstractAskPermissionDialog, com.amazon.tarazed.dialog.AbstractDialog
    @NotNull
    public Job finish() {
        getMetricsHelper().stopMetricTimer(TAG, METRIC_START_DIALOG_DURATION);
        return super.finish();
    }
    ...
    public void onAcceptClick() {
        getLogger().d(getTag(), "onAcceptClick - Start session request was accepted");
    ...
    public void onDeclineClickOrCancel(@NotNull String cause) {
        ...
        if (Intrinsics.areEqual(cause, PERMISSION_TIMEOUT)) {
            getLogger().d(getTag(), "onDeclineClick - Start session request was declined due to lack of user response");
            getOnTimeoutCallback().mo12560invoke();
            sendDialogResponseBizMetrics(Response.TIMEOUT, BizMetricsConstants.ASK_START_SESSION_EVENT_NAME);
            return;
        }
        getLogger().d(getTag(), "onDeclineClick - Start session request was declined");
    ...
    @Override // com.amazon.tarazed.dialog.AbstractDialog, com.amazon.tarazed.core.session.dialog.SessionAskPermissionDialog
    @NotNull
    public Job show() {
        getMetricsHelper().startMetricTimer(TAG, METRIC_START_DIALOG_DURATION);
        return super.show();
    }
}

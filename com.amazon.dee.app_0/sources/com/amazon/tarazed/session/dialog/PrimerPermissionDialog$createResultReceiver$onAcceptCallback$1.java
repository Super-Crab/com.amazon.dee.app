...
public final class PrimerPermissionDialog$createResultReceiver$onAcceptCallback$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ PrimerPermissionDialog this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PrimerPermissionDialog$createResultReceiver$onAcceptCallback$1(PrimerPermissionDialog primerPermissionDialog) {
        super(0);
    ...
    public final void mo12560invoke() {
        ...
        if (z) {
            this.this$0.getOnAcceptSessionCallback().mo12560invoke();

...
public final class MenuDrawerManager$pauseSessionButtonHandler$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ MenuDrawerManager this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MenuDrawerManager$pauseSessionButtonHandler$1(MenuDrawerManager menuDrawerManager) {
        super(0);
    ...
    public final void mo12560invoke() {
        ...
        tarazedSessionLogger.d("MenuDrawerManager", "Pause session clicked");
        MenuDrawerManager menuDrawerManager = this.this$0;
        view = menuDrawerManager.pauseSessionButton;
        menuDrawerManager.disableButton(view);
        MenuDrawerManager menuDrawerManager2 = this.this$0;
        view2 = menuDrawerManager2.resumeSessionButton;
        menuDrawerManager2.hideButton(view2);
        this.this$0.getReEnablePauseButtonTimer$TarazedAndroidLibrary_release().start();
        this.this$0.sendSessionStateChange(TarazedIntents.SessionAndroidService.PAUSE_SESSION);
    }
}

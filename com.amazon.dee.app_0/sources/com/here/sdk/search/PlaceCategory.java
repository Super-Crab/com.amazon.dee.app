...
public final class PlaceCategory extends NativeBase {
    public static final String ACCOMODATION = "500";
    public static final String ACCOMODATION_HOTEL_MOTEL = "500-5000";
    public static final String ACCOMODATION_LODGING = "500-5100";
    ...
    protected PlaceCategory(long j, Object obj) {
        super(j, new NativeBase.Disposer() { // from class: com.here.sdk.search.PlaceCategory.1
            @Override // com.here.NativeBase.Disposer
            public void disposeNative(long j2) {
                PlaceCategory.disposeNativeHandle(j2);
            }
        });
    }
    ...
    PlaceCategory(@NonNull String str, boolean z) {
        this(make(str, z), (Object) null);
        cacheThisInstance();
    }
    ...
    private static native long make(@NonNull String str, boolean z);

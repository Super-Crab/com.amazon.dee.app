...
public final class Anchor2D {
    ...
    public int hashCode() {
        return ((((int) (Double.doubleToLongBits(this.horizontal) ^ (Double.doubleToLongBits(this.horizontal) >>> 32))) + JfifUtil.MARKER_EOI) * 31) + ((int) (Double.doubleToLongBits(this.vertical) ^ (Double.doubleToLongBits(this.vertical) >>> 32)));
    }
}

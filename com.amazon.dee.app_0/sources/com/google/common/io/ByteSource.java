...
public abstract class ByteSource {
    ...
    public class AsCharSource extends CharSource {
        ...
        public Reader openStream() throws IOException {
            return new InputStreamReader(ByteSource.this.mo8235openStream(), this.charset);
        }
        ...
        public String toString() {
            ...
            return GeneratedOutlineSupport1.outline31(valueOf.length() + GeneratedOutlineSupport1.outline6(obj, 15), obj, ".asCharSource(", valueOf, ")");
        }
    }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        public InputStream openBufferedStream() throws IOException {
            return mo8235openStream();
        }

        @Override // com.google.common.io.ByteSource
        /* renamed from: openStream */
        public InputStream mo8235openStream() {
        ...
        public String toString() {
            ...
            return GeneratedOutlineSupport1.outline30(GeneratedOutlineSupport1.outline6(truncate, 17), "ByteSource.wrap(", truncate, ")");
        }
    ...
    public static final class ConcatenatedByteSource extends ByteSource {
        ...
        public String toString() {
            ...
            return GeneratedOutlineSupport1.outline30(valueOf.length() + 19, "ByteSource.concat(", valueOf, ")");
        }
    }
    ...
    public final class SlicedByteSource extends ByteSource {
        ...
        /* renamed from: openStream */
        public InputStream mo8235openStream() throws IOException {
            return sliceStream(ByteSource.this.mo8235openStream());
        }
        ...
        public String toString() {
            ...
            long j = this.offset;
            long j2 = this.length;
            StringBuilder sb = new StringBuilder(GeneratedOutlineSupport1.outline6(obj, 50));
            sb.append(obj);
            sb.append(".slice(");
            sb.append(j);
            sb.append(", ");
    ...
    public boolean contentEquals(ByteSource byteSource) throws IOException {
        ...
        try {
            InputStream inputStream = (InputStream) create.register(mo8235openStream());
            InputStream inputStream2 = (InputStream) create.register(byteSource.mo8235openStream());
            do {
    ...
    public long copyTo(OutputStream outputStream) throws IOException {
        ...
        try {
            return ByteStreams.copy((InputStream) Closer.create().register(mo8235openStream()), outputStream);
        } finally {
        }
    }
    ...
    public boolean isEmpty() throws IOException {
        ...
        Closer create = Closer.create();
        try {
            if (((InputStream) create.register(mo8235openStream())).read() != -1) {
                z = false;
            }
            return z;
        } catch (Throwable th) {
    ...
    public InputStream openBufferedStream() throws IOException {
        InputStream mo8235openStream = mo8235openStream();
        if (mo8235openStream instanceof BufferedInputStream) {
            return (BufferedInputStream) mo8235openStream;
        }
        return new BufferedInputStream(mo8235openStream);
    }

    /* renamed from: openStream */
    public abstract InputStream mo8235openStream() throws IOException;
    ...
    public long size() throws IOException {
        ...
        Closer create = Closer.create();
        try {
            return countBySkipping((InputStream) create.register(mo8235openStream()));
        } catch (IOException unused) {
            create.close();
            try {
                return ByteStreams.exhaust((InputStream) Closer.create().register(mo8235openStream()));
            } finally {
            }
        } finally {
        }
    ...
    public long copyTo(ByteSink byteSink) throws IOException {
        ...
        Closer create = Closer.create();
        try {
            return ByteStreams.copy((InputStream) create.register(mo8235openStream()), (OutputStream) create.register(byteSink.mo8234openStream()));
        } finally {
        }
    }
    ...
    public <T> T read(ByteProcessor<T> byteProcessor) throws IOException {
        ...
        try {
            return (T) ByteStreams.readBytes((InputStream) Closer.create().register(mo8235openStream()), byteProcessor);
        } finally {
        }
    }
}

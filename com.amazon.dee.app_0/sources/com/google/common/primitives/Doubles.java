...
public final class Doubles extends DoublesMethodsForWeb {
    ...
    private static Pattern fpPattern() {
        ...
        String outline30 = GeneratedOutlineSupport1.outline30("(?:[0-9a-fA-F]+#(?:\\.[0-9a-fA-F]*#)?|\\.[0-9a-fA-F]+#)".length() + 25, "0[xX]", "(?:[0-9a-fA-F]+#(?:\\.[0-9a-fA-F]*#)?|\\.[0-9a-fA-F]+#)", "[pP][+-]?\\d+#[fFdD]?");
        StringBuilder outline106 = GeneratedOutlineSupport1.outline106(GeneratedOutlineSupport1.outline6(outline30, GeneratedOutlineSupport1.outline6(concat, 23)), "[+-]?(?:NaN|Infinity|", concat, AccessoryMetricsConstants.DELIMITER, outline30);
        outline106.append(")");
        return Pattern.compile(outline106.toString().replace(MqttTopic.MULTI_LEVEL_WILDCARD, "+"));
    }

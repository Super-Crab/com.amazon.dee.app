...
public final class HostSpecifier {
    ...
    public static HostSpecifier fromValid(String str) {
        ...
        throw new IllegalArgumentException(host.length() != 0 ? "Domain name does not have a recognized public suffix: ".concat(host) : new String("Domain name does not have a recognized public suffix: "));
    }

...
public class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static final Queue<?> DISCARDING_QUEUE = new AbstractQueue<Object>() { // from class: com.google.common.cache.LocalCache.2
        ...
        public Iterator<Object> iterator() {
            return ImmutableSet.of().mo8029iterator();
        }
    ...
    public static final class AccessQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        ...
        public Iterator<ReferenceEntry<K, V>> iterator() {
            return new AbstractSequentialIterator<ReferenceEntry<K, V>>(mo7526peek()) { // from class: com.google.common.cache.LocalCache.AccessQueue.2
        ...
        @Override // java.util.Queue
        /* renamed from: peek */
        public ReferenceEntry<K, V> mo7526peek() {
            ReferenceEntry<K, V> nextInAccessQueue = this.head.getNextInAccessQueue();
        ...
        @Override // java.util.Queue
        /* renamed from: poll */
        public ReferenceEntry<K, V> mo7527poll() {
            ReferenceEntry<K, V> nextInAccessQueue = this.head.getNextInAccessQueue();
            if (nextInAccessQueue == this.head) {
                return null;
            }
    ...
    final class EntryIterator extends LocalCache<K, V>.HashIterator<Map.Entry<K, V>> {
        ...
        public Map.Entry<K, V> mo7528next() {
            return nextEntry();
        }
    }
    ...
    static final class LoadingSerializationProxy<K, V> extends ManualSerializationProxy<K, V> implements LoadingCache<K, V>, Serializable {
        ...
        /* renamed from: apply */
        public final V mo8172apply(K k) {
            return this.autoDelegate.mo8172apply(k);
        }
    ...
    static class ManualSerializationProxy<K, V> extends ForwardingCache<K, V> implements Serializable {
        ...
        public Cache<K, V> mo8280delegate() {
            return this.delegate;
        }
    }
    ...
    public static final class WriteQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        ...
        @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable
        public Iterator<ReferenceEntry<K, V>> iterator() {
            return new AbstractSequentialIterator<ReferenceEntry<K, V>>(mo7530peek()) { // from class: com.google.common.cache.LocalCache.WriteQueue.2
                @Override // com.google.common.collect.AbstractSequentialIterator
                protected /* bridge */ /* synthetic */ Object computeNext(Object obj) {
                    return computeNext((ReferenceEntry) ((ReferenceEntry) obj));
                }
        ...
        @Override // java.util.Queue
        /* renamed from: peek */
        public ReferenceEntry<K, V> mo7530peek() {
            ReferenceEntry<K, V> nextInWriteQueue = this.head.getNextInWriteQueue();
        ...
        @Override // java.util.Queue
        /* renamed from: poll */
        public ReferenceEntry<K, V> mo7531poll() {
            ReferenceEntry<K, V> nextInWriteQueue = this.head.getNextInWriteQueue();
            if (nextInWriteQueue == this.head) {
                return null;
            }
    ...
    LocalCache(CacheBuilder<? super K, ? super V> cacheBuilder, @NullableDecl CacheLoader<? super K, V> cacheLoader) {
        ...
        this.globalStatsCounter = cacheBuilder.getStatsCounterSupplier().mo8291get();
        ...
        if (evictsBySize()) {
            ...
            while (i < this.segments.length) {
                ...
                this.segments[i] = createSegment(i2, j3, cacheBuilder.getStatsCounterSupplier().mo8291get());
                i++;
            }
            return;
        }
        while (true) {
            ...
            segmentArr[i] = createSegment(i2, -1L, cacheBuilder.getStatsCounterSupplier().mo8291get());
            i++;
        }
    }
    ...
    */
    java.util.Map<K, V> loadAll(java.util.Set<? extends K> r7, com.google.common.cache.CacheLoader<? super K, V> r8) throws java.util.concurrent.ExecutionException {
        ...
        L4a:
            ...
            java.lang.String r8 = com.android.tools.r8.GeneratedOutlineSupport1.outline29(r0, r8, r1)
            r7.<init>(r8)
            throw r7
        L6b:
            com.google.common.cache.AbstractCache$StatsCounter r7 = r6.globalStatsCounter

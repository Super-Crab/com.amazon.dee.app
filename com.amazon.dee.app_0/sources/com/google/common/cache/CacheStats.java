...
public final class CacheStats {
    ...
    public double averageLoadPenalty() {
        ...
        return saturatedAdd == 0 ? FrostVideoEffectController.VIDEO_STRENGTH_CLEAR : this.totalLoadTime / saturatedAdd;
    }
    ...
    public double loadExceptionRate() {
        long saturatedAdd = LongMath.saturatedAdd(this.loadSuccessCount, this.loadExceptionCount);
        return saturatedAdd == 0 ? FrostVideoEffectController.VIDEO_STRENGTH_CLEAR : this.loadExceptionCount / saturatedAdd;
    }
    ...
    public double missRate() {
        long requestCount = requestCount();
        return requestCount == 0 ? FrostVideoEffectController.VIDEO_STRENGTH_CLEAR : this.missCount / requestCount;
    }

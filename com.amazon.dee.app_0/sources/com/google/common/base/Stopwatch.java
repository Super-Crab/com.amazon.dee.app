...
public final class Stopwatch {
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (AnonymousClass1.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            ...
            case 4:
                return "s";
            case 5:
                return ReactProperties.GEOFENCE_MINIMUM_RANGE;
            case 6:
                return "h";
            case 7:
                return "d";
    ...
    public String toString() {
        ...
        return GeneratedOutlineSupport1.outline30(GeneratedOutlineSupport1.outline6(abbreviate, GeneratedOutlineSupport1.outline6(formatCompact4Digits, 1)), formatCompact4Digits, " ", abbreviate);
    }

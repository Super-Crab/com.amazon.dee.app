...
public final class Strings {
    ...
    private static String lenientToString(@NullableDecl Object obj) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder(GeneratedOutlineSupport1.outline6(hexString, name.length() + 1));
            sb.append(name);
            sb.append('@');
            sb.append(hexString);
            ...
            StringBuilder outline106 = GeneratedOutlineSupport1.outline106(name2.length() + GeneratedOutlineSupport1.outline6(sb2, 9), Config.Compare.LESS_THAN, sb2, " threw ", name2);
    ...
    public static String padEnd(String str, int i, char c) {
        ...
        StringBuilder outline105 = GeneratedOutlineSupport1.outline105(i, str);

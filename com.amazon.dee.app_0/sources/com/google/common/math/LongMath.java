...
public final class LongMath {
    ...
    @VisibleForTesting
    @GwtIncompatible
    static final long[] powersOf10 = {1, 10, 100, 1000, 10000, TarazedPrimerActivity.PRIMER_FROZEN_TIMEOUT_MS, 1000000, 10000000, 100000000, C.NANOS_PER_SECOND, 10000000000L, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    @VisibleForTesting
    @GwtIncompatible
    ...
    public static long ceilingPowerOfTwo(long j) {
        MathPreconditions.checkPositive(ReactProperties.HereMapMarker.X, j);
    ...
    */
    ...
    public static boolean isPrime(long j) {
        long[][] jArr;
        if (j < 2) {
            MathPreconditions.checkNonNegative(JsonReportFormat.COUNT, j);
            return false;
        } else if (j < 66) {
    ...
    public static long sqrt(long j, RoundingMode roundingMode) {
        long j2;
        MathPreconditions.checkNonNegative(ReactProperties.HereMapMarker.X, j);
        if (fitsInInt(j)) {

...
public final class IntMath {
    ...
    @VisibleForTesting
    static final int[] powersOf10 = {1, 10, 100, 1000, 10000, 100000, TracePublisherServiceConfigImpl.TOTAL_TRACES_CAPACITY_IN_BYTES, 10000000, 100000000, 1000000000};
    @VisibleForTesting
    ...
    public static int ceilingPowerOfTwo(int i) {
        MathPreconditions.checkPositive(ReactProperties.HereMapMarker.X, i);
        if (i <= 1073741824) {
    ...
    */
    ...
    public static int sqrt(int i, RoundingMode roundingMode) {
        int lessThanBranchFree;
        MathPreconditions.checkNonNegative(ReactProperties.HereMapMarker.X, i);

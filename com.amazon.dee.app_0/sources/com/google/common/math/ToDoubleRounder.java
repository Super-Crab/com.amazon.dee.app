...
abstract class ToDoubleRounder<X extends Number & Comparable<X>> {
    ...
    public final double roundToDouble(X x, RoundingMode roundingMode) {
        X x2;
        double d;
        Preconditions.checkNotNull(x, ReactProperties.HereMapMarker.X);
        ...
        if (Double.isInfinite(roundToDoubleArbitrarily)) {
            switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                ...
                case 8:
                    ...
                    throw new ArithmeticException(GeneratedOutlineSupport1.outline29(valueOf.length() + 44, valueOf, " cannot be represented precisely as a double"));
            }
        }

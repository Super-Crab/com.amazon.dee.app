...
public final class SubscriberRegistry {
    ...
    private Multimap<Class<?>, Subscriber> findAllSubscribers(Object obj) {
        ...
        UnmodifiableIterator<Method> mo8029iterator = getAnnotatedMethods(obj.getClass()).mo8029iterator();
        while (mo8029iterator.hasNext()) {
            Method next = mo8029iterator.next();
    ...
    public Iterator<Subscriber> getSubscribers(Object obj) {
        ...
        UnmodifiableIterator<Class<?>> mo8029iterator = flattenHierarchy.mo8029iterator();
        while (mo8029iterator.hasNext()) {
            CopyOnWriteArraySet<Subscriber> copyOnWriteArraySet = this.subscribers.get(mo8029iterator.next());
    ...
    public void register(Object obj) {
        for (Map.Entry<Class<?>, Collection<Subscriber>> entry : findAllSubscribers(obj).mo8101asMap().entrySet()) {
    ...
    */
    public void unregister(java.lang.Object r5) {
        /*
            ...
            java.util.Map r0 = r0.mo8101asMap()
        ...
        L39:
            ...
            java.lang.String r5 = com.android.tools.r8.GeneratedOutlineSupport1.outline30(r1, r2, r5, r3)
            r0.<init>(r5)
            throw r0
        L51:
            return

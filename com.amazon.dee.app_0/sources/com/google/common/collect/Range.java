...
public final class Range<C extends Comparable> extends RangeGwtSerializationDependencies implements Predicate<C>, Serializable {
    ...
    static class LowerBoundFn implements Function<Range, Cut> {
        ...
        public Cut mo8172apply(Range range) {
    ...
    public Range<C> gap(Range<C> range) {
        if (this.lowerBound.compareTo((Cut) range.upperBound) < 0 && range.lowerBound.compareTo((Cut) this.upperBound) < 0) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline31(valueOf2.length() + valueOf.length() + 39, "Ranges have a nonempty intersection: ", valueOf, ", ", valueOf2));
        }

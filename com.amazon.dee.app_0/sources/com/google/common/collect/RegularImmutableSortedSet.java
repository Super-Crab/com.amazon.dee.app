...
public final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    ...
    public boolean containsAll(Collection<?> collection) {
        ...
        if (SortedIterables.hasSameComparator(comparator(), collection) && collection.size() > 1) {
            UnmodifiableIterator<E> mo8029iterator = mo8029iterator();
            Iterator<?> it2 = collection.iterator();
            if (!mo8029iterator.hasNext()) {
                return false;
            }
            Object next = it2.next();
            E next2 = mo8029iterator.next();
            while (true) {
                try {
    ...
    */
    public boolean equals(@org.checkerframework.checker.nullness.compatqual.NullableDecl java.lang.Object r6) {
        ...
        L1e:
            ...
            com.google.common.collect.UnmodifiableIterator r1 = r5.mo8029iterator()     // Catch: java.lang.Throwable -> L46
        L2e:
    ...
    public RegularImmutableSortedSet<E> getSubSet(int i, int i2) {
        ...
        if (i < i2) {
            return new RegularImmutableSortedSet<>(this.elements.mo7713subList(i, i2), this.comparator);
        }
    ...
    public UnmodifiableIterator<E> mo8008descendingIterator() {
        return this.elements.reverse().mo8029iterator();
    }

    @Override // com.google.common.collect.ImmutableSortedSet, com.google.common.collect.ImmutableSet, com.google.common.collect.ImmutableCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set, java.util.NavigableSet, com.google.common.collect.SortedIterable
    /* renamed from: iterator */
    public UnmodifiableIterator<E> mo8029iterator() {
        return this.elements.mo8029iterator();
    }
}

...
public class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private class CellIterator implements Iterator<Table.Cell<R, C, V>> {
        ...
        @Override // java.util.Iterator
        /* renamed from: next */
        public Table.Cell<R, C, V> mo8043next() {
    ...
    public class Column extends Maps.ViewCachingAbstractMap<R, V> {
        ...
        private class EntrySetIterator extends AbstractIterator<Map.Entry<R, V>> {
            ...
            public Map.Entry<R, V> mo8230computeNext() {
    ...
    public class ColumnKeyIterator extends AbstractIterator<C> {
        ...
        private ColumnKeyIterator() {
            this.seen = StandardTable.this.factory.mo8291get();
    ...
    public class ColumnMap extends Maps.ViewCachingAbstractMap<C, Map<R, V>> {
        ...
        public class ColumnMapEntrySet extends StandardTable<R, C, V>.TableSet<Map.Entry<C, Map<R, V>>> {
            ...
            public Iterator<Map.Entry<C, Map<R, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.mo7856columnKeySet(), new Function<C, Map<R, V>>() { // from class: com.google.common.collect.StandardTable.ColumnMap.ColumnMapEntrySet.1
                    ...
                    public Map<R, V> mo8172apply(C c) {
                        return StandardTable.this.mo8030column(c);
                    }
                });
            }
            ...
            public boolean retainAll(Collection<?> collection) {
                Preconditions.checkNotNull(collection);
                Iterator it2 = Lists.newArrayList(StandardTable.this.mo7856columnKeySet().iterator()).iterator();
                boolean z = false;
                while (it2.hasNext()) {
                    Object next = it2.next();
                    if (!collection.contains(Maps.immutableEntry(next, StandardTable.this.mo8030column(next)))) {
            ...
            @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
            public int size() {
                return StandardTable.this.mo7856columnKeySet().size();
            }
        }
        ...
        private class ColumnMapValues extends Maps.Values<C, Map<R, V>> {
            ...
            public boolean removeAll(Collection<?> collection) {
                ...
                while (it2.hasNext()) {
                    Object next = it2.next();
                    if (collection.contains(StandardTable.this.mo8030column(next))) {
                        StandardTable.this.removeColumn(next);
                        z = true;
                    }
                }
        ...
        /* renamed from: keySet */
        public Set<C> mo8042keySet() {
            return StandardTable.this.mo7856columnKeySet();
        }

        @Override // java.util.AbstractMap, java.util.Map
        public Map<R, V> get(Object obj) {
            if (StandardTable.this.containsColumn(obj)) {
                return StandardTable.this.mo8030column(obj);
            }
            return null;
        }
    ...
    public class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: backingRowMap */
        public Map<C, V> mo8098backingRowMap() {
            ...
            Map<C, V> mo8099computeBackingRowMap = mo8099computeBackingRowMap();
            this.backingRowMap = mo8099computeBackingRowMap;
            return mo8099computeBackingRowMap;
        }

        @Override // com.google.common.collect.Maps.IteratorBasedAbstractMap, java.util.AbstractMap, java.util.Map
        public void clear() {
            Map<C, V> mo8098backingRowMap = mo8098backingRowMap();
            if (mo8098backingRowMap != null) {
                mo8098backingRowMap.clear();
            }
            maintainEmptyInvariant();
        }

        /* renamed from: computeBackingRowMap */
        Map<C, V> mo8099computeBackingRowMap() {
        ...
        public boolean containsKey(Object obj) {
            Map<C, V> mo8098backingRowMap = mo8098backingRowMap();
            return (obj == null || mo8098backingRowMap == null || !Maps.safeContainsKey(mo8098backingRowMap, obj)) ? false : true;
        }
        ...
        public Iterator<Map.Entry<C, V>> entryIterator() {
            ...
            final Iterator<Map.Entry<C, V>> it2 = mo8098backingRowMap.entrySet().iterator();
        ...
        public V get(Object obj) {
            Map<C, V> mo8098backingRowMap = mo8098backingRowMap();
            if (obj == null || mo8098backingRowMap == null) {
                return null;
            }
            return (V) Maps.safeGet(mo8098backingRowMap, obj);
        }

        void maintainEmptyInvariant() {
            if (mo8098backingRowMap() == null || !this.backingRowMap.isEmpty()) {
                return;
            }
        ...
        public V remove(Object obj) {
            ...
            V v = (V) Maps.safeRemove(mo8098backingRowMap, obj);
            maintainEmptyInvariant();
            return v;
        }
        ...
        public int size() {
            ...
            return mo8098backingRowMap.size();
        }
        ...
        Map.Entry<C, V> wrapEntry(final Map.Entry<C, V> entry) {
            return new ForwardingMapEntry<C, V>(this) { // from class: com.google.common.collect.StandardTable.Row.2
                ...
                public Map.Entry<C, V> mo8280delegate() {
                    return entry;
                }
            };
        }
    ...
    public class RowMap extends Maps.ViewCachingAbstractMap<R, Map<C, V>> {
        ...
        public class EntrySet extends StandardTable<R, C, V>.TableSet<Map.Entry<R, Map<C, V>>> {
            ...
            public Iterator<Map.Entry<R, Map<C, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.backingMap.keySet(), new Function<R, Map<C, V>>() { // from class: com.google.common.collect.StandardTable.RowMap.EntrySet.1
                    ...
                    @Override // com.google.common.base.Function
                    /* renamed from: apply  reason: collision with other method in class */
                    public Map<C, V> mo8172apply(R r) {
                        return StandardTable.this.mo8094row(r);
                    }
                });
            }
        ...
        public Map<C, V> get(Object obj) {
            if (StandardTable.this.containsRow(obj)) {
                return StandardTable.this.mo8094row(obj);
            }
            return null;
        }
    ...
    private Map<C, V> getOrCreate(R r) {
        ...
        if (map == null) {
            Map<C, V> mo8291get = this.factory.mo8291get();
            this.backingMap.put(r, mo8291get);
            return mo8291get;
        }
        return map;
    }
    ...
    Map<R, Map<C, V>> mo8038createRowMap() {
        return new RowMap();
    }
    ...
    public Map<R, Map<C, V>> mo8096rowMap() {
        ...
        if (map == null) {
            Map<R, Map<C, V>> mo8038createRowMap = mo8038createRowMap();
            this.rowMap = mo8038createRowMap;
            return mo8038createRowMap;
        }
        return map;
    }

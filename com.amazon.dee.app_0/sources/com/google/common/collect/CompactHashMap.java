...
public class CompactHashMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private abstract class Itr<T> implements Iterator<T> {
        ...
        abstract T mo7591getOutput(int i);
        ...
        public T next() {
            ...
            if (hasNext()) {
                ...
                T mo7591getOutput = mo7591getOutput(i);
                this.currentIndex = CompactHashMap.this.getSuccessor(this.currentIndex);
                return mo7591getOutput;
            }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        throw new InvalidObjectException(GeneratedOutlineSupport1.outline27(25, "Invalid size: ", readInt));
    }
    ...
    Iterator<Map.Entry<K, V>> entrySetIterator() {
        ...
        return new CompactHashMap<K, V>.Itr<Map.Entry<K, V>>() { // from class: com.google.common.collect.CompactHashMap.2
            ...
            public Map.Entry<K, V> mo7591getOutput(int i) {

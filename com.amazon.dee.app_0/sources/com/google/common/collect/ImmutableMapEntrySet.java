...
public abstract class ImmutableMapEntrySet<K, V> extends ImmutableSet<Map.Entry<K, V>> {
    ...
    private static class EntrySetSerializedForm<K, V> implements Serializable {
        ...
        Object readResolve() {
            return this.map.mo7737entrySet();
        }
    }
    ...
    static final class RegularEntrySet<K, V> extends ImmutableMapEntrySet<K, V> {
        ...
        public UnmodifiableIterator<Map.Entry<K, V>> mo8029iterator() {
            return this.entries.mo8029iterator();
        }
    }
    ...
    public boolean contains(@NullableDecl Object obj) {
        if (obj instanceof Map.Entry) {
            ...
            V mo7740get = map().mo7740get(entry.getKey());
            return mo7740get != null && mo7740get.equals(entry.getValue());
        }
        return false;
    }

...
public final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    public static class EntrySet<K, V> extends ImmutableSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            if (obj instanceof Map.Entry) {
                ...
                return value != null && value.equals(this.map.mo7740get(key));
            }
            return false;
        }
    ...
    static final class KeySet<K> extends ImmutableSet<K> {
        ...
        public boolean contains(@NullableDecl Object obj) {
            return this.map.mo7740get(obj) != null;
        }
        ...
        @Override // com.google.common.collect.ImmutableSet, com.google.common.collect.ImmutableCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set, java.util.NavigableSet, com.google.common.collect.SortedIterable
        /* renamed from: iterator */
        public UnmodifiableIterator<K> mo8029iterator() {
            return asList().mo8029iterator();
        }
    }
    ...
    */
    ...
    private static IllegalArgumentException duplicateKeyException(Object obj, Object obj2, Object[] objArr, int i) {
        ...
        return new IllegalArgumentException(GeneratedOutlineSupport1.outline93(GeneratedOutlineSupport1.outline106(valueOf4.length() + valueOf3.length() + valueOf2.length() + valueOf.length() + 39, "Multiple entries with same key: ", valueOf, Config.Compare.EQUAL_TO, valueOf2), " and ", valueOf3, Config.Compare.EQUAL_TO, valueOf4));
    }

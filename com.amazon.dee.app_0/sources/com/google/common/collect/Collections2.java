...
public final class Collections2 {
    ...
    public static final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public String toString() {
            ...
            return GeneratedOutlineSupport1.outline30(valueOf.length() + 30, "orderedPermutationCollection(", valueOf, ")");
        }
    }
    ...
    private static final class OrderedPermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        public List<E> mo8230computeNext() {
    ...
    private static final class PermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public String toString() {
            String valueOf = String.valueOf(this.inputList);
            return GeneratedOutlineSupport1.outline30(valueOf.length() + 14, "permutations(", valueOf, ")");
        }
    }
    ...
    public static String toStringImpl(Collection<?> collection) {
        ...
        newStringBuilderForCollection.append(JsonReaderKt.BEGIN_LIST);
        boolean z = true;
        ...
        newStringBuilderForCollection.append(JsonReaderKt.END_LIST);

...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    public final class AsSet extends ImmutableSortedSet<C> {
        ...
        public int indexOf(Object obj) {
            if (contains(obj)) {
                ...
                long j = 0;
                UnmodifiableIterator mo8029iterator = ImmutableRangeSet.this.ranges.mo8029iterator();
                while (mo8029iterator.hasNext()) {
                    Range range = (Range) mo8029iterator.next();
        ...
        public int size() {
            ...
            if (num == null) {
                ...
                UnmodifiableIterator mo8029iterator = ImmutableRangeSet.this.ranges.mo8029iterator();
                while (mo8029iterator.hasNext()) {
                    j += ContiguousSet.create((Range) mo8029iterator.next(), this.domain).size();
                    if (j >= 2147483647L) {
                        break;
                    }
                }
        ...
        ImmutableSortedSet<C> subSet(Range<C> range) {
            return ImmutableRangeSet.this.mo7780subRangeSet((Range) range).asSet(this.domain);
        }
        ...
        public UnmodifiableIterator<C> mo8008descendingIterator() {
            return new AbstractIterator<C>() { // from class: com.google.common.collect.ImmutableRangeSet.AsSet.2
                ...
                {
                    this.rangeItr = ImmutableRangeSet.this.ranges.reverse().mo8029iterator();
                }

                /* JADX INFO: Access modifiers changed from: protected */
                @Override // com.google.common.collect.AbstractIterator
                /* renamed from: computeNext */
                public C mo8230computeNext() {
        ...
        public UnmodifiableIterator<C> mo8029iterator() {
            return new AbstractIterator<C>() { // from class: com.google.common.collect.ImmutableRangeSet.AsSet.1
                ...
                {
                    this.rangeItr = ImmutableRangeSet.this.ranges.mo8029iterator();
                }
                ...
                public C mo8230computeNext() {
                    while (!this.elemItr.hasNext()) {
                        if (this.rangeItr.hasNext()) {
                            this.elemItr = ContiguousSet.create(this.rangeItr.next(), AsSet.this.domain).mo8029iterator();
                        } else {
                            return (C) endOfData();
                        }
                    }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public Builder<C> addAll(RangeSet<C> rangeSet) {
            return addAll(rangeSet.mo7778asRanges());
        }
        ...
        public ImmutableRangeSet<C> build() {
            ...
            while (peekingIterator.hasNext()) {
                ...
                builder.mo7849add((ImmutableList.Builder) range);
            }
            ImmutableList mo7852build = builder.mo7852build();
            if (mo7852build.isEmpty()) {
                return ImmutableRangeSet.of();
            }
            if (mo7852build.size() == 1 && ((Range) Iterables.getOnlyElement(mo7852build)).equals(Range.all())) {
                return ImmutableRangeSet.all();
            }
            return new ImmutableRangeSet<>(mo7852build);
        }
    ...
    public final class ComplementRanges extends ImmutableList<Range<C>> {
        ...
        /* renamed from: get */
        public Range<C> mo7786get(int i) {
            Cut<C> cut;
            Cut<C> cut2;
    ...
    public static <C extends Comparable> ImmutableRangeSet<C> copyOf(RangeSet<C> rangeSet) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.copyOf((Collection) rangeSet.mo7778asRanges()));
    }
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        if (!this.ranges.isEmpty() && !range.isEmpty()) {
            ...
            return (ImmutableList<Range<C>>) new ImmutableList<Range<C>>() { // from class: com.google.common.collect.ImmutableRangeSet.1
                ...
                @Override // java.util.List
                /* renamed from: get */
                public Range<C> mo7781get(int i2) {
    ...
    public ImmutableRangeSet<C> intersection(RangeSet<C> rangeSet) {
        TreeRangeSet create = TreeRangeSet.create(this);
        create.removeAll(rangeSet.mo7779complement());
        return copyOf(create);
    }
    ...
    public ImmutableRangeSet<C> union(RangeSet<C> rangeSet) {
        return unionOf(Iterables.concat(mo7778asRanges(), rangeSet.mo7778asRanges()));
    }
    ...
    public ImmutableSet<Range<C>> mo7777asDescendingSetOfRanges() {
        if (this.ranges.isEmpty()) {
    ...
    public ImmutableSet<Range<C>> mo7778asRanges() {
        if (this.ranges.isEmpty()) {
            return ImmutableSet.of();
        }
    ...
    public ImmutableRangeSet<C> mo7779complement() {
    ...
    public ImmutableRangeSet<C> mo7780subRangeSet(Range<C> range) {
        if (!isEmpty()) {
            Range<C> span = span();
            if (range.encloses(span)) {
                return this;

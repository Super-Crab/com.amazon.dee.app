...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    private static final RangeMap EMPTY_SUB_RANGE_MAP = new RangeMap() { // from class: com.google.common.collect.TreeRangeMap.1
        ...
        public Map<Range, Object> mo7772asDescendingMapOfRanges() {
            return Collections.emptyMap();
        }

        @Override // com.google.common.collect.RangeMap
        /* renamed from: asMapOfRanges */
        public Map<Range, Object> mo7773asMapOfRanges() {
            return Collections.emptyMap();
        }
        ...
        public void put(Range range, Object obj) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline30(valueOf.length() + 46, "Cannot insert range ", valueOf, " into an empty subRangeMap"));
        }

        @Override // com.google.common.collect.RangeMap
        public void putAll(RangeMap rangeMap) {
            if (rangeMap.mo7773asMapOfRanges().isEmpty()) {
                return;
            }
        ...
        public RangeMap mo7776subRangeMap(Range range) {
            Preconditions.checkNotNull(range);
            return this;
        }
    };
    ...
    public final class AsMapOfRanges extends Maps.IteratorBasedAbstractMap<Range<K>, V> {
        ...
        public V get(@NullableDecl Object obj) {
            if (obj instanceof Range) {
                ...
                if (rangeMapEntry != null && rangeMapEntry.mo8108getKey().equals(range)) {
                    return (V) rangeMapEntry.mo7742getValue();
                }
                return null;
            }
            return null;
    ...
    public class SubRangeMap implements RangeMap<K, V> {
            ...
            Iterator<Map.Entry<Range<K>, V>> entryIterator() {
                if (!SubRangeMap.this.subRange.isEmpty()) {
                    ...
                    return new AbstractIterator<Map.Entry<Range<K>, V>>() { // from class: com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.3
                        ...
                        public Map.Entry<Range<K>, V> mo8230computeNext() {
                            while (it2.hasNext()) {
                                ...
                                if (rangeMapEntry.getLowerBound().compareTo((Cut<K>) SubRangeMap.this.subRange.upperBound) < 0) {
                                    if (rangeMapEntry.getUpperBound().compareTo((Cut<K>) SubRangeMap.this.subRange.lowerBound) > 0) {
                                        return Maps.immutableEntry(rangeMapEntry.mo8108getKey().intersection(SubRangeMap.this.subRange), rangeMapEntry.mo7742getValue());
                                    }
                                } else {
                ...
                try {
                    if (obj instanceof Range) {
                        ...
                        if (SubRangeMap.this.subRange.encloses(range) && !range.isEmpty()) {
                            ...
                            if (rangeMapEntry != null && rangeMapEntry.mo8108getKey().isConnected(SubRangeMap.this.subRange) && rangeMapEntry.mo8108getKey().intersection(SubRangeMap.this.subRange).equals(range)) {
                                return (V) rangeMapEntry.mo7742getValue();
                            }
                        }
                    }
        ...
        @Override // com.google.common.collect.RangeMap
        /* renamed from: asDescendingMapOfRanges */
        public Map<Range<K>, V> mo7772asDescendingMapOfRanges() {
        ...
        @Override // com.google.common.collect.RangeMap
        /* renamed from: asMapOfRanges */
        public Map<Range<K>, V> mo7773asMapOfRanges() {
        ...
        @Override // com.google.common.collect.RangeMap
        /* renamed from: subRangeMap */
        public RangeMap<K, V> mo7776subRangeMap(Range<K> range) {
            if (!range.isConnected(this.subRange)) {
                return TreeRangeMap.this.emptySubRangeMap();
            }
            return TreeRangeMap.this.mo7776subRangeMap(range.intersection(this.subRange));
        }
    ...
    private static <K extends Comparable, V> Range<K> coalesce(Range<K> range, V v, @NullableDecl Map.Entry<Cut<K>, RangeMapEntry<K, V>> entry) {
        return (entry == null || !entry.getValue().mo8108getKey().isConnected(range) || !entry.getValue().mo7742getValue().equals(v)) ? range : range.span(entry.getValue().mo8108getKey());
    }
    ...
    @Override // com.google.common.collect.RangeMap
    public void putAll(RangeMap<K, V> rangeMap) {
        for (Map.Entry<Range<K>, V> entry : rangeMap.mo7773asMapOfRanges().entrySet()) {
    ...
    public void remove(Range<K> range) {
        ...
        if (lowerEntry != null) {
            ...
            if (value.getUpperBound().compareTo(range.lowerBound) > 0) {
                if (value.getUpperBound().compareTo(range.upperBound) > 0) {
                    putRangeMapEntry(range.upperBound, value.getUpperBound(), lowerEntry.getValue().mo7742getValue());
                }
                putRangeMapEntry(value.getLowerBound(), range.lowerBound, lowerEntry.getValue().mo7742getValue());
            }
        }
        ...
        if (lowerEntry2 != null) {
            ...
            if (value2.getUpperBound().compareTo(range.upperBound) > 0) {
                putRangeMapEntry(range.upperBound, value2.getUpperBound(), lowerEntry2.getValue().mo7742getValue());
            }
        }
    ...
    public Range<K> span() {
        ...
        if (firstEntry != null) {
            return Range.create(firstEntry.getValue().mo8108getKey().lowerBound, lastEntry.getValue().mo8108getKey().upperBound);
        }
        throw new NoSuchElementException();
    }

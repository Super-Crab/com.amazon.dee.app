...
public final class EnumMultiset<E extends Enum<E>> extends AbstractMultiset<E> implements Serializable {
    ...
    abstract class Itr<T> implements Iterator<T> {
        ...
        public T next() {
            if (hasNext()) {
                T mo7623output = mo7623output(this.index);
                int i = this.index;
                this.toRemove = i;
                this.index = i + 1;
                return mo7623output;
    ...
    void checkIsE(@NullableDecl Object obj) {
        ...
        throw new ClassCastException(GeneratedOutlineSupport1.outline31(valueOf2.length() + valueOf.length() + 21, "Expected an ", valueOf, " but got ", valueOf2));
    }
    ...
    public Iterator<Multiset.Entry<E>> entryIterator() {
        return new EnumMultiset<E>.Itr<Multiset.Entry<E>>() { // from class: com.google.common.collect.EnumMultiset.2
            ...
            @Override // com.google.common.collect.EnumMultiset.Itr
            /* renamed from: output */
            public Multiset.Entry<E> mo7623output(final int i) {

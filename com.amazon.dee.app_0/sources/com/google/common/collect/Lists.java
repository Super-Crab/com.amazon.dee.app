...
public final class Lists {
    ...
    private static final class CharSequenceAsList extends AbstractList<Character> {
        ...
        @Override // java.util.AbstractList, java.util.List
        /* renamed from: get */
        public Character mo7879get(int i) {
    ...
    public static final class StringAsImmutableList extends ImmutableList<Character> {
        ...
        /* renamed from: get */
        public Character mo7881get(int i) {
            Preconditions.checkElementIndex(i, size());
        ...
        public ImmutableList<Character> mo7882subList(int i, int i2) {
            Preconditions.checkPositionIndexes(i, i2, size());
    ...
    public static class TransformingRandomAccessList<F, T> extends AbstractList<T> implements RandomAccess, Serializable {
        ...
        @Override // java.util.AbstractList, java.util.List
        public T get(int i) {
            return this.function.mo8172apply((F) this.fromList.get(i));
        }
        ...
        public ListIterator<T> listIterator(int i) {
            return new TransformedListIterator<F, T>(this.fromList.listIterator(i)) { // from class: com.google.common.collect.Lists.TransformingRandomAccessList.1
                ...
                public T mo7907transform(F f) {
                    return TransformingRandomAccessList.this.function.mo8172apply(f);
                }
            };
        }
        ...
        @Override // java.util.AbstractList, java.util.List
        public T remove(int i) {
            return this.function.mo8172apply((F) this.fromList.remove(i));
        }
    ...
    public static class TransformingSequentialList<F, T> extends AbstractSequentialList<T> implements Serializable {
        ...
        public ListIterator<T> listIterator(int i) {
            return new TransformedListIterator<F, T>(this.fromList.listIterator(i)) { // from class: com.google.common.collect.Lists.TransformingSequentialList.1
                ...
                /* renamed from: transform */
                public T mo7907transform(F f) {
                    return TransformingSequentialList.this.function.mo8172apply(f);
                }
            };
        }

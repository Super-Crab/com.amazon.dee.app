...
public abstract class MultimapBuilder<K0, V0> {
    ...
    public static abstract class MultimapBuilderWithKeys<K0> {
        ...
        public <V0 extends Enum<V0>> SetMultimapBuilder<K0, V0> enumSetValues(final Class<V0> cls) {
            ...
            return new SetMultimapBuilder<K0, V0>() { // from class: com.google.common.collect.MultimapBuilder.MultimapBuilderWithKeys.6
                ...
                public <K extends K0, V extends V0> SetMultimap<K, V> mo7950build() {
        ...
        public ListMultimapBuilder<K0, Object> linkedListValues() {
            return new ListMultimapBuilder<K0, Object>() { // from class: com.google.common.collect.MultimapBuilder.MultimapBuilderWithKeys.2
                ...
                /* renamed from: build */
                public <K extends K0, V> ListMultimap<K, V> mo7950build() {
        ...
        public SetMultimapBuilder<K0, Object> hashSetValues(final int i) {
            ...
            return new SetMultimapBuilder<K0, Object>() { // from class: com.google.common.collect.MultimapBuilder.MultimapBuilderWithKeys.3
                @Override // com.google.common.collect.MultimapBuilder.SetMultimapBuilder, com.google.common.collect.MultimapBuilder
                /* renamed from: build  reason: collision with other method in class */
                public <K extends K0, V> SetMultimap<K, V> mo7950build() {
        ...
        public <V0> SortedSetMultimapBuilder<K0, V0> treeSetValues(final Comparator<V0> comparator) {
            ...
            return new SortedSetMultimapBuilder<K0, V0>() { // from class: com.google.common.collect.MultimapBuilder.MultimapBuilderWithKeys.5
                ...
                /* renamed from: build */
                public <K extends K0, V extends V0> SortedSetMultimap<K, V> mo7950build() {
    ...
    /* renamed from: build */
    public abstract <K extends K0, V extends V0> Multimap<K, V> mo7950build();

    /* renamed from: build */
    public <K extends K0, V extends V0> Multimap<K, V> mo7951build(Multimap<? extends K, ? extends V> multimap) {
        Multimap<K, V> mo7950build = mo7950build();
        mo7950build.putAll(multimap);
        return mo7950build;
    }
    ...
    public static abstract class ListMultimapBuilder<K0, V0> extends MultimapBuilder<K0, V0> {
        ...
        /* renamed from: build */
        public abstract <K extends K0, V extends V0> ListMultimap<K, V> mo7950build();

        @Override // com.google.common.collect.MultimapBuilder
        /* renamed from: build */
        public <K extends K0, V extends V0> ListMultimap<K, V> mo7951build(Multimap<? extends K, ? extends V> multimap) {
            return (ListMultimap) super.mo7951build((Multimap) multimap);
        }
    }
    ...
    public static abstract class SetMultimapBuilder<K0, V0> extends MultimapBuilder<K0, V0> {
        ...
        @Override // com.google.common.collect.MultimapBuilder
        /* renamed from: build  reason: collision with other method in class */
        public abstract <K extends K0, V extends V0> SetMultimap<K, V> mo7950build();

        @Override // com.google.common.collect.MultimapBuilder
        /* renamed from: build  reason: collision with other method in class */
        public <K extends K0, V extends V0> SetMultimap<K, V> mo7951build(Multimap<? extends K, ? extends V> multimap) {
            return (SetMultimap) super.mo7951build((Multimap) multimap);
        }
    }
    ...
    public static abstract class SortedSetMultimapBuilder<K0, V0> extends SetMultimapBuilder<K0, V0> {
        ...
        @Override // com.google.common.collect.MultimapBuilder.SetMultimapBuilder, com.google.common.collect.MultimapBuilder
        /* renamed from: build */
        public abstract <K extends K0, V extends V0> SortedSetMultimap<K, V> mo7950build();

        @Override // com.google.common.collect.MultimapBuilder.SetMultimapBuilder, com.google.common.collect.MultimapBuilder
        /* renamed from: build */
        public <K extends K0, V extends V0> SortedSetMultimap<K, V> mo7951build(Multimap<? extends K, ? extends V> multimap) {
            return (SortedSetMultimap) super.mo7951build((Multimap) multimap);
        }
    }
}

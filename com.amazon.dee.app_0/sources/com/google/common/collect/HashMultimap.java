...
public final class HashMultimap<K, V> extends HashMultimapGwtSerializationDependencies<K, V> {
    ...
    public /* bridge */ /* synthetic */ Set mo8104get(@NullableDecl Object obj) {
        return super.mo8104get((HashMultimap<K, V>) obj);
    }
    ...
    public /* bridge */ /* synthetic */ Set mo8088replaceValues(@NullableDecl Object obj, Iterable iterable) {
        return super.mo8088replaceValues((HashMultimap<K, V>) obj, iterable);
    }
    ...
    private HashMultimap(Multimap<? extends K, ? extends V> multimap) {
        super(Platform.newHashMapWithExpectedSize(multimap.mo8105keySet().size()));
        this.expectedValuesPerKey = 2;
        putAll(multimap);
    }
}

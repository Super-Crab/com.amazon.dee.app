...
public final class FilteredEntrySetMultimap<K, V> extends FilteredEntryMultimap<K, V> implements FilteredSetMultimap<K, V> {
    ...
    public /* bridge */ /* synthetic */ Collection mo8104get(Object obj) {
        return mo8104get((FilteredEntrySetMultimap<K, V>) obj);
    }
    ...
    public /* bridge */ /* synthetic */ Collection mo8088replaceValues(Object obj, Iterable iterable) {
        return mo8088replaceValues((FilteredEntrySetMultimap<K, V>) obj, iterable);
    }
    ...
    public Set<Map.Entry<K, V>> mo7870createEntries() {
        return Sets.filter(mo7647unfiltered().mo8077entries(), entryPredicate());
    }
    ...
    public Set<V> mo8104get(K k) {
        return (Set) super.mo8104get((FilteredEntrySetMultimap<K, V>) k);
    }
    ...
    public Set<V> mo8088replaceValues(K k, Iterable<? extends V> iterable) {
        return (Set) super.mo8088replaceValues((FilteredEntrySetMultimap<K, V>) k, (Iterable) iterable);
    }

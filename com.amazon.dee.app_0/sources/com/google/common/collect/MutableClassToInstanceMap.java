...
public final class MutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    ...
    static <B> Map.Entry<Class<? extends B>, B> checkedEntry(final Map.Entry<Class<? extends B>, B> entry) {
        return new ForwardingMapEntry<Class<? extends B>, B>() { // from class: com.google.common.collect.MutableClassToInstanceMap.1
            ...
            public Map.Entry<Class<? extends B>, B> mo8280delegate() {
                return entry;
            }
        };
    }
    ...
    private Object writeReplace() {
        return new SerializedForm(mo8280delegate());
    }
    ...
    public Set<Map.Entry<Class<? extends B>, B>> entrySet() {
        return new ForwardingSet<Map.Entry<Class<? extends B>, B>>() { // from class: com.google.common.collect.MutableClassToInstanceMap.2
            ...
            public Iterator<Map.Entry<Class<? extends B>, B>> iterator() {
                return new TransformedIterator<Map.Entry<Class<? extends B>, B>, Map.Entry<Class<? extends B>, B>>(this, mo8280delegate().iterator()) { // from class: com.google.common.collect.MutableClassToInstanceMap.2.1
            ...
            public Set<Map.Entry<Class<? extends B>, B>> mo8280delegate() {
                return MutableClassToInstanceMap.this.mo8280delegate().entrySet();
            }
        };
    }
    ...
    /* renamed from: delegate  reason: collision with other method in class */
    public Map<Class<? extends B>, B> mo8280delegate() {

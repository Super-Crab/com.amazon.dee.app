...
public final class MoreExecutors {
    ...
    private static final class ScheduledListeningDecorator extends ListeningDecorator implements ListeningScheduledExecutorService {
        ...
        public ListenableScheduledFuture<?> mo8283scheduleAtFixedRate(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        ...
        public ListenableScheduledFuture<?> mo8284scheduleWithFixedDelay(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
            NeverSuccessfulListenableFutureTask neverSuccessfulListenableFutureTask = new NeverSuccessfulListenableFutureTask(runnable);
        ...
        public ListenableScheduledFuture<?> mo8281schedule(Runnable runnable, long j, TimeUnit timeUnit) {
        ...
        @Override // com.google.common.util.concurrent.ListeningScheduledExecutorService, java.util.concurrent.ScheduledExecutorService
        /* renamed from: schedule */
        public <V> ListenableScheduledFuture<V> mo8282schedule(Callable<V> callable, long j, TimeUnit timeUnit) {
    ...
    */
    ...
    private static <T> ListenableFuture<T> submitAndAddQueueListener(ListeningExecutorService listeningExecutorService, Callable<T> callable, final BlockingQueue<Future<T>> blockingQueue) {
        final ListenableFuture<T> mo8259submit = listeningExecutorService.mo8259submit((Callable) callable);
        mo8259submit.addListener(new Runnable() { // from class: com.google.common.util.concurrent.MoreExecutors.1
            @Override // java.lang.Runnable
            public void run() {
                blockingQueue.add(mo8259submit);
            }
        }, directExecutor());
        return mo8259submit;
    }
    ...
    static class Application {
        ...
        final void addDelayedShutdownHook(final ExecutorService executorService, final long j, final TimeUnit timeUnit) {
            ...
            addShutdownHook(MoreExecutors.newThread(GeneratedOutlineSupport1.outline29(valueOf.length() + 24, "DelayedShutdownHook-for-", valueOf), new Runnable(this) { // from class: com.google.common.util.concurrent.MoreExecutors.Application.1
                @Override // java.lang.Runnable
                public void run() {
                    try {
                        executorService.shutdown();

...
public abstract class SmoothRateLimiter extends RateLimiter {
    ...
    static final class SmoothBursty extends SmoothRateLimiter {
        ...
        void doSetRate(double d, double d2) {
            ...
            double d4 = FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
    ...
    static final class SmoothWarmingUp extends SmoothRateLimiter {
        ...
        void doSetRate(double d, double d2) {
            ...
            double d5 = this.thresholdPermits;
            this.maxPermits = ((j * 2.0d) / (d2 + d4)) + d5;
            double d6 = d4 - d2;
            double d7 = this.maxPermits;
            this.slope = d6 / (d7 - d5);
            if (d3 == Double.POSITIVE_INFINITY) {
                this.storedPermits = FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
                return;
            }
            if (d3 != FrostVideoEffectController.VIDEO_STRENGTH_CLEAR) {

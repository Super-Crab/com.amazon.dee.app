...
public abstract class AbstractListeningExecutorService extends AbstractExecutorService implements ListeningExecutorService {
    ...
    public /* bridge */ /* synthetic */ Future mo8258submit(Runnable runnable, @NullableDecl Object obj) {
        return mo8258submit(runnable, (Runnable) obj);
    }

    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService, com.google.common.util.concurrent.ListeningExecutorService
    /* renamed from: submit */
    public ListenableFuture<?> mo8257submit(Runnable runnable) {
        return (ListenableFuture) super.submit(runnable);
    }

    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService, com.google.common.util.concurrent.ListeningExecutorService
    /* renamed from: submit */
    public <T> ListenableFuture<T> mo8258submit(Runnable runnable, @NullableDecl T t) {
        return (ListenableFuture) super.submit(runnable, (Runnable) t);
    }

    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService, com.google.common.util.concurrent.ListeningExecutorService
    /* renamed from: submit */
    public <T> ListenableFuture<T> mo8259submit(Callable<T> callable) {

...
public interface ListeningExecutorService extends ExecutorService {
    ...
    /* renamed from: submit */
    ListenableFuture<?> mo8257submit(Runnable runnable);

    @Override // java.util.concurrent.ExecutorService, com.google.common.util.concurrent.ListeningExecutorService
    /* renamed from: submit */
    <T> ListenableFuture<T> mo8258submit(Runnable runnable, T t);

    @Override // java.util.concurrent.ExecutorService, com.google.common.util.concurrent.ListeningExecutorService
    /* renamed from: submit */
    <T> ListenableFuture<T> mo8259submit(Callable<T> callable);
}

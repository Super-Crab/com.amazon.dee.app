...
public final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        public Hasher mo8226putString(CharSequence charSequence, Charset charset) {
                ...
                while (i < length) {
                    ...
                    if (charAt5 < 128) {
                        ...
                        if (codePointAt != charAt5) {
                            ...
                            mo8196putBytes(charSequence.subSequence(i, length).toString().getBytes(charset));
                            return this;
                        }
                    }
                    i++;
            ...
            return super.mo8226putString(charSequence, charset);
        }
        ...
        public Hasher mo8221putBytes(ByteBuffer byteBuffer) {
            ...
            while (byteBuffer.remaining() >= 4) {
                mo8224putInt(byteBuffer.getInt());
            }
    ...
    public static long charToThreeUtf8Bytes(char c) {
        return (((c & Constants.DEFAULT_IMAGE_CHAR) | 128) << 16) | (((c >>> '\f') | 480) & 255) | ((((c >>> 6) & 63) | 128) << 8);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static long charToTwoUtf8Bytes(char c) {
        return (((c & Constants.DEFAULT_IMAGE_CHAR) | 128) << 8) | (((c >>> 6) | 960) & 255);
    }

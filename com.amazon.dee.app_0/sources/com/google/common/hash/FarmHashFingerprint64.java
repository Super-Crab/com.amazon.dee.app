    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            if (i7 == i4) {
                ...
                return hashLength16(GeneratedOutlineSupport1.outline9(shiftMix(load643), K0, hashLength16(jArr[0], jArr2[0], j3), rotateRight4), hashLength16(jArr[1], jArr2[1], j3) + rotateRight5, j3);
            }
            shiftMix = j2;
            j = load642;
            load64 = rotateRight3;

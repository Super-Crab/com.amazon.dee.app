...
public final class TypeResolver {
    ...
    public static class WildcardCapturer {
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            ...
            StringBuilder sb = new StringBuilder(GeneratedOutlineSupport1.outline6(join, 33));
            sb.append("capture#");
    ...
    public static <T> T expectArgument(Class<T> cls, Object obj) {
        try {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline30(simpleName.length() + valueOf.length() + 10, valueOf, " is not a ", simpleName));
        }
    }
    ...
    public static void populateTypeMappings(final Map<TypeVariableKey, Type> map, Type type, final Type type2) {
        ...
        new TypeVisitor() { // from class: com.google.common.reflect.TypeResolver.1
            ...
            void visitClass(Class<?> cls) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline31(valueOf2.length() + valueOf.length() + 25, "No type mapping from ", valueOf, " to ", valueOf2));
            }
    ...
    public static class TypeTable {
        ...
        Type resolveInternal(TypeVariable<?> typeVariable, TypeTable typeTable) {
            Type mo7740get = this.map.mo7740get(new TypeVariableKey(typeVariable));
            if (mo7740get == null) {
            ...
            return new TypeResolver(typeTable).resolveType(mo7740get);
        }

        final TypeTable where(Map<TypeVariableKey, ? extends Type> map) {
            ImmutableMap.Builder builder = ImmutableMap.builder();
            builder.mo7831putAll(this.map);
            for (Map.Entry<TypeVariableKey, ? extends Type> entry : map.entrySet()) {
                ...
                builder.mo7828put(key, value);
            }
            return new TypeTable(builder.mo7826build());
        }

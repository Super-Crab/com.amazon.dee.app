...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
    ...
    public static class ConstructorInvokable<T> extends Invokable<T, T> {
        ...
        final Object invokeInternal(@NullableDecl Object obj, Object[] objArr) throws InvocationTargetException, IllegalAccessException {
            try {
                ...
                throw new RuntimeException(GeneratedOutlineSupport1.outline29(valueOf.length() + 8, valueOf, " failed."), e);
            }
        }
    ...
    public final ImmutableList<TypeToken<? extends Throwable>> getExceptionTypes() {
        ...
        for (Type type : getGenericExceptionTypes()) {
            builder.mo7849add((ImmutableList.Builder) TypeToken.of(type));
        }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i = 0; i < genericParameterTypes.length; i++) {
            builder.mo7849add((ImmutableList.Builder) new Parameter(this, i, TypeToken.of(genericParameterTypes[i]), parameterAnnotations[i]));
        }
        return builder.mo7852build();
    }
    ...
    public final <R1 extends R> Invokable<T, R1> returning(TypeToken<R1> typeToken) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline31(valueOf2.length() + valueOf.length() + 35, "Invokable is known to return ", valueOf, ", not ", valueOf2));
    }
}

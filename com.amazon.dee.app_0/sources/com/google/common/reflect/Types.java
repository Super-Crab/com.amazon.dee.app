...
public final class Types {
    private static final Function<Type, String> TYPE_NAME = new Function<Type, String>() { // from class: com.google.common.reflect.Types.1
        ...
        public String mo8172apply(Type type) {
    ...
    public enum JavaVersion {
        JAVA6 { // from class: com.google.common.reflect.Types.JavaVersion.1
            ...
            public GenericArrayType mo8254newArrayType(Type type) {
        ...
        JAVA7 { // from class: com.google.common.reflect.Types.JavaVersion.2
            @Override // com.google.common.reflect.Types.JavaVersion
            /* renamed from: newArrayType */
            Type mo8254newArrayType(Type type) {
                if (type instanceof Class) {
        ...
        JAVA8 { // from class: com.google.common.reflect.Types.JavaVersion.3
            ...
            /* renamed from: newArrayType */
            Type mo8254newArrayType(Type type) {
                return JavaVersion.JAVA7.mo8254newArrayType(type);
            }
        ...
        JAVA9 { // from class: com.google.common.reflect.Types.JavaVersion.4
            ...
            /* renamed from: newArrayType */
            Type mo8254newArrayType(Type type) {
                return JavaVersion.JAVA8.mo8254newArrayType(type);
            }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: newArrayType */
        public abstract Type mo8254newArrayType(Type type);
        ...
        final ImmutableList<Type> usedInGenericType(Type[] typeArr) {
            ...
            for (Type type : typeArr) {
                builder.mo7849add((ImmutableList.Builder) usedInGenericType(type));
            }
    ...
    public static final class TypeVariableInvocationHandler implements InvocationHandler {
        ...
        static {
            ...
            for (Method method : TypeVariableImpl.class.getMethods()) {
                if (method.getDeclaringClass().equals(TypeVariableImpl.class)) {
                    ...
                    builder.mo7828put(method.getName(), method);
                }
            }
            typeVariableMethods = builder.mo7826build();
        }
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            ...
            Method mo7740get = typeVariableMethods.mo7740get(name);
            if (mo7740get != null) {
                try {
                    return mo7740get.invoke(this.typeVariableImpl, objArr);
    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder(WebConstants.UriConstants.QUESTIONMARK_KEY);
            UnmodifiableIterator<Type> mo8029iterator = this.lowerBounds.mo8029iterator();
            while (mo8029iterator.hasNext()) {
                sb.append(" super ");
                sb.append(JavaVersion.CURRENT.typeName(mo8029iterator.next()));
            }
    ...
    public static Type newArrayType(Type type) {
        ...
        return JavaVersion.CURRENT.mo8254newArrayType(type);
    }

...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Subtitle decoding failed. streamFormat=");
        outline107.append(this.streamFormat);
        Log.e(TAG, outline107.toString(), subtitleDecoderException);
        clearOutput();
        replaceDecoder();
    }
    ...
    public void render(long j, long j2) {
        ...
        if (this.nextSubtitle == null) {
            ...
            try {
                this.nextSubtitle = ((SubtitleDecoder) Assertions.checkNotNull(this.decoder)).mo7430dequeueOutputBuffer();
        ...
        while (!this.inputStreamEnded) {
            try {
                ...
                if (subtitleInputBuffer == null) {
                    subtitleInputBuffer = ((SubtitleDecoder) Assertions.checkNotNull(this.decoder)).mo7429dequeueInputBuffer();
                    if (subtitleInputBuffer == null) {
                        return;
                    }

...
public final class WebvttParserUtil {
    ...
    public static long parseTimestampUs(String str) throws NumberFormatException {
        String[] splitAtFirst = Util.splitAtFirst(str, ArcusConfig.PATH_SEPARATOR);
        long j = 0;
    ...
    public static void validateWebvttHeaderLine(ParsableByteArray parsableByteArray) throws ParserException {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Expected WEBVTT. Got ");
        outline107.append(parsableByteArray.readLine());

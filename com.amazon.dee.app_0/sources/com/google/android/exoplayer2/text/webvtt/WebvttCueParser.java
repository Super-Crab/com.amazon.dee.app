...
public final class WebvttCueParser {
    ...
    public static final class StartTag {
        ...
        public static StartTag buildStartTag(String str, int i) {
            ...
            String[] split = Util.split(trim, ArcusConfig.PATH_SEPARATOR);
            String str3 = split[0];
            ...
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i != 4) {
                            if (i != 5) {
                                GeneratedOutlineSupport1.outline152("Unknown textAlignment: ", i, WebvttCueParser.TAG);
                                return null;
                            }
                        }
                    }
    ...
    private static int parseLineAnchor(String str) {
        ...
        if (c != 0) {
            ...
            GeneratedOutlineSupport1.outline168("Invalid anchor value: ", str, TAG);
    ...
    private static int parseTextAlignment(String str) {
        ...
        if (c != 0) {
            ...
            GeneratedOutlineSupport1.outline168("Invalid alignment value: ", str, TAG);
            return 2;
        }
        return 1;
    }
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        if (c != 0) {
            ...
            GeneratedOutlineSupport1.outline168("Invalid 'vertical' value: ", str, TAG);
            return Integer.MIN_VALUE;
        }
        return 1;
    }
    ...
    private static void parseCueSettingsList(String str, WebvttCueInfoBuilder webvttCueInfoBuilder) {
        ...
        while (matcher.find()) {
            ...
            try {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Skipping bad cue setting: ");
                outline107.append(matcher.group());
    ...
    private static WebvttCueInfo parseCue(@Nullable String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Skipping cue with bad header: ");
            outline107.append(matcher.group());
            Log.w(TAG, outline107.toString());
            return null;
        }

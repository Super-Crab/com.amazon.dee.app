...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    public static final Parcelable.Creator<DrmInitData> CREATOR = new Parcelable.Creator<DrmInitData>() { // from class: com.google.android.exoplayer2.drm.DrmInitData.1
        ...
        public DrmInitData mo7284createFromParcel(Parcel parcel) {
        ...
        public DrmInitData[] mo7285newArray(int i) {
    ...
    public static final class SchemeData implements Parcelable {
        public static final Parcelable.Creator<SchemeData> CREATOR = new Parcelable.Creator<SchemeData>() { // from class: com.google.android.exoplayer2.drm.DrmInitData.SchemeData.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SchemeData mo7286createFromParcel(Parcel parcel) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SchemeData[] mo7287newArray(int i) {
        ...
        public int hashCode() {
            if (this.hashCode == 0) {
                ...
                this.hashCode = Arrays.hashCode(this.data) + GeneratedOutlineSupport1.outline7(this.mimeType, (hashCode + (str == null ? 0 : str.hashCode())) * 31, 31);
            }

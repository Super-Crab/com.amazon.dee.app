...
public final class MediaCodecInfo {
    ...
    private void logAssumedSupport(String str) {
        StringBuilder outline115 = GeneratedOutlineSupport1.outline115("AssumedSupport [", str, "] [");
        outline115.append(this.name);
        outline115.append(", ");
        outline115.append(this.mimeType);
        outline115.append("] [");
        outline115.append(Util.DEVICE_DEBUG_INFO);
        outline115.append("]");
        Log.d(TAG, outline115.toString());
    }

    private void logNoSupport(String str) {
        StringBuilder outline115 = GeneratedOutlineSupport1.outline115("NoSupport [", str, "] [");
        outline115.append(this.name);
        outline115.append(", ");
        outline115.append(this.mimeType);
        outline115.append("] [");
    ...
    public boolean isAudioChannelCountSupportedV21(int i) {
        ...
        if (audioCapabilities == null) {
            ...
            logNoSupport(GeneratedOutlineSupport1.outline49("channelCount.support, ", i));
            return false;
        }
    }
    ...
    public boolean isAudioSampleRateSupportedV21(int i) {
        ...
        if (audioCapabilities == null) {
            ...
            logNoSupport(GeneratedOutlineSupport1.outline49("sampleRate.support, ", i));
            return false;
        }
    }
    ...
    public boolean isCodecSupported(Format format) {
        ...
        if (!this.mimeType.equals(mediaMimeType)) {
            logNoSupport(GeneratedOutlineSupport1.outline92(GeneratedOutlineSupport1.outline107("codec.mime "), format.codecs, ", ", mediaMimeType));
            return false;
        }
        Pair<Integer, Integer> codecProfileAndLevel = MediaCodecUtil.getCodecProfileAndLevel(format);
        ...
        if (!AmazonQuirks.shouldSkipProfileLevelCheck() && (this.isVideo || intValue == 42)) {
            ...
            logNoSupport(GeneratedOutlineSupport1.outline92(GeneratedOutlineSupport1.outline107("codec.profileLevel, "), format.codecs, ", ", mediaMimeType));
            return false;
        }
        return true;
    }
    ...
    public boolean isVideoSizeAndRateSupportedV21(int i, int i2, double d) {
        ...
        if (videoCapabilities == null) {
            ...
            if (i < i2 && needsRotatedVerticalResolutionWorkaround(this.name) && areSizeAndRateSupportedV21(videoCapabilities, i2, i, d)) {
                StringBuilder outline110 = GeneratedOutlineSupport1.outline110("sizeAndRate.rotated, ", i, ReactProperties.HereMapMarker.X, i2, ReactProperties.HereMapMarker.X);
                outline110.append(d);
                logAssumedSupport(outline110.toString());
                return true;
            }
            StringBuilder outline1102 = GeneratedOutlineSupport1.outline110("sizeAndRate.support, ", i, ReactProperties.HereMapMarker.X, i2, ReactProperties.HereMapMarker.X);
            outline1102.append(d);
            logNoSupport(outline1102.toString());
            return false;
        }
    }

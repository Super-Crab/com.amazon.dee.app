...
public interface AudioProcessor {
    ...
    public static final class AudioFormat {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("AudioFormat[sampleRate=");
            outline107.append(this.sampleRate);
            outline107.append(", channelCount=");
            outline107.append(this.channelCount);
            outline107.append(", encoding=");
            return GeneratedOutlineSupport1.outline85(outline107, this.encoding, JsonReaderKt.END_LIST);
        }
    }

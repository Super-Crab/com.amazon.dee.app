...
public final class VorbisUtil {
    ...
    private static CodeBook readBook(VorbisBitArray vorbisBitArray) throws ParserException {
        if (vorbisBitArray.readBits(24) == 5653314) {
            ...
            throw new ParserException(GeneratedOutlineSupport1.outline49("lookup type greater than 2 not decodable: ", readBits5));
        }
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("expected code book to start with [0x56, 0x43, 0x42] at ");
        outline107.append(vorbisBitArray.getPosition());
    ...
    private static void readFloors(VorbisBitArray vorbisBitArray) throws ParserException {
        ...
        for (int i = 0; i < readBits; i++) {
            ...
            if (readBits2 == 0) {
                ...
                throw new ParserException(GeneratedOutlineSupport1.outline49("floor type greater than 1 not decodable: ", readBits2));
            }
        }
    }
    ...
    public static boolean verifyVorbisHeaderCapturePattern(int i, ParsableByteArray parsableByteArray, boolean z) throws ParserException {
        if (parsableByteArray.bytesLeft() < 7) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("too short header: ");
            outline107.append(parsableByteArray.bytesLeft());
            throw new ParserException(outline107.toString());
        } else if (parsableByteArray.readUnsignedByte() != i) {
            if (!z) {
                throw new ParserException(GeneratedOutlineSupport1.outline32(i, GeneratedOutlineSupport1.outline107("expected header type ")));
            }
            return false;

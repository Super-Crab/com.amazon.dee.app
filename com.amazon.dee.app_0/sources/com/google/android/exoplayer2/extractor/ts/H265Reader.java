...
public final class H265Reader implements ElementaryStreamReader {
    ...
    @EnsuresNonNull({ContactsModuleConstants.OUTPUT, "sampleReader"})
    private void assertTracksCreated() {
        Assertions.checkStateNotNull(this.output);
        Util.castNonNull(this.sampleReader);
    }

    @RequiresNonNull({ContactsModuleConstants.OUTPUT, "sampleReader"})
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (readBits2 == 255) {
                    ...
                    if (readBits2 < fArr.length) {
                        ...
                        GeneratedOutlineSupport1.outline152("Unexpected aspect_ratio_idc value: ", readBits2, TAG);
                    }
                }
            }
            if (parsableNalUnitBitArray.readBit()) {

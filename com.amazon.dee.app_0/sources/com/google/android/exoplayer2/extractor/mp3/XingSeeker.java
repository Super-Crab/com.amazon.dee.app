...
final class XingSeeker implements Seeker {
    ...
    public static XingSeeker create(long j, long j2, MpegAudioUtil.Header header, ParsableByteArray parsableByteArray) {
        ...
        if (j != -1) {
            ...
            if (j != j3) {
                StringBuilder outline111 = GeneratedOutlineSupport1.outline111("XING data size mismatch: ", j, ", ");
    ...
    public long getTimeUs(long j) {
        ...
        return Math.round((j3 == j4 ? FrostVideoEffectController.VIDEO_STRENGTH_CLEAR : (d - j3) / (j4 - j3)) * (timeUsForTableIndex2 - timeUsForTableIndex)) + timeUsForTableIndex;
    }

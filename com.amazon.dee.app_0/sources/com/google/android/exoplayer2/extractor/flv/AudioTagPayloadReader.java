    ...
    protected boolean parseHeader(ParsableByteArray parsableByteArray) throws TagPayloadReader.UnsupportedFormatException {
        if (!this.hasParsedAudioDataHeader) {
            ...
            if (i == 2) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Audio format not supported: ");
                outline107.append(this.audioFormat);
                throw new TagPayloadReader.UnsupportedFormatException(outline107.toString());
            }

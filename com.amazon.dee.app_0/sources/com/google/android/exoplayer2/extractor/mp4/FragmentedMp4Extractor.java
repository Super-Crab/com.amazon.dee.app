...
public class FragmentedMp4Extractor implements Extractor {
    ...
    private static final int INITIAL_DEFAULT_ENCRYPTED_SAMPLE_SIZE = 16384;
    ...
    public static final class TrackBundle {
        ...
        public TrackEncryptionBox getEncryptionBoxIfEncrypted() {
            ...
            TrackEncryptionBox sampleDescriptionEncryptionBox = trackEncryptionBox != null ? trackEncryptionBox : this.moovSampleTable.track.getSampleDescriptionEncryptionBox(i);
    ...
    private static int checkNonNegative(int i) throws ParserException {
        ...
        throw new ParserException(GeneratedOutlineSupport1.outline49("Unexpected negative value: ", i));
    }
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (parseFullAtomVersion == 0) {
            ...
            GeneratedOutlineSupport1.outline152("Skipping unsupported emsg version: ", parseFullAtomVersion, TAG);
            return;
        } else {
    ...
    private static void parseSaio(ParsableByteArray parsableByteArray, TrackFragment trackFragment) throws ParserException {
        ...
        throw new ParserException(GeneratedOutlineSupport1.outline49("Unexpected saio entry count: ", readUnsignedIntToInt));
    }
    ...
    private static void parseSaiz(TrackEncryptionBox trackEncryptionBox, ParsableByteArray parsableByteArray, TrackFragment trackFragment) throws ParserException {
        ...
        StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Saiz sample count ", readUnsignedIntToInt, " is greater than fragment sample count");
        outline109.append(trackFragment.sampleCount);
        throw new ParserException(outline109.toString());
    }
    ...
    */
    ...
    private boolean readSample(ExtractorInput extractorInput) throws IOException {
        ...
        if (track.nalUnitLengthFieldLength != 0) {
        ...
        } else if (this.aesEncryptionKey == null || this.aesEncryptionIv == null || (i = this.sampleSize) < 16) {
            while (true) {
            ...
            if (bArr.length < i) {
                this.scratchBuffer = new byte[bArr.length * 2];
            }
            extractorInput.readFully(this.scratchBuffer, 0, this.sampleSize, false);
            this.aesUtil.resetIV(this.aesEncryptionIv);
            byte[] decryptCBC = this.aesUtil.decryptCBC(this.scratchBuffer, 0, i11);
            if (decryptCBC != null) {
                this.sampleData.reset(decryptCBC, decryptCBC.length);
                trackOutput.sampleData(this.sampleData, decryptCBC.length);
            }
            if (i10 > 0) {
                this.sampleData.reset(this.scratchBuffer, this.sampleSize);
                this.sampleData.setPosition(i11);
                trackOutput.sampleData(this.sampleData, i10);
            }
            if (decryptCBC.length + i10 == this.sampleSize) {
                z = true;
            }
            Assertions.checkArgument(z);
            this.sampleBytesWritten = decryptCBC.length + i10 + this.sampleBytesWritten;
        }
    ...
    private static void parseSenc(ParsableByteArray parsableByteArray, int i, TrackFragment trackFragment) throws ParserException {
        ...
        if ((parseFullAtomFlags & 1) == 0) {
            ...
            if (readUnsignedIntToInt == 0) {
                ...
                StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Senc sample count ", readUnsignedIntToInt, " is different from fragment sample count");
                outline109.append(trackFragment.sampleCount);
                throw new ParserException(outline109.toString());
            }
        }
    ...
    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster) {
        this(i, timestampAdjuster, null, null, null, Collections.emptyList());
    }
    ...
    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster, @Nullable Track track, List<Format> list) {
        this(i, timestampAdjuster, track, null, null, list, null);
    }

    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster, @Nullable Track track, @Nullable TrackOutput trackOutput) {
        this(i, timestampAdjuster, track, null, null, Collections.emptyList());
    }
    ...
    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster, @Nullable Track track, List<Format> list, @Nullable TrackOutput trackOutput) {
        this(i, timestampAdjuster, track, null, null, list, trackOutput);
    }

    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster, @Nullable Track track, @Nullable byte[] bArr, @Nullable byte[] bArr2, List<Format> list) {
        this(i, timestampAdjuster, track, bArr, bArr2, list, null);
    }

    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster, @Nullable Track track, @Nullable byte[] bArr, @Nullable byte[] bArr2, List<Format> list, @Nullable TrackOutput trackOutput) {
        ...
        if (bArr2 != null && bArr != null) {
            this.scratchBuffer = new byte[16384];
            this.aesUtil = new AESUtil();
            this.aesUtil.initKey(bArr2);
        }

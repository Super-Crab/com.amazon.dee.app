...
final class AtomParsers {
    ...
    */
    ...
    private static Pair<Long, String> parseMdhd(ParsableByteArray parsableByteArray) {
        ...
        outline107.append((char) (((readUnsignedShort >> 10) & 31) + 96));
        outline107.append((char) (((readUnsignedShort >> 5) & 31) + 96));
        outline107.append((char) ((readUnsignedShort & 31) + 96));
        return Pair.create(Long.valueOf(readUnsignedInt), outline107.toString());
    }
    ...
    public static Metadata parseMdtaFromMeta(Atom.ContainerAtom containerAtom) {
        ...
        while (parsableByteArray2.bytesLeft() > 8) {
            ...
            if (readInt4 >= 0 && readInt4 < strArr.length) {
                ...
                GeneratedOutlineSupport1.outline152("Skipped metadata with unknown key index: ", readInt4, TAG);
            }
    ...
    */
    ...
    public static List<TrackSampleTable> parseTraks(Atom.ContainerAtom containerAtom, GaplessInfoHolder gaplessInfoHolder, long j, @Nullable DrmInitData drmInitData, boolean z, boolean z2, Function<Track, Track> function) throws ParserException {
        ...
        for (int i = 0; i < containerAtom.containerChildren.size(); i++) {
            ...
            if (containerAtom2.type == 1953653099 && (mo8172apply = function.mo8172apply(parseTrak(containerAtom2, (Atom.LeafAtom) Assertions.checkNotNull(containerAtom.getLeafAtomOfType(Atom.TYPE_mvhd)), j, drmInitData, z, z2))) != null) {
                arrayList.add(parseStbl(mo8172apply, (Atom.ContainerAtom) Assertions.checkNotNull(((Atom.ContainerAtom) Assertions.checkNotNull(((Atom.ContainerAtom) Assertions.checkNotNull(containerAtom2.getContainerAtomOfType(Atom.TYPE_mdia))).getContainerAtomOfType(Atom.TYPE_minf))).getContainerAtomOfType(Atom.TYPE_stbl)), gaplessInfoHolder));
            }
        }
        return arrayList;
    }

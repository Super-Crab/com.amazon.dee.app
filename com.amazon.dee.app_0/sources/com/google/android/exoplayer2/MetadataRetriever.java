        ...
        public final class MediaSourceHandlerCallback implements Handler.Callback {
            ...
            public final class MediaSourceCaller implements MediaSource.MediaSourceCaller {
                ...
                public void onSourceInfoRefreshed(MediaSource mediaSource, Timeline timeline) {
                    ...
                    MediaSourceHandlerCallback.this.mediaPeriod = mediaSource.mo7373createPeriod(new MediaSource.MediaPeriodId(timeline.getUidOfPeriod(0)), this.allocator, 0L);
            ...
            public boolean handleMessage(Message message) {
                int i = message.what;
                if (i == 0) {
                    this.mediaSource = MetadataRetrieverInternal.this.mediaSourceFactory.mo7418createMediaSource((MediaItem) message.obj);

...
public final class DecoderReuseEvaluation {
    ...
    public int hashCode() {
        int outline7 = GeneratedOutlineSupport1.outline7(this.decoderName, (((this.result + 527) * 31) + this.discardReasons) * 31, 31);
        return this.newFormat.hashCode() + ((this.oldFormat.hashCode() + outline7) * 31);
    }
}

...
class VideoDecoderGLFrameRenderer implements GLSurfaceView.Renderer, VideoDecoderOutputBufferRenderer {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        while (i2 < 3) {
            ...
            GLES20.glTexImage2D(3553, 0, 6409, iArr[i2], i3, 0, 6409, FujifilmMakernoteDirectory.TAG_FILM_MODE, byteBufferArr[i2]);
            i2++;
        }
        int i4 = (r3[0] + 1) / 2;
        ...
        for (int i5 = 0; i5 < 3; i5++) {
            if (this.previousWidths[i5] != iArr2[i5] || this.previousStrides[i5] != iArr[i5]) {
                ...
                GLES20.glVertexAttribPointer(this.texLocations[i5], 2, (int) FujifilmMakernoteDirectory.TAG_MAX_APERTURE_AT_MIN_FOCAL, false, 0, (Buffer) this.textureCoords[i5]);
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eGLConfig) {
        ...
        GLES20.glVertexAttribPointer(glGetAttribLocation, 2, (int) FujifilmMakernoteDirectory.TAG_MAX_APERTURE_AT_MIN_FOCAL, false, 0, (Buffer) TEXTURE_VERTICES);

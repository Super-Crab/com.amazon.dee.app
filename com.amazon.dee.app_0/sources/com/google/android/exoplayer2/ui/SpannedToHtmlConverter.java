...
final class SpannedToHtmlConverter {
    ...
    public static HtmlAndCss convert(@Nullable CharSequence charSequence, float f) {
        ...
        for (Integer num : hashSet) {
            ...
            hashMap.put(HtmlUtils.cssAllClassDescendantsSelector(GeneratedOutlineSupport1.outline49("bg_", intValue)), Util.formatInvariant("background-color:%s;", HtmlUtils.toCssRgba(intValue)));
        }
    ...
    private static String getClosingTag(Object obj) {
        ...
        if (obj instanceof StyleSpan) {
            ...
            return GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("<rt>"), escapeHtml(((RubySpan) obj).rubyText), "</rt></ruby>");
        } else {

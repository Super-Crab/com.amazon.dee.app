...
public class DefaultTrackNameProvider implements TrackNameProvider {
    ...
    private String buildRoleString(Format format) {
        ...
        return (format.roleFlags & PhotoshopDirectory.TAG_PATH_SELECTION_STATE) != 0 ? joinWithSeparator(string, this.resources.getString(R.string.exo_track_role_closed_captions)) : string;
    }

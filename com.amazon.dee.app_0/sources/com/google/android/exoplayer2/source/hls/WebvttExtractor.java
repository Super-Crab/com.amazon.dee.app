            ...
            if (readLine.startsWith("X-TIMESTAMP-MAP")) {
                ...
                if (matcher.find()) {
                    ...
                    if (matcher2.find()) {
                        ...
                        throw new ParserException(GeneratedOutlineSupport1.outline72("X-TIMESTAMP-MAP doesn't contain media timestamp: ", readLine));
                    }
                } else {
                    throw new ParserException(GeneratedOutlineSupport1.outline72("X-TIMESTAMP-MAP doesn't contain local timestamp: ", readLine));
                }
            }
        }

...
public final class HlsMediaPlaylist extends HlsPlaylist {
    ...
    public HlsMediaPlaylist(int i, String str, List<String> list, long j, long j2, boolean z, int i2, long j3, int i3, long j4, long j5, boolean z2, boolean z3, boolean z4, @Nullable DrmInitData drmInitData, List<Segment> list2, List<Part> list3, ServerControl serverControl, Map<Uri, RenditionReport> map) {
        super(str, list, z2);
        long j6;
        this.playlistType = i;
        this.startTimeUs = j2;
    ...
    /* renamed from: copy */
    public HlsPlaylist mo7425copy(List<StreamKey> list) {
        return this;
    }

    @Override // com.google.android.exoplayer2.offline.FilterableManifest
    /* renamed from: copy  reason: collision with other method in class */
    public /* bridge */ /* synthetic */ HlsPlaylist mo7425copy(List list) {
    ...
    public static final class Segment extends SegmentBase {
        ...
        public Segment(String str, long j, long j2, @Nullable String str2, @Nullable String str3) {
            this(str, null, "", 0L, -1, C.TIME_UNSET, null, str2, str3, null, j, j2, false, ImmutableList.of());
        }
        ...
        public Segment copyWith(long j, int i) {
            ...
            return new Segment(this.url, this.initializationSegment, this.title, this.durationUs, i, j, this.drmInitData, this.fullSegmentEncryptionKeyUri, this.encryptionIV, this.encryptionMethod, this.byteRangeOffset, this.byteRangeLength, this.hasGapTag, arrayList);
        }

        public Segment(String str, @Nullable Segment segment, String str2, long j, int i, long j2, @Nullable DrmInitData drmInitData, @Nullable String str3, @Nullable String str4, @Nullable String str5, long j3, long j4, boolean z, List<Part> list) {

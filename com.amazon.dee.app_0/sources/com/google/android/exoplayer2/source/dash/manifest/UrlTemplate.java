    ...
    private static int parseTemplate(String str, String[] strArr, int[] iArr, String[] strArr2) {
        ...
        while (i < str.length()) {
            ...
            if (indexOf == -1) {
                ...
                strArr[i2] = GeneratedOutlineSupport1.outline91(new StringBuilder(), strArr[i2], "$");
                i += 2;
            } else {
                int i3 = i + 1;
                ...
                if (substring.equals(REPRESENTATION)) {
                    ...
                    if (indexOf3 != -1) {
                        ...
                        if (!str2.endsWith("d") && !str2.endsWith(ReactProperties.HereMapMarker.X)) {
                            str2 = GeneratedOutlineSupport1.outline72(str2, "d");
                        }
                    ...
                    if (c == 0) {
                        ...
                        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline72("Invalid template: ", str));
                    }
                    strArr2[i2] = str2;
                }
                i2++;

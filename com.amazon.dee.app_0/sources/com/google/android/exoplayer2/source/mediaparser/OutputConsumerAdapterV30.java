...
public final class OutputConsumerAdapterV30 implements MediaParser.OutputConsumer {
    ...
    private static List<byte[]> getInitializationData(MediaFormat mediaFormat) {
        ...
        int i = 0;
        while (true) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("csd-");
            int i2 = i + 1;
            outline107.append(i);
            ByteBuffer byteBuffer = mediaFormat.getByteBuffer(outline107.toString());
            if (byteBuffer == null) {
                return arrayList;
            }
    ...
    private static String getMimeType(String str) {
        ...
        switch (c) {
            ...
            default:
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline72("Illegal parser name: ", str));
        }
    }

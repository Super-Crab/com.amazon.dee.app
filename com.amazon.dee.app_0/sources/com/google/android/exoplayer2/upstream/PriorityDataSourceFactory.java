...
public final class PriorityDataSourceFactory implements DataSource.Factory {
    ...
    public PriorityDataSource mo7468createDataSource() {
        return new PriorityDataSource(this.upstreamFactory.mo7468createDataSource(), this.priorityTaskManager, this.priority);
    }
}

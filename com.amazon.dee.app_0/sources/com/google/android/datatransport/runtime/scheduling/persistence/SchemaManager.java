...
public final class SchemaManager extends SQLiteOpenHelper {
    ...
    private void upgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        StringBuilder outline110 = GeneratedOutlineSupport1.outline110("Migration from ", i, " to ", i2, " was requested, but cannot be performed. Only ");
        outline110.append(INCREMENTAL_MIGRATIONS.size());
        outline110.append(" migrations are provided");

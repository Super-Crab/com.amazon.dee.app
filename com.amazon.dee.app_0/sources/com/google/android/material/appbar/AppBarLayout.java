...
public class AppBarLayout extends LinearLayout {
        ...
        */
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            if (i2 >= 0 && (pendingAction & 8) == 0) {
                ...
                setHeaderTopBottomOffset(coordinatorLayout, t, round + i3);
        ...
        public static class SavedState extends AbsSavedState {
            public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.SavedState.1
                ...
                public SavedState[] mo7482newArray(int i) {
                ...
                public SavedState mo7481createFromParcel(Parcel parcel, ClassLoader classLoader) {
                    return new SavedState(parcel, classLoader);
                }

                @Override // android.os.Parcelable.Creator
                /* renamed from: createFromParcel */
                public SavedState mo7480createFromParcel(Parcel parcel) {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        /* bridge */ /* synthetic */ View mo7483findFirstDependency(List list) {
            return mo7483findFirstDependency((List<View>) list);
        }
        ...
        public boolean onRequestChildRectangleOnScreen(CoordinatorLayout coordinatorLayout, View view, Rect rect, boolean z) {
            AppBarLayout mo7483findFirstDependency = mo7483findFirstDependency(coordinatorLayout.getDependencies(view));
            if (mo7483findFirstDependency != null) {
                rect.offset(view.getLeft(), view.getTop());
                Rect rect2 = this.tempRect1;
                rect2.set(0, 0, coordinatorLayout.getWidth(), coordinatorLayout.getHeight());
                if (!rect2.contains(rect)) {
                    mo7483findFirstDependency.setExpanded(false, !z);
                    return true;
                }
            }
            return false;
        ...
        AppBarLayout mo7483findFirstDependency(List<View> list) {
            int size = list.size();
            for (int i = 0; i < size; i++) {
    ...
    public LayoutParams mo7474generateDefaultLayoutParams() {
    ...
    public LayoutParams mo7476generateLayoutParams(AttributeSet attributeSet) {
    ...
    @Override // android.widget.LinearLayout, android.view.ViewGroup
    /* renamed from: generateLayoutParams  reason: collision with other method in class */
    public LayoutParams mo7477generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        int i = Build.VERSION.SDK_INT;

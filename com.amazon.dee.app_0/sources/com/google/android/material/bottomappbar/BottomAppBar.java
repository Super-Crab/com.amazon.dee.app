...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: com.google.android.material.bottomappbar.BottomAppBar.SavedState.1
            ...
            public SavedState[] mo7490newArray(int i) {
            ...
            public SavedState mo7489createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo7488createFromParcel(Parcel parcel) {
    ...
    private float getFabTranslationY(boolean z) {
        ...
        float height3 = (height / 2.0f) + (-getCradleVerticalOffset()) + (findDependentFab.getHeight() - rect.bottom);

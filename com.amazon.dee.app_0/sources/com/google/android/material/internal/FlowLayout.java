    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                i8 = childAt.getMeasuredWidth() + i6 + i5 + this.itemSpacing + i8;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int i11 = i6;
                if (childAt.getMeasuredWidth() + i6 + i3 > paddingRight && !isSingleLine()) {
                ...
                i6 = childAt.getMeasuredWidth() + i3 + i4 + this.itemSpacing + i11;
                i7 = measuredHeight;
            }
        }

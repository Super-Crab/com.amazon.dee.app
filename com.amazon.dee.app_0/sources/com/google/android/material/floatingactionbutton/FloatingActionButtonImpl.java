...
public class FloatingActionButtonImpl {
    ...
    private abstract class ShadowAnimatorImpl extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            shadowDrawableWrapper.setShadowSize((valueAnimator.getAnimatedFraction() * (this.shadowSizeEnd - f)) + f);
        }
    }
    ...
    private AnimatorSet createAnimator(@NonNull MotionSpec motionSpec, float f, float f2, float f3) {
        ...
        motionSpec.getTiming(ModelTransformer.KEY_BATTERY_SCALE).apply(ofFloat2);
        arrayList.add(ofFloat2);
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.view, View.SCALE_Y, f2);
        motionSpec.getTiming(ModelTransformer.KEY_BATTERY_SCALE).apply(ofFloat3);

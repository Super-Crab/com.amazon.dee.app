...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate {
    ...
    private float calculateTextOffsetFromStart(@NonNull ChipDrawable chipDrawable) {
        float textStartPadding = getTextStartPadding() + getChipStartPadding() + chipDrawable.calculateChipIconWidth();
        return ViewCompat.getLayoutDirection(this) == 0 ? textStartPadding : -textStartPadding;
    }
    ...
    private void updatePaddingInternal() {
        ...
        float textEndPadding = this.chipDrawable.getTextEndPadding() + this.chipDrawable.getTextStartPadding() + this.chipDrawable.getChipEndPadding() + chipDrawable.getChipStartPadding();
        if ((this.chipDrawable.isChipIconVisible() && this.chipDrawable.getChipIcon() != null) || (this.chipDrawable.getCheckedIcon() != null && this.chipDrawable.isCheckedIconVisible() && isChecked())) {
            textEndPadding += this.chipDrawable.getChipIconSize() + this.chipDrawable.getIconEndPadding() + this.chipDrawable.getIconStartPadding();
        }
        if (this.chipDrawable.isCloseIconVisible() && this.chipDrawable.getCloseIcon() != null) {
            textEndPadding += this.chipDrawable.getCloseIconSize() + this.chipDrawable.getCloseIconEndPadding() + this.chipDrawable.getCloseIconStartPadding();
        }
        if (ViewCompat.getPaddingEnd(this) == textEndPadding) {
            return;
        }
        ViewCompat.setPaddingRelative(this, ViewCompat.getPaddingStart(this), getPaddingTop(), (int) textEndPadding, getPaddingBottom());
    }

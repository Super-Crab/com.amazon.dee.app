...
final class zzed<T> implements zzen<T> {
    ...
    public static <T> zzed<T> zza(zzff<?, ?> zzffVar, zzcg<?> zzcgVar, zzdx zzdxVar) {
    ...
    public final void zza(T t, zzfz zzfzVar) throws IOException {
        Iterator<Map.Entry<?, Object>> it2 = this.zznt.zzb(t).iterator();
        while (it2.hasNext()) {
            ...
            zzfzVar.zza(zzclVar.zzbn(), next instanceof zzdc ? ((zzdc) next).zzcj().zzak() : next.getValue());
        }
    ...
    */
    ...
    public final int zzn(T t) {
        zzff<?, ?> zzffVar = this.zzns;
        int zzs = zzffVar.zzs(zzffVar.zzr(t)) + 0;

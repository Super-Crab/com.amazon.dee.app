...
import com.amazon.alexa.accessorykit.accessories.session.system.SystemWakewordModelTransformer;
...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    public static GoogleSignInOptions zab(@Nullable String str) throws JSONException {
        ...
        JSONArray jSONArray = jSONObject.getJSONArray(SystemWakewordModelTransformer.KEY_SCOPES);
    ...
    private final JSONObject zad() {
        ...
        try {
            ...
            jSONObject.put(SystemWakewordModelTransformer.KEY_SCOPES, jSONArray);
            if (this.zax != null) {

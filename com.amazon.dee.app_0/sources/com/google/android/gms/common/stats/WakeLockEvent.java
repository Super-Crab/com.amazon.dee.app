...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String zzv() {
        ...
        boolean z = this.zzgb;
        StringBuilder sb = new StringBuilder(GeneratedOutlineSupport1.outline6(str2, GeneratedOutlineSupport1.outline6(str4, GeneratedOutlineSupport1.outline6(str3, GeneratedOutlineSupport1.outline6(join, GeneratedOutlineSupport1.outline6(str, 51))))));
        ...
        sb.append(DeviceDatabaseUtils.DELIMITER);
        sb.append(i2);
        GeneratedOutlineSupport1.outline181(sb, DeviceDatabaseUtils.DELIMITER, str3, DeviceDatabaseUtils.DELIMITER, str4);
        sb.append(DeviceDatabaseUtils.DELIMITER);
        sb.append(f);
        sb.append(DeviceDatabaseUtils.DELIMITER);
        sb.append(str2);

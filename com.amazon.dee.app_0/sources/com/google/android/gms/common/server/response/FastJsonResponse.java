...
public abstract class FastJsonResponse {
    ...
    private final <I, O> void zaa(Field<I, O> field, I i) {
        ...
        switch (i2) {
            ...
            case 3:
            default:
                throw new IllegalStateException(GeneratedOutlineSupport1.outline27(44, "Unsupported type for conversion: ", i2));
            case 4:
                if (!zaa(str, convert)) {
                    return;
                }
    ...
    public Object getFieldValue(Field field) {
        ...
        if (field.zapx != null) {
            ...
            try {
                ...
                sb.append(MetricsConstants.Method.CACHE_GET);
                sb.append(upperCase);
                sb.append(substring);
    ...
    private static <O> boolean zaa(String str, O o) {
        if (o == null) {
            ...
            StringBuilder sb = new StringBuilder(GeneratedOutlineSupport1.outline6(str, 58));

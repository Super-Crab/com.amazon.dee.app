        ...
        public final GoogleApiClient build() {
            ...
            for (Api<?> api2 : this.zabz.keySet()) {
                ...
                if (buildClient.providesSignIn()) {
                    if (api != null) {
                        ...
                        throw new IllegalStateException(GeneratedOutlineSupport1.outline30(GeneratedOutlineSupport1.outline6(name2, GeneratedOutlineSupport1.outline6(name, 21)), name, " cannot be used with ", name2));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (!z) {
                    ...
                    throw new IllegalStateException(GeneratedOutlineSupport1.outline30(GeneratedOutlineSupport1.outline6(name3, 82), "With using ", name3, ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            }

...
public class SafeParcelReader {
        ...
        */
        public ParseException(java.lang.String r4, android.os.Parcel r5) {
            /*
                ...
                int r5 = r5.dataSize()
                r1 = 41
                int r1 = com.android.tools.r8.GeneratedOutlineSupport1.outline6(r4, r1)
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        ...
        throw new ParseException(GeneratedOutlineSupport1.outline27(37, "Overread allowed size end=", i), parcel);
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        throw new ParseException(GeneratedOutlineSupport1.outline28(54, "Size read is invalid start=", dataPosition, " end=", i), parcel);
    }
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        StringBuilder sb = new StringBuilder(GeneratedOutlineSupport1.outline6(hexString, 46));
        sb.append("Expected size ");
        sb.append(i2);
        sb.append(" got ");
        sb.append(readSize);
        throw new ParseException(GeneratedOutlineSupport1.outline92(sb, " (0x", hexString, ")"), parcel);
    }

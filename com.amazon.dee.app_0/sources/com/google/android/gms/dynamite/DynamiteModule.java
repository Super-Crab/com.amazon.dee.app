...
public final class DynamiteModule {
    ...
    public static int getLocalVersion(Context context, String str) {
        try {
            ...
            StringBuilder sb3 = new StringBuilder(GeneratedOutlineSupport1.outline6(str, 45));
    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            int i3 = zza2.zzit;
            if (i3 != 0 && ((i3 != -1 || zza2.zzir != 0) && (zza2.zzit != 1 || zza2.zzis != 0))) {
                int i4 = zza2.zzit;
                if (i4 == -1) {
                    ...
                    try {
                        ...
                        int i5 = zza2.zzir;
                        if (i5 != 0 && versionPolicy.zza(context, str, new zzb(i5, 0)).zzit == -1) {
    ...
    */
    ...
    private static DynamiteModule zzb(Context context, String str, int i) throws LoadingException, RemoteException {
        zzk zzkVar;
        IObjectWrapper zza2;
        StringBuilder sb = new StringBuilder(GeneratedOutlineSupport1.outline6(str, 51));

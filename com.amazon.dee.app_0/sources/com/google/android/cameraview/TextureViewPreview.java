...
class TextureViewPreview extends PreviewImpl {
    ...
    public TextureViewPreview(Context context, ViewGroup viewGroup) {
        ...
        this.mTextureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: com.google.android.cameraview.TextureViewPreview.1
    ...
    public SurfaceTexture mo7263getSurfaceTexture() {

...
public final class Enum extends GeneratedMessageV3 implements EnumOrBuilder {
    ...
    private static final Parser<Enum> PARSER = new AbstractParser<Enum>() { // from class: com.google.protobuf.Enum.1
        ...
        public Enum mo10082parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements EnumOrBuilder {
        ...
        public Builder addEnumvalue(int i, EnumValue.Builder builder) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ensureEnumvalueIsMutable();
                this.enumvalue_.add(i, builder.mo10084build());
                onChanged();
            } else {
        ...
        public Builder addEnumvalue(EnumValue.Builder builder) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ensureEnumvalueIsMutable();
                this.enumvalue_.add(builder.mo10084build());
                onChanged();
            } else {
        ...
        /* renamed from: build */
        public Enum mo10084build() {
            Enum mo10085buildPartial = mo10085buildPartial();
        ...
        public Enum mo10085buildPartial() {
            ...
            r0.sourceContext_ = singleFieldBuilderV3 == null ? this.sourceContext_ : singleFieldBuilderV3.build();
        ...
        public Enum mo10094getDefaultInstanceForType() {
        ...
        public EnumValueOrBuilder getEnumvalueOrBuilder(int i) {
            RepeatedFieldBuilderV3<EnumValue, EnumValue.Builder, EnumValueOrBuilder> repeatedFieldBuilderV3 = this.enumvalueBuilder_;
            return (EnumValueOrBuilder) (repeatedFieldBuilderV3 == null ? this.enumvalue_.get(i) : repeatedFieldBuilderV3.getMessageOrBuilder(i));
        }
        ...
        */
        public com.google.protobuf.Enum.Builder mo10097mergeFrom(com.google.protobuf.CodedInputStream r3, com.google.protobuf.ExtensionRegistryLite r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.Enum.Builder.mo10097mergeFrom(com.google.protobuf.CodedInputStream, com.google.protobuf.ExtensionRegistryLite):com.google.protobuf.Enum$Builder");
        }
        ...
        public Builder mergeFrom(Enum r4) {
            ...
            mo10099mergeUnknownFields(r4.unknownFields);
            onChanged();
            return this;
        }
        ...
        public Builder setEnumvalue(int i, EnumValue.Builder builder) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ensureEnumvalueIsMutable();
                this.enumvalue_.set(i, builder.mo10084build());
                onChanged();
            } else {
                        ...
                        if (readTag != 0) {
                            if (readTag != 10) {
                                if (readTag == 18) {
                                    ...
                                    readMessage = codedInputStream.readMessage(EnumValue.parser(), extensionRegistryLite);
                                } else if (readTag == 26) {
                                    if (!(z2 & true)) {
    ...
    public static Builder newBuilder(Enum r1) {
        return DEFAULT_INSTANCE.mo10081toBuilder().mergeFrom(r1);
    }
    ...
    public Parser<Enum> mo9954getParserForType() {
        return PARSER;
    }
    ...
    public int hashCode() {
        ...
        if (getEnumvalueCount() > 0) {
            hashCode = getEnumvalueList().hashCode() + GeneratedOutlineSupport1.outline4(hashCode, 37, 2, 53);
        }
        if (getOptionsCount() > 0) {
            hashCode = getOptionsList().hashCode() + GeneratedOutlineSupport1.outline4(hashCode, 37, 3, 53);
        }
        if (hasSourceContext()) {
            hashCode = getSourceContext().hashCode() + GeneratedOutlineSupport1.outline4(hashCode, 37, 4, 53);
        }
        int hashCode2 = this.unknownFields.hashCode() + ((GeneratedOutlineSupport1.outline4(hashCode, 37, 5, 53) + this.syntax_) * 29);

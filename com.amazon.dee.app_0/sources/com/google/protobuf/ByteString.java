...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static class LiteralByteString extends LeafByteString {
        ...
        public final boolean equalsRange(ByteString byteString, int i, int i2) {
            ...
            if (i3 > byteString.size()) {
                StringBuilder outline110 = GeneratedOutlineSupport1.outline110("Ran off end of other: ", i, ", ", i2, ", ");
                outline110.append(byteString.size());
    ...
    public static void checkIndex(int i, int i2) {
        if (((i2 - (i + 1)) | i) < 0) {
            if (i >= 0) {
                throw new ArrayIndexOutOfBoundsException(GeneratedOutlineSupport1.outline53("Index > length: ", i, ", ", i2));
            }
            throw new ArrayIndexOutOfBoundsException(GeneratedOutlineSupport1.outline49("Index < 0: ", i));
        }
    }
    ...
    public static int checkRange(int i, int i2, int i3) {
        ...
        if ((i | i2 | i4 | (i3 - i2)) < 0) {
            if (i < 0) {
                throw new IndexOutOfBoundsException(GeneratedOutlineSupport1.outline52("Beginning index: ", i, " < 0"));
            }
            if (i2 >= i) {
                throw new IndexOutOfBoundsException(GeneratedOutlineSupport1.outline53("End index: ", i2, " >= ", i3));
            }
            throw new IndexOutOfBoundsException(GeneratedOutlineSupport1.outline53("Beginning index larger than ending index: ", i, ", ", i2));
        }
        return i4;
    }
    ...
    public final ByteString concat(ByteString byteString) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("ByteString would be too long: ");
        outline107.append(size());
        outline107.append("+");
        outline107.append(byteString.size());

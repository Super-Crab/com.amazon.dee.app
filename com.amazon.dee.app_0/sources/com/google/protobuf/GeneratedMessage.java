...
public abstract class GeneratedMessage extends AbstractMessage implements Serializable {
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<BuilderType> implements ExtendableMessageOrBuilder<MessageType> {
        ...
        public BuilderType mo10093clone() {
            return (BuilderType) super.mo10093clone();
        }
    ...
    public static final class FieldAccessorTable {
        ...
        public static class OneofAccessor {
            ...
            OneofAccessor(Descriptors.Descriptor descriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2) {
                ...
                this.caseMethod = GeneratedMessage.getMethodOrDie(cls, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, "Case"), new Class[0]);
                this.caseMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, "Case"), new Class[0]);
                this.clearMethod = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline72(MetricsConstants.Method.CACHE_CLEAR, str), new Class[0]);
            }
        ...
        public static final class RepeatedEnumFieldAccessor extends RepeatedFieldAccessor {
            ...
            RepeatedEnumFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2) {
                ...
                if (this.supportUnknownEnumValue) {
                    this.getRepeatedValueMethod = GeneratedMessage.getMethodOrDie(cls, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, MAPCookie.KEY_VALUE), Integer.TYPE);
                    this.getRepeatedValueMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, MAPCookie.KEY_VALUE), Integer.TYPE);
                    String outline75 = GeneratedOutlineSupport1.outline75("set", str, MAPCookie.KEY_VALUE);
                    Class cls3 = Integer.TYPE;
                    this.setRepeatedValueMethod = GeneratedMessage.getMethodOrDie(cls2, outline75, cls3, cls3);
                    this.addRepeatedValueMethod = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75(BulkOperationType.add, str, MAPCookie.KEY_VALUE), Integer.TYPE);
                }
            }
        ...
        public static class RepeatedFieldAccessor implements FieldAccessor {
            ...
            RepeatedFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2) {
                this.getMethod = GeneratedMessage.getMethodOrDie(cls, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, "List"), new Class[0]);
                this.getMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, "List"), new Class[0]);
                this.getRepeatedMethod = GeneratedMessage.getMethodOrDie(cls, GeneratedOutlineSupport1.outline72(MetricsConstants.Method.CACHE_GET, str), Integer.TYPE);
                this.getRepeatedMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline72(MetricsConstants.Method.CACHE_GET, str), Integer.TYPE);
                this.type = this.getRepeatedMethod.getReturnType();
                this.setRepeatedMethod = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline72("set", str), Integer.TYPE, this.type);
                this.addRepeatedMethod = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline72(BulkOperationType.add, str), this.type);
                this.getCountMethod = GeneratedMessage.getMethodOrDie(cls, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, "Count"), new Class[0]);
                this.getCountMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, "Count"), new Class[0]);
                this.clearMethod = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline72(MetricsConstants.Method.CACHE_CLEAR, str), new Class[0]);
            }
        ...
        public static final class RepeatedMessageFieldAccessor extends RepeatedFieldAccessor {
            ...
            RepeatedMessageFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2) {
                ...
                this.getBuilderMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, "Builder"), Integer.TYPE);
            }

            private Object coerceType(Object obj) {
                return this.type.isInstance(obj) ? obj : ((Message.Builder) GeneratedMessage.invokeOrDie(this.newBuilderMethod, null, new Object[0])).mo10096mergeFrom((Message) obj).mo10084build();
            }
        ...
        public static final class SingularEnumFieldAccessor extends SingularFieldAccessor {
            ...
            SingularEnumFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2, String str2) {
                ...
                this.supportUnknownEnumValue = fieldDescriptor.getFile().supportsUnknownEnumValue();
                if (this.supportUnknownEnumValue) {
                    this.getValueMethod = GeneratedMessage.getMethodOrDie(cls, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, MAPCookie.KEY_VALUE), new Class[0]);
                    this.getValueMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, MAPCookie.KEY_VALUE), new Class[0]);
                    this.setValueMethod = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75("set", str, MAPCookie.KEY_VALUE), Integer.TYPE);
                }
            }
        ...
        public static class SingularFieldAccessor implements FieldAccessor {
            ...
            SingularFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2, String str2) {
                ...
                this.getMethod = GeneratedMessage.getMethodOrDie(cls, GeneratedOutlineSupport1.outline72(MetricsConstants.Method.CACHE_GET, str), new Class[0]);
                this.getMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline72(MetricsConstants.Method.CACHE_GET, str), new Class[0]);
                this.type = this.getMethod.getReturnType();
                this.setMethod = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline72("set", str), this.type);
                java.lang.reflect.Method method = null;
                this.hasMethod = this.hasHasMethod ? GeneratedMessage.getMethodOrDie(cls, GeneratedOutlineSupport1.outline72("has", str), new Class[0]) : null;
                this.hasMethodBuilder = this.hasHasMethod ? GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline72("has", str), new Class[0]) : null;
                this.clearMethod = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline72(MetricsConstants.Method.CACHE_CLEAR, str), new Class[0]);
                this.caseMethod = this.isOneofField ? GeneratedMessage.getMethodOrDie(cls, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str2, "Case"), new Class[0]) : null;
                this.caseMethodBuilder = this.isOneofField ? GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str2, "Case"), new Class[0]) : method;
            }
        ...
        public static final class SingularMessageFieldAccessor extends SingularFieldAccessor {
            ...
            SingularMessageFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2, String str2) {
                super(fieldDescriptor, str, cls, cls2, str2);
                this.newBuilderMethod = GeneratedMessage.getMethodOrDie(this.type, "newBuilder", new Class[0]);
                this.getBuilderMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, "Builder"), new Class[0]);
            }

            private Object coerceType(Object obj) {
                return this.type.isInstance(obj) ? obj : ((Message.Builder) GeneratedMessage.invokeOrDie(this.newBuilderMethod, null, new Object[0])).mo10096mergeFrom((Message) obj).mo10085buildPartial();
            }
        ...
        public static final class SingularStringFieldAccessor extends SingularFieldAccessor {
            ...
            SingularStringFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2, String str2) {
                super(fieldDescriptor, str, cls, cls2, str2);
                this.getBytesMethod = GeneratedMessage.getMethodOrDie(cls, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, "Bytes"), new Class[0]);
                this.getBytesMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75(MetricsConstants.Method.CACHE_GET, str, "Bytes"), new Class[0]);
                this.setBytesMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, GeneratedOutlineSupport1.outline75("set", str, "Bytes"), ByteString.class);
            }
    ...
    public static class GeneratedExtension<ContainingType extends Message, Type> extends Extension<ContainingType, Type> {
        ...
        GeneratedExtension(ExtensionDescriptorRetriever extensionDescriptorRetriever, Class cls, Message message, Extension.ExtensionType extensionType) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline38(cls, GeneratedOutlineSupport1.outline107("Bad messageDefaultInstance for ")));
        }
        ...
        public Message mo9554getMessageDefaultInstance() {
        ...
        public Object singularFromReflectionType(Object obj) {
            ...
            return ordinal != 7 ? (ordinal == 8 && !this.singularType.isInstance(obj)) ? this.messageDefaultInstance.mo10079newBuilderForType().mo10096mergeFrom((Message) obj).mo10084build() : obj : GeneratedMessage.invokeOrDie(this.enumValueOf, null, (Descriptors.EnumValueDescriptor) obj);
        }
        ...
        return new GeneratedExtension<>(new CachedDescriptorRetriever() { // from class: com.google.protobuf.GeneratedMessage.4
            ...
            protected Descriptors.FieldDescriptor loadDescriptor() {
                try {
                    ...
                    throw new RuntimeException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("Cannot load descriptors: "), str, " is not a valid descriptor class name"), e);
                }
            }
    ...
    public Parser<? extends GeneratedMessage> mo9954getParserForType() {

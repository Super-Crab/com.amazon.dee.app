...
public class LazyStringArrayList extends AbstractProtobufList<String> implements LazyStringList, RandomAccess {
    ...
    private static class ByteArrayListView extends AbstractList<byte[]> implements RandomAccess {
        ...
        public byte[] remove(int i) {
            String mo9673remove = this.list.mo9673remove(i);
            ((AbstractList) this).modCount++;
            return LazyStringArrayList.asByteArray(mo9673remove);
        }
    ...
    private static class ByteStringListView extends AbstractList<ByteString> implements RandomAccess {
        ...
        @Override // java.util.AbstractList, java.util.List
        /* renamed from: get */
        public ByteString mo9644get(int i) {
            return this.list.getByteString(i);
        }

        @Override // java.util.AbstractList, java.util.List
        /* renamed from: remove */
        public ByteString mo9645remove(int i) {
            String mo9673remove = this.list.mo9673remove(i);
            ((AbstractList) this).modCount++;
            return LazyStringArrayList.asByteString(mo9673remove);
        }
    ...
    public LazyStringArrayList mo9765mutableCopyWithCapacity(int i) {
        if (i >= size()) {
    ...
    public String mo9673remove(int i) {
        ensureIsMutable();

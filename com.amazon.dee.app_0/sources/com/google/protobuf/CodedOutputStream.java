...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static class OutOfSpaceException extends IOException {
        ...
        OutOfSpaceException(String str) {
            super(GeneratedOutlineSupport1.outline72("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str));
        }

        OutOfSpaceException(String str, Throwable th) {
            super(GeneratedOutlineSupport1.outline72("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str), th);
        }

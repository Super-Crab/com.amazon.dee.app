...
public abstract class CodedInputStream {
    ...
    public static final class ArrayDecoder extends CodedInputStream {
        ...
        public <T extends MessageLite> T readGroup(int i, Parser<T> parser, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            if (i2 < this.recursionLimit) {
                ...
                T mo10082parsePartialFrom = parser.mo10082parsePartialFrom(this, extensionRegistryLite);
                checkLastTagWas(WireFormat.makeTag(i, 4));
                this.recursionDepth--;
                return mo10082parsePartialFrom;
            }
        ...
        public void readGroup(int i, MessageLite.Builder builder, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            if (i2 < this.recursionLimit) {
                this.recursionDepth = i2 + 1;
                builder.mo10097mergeFrom(this, extensionRegistryLite);
                checkLastTagWas(WireFormat.makeTag(i, 4));
                this.recursionDepth--;
                return;
            }
        ...
        private boolean tryRefillBuffer(int i) throws IOException {
            ...
            if (i2 + i > this.bufferSize) {
                ...
                if (read == 0 || read < -1 || read > this.buffer.length) {
                    throw new IllegalStateException(GeneratedOutlineSupport1.outline52("InputStream#read(byte[]) returned invalid result: ", read, "\nThe InputStream implementation is buggy."));
                }
                if (read <= 0) {
                    return false;
                }
            ...
            throw new IllegalStateException(GeneratedOutlineSupport1.outline52("refillBuffer() called when ", i, " bytes were already available in buffer"));
        }
    ...
    public final int setRecursionLimit(int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Recursion limit cannot be negative: ", i));
    }
    ...
    public final int setSizeLimit(int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Size limit cannot be negative: ", i));
    }

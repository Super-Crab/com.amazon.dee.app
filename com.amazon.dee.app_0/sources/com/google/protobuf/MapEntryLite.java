...
public class MapEntryLite<K, V> {
    ...
    static <T> T parseField(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, WireFormat.FieldType fieldType, T t) throws IOException {
        ...
        if (ordinal != 9) {
            ...
            MessageLite.Builder mo10081toBuilder = ((MessageLite) t).mo10081toBuilder();
            codedInputStream.readMessage(mo10081toBuilder, extensionRegistryLite);
            return (T) mo10081toBuilder.mo10085buildPartial();
        }

...
public final class Component<T> {
    ...
    public String toString() {
        return "Component<" + Arrays.toString(this.providedInterfaces.toArray()) + ">{" + this.instantiation + ", type=" + this.type + ", deps=" + Arrays.toString(this.dependencies.toArray()) + EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE;
    }

...
public final class Encoder {
    ...
    */
    ...
    static BitArray interleaveWithECBytes(BitArray bitArray, int i, int i2, int i3) throws WriterException {
        if (bitArray.getSizeInBytes() == i2) {
            ...
            if (i2 == i4) {
                ...
                StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Interleaving error: ", i, " and ");
                outline109.append(bitArray2.getSizeInBytes());
                outline109.append(" differ.");
                throw new WriterException(outline109.toString());
            }
    ...
    static void terminateBits(int i, BitArray bitArray) throws WriterException {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("data bits cannot fit in the QR Code");
        outline107.append(bitArray.getSize());
        outline107.append(" > ");
        outline107.append(i2);
        throw new WriterException(outline107.toString());
    }

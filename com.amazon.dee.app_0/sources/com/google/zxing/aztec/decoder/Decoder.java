...
public final class Decoder {
    ...
    private static final String[] LOWER_TABLE = {"CTRL_PS", " ", "a", "b", "c", "d", "e", "f", "g", "h", ContextChain.TAG_INFRA, "j", "k", "l", "m", JsonReportFormat.COUNT, "o", "p", "q", "r", "s", "t", "u", "v", "w", ReactProperties.HereMapMarker.X, ReactProperties.HereMapMarker.Y, "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", DeviceDatabaseUtils.DELIMITER, "\n", "\u000b", "\f", StringUtils.CR, "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", AccessoryMetricsConstants.DELIMITER, "~", "\u007f", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", StringUtils.CR, "\r\n", ". ", ", ", RealTimeTextConstants.COLON_SPACE, "!", EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED, MqttTopic.MULTI_LEVEL_WILDCARD, "$", "%", WebConstants.UriConstants.AMPERSAND_KEY, "'", "(", ")", "*", "+", ",", ProcessIdUtil.DEFAULT_PROCESSID, ".", "/", ":", ";", Config.Compare.LESS_THAN, Config.Compare.EQUAL_TO, Config.Compare.GREATER_THAN, WebConstants.UriConstants.QUESTIONMARK_KEY, "[", "]", EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_OPEN, EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE, "CTRL_UL"};
    ...
    private boolean[] extractBits(BitMatrix bitMatrix) {
        ...
        int i = (nbLayers * 4) + (isCompact ? 11 : 14);
        int[] iArr = new int[i];

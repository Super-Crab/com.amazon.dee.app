...
public final class UPCEWriter extends UPCEANWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length == 7) {
            try {
                str = GeneratedOutlineSupport1.outline49(str, UPCEANReader.getStandardUPCEANChecksum(UPCEReader.convertUPCEtoUPCA(str)));
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Requested contents should be 8 digits long, but got ", length));
        }

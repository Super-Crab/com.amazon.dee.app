                ...
                if (charAt != ' ') {
                    if (charAt == '@') {
                        ...
                        if (charAt <= 26) {
                            ...
                            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Requested content contains a non-encodable character: '");
                            outline107.append(str.charAt(i));
                            outline107.append("'");
        ...
        if (length <= 80) {
            ...
            while (true) {
                if (i >= length) {
                    ...
                    length = str.length();
                    if (length > 80) {
                        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("Requested contents should be less than 80 digits long, but got ", length, " (extended full ASCII mode)"));
                    }
                } else {
                    i++;
                }

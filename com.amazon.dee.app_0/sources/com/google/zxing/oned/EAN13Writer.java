...
public final class EAN13Writer extends UPCEANWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length == 12) {
            try {
                str = GeneratedOutlineSupport1.outline49(str, UPCEANReader.getStandardUPCEANChecksum(str));
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Requested contents should be 12 or 13 digits long, but got ", length));
        }

...
public final class RSS14Reader extends AbstractRSSReader {
    ...
    private static final int[] INSIDE_GSUM = {0, IptcDirectory.TAG_TIME_SENT, 1036, 1516};
    ...
    private DataCharacter decodeDataCharacter(BitArray bitArray, FinderPattern finderPattern, boolean z) throws NotFoundException {
        ...
        if (z) {
            if ((i9 & 1) == 0 && i9 <= 12 && i9 >= 4) {
                ...
                return new DataCharacter(GeneratedOutlineSupport1.outline3(RSSUtils.getRSSvalue(oddCounts, i14, false), OUTSIDE_EVEN_TOTAL_SUBSET[i13], RSSUtils.getRSSvalue(evenCounts, 9 - i14, true), OUTSIDE_GSUM[i13]), i12);
            }
            throw NotFoundException.getNotFoundInstance();
        } else if ((i11 & 1) == 0 && i11 <= 10 && i11 >= 4) {
            int i15 = (10 - i11) / 2;
            int i16 = INSIDE_ODD_WIDEST[i15];
            return new DataCharacter(GeneratedOutlineSupport1.outline3(RSSUtils.getRSSvalue(evenCounts, 9 - i16, false), INSIDE_ODD_TOTAL_SUBSET[i15], RSSUtils.getRSSvalue(oddCounts, i16, true), INSIDE_GSUM[i15]), i12);
        } else {
            throw NotFoundException.getNotFoundInstance();
        }
    }

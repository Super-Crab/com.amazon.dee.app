    ...
    private static String processFixedAI(int i, int i2, String str) throws NotFoundException {
        if (str.length() >= i) {
            ...
            if (str.length() >= i3) {
                ...
                return parseFieldsInGeneralPurpose == null ? str2 : GeneratedOutlineSupport1.outline72(str2, parseFieldsInGeneralPurpose);
            }
            throw NotFoundException.getNotFoundInstance();
        }
        throw NotFoundException.getNotFoundInstance();

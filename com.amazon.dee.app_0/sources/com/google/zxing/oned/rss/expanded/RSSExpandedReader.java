...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, 180, 118, 143, 7, 21, 63}, new int[]{189, 145, 13, 39, 117, 140, 209, 205}, new int[]{193, 157, 49, 147, 19, 57, 171, 91}, new int[]{62, 186, 136, 197, 169, 85, 44, 132}, new int[]{185, 133, 188, 142, 4, 12, 36, 108}, new int[]{113, 128, 173, 97, 80, 29, 87, 50}, new int[]{150, 28, 84, 41, 123, 158, 52, 156}, new int[]{46, 138, 203, 187, 139, HttpServletResponse.SC_PARTIAL_CONTENT, CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256, 166}, new int[]{76, 17, 51, 153, 37, 111, 122, 155}, new int[]{43, 129, 176, 106, 107, 110, 119, 146}, new int[]{16, 48, 144, 10, 30, 90, 59, 177}, new int[]{109, 116, 137, 200, 178, 112, 125, 164}, new int[]{70, 210, 208, 202, 184, 130, 179, 115}, new int[]{134, 191, 151, 31, 93, 68, 204, 190}, new int[]{148, 22, 66, Opcodes.IFNULL, 172, 94, 71, 2}, new int[]{6, 18, 54, 162, 64, 192, 154, 40}, new int[]{120, 149, 25, 75, 14, 42, 126, 167}, new int[]{79, 26, 78, 23, 69, 207, 199, 175}, new int[]{103, 98, 83, 38, 114, 131, 182, 124}, new int[]{161, 61, 183, 127, 170, 88, 53, 159}, new int[]{55, 165, 73, 8, 24, 72, 5, 15}, new int[]{45, 135, 194, 160, 58, 174, 100, 89}};
    ...
    private boolean checkChecksum() {
        ...
        return GeneratedOutlineSupport1.outline2(i, -4, 211, checksumPortion % 211) == leftChar.getValue();
    }
    ...
    static Result constructResult(List<ExpandedPair> list) throws NotFoundException, FormatException {
        ...
        ResultPoint[] resultPoints2 = ((ExpandedPair) GeneratedOutlineSupport1.outline25(list, 1)).getFinderPattern().getResultPoints();
    ...
    private void findNextPair(BitArray bitArray, List<ExpandedPair> list, int i) throws NotFoundException {
        ...
        if (i < 0) {
            i = list.isEmpty() ? 0 : ((ExpandedPair) GeneratedOutlineSupport1.outline25(list, 1)).getFinderPattern().getStartEnd()[1];
        }
    ...
    */
        ...
        if (Math.abs(sum - f) / f <= 0.3f) {
            ...
            for (int length2 = oddCounts.length - 1; length2 >= 0; length2--) {
                if (isNotA1left(finderPattern, z, z2)) {
                    i7 = (oddCounts[length2] * WEIGHTS[value][length2 * 2]) + i7;
                }
            ...
            for (int length3 = evenCounts.length - 1; length3 >= 0; length3--) {
                if (isNotA1left(finderPattern, z, z2)) {
                    i9 = (evenCounts[length3] * WEIGHTS[value][(length3 * 2) + 1]) + i9;
                }
            }
            int i10 = i7 + i9;
            if ((i8 & 1) == 0 && i8 <= 13 && i8 >= 4) {
                ...
                return new DataCharacter(GeneratedOutlineSupport1.outline3(RSSUtils.getRSSvalue(oddCounts, i12, true), EVEN_TOTAL_SUBSET[i11], RSSUtils.getRSSvalue(evenCounts, 9 - i12, false), GSUM[i11]), i10);
            }
            throw NotFoundException.getNotFoundInstance();
        }
        throw NotFoundException.getNotFoundInstance();
    ...
    ExpandedPair retrieveNextPair(BitArray bitArray, List<ExpandedPair> list, int i) throws NotFoundException {
        ...
        if (!list.isEmpty() && ((ExpandedPair) GeneratedOutlineSupport1.outline25(list, 1)).mustBeLast()) {
            throw NotFoundException.getNotFoundInstance();
        }
        try {

...
public final class CodaBarWriter extends OneDimensionalCodeWriter {
    ...
    private static final char[] CHARS_WHICH_ARE_TEN_LENGTH_EACH_AFTER_DECODED = {'/', JsonReaderKt.COLON, '+', '.'};
    ...
    public boolean[] encode(String str) {
        ...
        if (str.length() < 2) {
            ...
            if (arrayContains) {
                if (!arrayContains2) {
                    throw new IllegalArgumentException(GeneratedOutlineSupport1.outline72("Invalid start/end guards: ", str));
                }
        ...
        for (int i3 = 1; i3 < str.length() - 1; i3++) {
            if (Character.isDigit(str.charAt(i3)) || str.charAt(i3) == '-' || str.charAt(i3) == '$') {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Cannot encode : '");
                outline107.append(str.charAt(i3));

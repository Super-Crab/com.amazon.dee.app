...
public class Code93Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            outline107.append("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".charAt(computeChecksumIndex));
            toIntArray(Code93Reader.CHARACTER_ENCODINGS[computeChecksumIndex(outline107.toString(), 15)], iArr);
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline49("Requested contents should be less than 80 digits long, but got ", length));
    }
}

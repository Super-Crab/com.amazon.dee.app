    ...
    static void assertInstantiable(Class<?> cls) {
        ...
        if (!Modifier.isInterface(modifiers)) {
            if (Modifier.isAbstract(modifiers)) {
                throw new UnsupportedOperationException(GeneratedOutlineSupport1.outline38(cls, GeneratedOutlineSupport1.outline107("Abstract class can't be instantiated! Class name: ")));
            }
            return;
        }
        throw new UnsupportedOperationException(GeneratedOutlineSupport1.outline38(cls, GeneratedOutlineSupport1.outline107("Interface can't be instantiated! Interface name: ")));
    }

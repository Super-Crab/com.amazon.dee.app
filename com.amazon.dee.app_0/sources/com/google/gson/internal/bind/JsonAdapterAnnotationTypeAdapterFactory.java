    ...
    public TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter) {
        ...
        if (construct instanceof TypeAdapter) {
            ...
            if (!z && !(construct instanceof JsonDeserializer)) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Invalid attempt to bind an instance of ");
                outline107.append(construct.getClass().getName());
                outline107.append(" as a @JsonAdapter for ");
                outline107.append(typeToken.toString());
                outline107.append(". @JsonAdapter value must be a TypeAdapter, TypeAdapterFactory, JsonSerializer or JsonDeserializer.");

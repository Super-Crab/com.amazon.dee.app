...
public final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public String toString() {
        ...
        if (dateFormat instanceof SimpleDateFormat) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("DefaultDateTypeAdapter(");
            outline107.append(((SimpleDateFormat) dateFormat).toPattern());
            outline107.append(')');
            return outline107.toString();
        }
        StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("DefaultDateTypeAdapter(");
        outline1072.append(dateFormat.getClass().getSimpleName());
        outline1072.append(')');

...
public enum FieldNamingPolicy implements FieldNamingStrategy {
    ...
    LOWER_CASE_WITH_DASHES { // from class: com.google.gson.FieldNamingPolicy.5
        @Override // com.google.gson.FieldNamingStrategy
        public String translateName(Field field) {
            return FieldNamingPolicy.separateCamelCase(field.getName(), ProcessIdUtil.DEFAULT_PROCESSID).toLowerCase(Locale.ENGLISH);
        }
    },
    ...
    private static String modifyString(char c, String str, int i) {
        if (i < str.length()) {
            return GeneratedOutlineSupport1.outline55(str, i, GeneratedOutlineSupport1.outline104(c));
        }

...
public class JsonReader implements Closeable {
        ...
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() { // from class: com.google.gson.stream.JsonReader.1
            ...
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                if (i == 13) {
                    ...
                    outline107.append(jsonReader.locationString());
        ...
        while (true) {
            if (i == i2) {
                ...
                if (!fillBuffer(1)) {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("End of input");
                    outline107.append(locationString());
    ...
    */
    ...
    private IOException syntaxError(String str) throws IOException {
        ...
        outline107.append(locationString());
        throw new MalformedJsonException(outline107.toString());
    }
    ...
    String locationString() {
        StringBuilder outline110 = GeneratedOutlineSupport1.outline110(" at line ", this.lineNumber + 1, " column ", (this.pos - this.lineStart) + 1, " path ");
        outline110.append(getPath());
    ...
    public int nextInt() throws IOException {
        ...
        if (i == 16) {
            ...
            outline1072.append(locationString());
        ...
        outline1073.append(locationString());

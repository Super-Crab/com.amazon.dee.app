...
public class ShapeData {
    ...
    public void interpolateBetween(ShapeData shapeData, ShapeData shapeData2, @FloatRange(from = 0.0d, to = 1.0d) float f) {
        ...
        if (shapeData.getCurves().size() != shapeData2.getCurves().size()) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Curves must have the same number of control points. Shape 1: ");
            outline107.append(shapeData.getCurves().size());
            outline107.append("\tShape 2: ");
            outline107.append(shapeData2.getCurves().size());
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("ShapeData{numCurves=");
        outline107.append(this.curves.size());
        outline107.append("closed=");
        outline107.append(this.closed);

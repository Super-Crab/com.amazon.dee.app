...
public abstract class JsonReader implements Closeable {
    ...
    */
    public static void string(okio.BufferedSink r7, java.lang.String r8) throws java.io.IOException {
        ...
        L29:
            if (r4 >= r3) goto L2e
            r7.mo12608writeUtf8(r8, r4, r3)
        L2e:
            r7.mo12607writeUtf8(r5)
            int r4 = r3 + 1
        L33:
            int r3 = r3 + 1
            goto Ld
    ...
    public final void pushScope(int i) {
        ...
        if (i2 == iArr.length) {
            if (i2 != 256) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Nesting too deep at ");
    ...
    public final JsonEncodingException syntaxError(String str) throws JsonEncodingException {
        StringBuilder outline113 = GeneratedOutlineSupport1.outline113(str, " at path ");
        outline113.append(getPath());
        throw new JsonEncodingException(outline113.toString());
    }
}

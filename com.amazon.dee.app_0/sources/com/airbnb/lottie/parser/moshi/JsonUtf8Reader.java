...
final class JsonUtf8Reader extends JsonReader {
    ...
    */
    ...
    private char readEscapeCharacter() throws IOException {
        ...
        if (this.source.request(1L)) {
            ...
            if (readByte != 117) {
                ...
                outline107.append((char) readByte);
                throw syntaxError(outline107.toString());
                ...
                for (int i3 = 0; i3 < 4; i3++) {
                    ...
                    if (b < 48 || b > 57) {
                        if (b >= 97 && b <= 102) {
                            ...
                            outline1072.append(this.buffer.readUtf8(4L));
                            throw syntaxError(outline1072.toString());
                        } else {
                ...
                StringBuilder outline1073 = GeneratedOutlineSupport1.outline107("Unterminated escape sequence at path ");
                outline1073.append(getPath());
                throw new EOFException(outline1073.toString());
            }
        }
    ...
    public void beginArray() throws IOException {
        ...
        outline107.append(" at path ");
        outline107.append(getPath());
        throw new JsonDataException(outline107.toString());
    }
    ...
    public double nextDouble() throws IOException {
        ...
        try {
            ...
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("Expected a double but was ");
            outline1072.append(this.peekedString);
            outline1072.append(" at path ");
            outline1072.append(getPath());
            throw new JsonDataException(outline1072.toString());
        }
    }
    ...
    public int nextInt() throws IOException {
        ...
        try {
            ...
            outline1073.append(" at path ");
            outline1073.append(getPath());
            throw new JsonDataException(outline1073.toString());
        } catch (NumberFormatException unused2) {
            StringBuilder outline1074 = GeneratedOutlineSupport1.outline107("Expected an int but was ");
            outline1074.append(this.peekedString);
            outline1074.append(" at path ");
            outline1074.append(getPath());
            throw new JsonDataException(outline1074.toString());
        }
    }
    ...
    public void skipName() throws IOException {
        ...
        StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("Cannot skip unexpected ");
        outline1072.append(peek());
    ...
    public void skipValue() throws IOException {
                ...
                if (i2 == 3) {
                    ...
                    if (i2 == 4) {
                        ...
                        if (i >= 0) {
                            ...
                            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Expected a value but was ");
                            outline107.append(peek());
                            outline107.append(" at path ");
                            outline107.append(getPath());
                            throw new JsonDataException(outline107.toString());
                        ...
                        if (i >= 0) {
                            ...
                            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("Expected a value but was ");
                            outline1072.append(peek());
                            outline1072.append(" at path ");
                            outline1072.append(getPath());
                            throw new JsonDataException(outline1072.toString());
                        ...
                        StringBuilder outline1073 = GeneratedOutlineSupport1.outline107("Expected a value but was ");
                        outline1073.append(peek());
                        outline1073.append(" at path ");
                        outline1073.append(getPath());
                        throw new JsonDataException(outline1073.toString());
                    }
        ...
        StringBuilder outline1074 = GeneratedOutlineSupport1.outline107("Cannot skip unexpected ");
        outline1074.append(peek());
        outline1074.append(" at ");
        outline1074.append(getPath());
        throw new JsonDataException(outline1074.toString());
    }

    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("JsonReader(");

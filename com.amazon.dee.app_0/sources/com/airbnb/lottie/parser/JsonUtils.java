...
class JsonUtils {
    private static final JsonReader.Options POINT_NAMES = JsonReader.Options.of(ReactProperties.HereMapMarker.X, ReactProperties.HereMapMarker.Y);
    ...
    public static PointF jsonToPoint(JsonReader jsonReader, float f) throws IOException {
        ...
        if (ordinal != 0) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unknown point starts with ");

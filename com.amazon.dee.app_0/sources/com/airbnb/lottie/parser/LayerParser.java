...
public class LayerParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", "ind", "refId", "ty", RouteParameter.PARENT, "sw", "sh", "sc", "ks", TtmlNode.TAG_TT, "masksProperties", "shapes", "t", "ef", "sr", Constants.TIMELINE_START_TIME_KEY, "w", "h", "ip", "op", "tm", "cl", "hd");

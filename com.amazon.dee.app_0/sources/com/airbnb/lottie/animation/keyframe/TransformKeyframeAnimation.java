...
public class TransformKeyframeAnimation {
    ...
    public TransformKeyframeAnimation(AnimatableTransform animatableTransform) {
        this.anchorPoint = animatableTransform.getAnchorPoint() == null ? null : animatableTransform.getAnchorPoint().mo271createAnimation();
        this.position = animatableTransform.getPosition() == null ? null : animatableTransform.getPosition().mo271createAnimation();
        this.scale = animatableTransform.getScale() == null ? null : animatableTransform.getScale().mo271createAnimation();
        this.rotation = animatableTransform.getRotation() == null ? null : animatableTransform.getRotation().mo271createAnimation();
        this.skew = animatableTransform.getSkew() == null ? null : (FloatKeyframeAnimation) animatableTransform.getSkew().mo271createAnimation();
        if (this.skew != null) {
        ...
        this.skewAngle = animatableTransform.getSkewAngle() == null ? null : (FloatKeyframeAnimation) animatableTransform.getSkewAngle().mo271createAnimation();
        if (animatableTransform.getOpacity() != null) {
            this.opacity = animatableTransform.getOpacity().mo271createAnimation();
        }
        if (animatableTransform.getStartOpacity() != null) {
            this.startOpacity = animatableTransform.getStartOpacity().mo271createAnimation();
        } else {
            this.startOpacity = null;
        }
        if (animatableTransform.getEndOpacity() != null) {
            this.endOpacity = animatableTransform.getEndOpacity().mo271createAnimation();
        } else {
    ...
    public Matrix getMatrix() {
        ...
        if (baseKeyframeAnimation != null) {
            PointF mo268getValue = baseKeyframeAnimation.mo268getValue();
            if (mo268getValue.x != 0.0f || mo268getValue.y != 0.0f) {
                this.matrix.preTranslate(mo268getValue.x, mo268getValue.y);
            }
        }
        ...
        if (baseKeyframeAnimation2 != null) {
            if (baseKeyframeAnimation2 instanceof ValueCallbackKeyframeAnimation) {
                floatValue = baseKeyframeAnimation2.mo268getValue().floatValue();
            } else {
        ...
        if (baseKeyframeAnimation3 != null) {
            ScaleXY mo268getValue2 = baseKeyframeAnimation3.mo268getValue();
            if (mo268getValue2.getScaleX() != 1.0f || mo268getValue2.getScaleY() != 1.0f) {
                this.matrix.preScale(mo268getValue2.getScaleX(), mo268getValue2.getScaleY());
            }
        }
        BaseKeyframeAnimation<PointF, PointF> baseKeyframeAnimation4 = this.anchorPoint;
        if (baseKeyframeAnimation4 != null) {
            PointF mo268getValue3 = baseKeyframeAnimation4.mo268getValue();
            if (mo268getValue3.x != 0.0f || mo268getValue3.y != 0.0f) {
                this.matrix.preTranslate(-mo268getValue3.x, -mo268getValue3.y);
            }
        }
        return this.matrix;
    }
    ...
    public Matrix getMatrixForRepeater(float f) {
        BaseKeyframeAnimation<?, PointF> baseKeyframeAnimation = this.position;
        PointF pointF = null;
        PointF mo268getValue = baseKeyframeAnimation == null ? null : baseKeyframeAnimation.mo268getValue();
        BaseKeyframeAnimation<ScaleXY, ScaleXY> baseKeyframeAnimation2 = this.scale;
        ScaleXY mo268getValue2 = baseKeyframeAnimation2 == null ? null : baseKeyframeAnimation2.mo268getValue();
        this.matrix.reset();
        if (mo268getValue != null) {
            this.matrix.preTranslate(mo268getValue.x * f, mo268getValue.y * f);
        }
        if (mo268getValue2 != null) {
            double d = f;
            this.matrix.preScale((float) Math.pow(mo268getValue2.getScaleX(), d), (float) Math.pow(mo268getValue2.getScaleY(), d));
        }
        BaseKeyframeAnimation<Float, Float> baseKeyframeAnimation3 = this.rotation;
        if (baseKeyframeAnimation3 != null) {
            float floatValue = baseKeyframeAnimation3.mo268getValue().floatValue();
            BaseKeyframeAnimation<PointF, PointF> baseKeyframeAnimation4 = this.anchorPoint;
            if (baseKeyframeAnimation4 != null) {
                pointF = baseKeyframeAnimation4.mo268getValue();
            }

...
public class TrimPathContent implements Content, BaseKeyframeAnimation.AnimationListener {
    ...
    public TrimPathContent(BaseLayer baseLayer, ShapeTrimPath shapeTrimPath) {
        ...
        this.startAnimation = shapeTrimPath.getStart().mo271createAnimation();
        this.endAnimation = shapeTrimPath.getEnd().mo271createAnimation();
        this.offsetAnimation = shapeTrimPath.getOffset().mo271createAnimation();

...
public class FillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public FillContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, ShapeFill shapeFill) {
        ...
        if (shapeFill.getColor() != null && shapeFill.getOpacity() != null) {
            ...
            this.colorAnimation = shapeFill.getColor().mo271createAnimation();
            this.colorAnimation.addUpdateListener(this);
            baseLayer.addAnimation(this.colorAnimation);
            this.opacityAnimation = shapeFill.getOpacity().mo271createAnimation();
    ...
    public void draw(Canvas canvas, Matrix matrix, int i) {
        ...
        this.paint.setAlpha(MiscUtils.clamp((int) ((((i / 255.0f) * this.opacityAnimation.mo268getValue().intValue()) / 100.0f) * 255.0f), 0, 255));

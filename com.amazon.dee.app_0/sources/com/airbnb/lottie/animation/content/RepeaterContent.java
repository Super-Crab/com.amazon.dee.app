...
public class RepeaterContent implements DrawingContent, PathContent, GreedyContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public RepeaterContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, Repeater repeater) {
        ...
        this.copies = repeater.getCopies().mo271createAnimation();
        baseLayer.addAnimation(this.copies);
        this.copies.addUpdateListener(this);
        this.offset = repeater.getOffset().mo271createAnimation();
    ...
    public void draw(Canvas canvas, Matrix matrix, int i) {
        float floatValue = this.copies.mo268getValue().floatValue();
        float floatValue2 = this.offset.mo268getValue().floatValue();
        float floatValue3 = this.transform.getStartOpacity().mo268getValue().floatValue() / 100.0f;
        float floatValue4 = this.transform.getEndOpacity().mo268getValue().floatValue() / 100.0f;

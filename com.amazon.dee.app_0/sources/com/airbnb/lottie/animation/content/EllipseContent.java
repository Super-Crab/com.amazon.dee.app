...
public class EllipseContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public EllipseContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, CircleShape circleShape) {
        ...
        this.sizeAnimation = circleShape.getSize().mo271createAnimation();
        this.positionAnimation = circleShape.getPosition().mo271createAnimation();
    ...
    public Path getPath() {
        ...
        this.path.offset(mo268getValue2.x, mo268getValue2.y);
        this.path.close();

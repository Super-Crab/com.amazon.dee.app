...
public final class Base64Variant implements Serializable {
    ...
    public Base64Variant(String str, String str2, boolean z, char c, int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("Base64Alphabet length must be exactly 64 (was ", length, ")"));
    }
    ...
    protected void _reportInvalidBase64(char c, int i, String str) throws IllegalArgumentException {
        ...
        if (c <= ' ') {
            ...
            outline1072.append(getPaddingChar());
        ...
        throw new IllegalArgumentException(outline33);
    }
    ...
    protected Object readResolve() {
        ...
        return (z == z2 && this._paddingChar == valueOf._paddingChar && this._paddingReadBehaviour == valueOf._paddingReadBehaviour && this._maxLineLength == valueOf._maxLineLength && z == z2) ? valueOf : new Base64Variant(valueOf, this._name, this._writePadding, this._paddingChar, this._paddingReadBehaviour, this._maxLineLength);
    }
            ...
            if (charAt > ' ') {
                ...
                if (decodeBase64Char3 < 0) {
                    ...
                    if (!usesPaddingChar(charAt4)) {
                        ...
                        outline107.append(getPaddingChar());
                        outline107.append("'");
                        _reportInvalidBase64(charAt4, 3, outline107.toString());
                    }
                    byteArrayBuilder.append(i4 >> 4);
                } else {

...
public abstract class JsonParser implements Closeable, Versioned {
    ...
    public JsonParseException _constructError(String str) {
        return new JsonParseException(this, str).mo7002withRequestPayload(this._requestPayload);
    }

    protected void _reportUnsupportedOperation() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Operation not supported by parser of type ");
    ...
    public boolean getBooleanValue() throws IOException {
        ...
        if (currentToken != JsonToken.VALUE_FALSE) {
            throw new JsonParseException(this, String.format("Current token (%s) not of boolean type", currentToken)).mo7002withRequestPayload(this._requestPayload);
        }
        return false;
    }
    ...
    public Object getCurrentValue() {
        JsonStreamContext mo7000getParsingContext = mo7000getParsingContext();
        if (mo7000getParsingContext == null) {
            return null;
        }
        return mo7000getParsingContext.getCurrentValue();
    }
    ...
    public NonBlockingInputFeeder mo7011getNonBlockingInputFeeder() {
        return null;
    }
    ...
    public <T> Iterator<T> readValuesAs(Class<T> cls) throws IOException {
        return _codec().mo7038readValues(this, cls);
    }
    ...
    public void setCurrentValue(Object obj) {
        JsonStreamContext mo7000getParsingContext = mo7000getParsingContext();
        if (mo7000getParsingContext != null) {
            mo7000getParsingContext.setCurrentValue(obj);
        }
    }
    ...
    public <T> Iterator<T> readValuesAs(TypeReference<T> typeReference) throws IOException {
        return _codec().mo7037readValues(this, typeReference);
    }

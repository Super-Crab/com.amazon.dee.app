...
public final class ByteSourceJsonBootstrapper {
    ...
    public static int skipUTF8BOM(DataInput dataInput) throws IOException {
        ...
        if (readUnsignedByte2 == 187) {
            ...
            throw new IOException(GeneratedOutlineSupport1.outline33(readUnsignedByte3, GeneratedOutlineSupport1.outline107("Unexpected byte 0x"), " following 0xEF 0xBB; should get 0xBF as part of UTF-8 BOM"));
        }
        throw new IOException(GeneratedOutlineSupport1.outline33(readUnsignedByte2, GeneratedOutlineSupport1.outline107("Unexpected byte 0x"), " following 0xEF; should get 0xBB as part of UTF-8 BOM"));
    }

...
public class UTF8DataInputJsonParser extends ParserBase {
    ...
    private void _closeScope(int i) throws JsonParseException {
        if (i == 93) {
            if (!this._parsingContext.inArray()) {
                _reportMismatchedEndMarker(i, JsonReaderKt.END_OBJ);
            }
        ...
        if (i == 125) {
            if (!this._parsingContext.inObject()) {
                _reportMismatchedEndMarker(i, JsonReaderKt.END_LIST);
            }
            this._parsingContext = this._parsingContext.clearAndGetParent();
    ...
    */
    ...
    protected final byte[] _decodeBase64(Base64Variant base64Variant) throws IOException {
        ...
        outline107.append("'");
        throw reportInvalidBase64Char(base64Variant, readUnsignedByte, 3, outline107.toString());
    }
    ...
    */
    ...
    protected String _parseAposName() throws IOException {
        ...
        if (i2 > 0) {
            if (i3 >= iArr3.length) {
                int[] _growArrayBy3 = _growArrayBy(iArr3, iArr3.length);
        ...
        if (_skipWS != 93 && _skipWS != 125) {
            if (this._parsingContext.expectComma()) {
                if (_skipWS != 44) {
                    ...
                    _reportUnexpectedChar(_skipWS, outline107.toString());
                }
                _skipWS = _skipWS();

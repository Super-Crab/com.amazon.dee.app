...
public class JsonPointer {
    ...
    public static JsonPointer compile(String str) throws IllegalArgumentException {
        if (str != null && str.length() != 0) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("Invalid input: JSON Pointer expression must start with '/': \"", str, EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED));
        }
        return EMPTY;
    }
    ...
    protected JsonPointer _constructHead() {
        ...
        return new JsonPointer(GeneratedOutlineSupport1.outline51(this._asString, length, 0), this._matchingPropertyName, this._matchingElementIndex, this._nextSegment._constructHead(length, last));
    }
    ...
    public JsonPointer append(JsonPointer jsonPointer) {
        ...
        outline107.append(jsonPointer._asString);
        return compile(outline107.toString());
    }
    ...
    protected JsonPointer _constructHead(int i, JsonPointer jsonPointer) {
        ...
        return new JsonPointer(GeneratedOutlineSupport1.outline51(this._asString, i, 0), this._matchingPropertyName, this._matchingElementIndex, this._nextSegment._constructHead(i, jsonPointer));
    }

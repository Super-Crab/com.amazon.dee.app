...
public final class ByteQuadsCanonicalizer {
    ...
    */
    ...
    private void rehash() {
        ...
        if (i6 != i2) {
            throw new IllegalStateException(GeneratedOutlineSupport1.outline53("Failed rehash(): old count=", i2, ", copyCount=", i6));
        }
    }
    ...
    protected void _reportTooManyCollisions() {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Spill-over slots in symbol table with ");
        outline107.append(this._count);
        outline107.append(" entries, hash area of ");
        outline107.append(this._hashSize);
        outline107.append(" slots is now full (all ");
        throw new IllegalStateException(GeneratedOutlineSupport1.outline86(outline107, this._hashSize >> 3, " slots -- suspect a DoS attack based on hash collisions. You can disable the check via `JsonFactory.Feature.FAIL_ON_SYMBOL_HASH_OVERFLOW`"));
    }

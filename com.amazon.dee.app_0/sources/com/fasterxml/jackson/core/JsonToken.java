...
public enum JsonToken {
    ...
    START_OBJECT(EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_OPEN, 1),
    END_OBJECT(EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE, 2),
    START_ARRAY("[", 3),
    END_ARRAY("]", 4),
    FIELD_NAME(null, 5),
    ...
    VALUE_TRUE("true", 9),
    VALUE_FALSE(PCCConstants.PHONE_CALL_CONTROLLER_CALLING_FEATURE_ABSENT_VALUE, 10),
    VALUE_NULL("null", 11);

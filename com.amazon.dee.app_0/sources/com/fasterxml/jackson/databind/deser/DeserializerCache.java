...
public final class DeserializerCache implements Serializable {
    ...
    private boolean _hasCustomHandlers(JavaType javaType) {
        if (javaType.isContainerType()) {
            ...
            if (mo7243getContentType != null && (mo7243getContentType.getValueHandler() != null || mo7243getContentType.getTypeHandler() != null)) {
                return true;
            }
            return javaType.isMapLikeType() && javaType.mo7229getKeyType().getValueHandler() != null;
        }
        return false;
    }
    ...
    private Class<?> _verifyAsClass(Object obj, String str, Class<?> cls) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport1.outline46(obj, GeneratedOutlineSupport1.outline115("AnnotationIntrospector.", str, "() returned value of type "), ": expected type JsonSerializer or Class<JsonSerializer> instead"));
    }
    ...
    private JavaType modifyTypeByAnnotation(DeserializationContext deserializationContext, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (javaType.isMapLikeType() && (mo7229getKeyType = javaType.mo7229getKeyType()) != null && mo7229getKeyType.getValueHandler() == null && (findKeyDeserializer = annotationIntrospector.findKeyDeserializer(annotated)) != null && (keyDeserializerInstance = deserializationContext.keyDeserializerInstance(annotated, findKeyDeserializer)) != null) {
            javaType = ((MapLikeType) javaType).mo7239withKeyValueHandler(keyDeserializerInstance);
        }
        JavaType mo7243getContentType = javaType.mo7243getContentType();
        if (mo7243getContentType != null && mo7243getContentType.getValueHandler() == null && (findContentDeserializer = annotationIntrospector.findContentDeserializer(annotated)) != null) {
            ...
            if (jsonDeserializer != null) {
                javaType = javaType.mo7250withContentValueHandler(jsonDeserializer);
            }
        }
        return annotationIntrospector.refineDeserializationType(deserializationContext.mo7051getConfig(), annotated, javaType);
    }
    ...
    protected JsonDeserializer<Object> _createDeserializer(DeserializationContext deserializationContext, DeserializerFactory deserializerFactory, JavaType javaType) throws JsonMappingException {
        ...
        if (javaType.isAbstract() || javaType.isMapLikeType() || javaType.isCollectionLikeType()) {
            javaType = deserializerFactory.mapAbstractType(mo7051getConfig, javaType);
        }
        ...
        if (modifyTypeByAnnotation != javaType) {
            introspect = mo7051getConfig.introspect(modifyTypeByAnnotation);
        ...
        if (!inputType.hasRawClass(javaType.getRawClass())) {
            introspect = mo7051getConfig.introspect(inputType);
        }
    ...
    protected JsonDeserializer<?> _createDeserializer2(DeserializationContext deserializationContext, DeserializerFactory deserializerFactory, JavaType javaType, BeanDescription beanDescription) throws JsonMappingException {
        ...
        if (JsonNode.class.isAssignableFrom(javaType.getRawClass())) {
            return deserializerFactory.createTreeDeserializer(mo7051getConfig, javaType, beanDescription);
        }

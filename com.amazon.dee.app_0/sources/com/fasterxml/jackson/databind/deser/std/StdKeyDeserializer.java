...
public class StdKeyDeserializer extends KeyDeserializer implements Serializable {
    ...
    static final class DelegatingKD extends KeyDeserializer implements Serializable {
        ...
        public final Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
            ...
            try {
                ...
                asParser.nextToken();
                Object mo7111deserialize = this._delegate.mo7111deserialize(asParser, deserializationContext);
                return mo7111deserialize != null ? mo7111deserialize : deserializationContext.handleWeirdKey(this._keyClass, str, "not a valid representation", new Object[0]);
            } catch (Exception e) {
    ...
    static final class EnumKD extends StdKeyDeserializer {
        ...
        private EnumResolver _getToStringResolver(DeserializationContext deserializationContext) {
            ...
            if (enumResolver == null) {
                synchronized (this) {
                    enumResolver = EnumResolver.constructUsingToString(deserializationContext.mo7051getConfig(), this._byNameResolver.getEnumClass());
    ...
    protected Object _parse(String str, DeserializationContext deserializationContext) throws Exception {
        switch (this._kind) {
            ...
            case 9:
                try {
                    return this._deser.mo7110_deserialize(str, deserializationContext);
            ...
            case 17:
                try {
                    return deserializationContext.mo7051getConfig().getBase64Variant().decode(str);
                } catch (IllegalArgumentException e6) {
                    return _weirdKey(deserializationContext, str, e6);
                }
            default:
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Internal error: unknown key type ");
                outline107.append(this._keyClass);
    ...
    public Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
        ...
        try {
            ...
            if (ClassUtil.isEnumType(this._keyClass) && deserializationContext.mo7051getConfig().isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL)) {
                return null;
            }

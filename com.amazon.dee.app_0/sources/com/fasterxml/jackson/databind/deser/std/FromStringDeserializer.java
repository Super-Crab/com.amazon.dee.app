...
public abstract class FromStringDeserializer<T> extends StdScalarDeserializer<T> {
    ...
    public static class Std extends FromStringDeserializer<Object> {
        ...
        protected Object mo7110_deserialize(String str, DeserializationContext deserializationContext) throws IOException {
            switch (this._kind) {
                case 1:
                    return new File(str);
                case 2:
    ...
    public static class StringBuilderDeserializer extends FromStringDeserializer<Object> {
        ...
        public Object mo7111deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
            ...
            if (valueAsString != null) {
                return mo7110_deserialize(valueAsString, deserializationContext);
            }
            return super.mo7111deserialize(jsonParser, deserializationContext);
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: _deserialize */
    public abstract T mo7110_deserialize(String str, DeserializationContext deserializationContext) throws IOException;
    ...
    public T mo7111deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (!valueAsString.isEmpty()) {
            ...
            if (!trim.isEmpty()) {
                try {
                    return mo7110_deserialize(trim, deserializationContext);
                } catch (IllegalArgumentException | MalformedURLException e) {
                    String str = "not a valid textual representation";
                    String message = e.getMessage();
                    if (message != null) {
                        str = GeneratedOutlineSupport1.outline75(str, ", problem: ", message);
                    }

...
public abstract class DelegatingDeserializer extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer {
    ...
    public Object mo7111deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        return this._delegatee.mo7111deserialize(jsonParser, deserializationContext);
    }
    ...
    public Object mo7107deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer) throws IOException {
        return this._delegatee.mo7107deserializeWithType(jsonParser, deserializationContext, typeDeserializer);
    }
    ...
    public Object mo7075getNullValue(DeserializationContext deserializationContext) throws JsonMappingException {
        return this._delegatee.mo7075getNullValue(deserializationContext);
    }

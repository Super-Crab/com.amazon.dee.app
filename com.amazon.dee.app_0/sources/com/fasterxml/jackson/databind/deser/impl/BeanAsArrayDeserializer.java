...
public class BeanAsArrayDeserializer extends BeanDeserializerBase {
    ...
    public BeanDeserializerBase mo7057withByNameInclusion(Set<String> set, Set<String> set2) {
        return new BeanAsArrayDeserializer(this._delegate.mo7057withByNameInclusion(set, set2), this._orderedProperties);
    }
    ...
    public BeanDeserializerBase mo7058withObjectIdReader(ObjectIdReader objectIdReader) {
        return new BeanAsArrayDeserializer(this._delegate.mo7058withObjectIdReader(objectIdReader), this._orderedProperties);
    }

...
public class BeanPropertyMap implements Iterable<SettableBeanProperty>, Serializable {
    ...
    private final int _findFromOrdered(SettableBeanProperty settableBeanProperty) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Illegal state: property '");
        outline107.append(settableBeanProperty.getName());
        outline107.append("' missing from _propsInOrder");
    ...
    public void remove(SettableBeanProperty settableBeanProperty) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("No entry '");
        outline107.append(settableBeanProperty.getName());
        outline107.append("' found, can't remove");
        throw new NoSuchElementException(outline107.toString());
    }
    ...
    public void replace(SettableBeanProperty settableBeanProperty, SettableBeanProperty settableBeanProperty2) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("No entry '");
        outline107.append(settableBeanProperty.getName());
        outline107.append("' found, can't replace");
        throw new NoSuchElementException(outline107.toString());
    }
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Properties=[");
        ...
        while (it2.hasNext()) {
            ...
            outline107.append(next.getName());
            outline107.append('(');
            outline107.append(next.getType());
            outline107.append(')');
            i = i2;
        }
        outline107.append(JsonReaderKt.END_LIST);
        if (!this._aliasDefs.isEmpty()) {
            outline107.append("(aliases: ");
            outline107.append(this._aliasDefs);
            outline107.append(")");
        }

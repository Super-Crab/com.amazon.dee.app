...
public abstract class SettableBeanProperty extends ConcreteBeanPropertyBase implements Serializable {
    ...
    public final Object deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        if (jsonParser.hasToken(JsonToken.VALUE_NULL)) {
            return this._nullProvider.mo7075getNullValue(deserializationContext);
        }
        TypeDeserializer typeDeserializer = this._valueTypeDeserializer;
        if (typeDeserializer != null) {
            return this._valueDeserializer.mo7107deserializeWithType(jsonParser, deserializationContext, typeDeserializer);
        }
        Object mo7111deserialize = this._valueDeserializer.mo7111deserialize(jsonParser, deserializationContext);
        return mo7111deserialize == null ? this._nullProvider.mo7075getNullValue(deserializationContext) : mo7111deserialize;
    }
    ...
    public final Object deserializeWith(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj) throws IOException {
        if (jsonParser.hasToken(JsonToken.VALUE_NULL)) {
            return NullsConstantProvider.isSkipper(this._nullProvider) ? obj : this._nullProvider.mo7075getNullValue(deserializationContext);
        }
        ...
        return deserialize == null ? NullsConstantProvider.isSkipper(this._nullProvider) ? obj : this._nullProvider.mo7075getNullValue(deserializationContext) : deserialize;
    }

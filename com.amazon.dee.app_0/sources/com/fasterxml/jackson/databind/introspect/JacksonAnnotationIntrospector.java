...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    public VisibilityChecker<?> findAutoDetectVisibility(AnnotatedClass annotatedClass, VisibilityChecker<?> visibilityChecker) {
        ...
        return jsonAutoDetect == null ? visibilityChecker : visibilityChecker.mo7138with(jsonAutoDetect);
    }
    ...
    public TypeResolverBuilder<?> findPropertyContentTypeResolver(MapperConfig<?> mapperConfig, AnnotatedMember annotatedMember, JavaType javaType) {
        if (javaType.mo7243getContentType() != null) {
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (javaType.isMapLikeType()) {
            ...
            if (_classIfExplicit2 != null && !_primitiveAndWrapper(mo7229getKeyType, _classIfExplicit2)) {
                try {
                    javaType = ((MapLikeType) javaType).mo7237withKeyType(typeFactory.constructSpecializedType(mo7229getKeyType, _classIfExplicit2));
        ...
        if (mo7243getContentType != null) {
            Class<?> _classIfExplicit3 = jsonDeserialize == null ? null : _classIfExplicit(jsonDeserialize.contentAs());
            if (_classIfExplicit3 == null || _primitiveAndWrapper(mo7243getContentType, _classIfExplicit3)) {
                return javaType;
            }
            try {
                return javaType.withContentType(typeFactory.constructSpecializedType(mo7243getContentType, _classIfExplicit3));
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        JavaType mo7251withStaticTyping;
        JavaType mo7251withStaticTyping2;
        TypeFactory typeFactory = mapperConfig.getTypeFactory();
        JsonSerialize jsonSerialize = (JsonSerialize) _findAnnotation(annotated, JsonSerialize.class);
        ...
        if (_classIfExplicit != null) {
            if (javaType.hasRawClass(_classIfExplicit)) {
                javaType = javaType.mo7251withStaticTyping();
            } else {
        ...
        if (javaType.isMapLikeType()) {
            ...
            if (_classIfExplicit2 != null) {
                if (mo7229getKeyType.hasRawClass(_classIfExplicit2)) {
                    mo7251withStaticTyping2 = mo7229getKeyType.mo7251withStaticTyping();
                } else {
                    Class<?> rawClass2 = mo7229getKeyType.getRawClass();
                    try {
                        if (_classIfExplicit2.isAssignableFrom(rawClass2)) {
                            mo7251withStaticTyping2 = typeFactory.constructGeneralizedType(mo7229getKeyType, _classIfExplicit2);
                        } else if (rawClass2.isAssignableFrom(_classIfExplicit2)) {
                            mo7251withStaticTyping2 = typeFactory.constructSpecializedType(mo7229getKeyType, _classIfExplicit2);
                        } else if (_primitiveAndWrapper(rawClass2, _classIfExplicit2)) {
                            mo7251withStaticTyping2 = mo7229getKeyType.mo7251withStaticTyping();
                        } else {
                            throw new JsonMappingException((Closeable) null, String.format("Cannot refine serialization key type %s into %s; types not related", mo7229getKeyType, _classIfExplicit2.getName()));
                        }
                    } catch (IllegalArgumentException e2) {
                ...
                javaType = ((MapLikeType) javaType).mo7237withKeyType(mo7251withStaticTyping2);
            }
        }
        JavaType mo7243getContentType = javaType.mo7243getContentType();
        if (mo7243getContentType != null) {
            ...
            if (mo7243getContentType.hasRawClass(_classIfExplicit3)) {
                mo7251withStaticTyping = mo7243getContentType.mo7251withStaticTyping();
            } else {
                Class<?> rawClass3 = mo7243getContentType.getRawClass();
                try {
                    if (_classIfExplicit3.isAssignableFrom(rawClass3)) {
                        mo7251withStaticTyping = typeFactory.constructGeneralizedType(mo7243getContentType, _classIfExplicit3);
                    } else if (rawClass3.isAssignableFrom(_classIfExplicit3)) {
                        mo7251withStaticTyping = typeFactory.constructSpecializedType(mo7243getContentType, _classIfExplicit3);
                    } else if (_primitiveAndWrapper(rawClass3, _classIfExplicit3)) {
                        mo7251withStaticTyping = mo7243getContentType.mo7251withStaticTyping();
                    } else {
                        throw new JsonMappingException((Closeable) null, String.format("Cannot refine serialization content type %s into %s; types not related", mo7243getContentType, _classIfExplicit3.getName()));
                    }
                } catch (IllegalArgumentException e3) {
            ...
            return javaType.withContentType(mo7251withStaticTyping);
        }
        return javaType;
    }

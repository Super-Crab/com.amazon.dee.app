...
public class ObjectIdInfo {
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("ObjectIdInfo: propName=");
        outline107.append(this._propertyName);
        outline107.append(", scope=");
        outline107.append(ClassUtil.nameOf(this._scope));
        outline107.append(", generatorType=");
        outline107.append(ClassUtil.nameOf(this._generator));
        outline107.append(", alwaysAsId=");
        outline107.append(this._alwaysAsId);

...
public class StdArraySerializers {
    ...
    public static class BooleanArraySerializer extends ArraySerializerBase<boolean[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ...
            createSchemaNode.set(EntertainmentConstants.ENTERTAINMENT_ITEM_JSON_ATTR_ITEMS, createSchemaNode("boolean"));
    ...
    public static class CharArraySerializer extends StdSerializer<char[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ...
            return createSchemaNode.set(EntertainmentConstants.ENTERTAINMENT_ITEM_JSON_ATTR_ITEMS, createSchemaNode2);
        }
    ...
    public static class DoubleArraySerializer extends ArraySerializerBase<double[]> {
        ...
        @Override // com.fasterxml.jackson.databind.ser.std.StdSerializer, com.fasterxml.jackson.databind.jsonschema.SchemaAware
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            return createSchemaNode("array", true).set(EntertainmentConstants.ENTERTAINMENT_ITEM_JSON_ATTR_ITEMS, createSchemaNode("number"));
        }
    ...
    public static class IntArraySerializer extends ArraySerializerBase<int[]> {
        ...
        @Override // com.fasterxml.jackson.databind.ser.std.StdSerializer, com.fasterxml.jackson.databind.jsonschema.SchemaAware
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            return createSchemaNode("array", true).set(EntertainmentConstants.ENTERTAINMENT_ITEM_JSON_ATTR_ITEMS, createSchemaNode("integer"));
        }
    ...
    public static class LongArraySerializer extends TypedPrimitiveArraySerializer<long[]> {
        ...
        @Override // com.fasterxml.jackson.databind.ser.std.StdSerializer, com.fasterxml.jackson.databind.jsonschema.SchemaAware
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            return createSchemaNode("array", true).set(EntertainmentConstants.ENTERTAINMENT_ITEM_JSON_ATTR_ITEMS, createSchemaNode("number", true));
        }
    ...
    protected static abstract class TypedPrimitiveArraySerializer<T> extends ArraySerializerBase<T> {
        ...
        @Override // com.fasterxml.jackson.databind.ser.ContainerSerializer
        /* renamed from: _withValueTypeSerializer */
        public final ContainerSerializer<?> mo7209_withValueTypeSerializer(TypeSerializer typeSerializer) {
            return this;
        }

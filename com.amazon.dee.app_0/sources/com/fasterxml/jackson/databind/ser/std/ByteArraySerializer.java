...
public class ByteArraySerializer extends StdSerializer<byte[]> {
    ...
    public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
        return createSchemaNode("array", true).set(EntertainmentConstants.ENTERTAINMENT_ITEM_JSON_ATTR_ITEMS, createSchemaNode("byte"));
    }
    ...
    public void serialize(byte[] bArr, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        jsonGenerator.writeBinary(serializerProvider.mo7051getConfig().getBase64Variant(), bArr, 0, bArr.length);
    }

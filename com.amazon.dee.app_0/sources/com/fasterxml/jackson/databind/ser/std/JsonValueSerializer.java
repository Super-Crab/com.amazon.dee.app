...
public class JsonValueSerializer extends StdSerializer<Object> implements ContextualSerializer, JsonFormatVisitable, SchemaAware {
    ...
    static class TypeSerializerRerouter extends TypeSerializer {
        ...
        public TypeSerializer mo7152forProperty(BeanProperty beanProperty) {
    ...
    public String toString() {
        ...
        outline107.append(this._accessor.getDeclaringClass());
        outline107.append(MqttTopic.MULTI_LEVEL_WILDCARD);
        outline107.append(this._accessor.getName());
        outline107.append(")");

...
public abstract class DateTimeSerializerBase<T> extends StdScalarSerializer<T> implements ContextualSerializer {
    ...
    public boolean _asTimestamp(SerializerProvider serializerProvider) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Null SerializerProvider passed for ");
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        DateFormat dateFormat = serializerProvider.mo7051getConfig().getDateFormat();

...
public abstract class DefaultSerializerProvider extends SerializerProvider implements Serializable {
    ...
    public static final class Impl extends DefaultSerializerProvider {
        ...
        public Impl mo7200createInstance(SerializationConfig serializationConfig, SerializerFactory serializerFactory) {
    ...
    private IOException _wrapAsIOE(JsonGenerator jsonGenerator, Exception exc) {
        ...
        if (exceptionMessage == null) {
            ...
            outline107.append(exc.getClass().getName());
            outline107.append("]");
    ...
    /* renamed from: createInstance */
    public abstract DefaultSerializerProvider mo7200createInstance(SerializationConfig serializationConfig, SerializerFactory serializerFactory);
    ...
    public JsonSerializer<Object> serializerInstance(Annotated annotated, Object obj) throws JsonMappingException {
        ...
        if (obj instanceof JsonSerializer) {
            ...
            if (!(obj instanceof Class)) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("AnnotationIntrospector returned serializer definition of type ");
                outline107.append(obj.getClass().getName());
                outline107.append("; expected type JsonSerializer or Class<JsonSerializer> instead");
                reportBadDefinition(type, outline107.toString());
            }
            Class<?> cls = (Class) obj;
            ...
            if (!JsonSerializer.class.isAssignableFrom(cls)) {
                ...
                StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("AnnotationIntrospector returned Class ");
                outline1072.append(cls.getName());
                outline1072.append("; expected Class<JsonSerializer>");
                reportBadDefinition(type2, outline1072.toString());
            }
            HandlerInstantiator handlerInstantiator = this._config.getHandlerInstantiator();
            if (handlerInstantiator != null) {

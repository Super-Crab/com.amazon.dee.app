...
public class UnwrappingBeanPropertyWriter extends BeanPropertyWriter implements Serializable {
    ...
    protected void _depositSchemaProperty(ObjectNode objectNode, JsonNode jsonNode) {
        JsonNode mo7196get = jsonNode.mo7196get("properties");
        if (mo7196get != null) {
            Iterator<Map.Entry<String, JsonNode>> fields = mo7196get.fields();
    ...
    public UnwrappingBeanPropertyWriter mo7205rename(NameTransformer nameTransformer) {

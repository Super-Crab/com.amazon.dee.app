...
public class OptionalHandlerFactory implements Serializable {
    ...
    private Object instantiate(String str, JavaType javaType) {
        try {
            ...
            StringBuilder outline115 = GeneratedOutlineSupport1.outline115("Failed to find class `", str, "` for handling values of type ");
            outline115.append(ClassUtil.getTypeDescription(javaType));
            outline115.append(", problem: (");
            outline115.append(th.getClass().getName());
            outline115.append(") ");
    ...
    private Object instantiate(Class<?> cls, JavaType javaType) {
        try {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Failed to create instance of `");
            outline107.append(cls.getName());
            outline107.append("` for handling values of type ");

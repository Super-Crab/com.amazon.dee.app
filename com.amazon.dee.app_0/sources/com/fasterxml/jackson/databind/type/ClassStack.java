...
public final class ClassStack {
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("[ClassStack (self-refs: ");
        ArrayList<ResolvedRecursiveType> arrayList = this._selfRefs;
        outline107.append(arrayList == null ? "0" : String.valueOf(arrayList.size()));
        outline107.append(')');
        for (ClassStack classStack = this; classStack != null; classStack = classStack._parent) {
            outline107.append(Chars.SPACE);
            outline107.append(classStack._current.getName());
        }

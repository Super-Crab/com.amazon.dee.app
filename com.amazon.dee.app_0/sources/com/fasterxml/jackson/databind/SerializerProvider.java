...
public abstract class SerializerProvider extends DatabindContext {
    ...
    public JavaType constructSpecializedType(JavaType javaType, Class<?> cls) throws IllegalArgumentException {
        return javaType.hasRawClass(cls) ? javaType : mo7051getConfig().getTypeFactory().constructSpecializedType(javaType, cls, true);
    }
    ...
    public JsonSerializer<Object> findTypedValueSerializer(Class<?> cls, boolean z, BeanProperty beanProperty) throws JsonMappingException {
        ...
        if (createTypeSerializer != null) {
            findValueSerializer = new TypeWrappedSerializer(createTypeSerializer.mo7152forProperty(beanProperty), findValueSerializer);
        }
        if (z) {
    ...
    public <T> T reportBadPropertyDefinition(BeanDescription beanDescription, BeanPropertyDefinition beanPropertyDefinition, String str, Object... objArr) throws JsonMappingException {
        ...
        String str2 = CapabilityQueryConstants.TARGET_NOT_AVAILABLE;
    ...
    public <T> T reportBadTypeDefinition(BeanDescription beanDescription, String str, Object... objArr) throws JsonMappingException {
        throw InvalidDefinitionException.from(getGenerator(), String.format("Invalid type definition for type %s: %s", beanDescription != null ? ClassUtil.nameOf(beanDescription.getBeanClass()) : CapabilityQueryConstants.TARGET_NOT_AVAILABLE, _format(str, objArr)), beanDescription, (BeanPropertyDefinition) null);
    }
    ...
    public final SerializationConfig mo7051getConfig() {
        return this._config;
    }
    ...
    public SerializerProvider mo7052setAttribute(Object obj, Object obj2) {

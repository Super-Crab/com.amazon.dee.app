...
public abstract class ValueNode extends BaseJsonNode {
    ...
    public final ObjectNode mo7194findParent(String str) {
        return null;
    }
    ...
    public final JsonNode mo7195get(int i) {
        return null;
    }

    @Override // com.fasterxml.jackson.databind.JsonNode, com.fasterxml.jackson.core.TreeNode
    /* renamed from: get  reason: collision with other method in class */
    public final JsonNode mo7196get(String str) {
        return null;
    }
    ...
    public final JsonNode mo7197path(int i) {
        return MissingNode.getInstance();
    }

    @Override // com.fasterxml.jackson.databind.JsonNode, com.fasterxml.jackson.core.TreeNode
    /* renamed from: path  reason: collision with other method in class */
    public final JsonNode mo7198path(String str) {
        return MissingNode.getInstance();
    }
}

...
public abstract class MapperConfig<T extends MapperConfig<T>> implements ClassIntrospector.MixInResolver, Serializable {
    ...
    /* renamed from: with */
    public abstract T mo7054with(MapperFeature mapperFeature, boolean z);

    /* renamed from: with */
    public abstract T mo7055with(MapperFeature... mapperFeatureArr);

    /* renamed from: without */
    public abstract T mo7056without(MapperFeature... mapperFeatureArr);
    ...
    public BeanDescription introspectClassAnnotations(JavaType javaType) {
        return getClassIntrospector().mo7121forClassAnnotations(this, javaType, this);
    }

    public final BeanDescription introspectDirectClassAnnotations(JavaType javaType) {
        return getClassIntrospector().mo7126forDirectClassAnnotations(this, javaType, this);
    }

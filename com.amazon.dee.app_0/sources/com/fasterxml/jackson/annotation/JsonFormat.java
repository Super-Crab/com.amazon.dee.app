...
public @interface JsonFormat {
    ...
    public static class Features {
        ...
        public String toString() {
            return this == EMPTY ? SimbaEventProcessor.SOURCE_EMPTY : String.format("(enabled=0x%x,disabled=0x%x)", Integer.valueOf(this._enabled), Integer.valueOf(this._disabled));
        }

...
public class GifFrameLoader {
    ...
    private static RequestBuilder<Bitmap> getRequestBuilder(RequestManager requestManager, int i, int i2) {
        return requestManager.mo1635asBitmap().mo1615apply(RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE).mo1613useAnimationPool(true).mo1607skipMemoryCache(true).mo1600override(i, i2));
    }
    ...
    private void loadNextFrame() {
        ...
        this.requestBuilder.mo1615apply(RequestOptions.signatureOf(getFrameSignature())).mo6761load((Object) this.gifDecoder).into((RequestBuilder<Bitmap>) this.next);
    }
    ...
    public void setFrameTransformation(Transformation<Bitmap> transformation, Bitmap bitmap) {
        ...
        this.requestBuilder = this.requestBuilder.mo1615apply(new RequestOptions().mo1610transform(transformation));
    }

...
public class HttpUrlFetcher implements DataFetcher<InputStream> {
    ...
    private InputStream getStreamForSuccessfulRequest(HttpURLConnection httpURLConnection) throws IOException {
        if (TextUtils.isEmpty(httpURLConnection.getContentEncoding())) {
            ...
            if (Log.isLoggable(TAG, 3)) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Got non empty content encoding: ");
                outline107.append(httpURLConnection.getContentEncoding());
                outline107.toString();
            }
    ...
    public void loadData(@NonNull Priority priority, @NonNull DataFetcher.DataCallback<? super InputStream> dataCallback) {
        ...
        try {
            ...
            if (Log.isLoggable(TAG, 2)) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Finished http url fetcher fetch in ");

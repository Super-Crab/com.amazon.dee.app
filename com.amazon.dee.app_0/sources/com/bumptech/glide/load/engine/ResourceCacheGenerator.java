...
public class ResourceCacheGenerator implements DataFetcherGenerator, DataFetcher.DataCallback<Object> {
    ...
    public boolean startNext() {
        ...
        if (registeredResourceClasses.isEmpty()) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Failed to find any load path from ");
            outline107.append(this.helper.getModelClass());
            outline107.append(" to ");
            outline107.append(this.helper.getTranscodeClass());

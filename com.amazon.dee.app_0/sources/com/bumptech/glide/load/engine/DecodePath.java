...
public class DecodePath<DataType, ResourceType, Transcode> {
    ...
    public DecodePath(Class<DataType> cls, Class<ResourceType> cls2, Class<Transcode> cls3, List<? extends ResourceDecoder<DataType, ResourceType>> list, ResourceTranscoder<ResourceType, Transcode> resourceTranscoder, Pools.Pool<List<Throwable>> pool) {
        ...
        this.listPool = pool;
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Failed DecodePath{");
    ...
    private Resource<ResourceType> decodeResourceWithList(DataRewinder<DataType> dataRewinder, int i, int i2, @NonNull Options options, List<Throwable> list) throws GlideException {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            try {
                if (resourceDecoder.handles(dataRewinder.mo6787rewindAndGet(), options)) {
                    resource = resourceDecoder.decode(dataRewinder.mo6787rewindAndGet(), i, i2, options);
                }
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("DecodePath{ dataClass=");
        outline107.append(this.dataClass);
        outline107.append(", decoders=");
        outline107.append(this.decoders);
        outline107.append(", transcoder=");
        outline107.append(this.transcoder);

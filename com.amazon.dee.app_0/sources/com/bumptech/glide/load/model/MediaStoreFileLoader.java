    ...
    public static class FilePathFetcher implements DataFetcher<File> {
        ...
        public void loadData(@NonNull Priority priority, @NonNull DataFetcher.DataCallback<? super File> dataCallback) {
            ...
            if (TextUtils.isEmpty(str)) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Failed to find file path for: ");
                outline107.append(this.uri);
                dataCallback.onLoadFailed(new FileNotFoundException(outline107.toString()));
                return;
            }

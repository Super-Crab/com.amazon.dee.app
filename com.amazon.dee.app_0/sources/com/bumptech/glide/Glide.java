    ...
    private static void initializeGlide(@NonNull Context context, @NonNull GlideBuilder glideBuilder) {
        ...
        if (Log.isLoggable(TAG, 3)) {
            for (GlideModule glideModule : emptyList) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Discovered GlideModule from manifest: ");
                outline107.append(glideModule.getClass());
                outline107.toString();
            }
        }
        glideBuilder.setRequestManagerFactory(annotationGeneratedGlideModules != null ? annotationGeneratedGlideModules.mo6746getRequestManagerFactory() : null);

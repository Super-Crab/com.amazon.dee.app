...
public final class Util {
    ...
    public static int getBitmapByteSize(@NonNull Bitmap bitmap) {
        ...
        throw new IllegalStateException("Cannot obtain size for recycled Bitmap: " + bitmap + "[" + bitmap.getWidth() + ReactProperties.HereMapMarker.X + bitmap.getHeight() + "] " + bitmap.getConfig());
    }

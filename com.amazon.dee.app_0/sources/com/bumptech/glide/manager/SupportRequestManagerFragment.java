...
public class SupportRequestManagerFragment extends Fragment {
    ...
    private class SupportFragmentRequestManagerTreeNode implements RequestManagerTreeNode {
        ...
        public String toString() {
            return super.toString() + "{fragment=" + SupportRequestManagerFragment.this + EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE;
        }
    }
    ...
    @Override // androidx.fragment.app.Fragment
    public String toString() {
        return super.toString() + "{parent=" + getParentFragmentUsingHint() + EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE;
    }

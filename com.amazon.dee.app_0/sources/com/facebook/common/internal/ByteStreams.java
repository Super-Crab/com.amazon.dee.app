...
public final class ByteStreams {
    ...
    private static final class FastByteArrayOutputStream extends ByteArrayOutputStream {
        ...
        void writeTo(byte[] b, int off) {
            System.arraycopy(((ByteArrayOutputStream) this).buf, 0, b, off, ((ByteArrayOutputStream) this).count);
        }
    }
    ...
    public static void readFully(InputStream in, byte[] b, int off, int len) throws IOException {
        ...
        throw new EOFException(GeneratedOutlineSupport1.outline54("reached end of stream after reading ", read, " bytes; ", len, " bytes expected"));
    }
    ...
    public static byte[] toByteArray(InputStream in, int expectedSize) throws IOException {
        ...
        byte[] bArr2 = new byte[fastByteArrayOutputStream.size() + bArr.length];

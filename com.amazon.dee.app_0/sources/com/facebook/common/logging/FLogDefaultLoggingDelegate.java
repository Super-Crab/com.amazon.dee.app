...
public class FLogDefaultLoggingDelegate implements LoggingDelegate {
    ...
    private static String getMsg(String msg, Throwable tr) {
        StringBuilder outline108 = GeneratedOutlineSupport1.outline108(msg, '\n');
        outline108.append(getStackTraceString(tr));
    ...
    private String prefixTag(String tag) {
        return this.mApplicationTag != null ? GeneratedOutlineSupport1.outline92(new StringBuilder(), this.mApplicationTag, ":", tag) : tag;
    }

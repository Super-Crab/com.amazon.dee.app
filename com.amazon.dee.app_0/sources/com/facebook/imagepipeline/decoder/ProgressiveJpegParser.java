...
public class ProgressiveJpegParser {
    ...
    public boolean parseMoreData(final EncodedImage encodedImage) {
        if (this.mParserState != 6 && encodedImage.getSize() > this.mBytesParsed) {
            PooledByteArrayBufferedInputStream pooledByteArrayBufferedInputStream = new PooledByteArrayBufferedInputStream(encodedImage.getInputStreamOrThrow(), this.mByteArrayPool.mo6905get(16384), this.mByteArrayPool);
            try {

...
public abstract class MultiplexProducer<K, T extends Closeable> implements Producer<T> {
    ...
    /* renamed from: getKey */
    protected abstract K mo6917getKey(ProducerContext producerContext);
    ...
    public void produceResults(Consumer<T> consumer, ProducerContext context) {
        ...
        try {
            ...
            K mo6917getKey = mo6917getKey(context);
            do {
                z = false;
                synchronized (this) {
                    existingMultiplexer = getExistingMultiplexer(mo6917getKey);
                    if (existingMultiplexer == null) {
                        existingMultiplexer = createAndPutNewMultiplexer(mo6917getKey);
                        z = true;
                    }
                }

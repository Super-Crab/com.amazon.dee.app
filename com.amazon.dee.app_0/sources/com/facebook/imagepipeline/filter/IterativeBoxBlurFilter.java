...
public abstract class IterativeBoxBlurFilter {
    ...
    private static void internalVerticalBlur(int[] pixels, int[] outCol, int w, int h, int col, int diameter, int[] div) {
        int outline2 = GeneratedOutlineSupport1.outline2(h, -1, w, col);
        int i = (diameter >> 1) * w;
        int i2 = (diameter - 1) * w;
        int i3 = col - i;
        int i4 = 0;
        ...
        int i8 = 0;
        while (i3 <= outline2 + i) {
            int i9 = pixels[bound(i3, col, outline2)];
            i4 += (i9 >> 16) & 255;
            i5 += (i9 >> 8) & 255;
            i6 += i9 & 255;
            i7 += i9 >>> 24;
            if (i3 - i >= col) {
                outCol[i8] = (div[i7] << 24) | (div[i4] << 16) | (div[i5] << 8) | div[i6];
                i8++;
                int i10 = pixels[bound(i3 - i2, col, outline2)];
                i4 -= (i10 >> 16) & 255;
                i5 -= (i10 >> 8) & 255;
                i6 -= i10 & 255;
                i7 -= i10 >>> 24;

...
public class ImagePipelineConfig implements ImagePipelineConfigInterface {
    ...
    private ImagePipelineConfig(Builder builder) {
        ...
        if (builder.mBitmapMemoryCacheParamsSupplier != null) {
            ...
            supplier = new DefaultBitmapMemoryCacheParamsSupplier((ActivityManager) Preconditions.checkNotNull(builder.mContext.getSystemService(MultipleAccountManager.SessionPackageMappingType.JSON_KEY_SESSION_PACKAGE_MAPPING_REMOVE_ACTIVITY_CLASS_NAME)));
        }

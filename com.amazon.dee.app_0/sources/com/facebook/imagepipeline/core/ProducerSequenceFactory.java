...
public class ProducerSequenceFactory {
    ...
    private synchronized Producer<EncodedImage> getCommonNetworkFetchToEncodedMemorySequence() {
        ...
        if (this.mCommonNetworkFetchToEncodedMemorySequence == null) {
            ...
            this.mCommonNetworkFetchToEncodedMemorySequence = ProducerFactory.newAddImageTransformMetaDataProducer((Producer) Preconditions.checkNotNull(newEncodedCacheMultiplexToTranscodeSequence));
    ...
    public Producer<Void> getEncodedImagePrefetchProducerSequence(ImageRequest imageRequest) {
        ...
        if (sourceUriType != 0) {
            if (sourceUriType != 2 && sourceUriType != 3) {
                Uri sourceUri = imageRequest.getSourceUri();
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unsupported uri scheme for encoded image fetch! Uri is: ");
                outline107.append(getShortenedUriString(sourceUri));

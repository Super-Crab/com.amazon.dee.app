    ...
    public void handleTouchEvent(MotionEvent motionEvent, EventDispatcher eventDispatcher) {
        ...
        if (action == 0) {
            ...
            if (i2 == -1) {
                ...
                eventDispatcher.dispatchEvent(TouchEvent.obtain(i3, touchEventType2, motionEvent, j2, fArr2[0], fArr2[1], this.mTouchEventCoalescingKeyHelper));
                this.mTargetTag = -1;
                ...
                eventDispatcher.dispatchEvent(TouchEvent.obtain(i4, touchEventType3, motionEvent, j3, fArr3[0], fArr3[1], this.mTouchEventCoalescingKeyHelper));
            } else if (action == 5) {
                TouchEventType touchEventType4 = TouchEventType.START;
                long j4 = this.mGestureStartTime;
                float[] fArr4 = this.mTargetCoordinates;
                eventDispatcher.dispatchEvent(TouchEvent.obtain(i2, touchEventType4, motionEvent, j4, fArr4[0], fArr4[1], this.mTouchEventCoalescingKeyHelper));
            } else if (action == 6) {
                TouchEventType touchEventType5 = TouchEventType.END;
                long j5 = this.mGestureStartTime;
                float[] fArr5 = this.mTargetCoordinates;
                eventDispatcher.dispatchEvent(TouchEvent.obtain(i2, touchEventType5, motionEvent, j5, fArr5[0], fArr5[1], this.mTouchEventCoalescingKeyHelper));
            } else if (action == 3) {
                ...
                StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Warning : touch event was ignored. Action=", action, " Target=");
                outline109.append(this.mTargetTag);
                FLog.w(ReactConstants.TAG, outline109.toString());
            }
        }
    }

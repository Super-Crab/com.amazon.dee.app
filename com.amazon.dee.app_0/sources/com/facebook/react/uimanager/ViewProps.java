    ...
    public static boolean isLayoutOnly(ReadableMap readableMap, String str) {
        ...
        switch (c) {
            ...
            case 1:
                ...
                return !readableMap.hasKey(BORDER_WIDTH) || readableMap.isNull(BORDER_WIDTH) || readableMap.getDouble(BORDER_WIDTH) == FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
            case 2:
            ...
            case 6:
                return readableMap.isNull(BORDER_WIDTH) || readableMap.getDouble(BORDER_WIDTH) == FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
            case 7:
                return readableMap.isNull(BORDER_LEFT_WIDTH) || readableMap.getDouble(BORDER_LEFT_WIDTH) == FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
            case '\b':
                return readableMap.isNull(BORDER_TOP_WIDTH) || readableMap.getDouble(BORDER_TOP_WIDTH) == FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
            case '\t':
                return readableMap.isNull(BORDER_RIGHT_WIDTH) || readableMap.getDouble(BORDER_RIGHT_WIDTH) == FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
            case '\n':
                return readableMap.isNull(BORDER_BOTTOM_WIDTH) || readableMap.getDouble(BORDER_BOTTOM_WIDTH) == FrostVideoEffectController.VIDEO_STRENGTH_CLEAR;
            case 11:

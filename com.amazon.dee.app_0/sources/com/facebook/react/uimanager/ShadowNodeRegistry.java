...
public class ShadowNodeRegistry {
    ...
    public void removeNode(int i) {
        ...
        throw new IllegalViewOperationException(GeneratedOutlineSupport1.outline52("Trying to remove root node ", i, " without using removeRootNode!"));
    }
    ...
    public void removeRootNode(int i) {
        ...
        throw new IllegalViewOperationException(GeneratedOutlineSupport1.outline52("View with tag ", i, " is not registered as a root view"));
    }
}

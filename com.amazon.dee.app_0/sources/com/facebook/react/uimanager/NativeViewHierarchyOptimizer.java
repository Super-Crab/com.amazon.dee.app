...
public class NativeViewHierarchyOptimizer {
    ...
    private void transitionLayoutOnlyViewToNativeView(ReactShadowNode reactShadowNode, @Nullable ReactStylesDiffMap reactStylesDiffMap) {
        ...
        if (ReactFeatureFlags.enableTransitionLayoutOnlyViewCleanup) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Transitioning LayoutOnlyView - tag: ");
            outline107.append(reactShadowNode.getReactTag());
            outline107.append(" - rootTag: ");
            outline107.append(reactShadowNode.getRootTag());
            outline107.append(" - hasProps: ");
            outline107.append(reactStylesDiffMap != null);
            outline107.append(" - tagsWithLayout.size: ");
            outline107.append(this.mTagsWithLayoutVisited.size());
            FLog.i(TAG, outline107.toString());
        }

...
public class ReactShadowNodeImpl implements ReactShadowNode<ReactShadowNodeImpl> {
    ...
    */
    ...
    public void removeAndDisposeAllChildren() {
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            if (this.mYogaNode != null && !isYogaLeafNode()) {
                this.mYogaNode.mo6982removeChildAt(childCount);
            }
    ...
    public String toString() {
        ...
        outline107.append(this.mViewClassName);
        outline107.append(" ");
        outline107.append(getReactTag());
        outline107.append("]");
    ...
    public void addChildAt(ReactShadowNodeImpl reactShadowNodeImpl, int i) {
        ...
        if (this.mYogaNode != null && !isYogaLeafNode()) {
            ...
            if (yogaNode != null) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Cannot add a child that doesn't have a YogaNode to a parent without a measure function! (Trying to add a '");
                outline107.append(reactShadowNodeImpl.toString());
    ...
    public final ReactShadowNodeImpl getChildAt(int i) {
        ...
        throw new ArrayIndexOutOfBoundsException(GeneratedOutlineSupport1.outline52("Index ", i, " out of bounds: node has no children"));
    }
    ...
    public final int getNativeOffsetForChild(ReactShadowNodeImpl reactShadowNodeImpl) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Child ");
        outline107.append(reactShadowNodeImpl.getReactTag());
        outline107.append(" was not a child of ");
    ...
    public ReactShadowNodeImpl removeChildAt(int i) {
        ...
        if (arrayList != null) {
            ...
            remove.mParent = null;
            if (this.mYogaNode != null && !isYogaLeafNode()) {
                this.mYogaNode.mo6982removeChildAt(i);
            }
            markUpdated();

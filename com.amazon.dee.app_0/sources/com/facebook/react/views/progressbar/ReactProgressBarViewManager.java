...
public class ReactProgressBarViewManager extends BaseViewManager<ProgressBarContainerView, ProgressBarShadowNode> implements AndroidProgressBarManagerInterface<ProgressBarContainerView> {
    ...
    public static int getStyleFromString(@Nullable String str) {
        if (str != null) {
            ...
            if (!str.equals("Normal")) {
                throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport1.outline72("Unknown ProgressBar style: ", str));
            }
            return 16842871;
        }
    ...
    public ProgressBarShadowNode mo10136createShadowNodeInstance() {
    ...
    public ProgressBarContainerView mo12880createViewInstance(ThemedReactContext themedReactContext) {

...
public class TextAttributes {
    ...
    public String toString() {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("TextAttributes {\n  getAllowFontScaling(): ");
        outline107.append(getAllowFontScaling());
        outline107.append("\n  getFontSize(): ");
        outline107.append(getFontSize());
        outline107.append("\n  getEffectiveFontSize(): ");
        outline107.append(getEffectiveFontSize());
        outline107.append("\n  getHeightOfTallestInlineViewOrImage(): ");
        outline107.append(getHeightOfTallestInlineViewOrImage());
        outline107.append("\n  getLetterSpacing(): ");
        outline107.append(getLetterSpacing());
        outline107.append("\n  getEffectiveLetterSpacing(): ");
        outline107.append(getEffectiveLetterSpacing());
        outline107.append("\n  getLineHeight(): ");
        outline107.append(getLineHeight());
        outline107.append("\n  getEffectiveLineHeight(): ");
        outline107.append(getEffectiveLineHeight());
        outline107.append("\n  getTextTransform(): ");
        outline107.append(getTextTransform());
        outline107.append("\n  getMaxFontSizeMultiplier(): ");
        outline107.append(getMaxFontSizeMultiplier());
        outline107.append("\n  getEffectiveMaxFontSizeMultiplier(): ");
        outline107.append(getEffectiveMaxFontSizeMultiplier());
        outline107.append("\n}");

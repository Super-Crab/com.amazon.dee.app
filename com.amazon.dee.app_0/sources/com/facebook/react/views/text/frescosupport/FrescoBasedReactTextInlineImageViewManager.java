...
public class FrescoBasedReactTextInlineImageViewManager extends ViewManager<View, FrescoBasedReactTextInlineImageShadowNode> {
    ...
    public View mo12880createViewInstance(ThemedReactContext themedReactContext) {
    ...
    public FrescoBasedReactTextInlineImageShadowNode mo10136createShadowNodeInstance() {

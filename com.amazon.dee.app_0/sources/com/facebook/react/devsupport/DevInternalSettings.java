...
public class DevInternalSettings implements DeveloperSettings, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void setElementInspectorEnabled(boolean z) {
        GeneratedOutlineSupport1.outline143(this.mPreferences, PREFS_INSPECTOR_DEBUG_KEY, z);
    }

    public void setFpsDebugEnabled(boolean z) {
        GeneratedOutlineSupport1.outline143(this.mPreferences, PREFS_FPS_DEBUG_KEY, z);
    }

    public void setHotModuleReplacementEnabled(boolean z) {
        GeneratedOutlineSupport1.outline143(this.mPreferences, PREFS_HOT_MODULE_REPLACEMENT_KEY, z);
    }

    public void setJSDevModeEnabled(boolean z) {
        GeneratedOutlineSupport1.outline143(this.mPreferences, PREFS_JS_DEV_MODE_DEBUG_KEY, z);
    }

    @Override // com.facebook.react.modules.debug.interfaces.DeveloperSettings
    public void setRemoteJSDebugEnabled(boolean z) {
        GeneratedOutlineSupport1.outline143(this.mPreferences, PREFS_REMOTE_JS_DEBUG_KEY, z);
    }
}

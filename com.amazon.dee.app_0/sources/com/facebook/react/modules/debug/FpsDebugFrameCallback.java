...
public class FpsDebugFrameCallback extends ChoreographerCompat.FrameCallback {
    ...
    public double getFPS() {
        return this.mLastFrameTime == this.mFirstFrameTime ? FrostVideoEffectController.VIDEO_STRENGTH_CLEAR : (getNumFrames() * 1.0E9d) / (this.mLastFrameTime - this.mFirstFrameTime);
    }
    ...
    public double getJSFPS() {
        return this.mLastFrameTime == this.mFirstFrameTime ? FrostVideoEffectController.VIDEO_STRENGTH_CLEAR : (getNumJSFrames() * 1.0E9d) / (this.mLastFrameTime - this.mFirstFrameTime);
    }
    ...
    public int getTotalTimeMS() {
        return ((int) (this.mLastFrameTime - this.mFirstFrameTime)) / TracePublisherServiceConfigImpl.TOTAL_TRACES_CAPACITY_IN_BYTES;
    }

...
public class SystraceRequestListener extends BaseRequestListener {
    ...
    public void onProducerEvent(String str, String str2, String str3) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("FRESCO_PRODUCER_EVENT_");
        outline107.append(str.replace(JsonReaderKt.COLON, '_'));
        outline107.append("_");
        outline107.append(str2.replace(JsonReaderKt.COLON, '_'));
        outline107.append("_");
        outline107.append(str3.replace(JsonReaderKt.COLON, '_'));
        Systrace.traceInstant(0L, outline107.toString(), Systrace.EventScope.THREAD);
    }
    ...
    public void onProducerStart(String str, String str2) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("FRESCO_PRODUCER_");
        outline107.append(str2.replace(JsonReaderKt.COLON, '_'));
        Pair<Integer, String> create = Pair.create(Integer.valueOf(this.mCurrentID), outline107.toString());
    ...
    public void onRequestStart(ImageRequest imageRequest, Object obj, String str, boolean z) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("FRESCO_REQUEST_");
        outline107.append(imageRequest.getSourceUri().toString().replace(JsonReaderKt.COLON, '_'));
        Pair<Integer, String> create = Pair.create(Integer.valueOf(this.mCurrentID), outline107.toString());
        Systrace.beginAsyncSection(0L, (String) create.second, this.mCurrentID);

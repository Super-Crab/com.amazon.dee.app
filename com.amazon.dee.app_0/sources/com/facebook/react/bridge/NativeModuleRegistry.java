...
public class NativeModuleRegistry {
    ...
    public <T extends NativeModule> T getModule(Class<T> cls) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline38(cls, GeneratedOutlineSupport1.outline107("Could not find @ReactModule annotation in class ")));
    }

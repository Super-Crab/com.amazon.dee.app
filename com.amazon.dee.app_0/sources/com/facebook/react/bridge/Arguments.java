...
public class Arguments {
    ...
    private static void addEntry(WritableNativeMap writableNativeMap, String str, Object obj) {
        ...
        if (makeNativeObject == null) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline44(makeNativeObject, GeneratedOutlineSupport1.outline107("Could not convert ")));
        }
    }
        ...
        if (obj instanceof String[]) {
            ...
            while (i < length7) {
                ...
                if (parcelable instanceof Bundle) {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unexpected array member type ");
                    outline107.append(parcelable.getClass());
                    throw new IllegalArgumentException(outline107.toString());
                }
            }
        } else {
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline44(obj, GeneratedOutlineSupport1.outline107("Unknown array type ")));
        }
        return createArray;
    }
    ...
    public static WritableMap fromBundle(Bundle bundle) {
        ...
        for (String str : bundle.keySet()) {
            ...
            if (obj == null) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline44(obj, GeneratedOutlineSupport1.outline107("Could not convert ")));
            }
        }
        return createMap;
    }
        ...
        for (Object obj : objArr) {
            if (obj == null) {
                ...
                if (cls == Boolean.class) {
                    ...
                    throw new RuntimeException(GeneratedOutlineSupport1.outline66("Cannot convert argument of type ", cls));
                }
            }
        }
    ...
    public static WritableArray fromList(List list) {
        ...
        for (Object obj : list) {
            if (obj == null) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline44(obj, GeneratedOutlineSupport1.outline107("Unknown value type ")));
            }
        }
        return createArray;
    }
    ...
    public static Bundle toBundle(@Nullable ReadableMap readableMap) {
        ...
        while (keySetIterator.hasNextKey()) {
            ...
            if (ordinal == 0) {
                ...
                bundle.putBundle(nextKey, toBundle(readableMap.mo6945getMap(nextKey)));
            } else if (ordinal == 5) {
                bundle.putSerializable(nextKey, toList(readableMap.getArray(nextKey)));
            } else {
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("Could not convert object with key: ", nextKey, "."));
            }
        }
        return bundle;
    }
    ...
    public static ArrayList toList(@Nullable ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            ...
            if (ordinal == 0) {
                ...
                arrayList.add(toBundle(readableArray.mo6944getMap(i)));
            } else if (ordinal == 5) {
                arrayList.add(toList(readableArray.mo6943getArray(i)));
            } else {

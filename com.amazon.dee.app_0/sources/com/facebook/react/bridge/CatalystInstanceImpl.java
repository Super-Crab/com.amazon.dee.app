...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            ...
            CatalystInstanceImpl.this.getReactQueueConfiguration().getJSQueueThread().runOnQueue(new RunnableC00811());
        }
    }
    ...
    public static class PendingJSCall {
        ...
        public String toString() {
            ...
            sb.append("(");
            NativeArray nativeArray = this.mArguments;
            return GeneratedOutlineSupport1.outline91(sb, nativeArray == null ? "" : nativeArray.toString(), ")");
        }
    }
    ...
    private <T extends NativeModule> String getNameFromAnnotation(Class<T> cls) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Could not find @ReactModule annotation in ");
    ...
    public native CallInvokerHolderImpl mo6930getJSCallInvokerHolder();
    ...
    public native CallInvokerHolderImpl mo6931getNativeCallInvokerHolder();
    ...
    private CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, NativeModuleCallExceptionHandler nativeModuleCallExceptionHandler) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("pending_js_calls_instance");
        outline107.append(sNextInstanceIdForTrace.getAndIncrement());
        this.mJsPendingCallsTitleForTrace = outline107.toString();

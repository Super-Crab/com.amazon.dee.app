...
public class DebugServerException extends RuntimeException {
    ...
    public static DebugServerException parse(String str, String str2) {
        ...
        try {
            ...
            return new DebugServerException(jSONObject.getString("message"), shortenFileName(jSONObject.getString(ContentDisposition.Parameters.FileName)), jSONObject.getInt(StackTraceHelper.LINE_NUMBER_KEY), jSONObject.getInt(StackTraceHelper.COLUMN_KEY));
    ...
    public static DebugServerException makeGeneric(String str, String str2, String str3, Throwable th) {
        return new DebugServerException(GeneratedOutlineSupport1.outline75(str2, GENERIC_ERROR_MESSAGE.replace("<PORT>", String.valueOf(Uri.parse(str).getPort())), str3), th);
    }

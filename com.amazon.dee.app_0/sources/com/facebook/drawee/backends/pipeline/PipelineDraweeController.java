...
public class PipelineDraweeController extends AbstractDraweeController<CloseableReference<CloseableImage>, ImageInfo> {
    ...
    private Drawable maybeCreateDrawableFromFactories(@Nullable ImmutableList<DrawableFactory> drawableFactories, CloseableImage closeableImage) {
        ...
        Iterator<DrawableFactory> it2 = drawableFactories.iterator();
        while (it2.hasNext()) {
    ...
    protected DataSource<CloseableReference<CloseableImage>> getDataSource() {
        ...
        DataSource<CloseableReference<CloseableImage>> mo6895get = this.mDataSourceSupplier.mo6895get();
        if (FrescoSystrace.isTracing()) {
    ...
    public CloseableReference<CloseableImage> mo6874getCachedImage() {
        if (FrescoSystrace.isTracing()) {
    ...
    public void onImageLoadedFromCacheImmediately(String id, CloseableReference<CloseableImage> cachedImage) {
        ...
        synchronized (this) {
            if (this.mImageOriginListener != null) {
                this.mImageOriginListener.onImageLoaded(id, 6, true, "PipelineDraweeController");
            }
        }
    }

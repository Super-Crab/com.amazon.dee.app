...
public abstract class YogaNodeJNIBase extends YogaNode implements Cloneable {
    ...
    public YogaNodeJNIBase mo6977cloneWithChildren() {
        try {
            ...
            for (int i = 0; i < yogaNodeJNIBase.getChildCount(); i++) {
                yogaNodeJNIBase.swapChildAt(yogaNodeJNIBase.mo6979getChildAt(i).mo6977cloneWithChildren(), i);
            }
    ...
    public YogaNodeJNIBase mo6978cloneWithoutChildren() {
        try {
            YogaNodeJNIBase yogaNodeJNIBase = (YogaNodeJNIBase) super.clone();
            long jni_YGNodeCloneJNI = YogaNative.jni_YGNodeCloneJNI(this.mNativePointer);
            yogaNodeJNIBase.mOwner = null;
    ...
    public YogaNodeJNIBase mo6979getChildAt(int i) {
        List<YogaNodeJNIBase> list = this.mChildren;
        if (list != null) {
            return list.get(i);
        }
    ...
    public YogaNodeJNIBase mo6980getOwner() {
        return this.mOwner;
    }
    ...
    public YogaNodeJNIBase mo6981getParent() {
        return mo6980getOwner();
    }

    @Override // com.facebook.yoga.YogaNode
    /* renamed from: removeChildAt  reason: collision with other method in class */
    public YogaNodeJNIBase mo6982removeChildAt(int i) {
        List<YogaNodeJNIBase> list = this.mChildren;
        if (list != null) {

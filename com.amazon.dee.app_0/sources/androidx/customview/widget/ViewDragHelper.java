...
public class ViewDragHelper {
    ...
    public void captureChildView(@NonNull View view, int i) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
        outline107.append(this.mParentView);
        outline107.append(")");

...
public abstract class AbsSavedState implements Parcelable {
    ...
    public static final Parcelable.Creator<AbsSavedState> CREATOR = new Parcelable.ClassLoaderCreator<AbsSavedState>() { // from class: androidx.customview.view.AbsSavedState.2
        ...
        public AbsSavedState[] mo139newArray(int i) {
        ...
        public AbsSavedState mo138createFromParcel(Parcel parcel, ClassLoader classLoader) {
        ...
        @Override // android.os.Parcelable.Creator
        /* renamed from: createFromParcel */
        public AbsSavedState mo137createFromParcel(Parcel parcel) {
            return mo138createFromParcel(parcel, (ClassLoader) null);
        }
    };

...
public abstract class MediaBrowserServiceCompat extends Service {
                ...
                public void run() {
                    ...
                    while (it2.hasNext()) {
                        ...
                        try {
                            ...
                            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Connection for ");
                            outline107.append(next.pkg);
                            outline107.append(" is no longer valid.");
                            Log.w(MediaBrowserServiceCompat.TAG, outline107.toString());
                            it2.remove();
                        }
                    }
                }
    ...
    public static class Result<T> {
        ...
        public void detach() {
            if (!this.mDetachCalled) {
                if (!this.mSendResultCalled) {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("detach() called when sendError() had already been called for: ");
                    outline107.append(this.mDebug);
                    throw new IllegalStateException(outline107.toString());
                }
                StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("detach() called when sendResult() had already been called for: ");
                outline1072.append(this.mDebug);
                throw new IllegalStateException(outline1072.toString());
            }
            StringBuilder outline1073 = GeneratedOutlineSupport1.outline107("detach() called when detach() had already been called for: ");
            outline1073.append(this.mDebug);
        ...
        void onErrorSent(Bundle bundle) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("It is not supported to send an error for ");
            outline107.append(this.mDebug);
            throw new UnsupportedOperationException(outline107.toString());
        }

        void onProgressUpdateSent(Bundle bundle) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("It is not supported to send an interim update for ");
            outline107.append(this.mDebug);
            throw new UnsupportedOperationException(outline107.toString());
        }
        ...
        public void sendError(Bundle bundle) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("sendError() called when either sendResult() or sendError() had already been called for: ");
            outline107.append(this.mDebug);
            throw new IllegalStateException(outline107.toString());
        }
        ...
        public void sendProgressUpdate(Bundle bundle) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ");
            outline107.append(this.mDebug);
            throw new IllegalStateException(outline107.toString());
        }
        ...
        public void sendResult(T t) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("sendResult() called when either sendResult() or sendError() had already been called for: ");
            outline107.append(this.mDebug);
            throw new IllegalStateException(outline107.toString());
        }
        ...
        public void addSubscription(final String str, final IBinder iBinder, final Bundle bundle, final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.3
                ...
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("addSubscription for callback that isn't registered id=");
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                    ...
                    public void run() {
                        ...
                        if (connectionRecord.root == null) {
                            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("No root for client ");
                            outline107.append(str);
                            outline107.append(" from service ");
                            outline107.append(AnonymousClass1.class.getName());
                            Log.i(MediaBrowserServiceCompat.TAG, outline107.toString());
                            try {
                                serviceCallbacks.onConnectFailed();
                                return;
                            } catch (RemoteException unused) {
                                StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("Calling onConnectFailed() failed. Ignoring. pkg=");
                                outline1072.append(str);
                                Log.w(MediaBrowserServiceCompat.TAG, outline1072.toString());
                                return;
                            }
                        }
                        try {
                            ...
                            StringBuilder outline1073 = GeneratedOutlineSupport1.outline107("Calling onConnect() failed. Dropping client. pkg=");
                            outline1073.append(str);
                            Log.w(MediaBrowserServiceCompat.TAG, outline1073.toString());
                            MediaBrowserServiceCompat.this.mConnections.remove(asBinder);
                        }
                    }
                });
        ...
        public void getMediaItem(final String str, final ResultReceiver resultReceiver, final ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.5
                ...
                public void run() {
                    ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                    if (connectionRecord == null) {
                        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("getMediaItem for callback that isn't registered id=");
                        outline107.append(str);
                        Log.w(MediaBrowserServiceCompat.TAG, outline107.toString());
                        return;
                    }
        ...
        public void removeSubscription(final String str, final IBinder iBinder, final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.4
                ...
                public void run() {
                    ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                    if (connectionRecord == null) {
                        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("removeSubscription for callback that isn't registered id=");
                        outline107.append(str);
                        Log.w(MediaBrowserServiceCompat.TAG, outline107.toString());
                    } else if (MediaBrowserServiceCompat.this.removeSubscription(str, connectionRecord, iBinder)) {
                    } else {
                        StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("removeSubscription called for ");
                        outline1072.append(str);
                        outline1072.append(" which is not subscribed");
                        Log.w(MediaBrowserServiceCompat.TAG, outline1072.toString());
                    }
                }
            });
        ...
        public void search(final String str, final Bundle bundle, final ResultReceiver resultReceiver, final ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.8
                ...
                public void run() {
                    ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                    if (connectionRecord == null) {
                        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("search for callback that isn't registered query=");
                        outline107.append(str);
                        Log.w(MediaBrowserServiceCompat.TAG, outline107.toString());
                        return;
                    }
        ...
        public void sendCustomAction(final String str, final Bundle bundle, final ResultReceiver resultReceiver, final ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.9
                ...
                public void run() {
                    ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                    if (connectionRecord == null) {
                        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("sendCustomAction for callback that isn't registered action=");
                        outline107.append(str);
    ...
    void performLoadChildren(final String str, final ConnectionRecord connectionRecord, final Bundle bundle, final Bundle bundle2) {
        Result<List<MediaBrowserCompat.MediaItem>> result = new Result<List<MediaBrowserCompat.MediaItem>>(str) { // from class: androidx.media.MediaBrowserServiceCompat.1
            ...
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                if (MediaBrowserServiceCompat.this.mConnections.get(connectionRecord.callbacks.asBinder()) != connectionRecord) {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Not sending onLoadChildren result for connection that has been disconnected. pkg=");
                    outline107.append(connectionRecord.pkg);
                ...
                try {
                    ...
                    StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("Calling onLoadChildren() failed for id=");
                    outline1072.append(str);
                    outline1072.append(" package=");
                    outline1072.append(connectionRecord.pkg);
                    Log.w(MediaBrowserServiceCompat.TAG, outline1072.toString());
                }
            }
        };
        ...
        throw new IllegalStateException(GeneratedOutlineSupport1.outline92(GeneratedOutlineSupport1.outline107("onLoadChildren must call detach() or sendResult() before returning for package="), connectionRecord.pkg, " id=", str));
    }
    ...
    void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport1.outline72("onLoadItem must call detach() or sendResult() before returning for id=", str));
    }
    ...
    void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport1.outline72("onSearch must call detach() or sendResult() before returning for query=", str));
    }

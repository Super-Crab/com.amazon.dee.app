...
public class WorkTimer {
    ...
    private final ThreadFactory mBackgroundThreadFactory = new ThreadFactory() { // from class: androidx.work.impl.utils.WorkTimer.1
        ...
        public Thread newThread(@NonNull Runnable runnable) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("WorkManager-WorkTimer-thread-");
            outline107.append(this.mThreadsCreated);
            newThread.setName(outline107.toString());

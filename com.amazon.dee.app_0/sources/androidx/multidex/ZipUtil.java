...
public final class ZipUtil {
    ...
    static CentralDirectory findCentralDirectory(RandomAccessFile randomAccessFile) throws IOException, ZipException {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("File too short to be a zip file: ");
        outline107.append(randomAccessFile.length());
        throw new ZipException(outline107.toString());
    }

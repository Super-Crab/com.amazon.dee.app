...
public class RoomOpenHelper extends SupportSQLiteOpenHelper.Callback {
    ...
    private void checkIdentity(SupportSQLiteDatabase db) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Pre-packaged database has an invalid schema: ");
        outline107.append(onValidateSchema.expectedFoundMsg);
    ...
    public void onUpgrade(SupportSQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (databaseConfiguration == null || (findMigrationPath = databaseConfiguration.migrationContainer.findMigrationPath(oldVersion, newVersion)) == null) {
            ...
            if (onValidateSchema.isValid) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Migration didn't properly handle: ");
                outline107.append(onValidateSchema.expectedFoundMsg);
                throw new IllegalStateException(outline107.toString());
            }
        }
        if (!z) {
            ...
            throw new IllegalStateException(GeneratedOutlineSupport1.outline54("A migration from ", oldVersion, " to ", newVersion, " was required but not found. Please provide the necessary Migration path via RoomDatabase.Builder.addMigration(Migration ...) or allow for destructive migrations via one of the RoomDatabase.Builder.fallbackToDestructiveMigration* methods."));
        }
    }

...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float f) {
        ...
        float max = (((float) Math.max(min - 0.4d, (double) FrostVideoEffectController.VIDEO_STRENGTH_CLEAR)) * 5.0f) / 3.0f;
        ...
        this.mProgress.setProgressRotation(((pow * DECELERATE_INTERPOLATION_FACTOR) + ((max * 0.4f) - 0.25f)) * DRAG_RATE);

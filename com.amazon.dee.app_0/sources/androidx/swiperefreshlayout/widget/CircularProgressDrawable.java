...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private void applyFinishTranslation(float f, Ring ring) {
        ...
        ring.setStartTrim(GeneratedOutlineSupport1.outline0(ring.getStartingEndTrim() - 0.01f, ring.getStartingStartTrim(), f, ring.getStartingStartTrim()));
        ring.setEndTrim(ring.getStartingEndTrim());
        ring.setRotation(GeneratedOutlineSupport1.outline0((float) (Math.floor(ring.getStartingRotation() / MAX_PROGRESS_ARC) + 1.0d), ring.getStartingRotation(), f, ring.getStartingRotation()));
    }

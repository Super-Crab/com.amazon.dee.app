...
public final class CallbackToFutureAdapter {
    ...
    public static final class Completer<T> {
        ...
        protected void finalize() {
            ...
            if (safeFuture != null && !safeFuture.isDone()) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("The completer object was garbage collected - this future would otherwise never complete. The tag was: ");
                outline107.append(this.tag);
                safeFuture.setException(new FutureGarbageCollectedException(outline107.toString()));
            }
    ...
    public interface Resolver<T> {
        ...
        Object mo4453attachCompleter(@NonNull Completer<T> completer) throws Exception;
    }
    ...
    public static final class SafeFuture<T> implements ListenableFuture<T> {
        ...
        private final AbstractResolvableFuture<T> delegate = new AbstractResolvableFuture<T>() { // from class: androidx.concurrent.futures.CallbackToFutureAdapter.SafeFuture.1
            ...
            protected String pendingToString() {
                ...
                return completer == null ? "Completer object has been garbage collected, future will fail soon" : GeneratedOutlineSupport1.outline88(GeneratedOutlineSupport1.outline107("tag=["), completer.tag, "]");
            }
        };
    ...
    public static <T> ListenableFuture<T> getFuture(@NonNull Resolver<T> resolver) {
        ...
        try {
            Object mo4453attachCompleter = resolver.mo4453attachCompleter(completer);
            if (mo4453attachCompleter != null) {
                completer.tag = mo4453attachCompleter;
            }
        } catch (Exception e) {

...
public abstract class VersionedParcel {
    ...
    private <T> int getType(T t) {
        ...
        if (!(t instanceof Float)) {
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline46(t, new StringBuilder(), " cannot be VersionedParcelled"));
        }
        return 8;
    }
    ...
    protected Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport1.outline75("VersionedParcelable encountered IOException reading a Serializable object (name = ", readString, ")"), e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException(GeneratedOutlineSupport1.outline75("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", readString, ")"), e2);
        }
    }
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport1.outline75("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e);
        }
    }

            ...
            for (String str : bundle.keySet()) {
                if (str.startsWith("f")) {
                    ...
                    if (fragment != null) {
                        ...
                        GeneratedOutlineSupport1.outline164("Bad fragment at key ", str, TAG);
                    }
                }
            }
        }
    ...
    public Parcelable saveState() {
        ...
        for (int i = 0; i < this.mFragments.size(); i++) {
            ...
            if (fragment != null && fragment.isAdded()) {
                ...
                this.mFragmentManager.putFragment(bundle, GeneratedOutlineSupport1.outline49("f", i), fragment);
            }
        }
        return bundle;
    }

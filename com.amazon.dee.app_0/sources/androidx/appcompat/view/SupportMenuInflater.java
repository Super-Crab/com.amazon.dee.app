    ...
    public static class InflatedOnMenuItemClickListener implements MenuItem.OnMenuItemClickListener {
        ...
        public InflatedOnMenuItemClickListener(Object obj, String str) {
            ...
            try {
                ...
                InflateException inflateException = new InflateException(GeneratedOutlineSupport1.outline38(cls, GeneratedOutlineSupport1.outline115("Couldn't resolve menu item onClick handler ", str, " in class ")));
        ...
        while (true) {
            if (eventType == 2) {
                ...
                if (name.equals("menu")) {
                    ...
                    throw new RuntimeException(GeneratedOutlineSupport1.outline72("Expecting menu, got ", name));
                }
            } else {
                eventType = xmlPullParser.next();
                if (eventType == 1) {

...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private View findParentViewForSubmenu(@NonNull CascadingMenuInfo cascadingMenuInfo, @NonNull MenuBuilder menuBuilder) {
        ...
        while (true) {
            if (i2 >= count) {
                i2 = -1;
                break;
            } else if (findMenuItemForSubmenu == menuAdapter.mo86getItem(i2)) {
                break;
            } else {
                i2++;
            }
    ...
    private int getNextMenuPosition(int i) {
        ListView listView = ((CascadingMenuInfo) GeneratedOutlineSupport1.outline25(this.mShowingMenus, 1)).getListView();
        int[] iArr = new int[2];
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            cascadingMenuInfo = (CascadingMenuInfo) GeneratedOutlineSupport1.outline25(this.mShowingMenus, 1);
    ...
    public ListView getListView() {
        ...
        return ((CascadingMenuInfo) GeneratedOutlineSupport1.outline24(this.mShowingMenus, -1)).getListView();
    }

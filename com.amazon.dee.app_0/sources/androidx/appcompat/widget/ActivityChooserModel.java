...
public class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            StringBuilder outline113 = GeneratedOutlineSupport1.outline113("[", "resolveInfo:");
            outline113.append(this.resolveInfo.toString());
            outline113.append("; weight:");
            outline113.append(new BigDecimal(this.weight));
            outline113.append("]");
    ...
    public static final class HistoricalRecord {
        ...
        public String toString() {
            StringBuilder outline113 = GeneratedOutlineSupport1.outline113("[", "; activity:");
            outline113.append(this.activity);
            outline113.append("; time:");
            outline113.append(this.time);
            outline113.append("; weight:");
            outline113.append(new BigDecimal(this.weight));
            outline113.append("]");
            return outline113.toString();
    ...
    private ActivityChooserModel(Context context, String str) {
        ...
        if (!TextUtils.isEmpty(str) && !str.endsWith(HISTORY_FILE_EXTENSION)) {
            this.mHistoryFileName = GeneratedOutlineSupport1.outline72(str, HISTORY_FILE_EXTENSION);
        } else {

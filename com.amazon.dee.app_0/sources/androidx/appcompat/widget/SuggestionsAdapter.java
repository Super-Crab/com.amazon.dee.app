...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Invalid icon resource ", iconResource, " for ");
            outline109.append(componentName.flattenToShortString());
            Log.w(LOG_TAG, outline109.toString());
            return null;
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            GeneratedOutlineSupport1.outline164("Icon resource not found: ", str, LOG_TAG);
            return null;
                ...
                if (pathSegments != null) {
                    ...
                    if (size == 1) {
                        try {
                            ...
                            throw new FileNotFoundException(GeneratedOutlineSupport1.outline58("Single path segment is not a resource ID: ", uri));
                        }
                    } else if (size == 2) {
                        parseInt = resourcesForApplication.getIdentifier(pathSegments.get(1), pathSegments.get(0), authority);
                    } else {
                        throw new FileNotFoundException(GeneratedOutlineSupport1.outline58("More than two path segments: ", uri));
                    }
                    if (parseInt != 0) {
                        return resourcesForApplication.getDrawable(parseInt);
                    }
                    throw new FileNotFoundException(GeneratedOutlineSupport1.outline58("No resource found for: ", uri));
                }
                throw new FileNotFoundException(GeneratedOutlineSupport1.outline58("No path: ", uri));
            } catch (PackageManager.NameNotFoundException unused2) {
                throw new FileNotFoundException(GeneratedOutlineSupport1.outline58("No package found for authority: ", uri));
            }
        }
        throw new FileNotFoundException(GeneratedOutlineSupport1.outline58("No authority: ", uri));
    }
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        if (i > 0) {
            fragment.appendQueryParameter(MetricsUtil.LegacyMetricTypes.LIMIT, String.valueOf(i));
        }

...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: androidx.appcompat.widget.SearchView.SavedState.1
            ...
            public SavedState mo104createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo103createFromParcel(Parcel parcel) {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("SearchView.SavedState{");
            outline107.append(Integer.toHexString(System.identityHashCode(this)));
            outline107.append(" isIconified=");
            return GeneratedOutlineSupport1.outline97(outline107, this.isIconified, EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE);
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mVoiceWebSearchIntent = new Intent(VoiceActivity.ACTION_LAUNCH_FROM_VOICE_WEB_SEARCH);

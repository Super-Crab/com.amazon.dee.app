...
public class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    */
    ...
    DrawableContainerState mo79cloneConstantState() {
    ...
    public Drawable mutate() {
        if (!this.mMutated && super.mutate() == this) {
            DrawableContainerState mo79cloneConstantState = mo79cloneConstantState();
            mo79cloneConstantState.mutate();
            setConstantState(mo79cloneConstantState);
            this.mMutated = true;
        }
        return this;
    }

...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public class AutoBatteryNightModeManager extends AutoNightModeManager {
        ...
        IntentFilter createIntentFilterForBroadcastReceiver() {
            int i = Build.VERSION.SDK_INT;
            return GeneratedOutlineSupport1.outline10("android.os.action.POWER_SAVE_MODE_CHANGED");
        }
    ...
    public static final class PanelFeatureState {
        ...
        public static class SavedState implements Parcelable {
            public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.PanelFeatureState.SavedState.1
                ...
                public SavedState mo76createFromParcel(Parcel parcel, ClassLoader classLoader) {
                    return SavedState.readFromParcel(parcel, classLoader);
                }

                @Override // android.os.Parcelable.Creator
                /* renamed from: createFromParcel */
                public SavedState mo75createFromParcel(Parcel parcel) {
    ...
    static {
        ...
        sAlwaysOverrideConfiguration = false;
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("AppCompat does not support the current theme features: { windowActionBar: ");
            outline107.append(this.mHasActionBar);
            outline107.append(", windowActionBarOverlay: ");
            outline107.append(this.mOverlayActionBar);
            outline107.append(", android:windowIsFloating: ");
            outline107.append(this.mIsFloating);
            outline107.append(", windowActionModeOverlay: ");
            outline107.append(this.mOverlayActionMode);
            outline107.append(", windowNoTitle: ");
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline97(outline107, this.mWindowNoTitle, " }"));
        }
        obtainStyledAttributes.recycle();
    ...
    private boolean updateForNightMode(int i, boolean z) {
        ...
        boolean z3 = false;
        if ((sAlwaysOverrideConfiguration || i3 != i2) && !isActivityManifestHandlingUiMode) {
        ...
        if (!z3 && i5 != i3 && z && !isActivityManifestHandlingUiMode && this.mBaseContextAttached) {

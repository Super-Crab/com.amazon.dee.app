    ...
    public static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context, @NonNull String str) {
            ...
            if (id == -1) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107(" with id '");
                outline107.append(this.mHostView.getContext().getResources().getResourceEntryName(id));
                outline107.append("'");
                sb = outline107.toString();
            }
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("Could not find method ");
            outline1072.append(this.mMethodName);
            outline1072.append("(View) in a parent or ancestor Context for android:onClick attribute defined on view ");
            outline1072.append(this.mHostView.getClass());
    ...
    public final View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        switch (str.hashCode()) {
            ...
            case 799298502:
                ...
                break;
            case 1125864064:
                if (str.equals(ImageModel.IMAGE_MODEL_TYPE)) {
                    c = 1;
                    break;
                }
                break;

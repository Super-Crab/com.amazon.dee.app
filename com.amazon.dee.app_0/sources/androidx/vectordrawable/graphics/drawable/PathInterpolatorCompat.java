...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("The Path must start at (0,0) and end at (1,1) start: ");
            outline107.append(this.mX[0]);
            outline107.append(",");
            outline107.append(this.mY[0]);
            outline107.append(" end:");
            int i6 = min - 1;
            outline107.append(this.mX[i6]);
            outline107.append(",");
            outline107.append(this.mY[i6]);
    ...
    private void parseInterpolatorFromTypeArray(TypedArray typedArray, XmlPullParser xmlPullParser) {
        if (TypedArrayUtils.hasAttribute(xmlPullParser, "pathData")) {
            ...
            throw new InflateException(GeneratedOutlineSupport1.outline72("The path is null, which is created from ", namedString));
    ...
    public float getInterpolation(float f) {
        ...
        float[] fArr2 = this.mY;
        float f3 = fArr2[i];
        return GeneratedOutlineSupport1.outline0(fArr2[length], f3, (f - fArr[i]) / f2, f3);
    }

...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder outline113 = GeneratedOutlineSupport1.outline113(str, "current group is :");
        outline113.append(vGroup.getGroupName());
        outline113.append(" rotation is ");
        outline113.append(vGroup.mRotate);
        outline113.toString();
        String str2 = str + "matrix is :" + vGroup.getLocalMatrix().toString();
    ...
    public static abstract class VPath extends VObject {
        ...
        public void printVPath(int i) {
            ...
            StringBuilder outline113 = GeneratedOutlineSupport1.outline113(str, "current path is :");
            outline113.append(this.mPathName);
            outline113.append(" pathData is ");
            outline113.append(nodesToString(this.mNodes));
            outline113.toString();
        }

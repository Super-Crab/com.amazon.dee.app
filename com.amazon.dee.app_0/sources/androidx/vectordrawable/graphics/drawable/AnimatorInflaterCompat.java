...
public class AnimatorInflaterCompat {
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Keyframe ", i, ": fraction ");
            Object obj = "null";
            outline109.append(keyframe.getFraction() < 0.0f ? obj : Float.valueOf(keyframe.getFraction()));
            outline109.append(", , value : ");
            if (keyframe.hasValue()) {
                obj = keyframe.getValue();
            }
            outline109.append(obj);
            outline109.toString();
        }
    }
        ...
        if (i == 2) {
            ...
            if (createNodesFromPathData2 != null) {
                if (PathParser.canMorph(createNodesFromPathData, createNodesFromPathData2)) {
                    ...
                    throw new InflateException(GeneratedOutlineSupport1.outline76(" Can't morph from ", string, " to ", string2));
                }
            } else {

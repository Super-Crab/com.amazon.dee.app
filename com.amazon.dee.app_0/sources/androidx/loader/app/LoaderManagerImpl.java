...
public class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            ...
            this.mLoader.dump(GeneratedOutlineSupport1.outline72(str, "  "), fileDescriptor, printWriter, strArr);
            if (this.mObserver != null) {
                printWriter.print(str);
                printWriter.print("mCallbacks=");
                printWriter.println(this.mObserver);
                this.mObserver.dump(GeneratedOutlineSupport1.outline72(str, "  "), printWriter);
            }
            printWriter.print(str);
        ...
        public String toString() {
            StringBuilder outline105 = GeneratedOutlineSupport1.outline105(64, "LoaderInfo{");
            outline105.append(Integer.toHexString(System.identityHashCode(this)));
            outline105.append(" #");
            outline105.append(this.mId);
            outline105.append(" : ");
            DebugUtils.buildShortClassTag(this.mLoader, outline105);
            outline105.append("}}");
    ...
    public static class LoaderObserver<D> implements Observer<D> {
        ...
        public void onChanged(@Nullable D d) {
            if (LoaderManagerImpl.DEBUG) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("  onLoadFinished in ");
                outline107.append(this.mLoader);
                outline107.append(RealTimeTextConstants.COLON_SPACE);
                outline107.append(this.mLoader.dataToString(d));
                outline107.toString();
            }
        ...
        void reset() {
            if (this.mDeliveredData) {
                if (LoaderManagerImpl.DEBUG) {
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("  Resetting: ");
                    outline107.append(this.mLoader);
                    outline107.toString();
                }
    ...
    public String toString() {
        StringBuilder outline105 = GeneratedOutlineSupport1.outline105(128, "LoaderManager{");
        outline105.append(Integer.toHexString(System.identityHashCode(this)));
        outline105.append(" in ");
        DebugUtils.buildShortClassTag(this.mLifecycleOwner, outline105);
        outline105.append("}}");
        return outline105.toString();
    }
}

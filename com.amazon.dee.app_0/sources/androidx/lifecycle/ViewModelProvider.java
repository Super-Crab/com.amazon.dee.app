        ...
        public <T extends ViewModel> T create(@NonNull Class<T> cls) {
            if (AndroidViewModel.class.isAssignableFrom(cls)) {
                try {
                    ...
                    throw new RuntimeException(GeneratedOutlineSupport1.outline66("Cannot create an instance of ", cls), e);
                } catch (InstantiationException e2) {
                    throw new RuntimeException(GeneratedOutlineSupport1.outline66("Cannot create an instance of ", cls), e2);
                } catch (NoSuchMethodException e3) {
                    throw new RuntimeException(GeneratedOutlineSupport1.outline66("Cannot create an instance of ", cls), e3);
                } catch (InvocationTargetException e4) {
                    throw new RuntimeException(GeneratedOutlineSupport1.outline66("Cannot create an instance of ", cls), e4);
                }
            }

...
class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public int delete(String str, String str2, Object[] objArr) {
        StringBuilder outline113 = GeneratedOutlineSupport1.outline113("DELETE FROM ", str);
        outline113.append(TextUtils.isEmpty(str2) ? "" : GeneratedOutlineSupport1.outline72(" WHERE ", str2));
        SupportSQLiteStatement compileStatement = compileStatement(outline113.toString());
    ...
    public int update(String str, int i, ContentValues contentValues, String str2, Object[] objArr) {
        if (contentValues != null && contentValues.size() != 0) {
            ...
            SupportSQLiteStatement compileStatement = compileStatement(outline105.toString());

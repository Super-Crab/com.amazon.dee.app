...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior != null && behavior.getInsetDodgeRect(this, view, acquireTempRect)) {
                if (!acquireTempRect2.contains(acquireTempRect)) {
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Rect should be within the child's bounds. Rect:");
                    outline107.append(acquireTempRect.toShortString());
                    outline107.append(" | Bounds:");
                    outline107.append(acquireTempRect2.toShortString());
    ...
    static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport1.outline72("Could not inflate Behavior subclass ", str), e);
        }
    }
            ...
            if (view instanceof AttachedBehavior) {
                ...
                if (defaultBehavior != null) {
                    try {
                        ...
                        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Default behavior class ");
                        outline107.append(defaultBehavior.value().getName());
                        outline107.append(" could not be instantiated. Did you forget");
                        outline107.append(" a default constructor?");
    ...
    */
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: androidx.coordinatorlayout.widget.CoordinatorLayout.SavedState.1
            ...
            public SavedState mo126createFromParcel(Parcel parcel, ClassLoader classLoader) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (view2 == null) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Could not find CoordinatorLayout descendant view with id ");
                outline107.append(coordinatorLayout.getResources().getResourceName(this.mAnchorId));
                outline107.append(" to anchor view ");
                outline107.append(view);

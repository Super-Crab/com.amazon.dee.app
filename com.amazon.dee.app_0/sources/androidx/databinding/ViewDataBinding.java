...
public abstract class ViewDataBinding extends BaseObservable {
    ...
    private static int findLastMatching(ViewGroup viewGroup, int i) {
        ...
        String outline50 = GeneratedOutlineSupport1.outline50(str, -1, 0);
        int length = outline50.length();
        int childCount = viewGroup.getChildCount();
        for (int i2 = i + 1; i2 < childCount; i2++) {
            View childAt = viewGroup.getChildAt(i2);
            String str2 = childAt.getTag() instanceof String ? (String) childAt.getTag() : null;
            if (str2 != null && str2.startsWith(outline50)) {
    ...
    protected void ensureBindingComponentIsNotNull(Class<?> cls) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Required DataBindingComponent is null in class ");
        outline107.append(getClass().getSimpleName());
        outline107.append(". A BindingAdapter in ");
        outline107.append(cls.getCanonicalName());
        outline107.append(" is not static and requires an object to use, retrieved from the DataBindingComponent. If you don't use an inflation method taking a DataBindingComponent, use DataBindingUtil.setDefaultComponent or make all BindingAdapter methods static.");
    ...
    */
    ...
    protected static double safeUnbox(Double d) {
        return d == null ? FrostVideoEffectController.VIDEO_STRENGTH_CLEAR : d.doubleValue();
    }
    ...
    protected static double getFromArray(double[] dArr, int i) {
        return (dArr == null || i < 0 || i >= dArr.length) ? FrostVideoEffectController.VIDEO_STRENGTH_CLEAR : dArr[i];
    }

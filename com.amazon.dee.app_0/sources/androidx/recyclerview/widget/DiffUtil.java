...
public class DiffUtil {
    ...
    public static class DiffResult {
        ...
        private void dispatchAdditions(List<PostponedUpdate> list, ListUpdateCallback listUpdateCallback, int i, int i2, int i3) {
            ...
            for (int i4 = i2 - 1; i4 >= 0; i4--) {
                ...
                if (i6 == 0) {
                    ...
                    StringBuilder outline109 = GeneratedOutlineSupport1.outline109("unknown flag for pos ", i5, " ");
                    outline109.append(Long.toBinaryString(i6));
        ...
        public int convertNewPositionToOld(@IntRange(from = 0) int i) {
            ...
            StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Index out of bounds - passed position = ", i, ", new list size = ");
            outline109.append(this.mNewItemStatuses.length);
        ...
        public int convertOldPositionToNew(@IntRange(from = 0) int i) {
            ...
            StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Index out of bounds - passed position = ", i, ", old list size = ");
            outline109.append(this.mOldItemStatuses.length);
            throw new IndexOutOfBoundsException(outline109.toString());
        }

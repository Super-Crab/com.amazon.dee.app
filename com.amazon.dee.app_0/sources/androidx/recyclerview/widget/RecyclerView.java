...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final VH createViewHolder(@NonNull ViewGroup viewGroup, int i) {
            try {
                ...
                VH mo7499onCreateViewHolder = mo7499onCreateViewHolder(viewGroup, i);
                if (mo7499onCreateViewHolder.itemView.getParent() == null) {
                    mo7499onCreateViewHolder.mItemViewType = i;
                    return mo7499onCreateViewHolder;
                }
        ...
        public abstract VH mo7499onCreateViewHolder(@NonNull ViewGroup viewGroup, int i);
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (!childViewHolderInt.wasReturnedFromScrap() && !childViewHolderInt.isScrap()) {
                if (view.getParent() == this.mRecyclerView) {
                    ...
                    if (indexOfChild == -1) {
                        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
                        outline107.append(this.mRecyclerView.indexOfChild(view));
                        outline107.append(this.mRecyclerView.exceptionLabel());
        ...
        */
        ...
        public void ignoreView(@NonNull View view) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("View should be fully attached to be ignored");
            outline107.append(this.mRecyclerView.exceptionLabel());
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            if (childViewHolderInt != null) {
                ...
                StringBuilder outline110 = GeneratedOutlineSupport1.outline110("Inconsistency detected. Invalid item position ", i, "(offset:", findPositionOffset, ").");
                outline110.append("state:");
                outline110.append(RecyclerView.this.mState.getItemCount());
                outline110.append(RecyclerView.this.exceptionLabel());
                throw new IndexOutOfBoundsException(outline110.toString());
            }
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter");
            outline107.append(RecyclerView.this.exceptionLabel());
            throw new IllegalArgumentException(outline107.toString());
        }
        ...
        void offsetPositionRecordsForMove(int i, int i2) {
            ...
            for (int i7 = 0; i7 < size; i7++) {
                ...
                if (viewHolder != null && (i6 = viewHolder.mPosition) >= i5 && i6 <= i3) {
                    if (i6 == i) {
        ...
        void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (!viewHolder.isScrap() && viewHolder.itemView.getParent() == null) {
                if (!viewHolder.isTmpDetached()) {
                    ...
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.");
                    outline107.append(RecyclerView.this.exceptionLabel());
                    throw new IllegalArgumentException(outline107.toString());
                }
            ...
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("Scrapped or attached views may not be recycled. isScrap:");
            outline1072.append(viewHolder.isScrap());
            outline1072.append(" isAttached:");
            if (viewHolder.itemView.getParent() != null) {
                z2 = true;
            }
            outline1072.append(z2);
            outline1072.append(RecyclerView.this.exceptionLabel());
        ...
        void scrapView(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.");
                outline107.append(RecyclerView.this.exceptionLabel());
                throw new IllegalArgumentException(outline107.toString());
            } else {
        ...
        /* JADX WARN: Removed duplicated region for block: B:106:0x0216 A[ADDED_TO_REGION] */
    ...
    public static abstract class SmoothScroller {
        ...
        public PointF computeScrollVectorForPosition(int i) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("You should override computeScrollVectorForPosition when the LayoutManager does not implement ");
            outline107.append(ScrollVectorProvider.class.getCanonicalName());
            Log.w(RecyclerView.TAG, outline107.toString());
            return null;
        }
        ...
        void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            if (this.mStarted) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("An instance of ");
                outline107.append(getClass().getSimpleName());
                outline107.append(" was started ");
                outline107.append("more than once. Each instance of");
                outline107.append(getClass().getSimpleName());
                outline107.append(" ");
                outline107.append("is intended to only be used once. You should create a new instance for ");
                outline107.append("each use.");
                Log.w(RecyclerView.TAG, outline107.toString());
            }
            this.mRecyclerView = recyclerView;
    ...
    public static class State {
        ...
        void assertLayoutStep(int i) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Layout state should be one of ");
            outline107.append(Integer.toBinaryString(i));
            outline107.append(" but it is ");
            outline107.append(Integer.toBinaryString(this.mLayoutStep));
            throw new IllegalStateException(outline107.toString());
        }
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("State{mTargetPosition=");
            outline107.append(this.mTargetPosition);
            outline107.append(", mData=");
            outline107.append(this.mData);
            outline107.append(", mItemCount=");
            outline107.append(this.mItemCount);
            outline107.append(", mIsMeasuring=");
            outline107.append(this.mIsMeasuring);
            outline107.append(", mPreviousLayoutItemCount=");
            outline107.append(this.mPreviousLayoutItemCount);
            outline107.append(", mDeletedInvisibleItemCountSincePreviousLayout=");
            outline107.append(this.mDeletedInvisibleItemCountSincePreviousLayout);
            outline107.append(", mStructureChanged=");
            outline107.append(this.mStructureChanged);
            outline107.append(", mInPreLayout=");
            outline107.append(this.mInPreLayout);
            outline107.append(", mRunSimpleAnimations=");
            outline107.append(this.mRunSimpleAnimations);
            outline107.append(", mRunPredictiveAnimations=");
            outline107.append(this.mRunPredictiveAnimations);
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("ViewHolder{");
            ...
            outline107.append(this.mItemId);
            outline107.append(", oldPos=");
            outline107.append(this.mOldPosition);
            outline107.append(", pLpos:");
            outline107.append(this.mPreLayoutPosition);
            ...
            if (!isRecyclable()) {
                StringBuilder outline1072 = GeneratedOutlineSupport1.outline107(" not recyclable(");
                outline1072.append(this.mIsRecyclableCount);
                outline1072.append(")");
    ...
    */
    ...
    void assertInLayoutOrScroll(String str) {
        if (!isComputingLayout()) {
            if (str == null) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Cannot call this method unless RecyclerView is computing a layout or scrolling");
                outline107.append(exceptionLabel());
                throw new IllegalStateException(outline107.toString());
            }
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107(str);
            outline1072.append(exceptionLabel());
    ...
    void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Cannot call this method while RecyclerView is computing a layout or scrolling");
                outline107.append(exceptionLabel());
                throw new IllegalStateException(outline107.toString());
            }
            ...
            outline1072.append(exceptionLabel());
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(outline1072.toString()));
        }
    }
    ...
    String exceptionLabel() {
        ...
        outline107.append(", adapter:");
        outline107.append(this.mAdapter);
        outline107.append(", layout:");
        outline107.append(this.mLayout);
    ...
    */
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("RecyclerView has no LayoutManager");
        outline107.append(exceptionLabel());
        throw new IllegalStateException(outline107.toString());
    }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Trying to set fast scroller without both required drawables.");
        outline107.append(exceptionLabel());
        throw new IllegalArgumentException(outline107.toString());
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Error processing scroll; pointer index for id ");
                outline107.append(this.mScrollPointerId);
                outline107.append(" not found. Did any MotionEvents get skipped?");
    ...
    */
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: androidx.recyclerview.widget.RecyclerView.SavedState.1
            ...
            public SavedState[] mo196newArray(int i) {
            ...
            public SavedState mo195createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo194createFromParcel(Parcel parcel) {

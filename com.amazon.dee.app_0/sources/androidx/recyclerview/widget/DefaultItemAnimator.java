...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("ChangeInfo{oldHolder=");
            outline107.append(this.oldHolder);
            outline107.append(", newHolder=");
            outline107.append(this.newHolder);
            outline107.append(", fromX=");
            outline107.append(this.fromX);
            outline107.append(", fromY=");
            outline107.append(this.fromY);
            outline107.append(", toX=");
            outline107.append(this.toX);
            outline107.append(", toY=");
            return GeneratedOutlineSupport1.outline85(outline107, this.toY, JsonReaderKt.END_OBJ);
        }

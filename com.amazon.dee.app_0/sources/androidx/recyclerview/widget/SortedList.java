...
public class SortedList<T> {
    ...
    private void addToData(int i, T t) {
        ...
        StringBuilder outline109 = GeneratedOutlineSupport1.outline109("cannot add item to ", i, " because size is ");
        outline109.append(this.mSize);
    ...
    public T get(int i) throws IndexOutOfBoundsException {
        ...
        StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Asked to get item at ", i, " but size is ");
        outline109.append(this.mSize);
        throw new IndexOutOfBoundsException(outline109.toString());
    }

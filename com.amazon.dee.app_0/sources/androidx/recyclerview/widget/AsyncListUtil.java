...
public class AsyncListUtil<T> {
    ...
    private final ThreadUtil.MainThreadCallback<T> mMainThreadCallback = new ThreadUtil.MainThreadCallback<T>() { // from class: androidx.recyclerview.widget.AsyncListUtil.1
        ...
        public void addTile(int i, TileList.Tile<T> tile) {
            ...
            if (addOrReplace != null) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("duplicate tile @");
                outline107.append(addOrReplace.mStartPosition);
                Log.e(AsyncListUtil.TAG, outline107.toString());
    ...
    private final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback<T>() { // from class: androidx.recyclerview.widget.AsyncListUtil.2
        ...
        private void log(String str, Object... objArr) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("[BKGR] ");
            outline107.append(String.format(str, objArr));
            outline107.toString();
        }
    ...
    void log(String str, Object... objArr) {
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("[MAIN] ");
        outline107.append(String.format(str, objArr));
        outline107.toString();
    }

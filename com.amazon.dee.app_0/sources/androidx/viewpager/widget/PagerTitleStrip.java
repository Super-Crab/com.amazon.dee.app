...
public class PagerTitleStrip extends ViewGroup {
    ...
    public class PageListener extends DataSetObserver implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener {
        ...
        public void onChanged() {
            ...
            pagerTitleStrip.updateText(pagerTitleStrip.mPager.getCurrentItem(), PagerTitleStrip.this.mPager.mo10138getAdapter());
    ...
    protected void onAttachedToWindow() {
        ...
        if (parent instanceof ViewPager) {
            ...
            PagerAdapter mo10138getAdapter = viewPager.mo10138getAdapter();
            viewPager.setInternalPageChangeListener(this.mPageListener);
            viewPager.addOnAdapterChangeListener(this.mPageListener);
            this.mPager = viewPager;
            WeakReference<PagerAdapter> weakReference = this.mWatchingAdapter;
            updateAdapter(weakReference != null ? weakReference.get() : null, mo10138getAdapter);
            return;
        }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (viewPager != null) {
            updateAdapter(viewPager.mo10138getAdapter(), null);
    ...
    public void updateTextPositions(int i, float f, boolean z) {
        ...
        if (i != this.mLastKnownCurrentPage) {
            updateText(i, this.mPager.mo10138getAdapter());

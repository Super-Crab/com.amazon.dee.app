...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: androidx.core.widget.NestedScrollView.SavedState.1
            ...
            public SavedState[] mo136newArray(int i) {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("HorizontalScrollView.SavedState{");
            outline107.append(Integer.toHexString(System.identityHashCode(this)));
            outline107.append(" scrollPosition=");
            return GeneratedOutlineSupport1.outline86(outline107, this.scrollPosition, EntertainmentConstants.TCOMM_PAYLOAD_DESERIALIZED_CLOSE);
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Invalid pointerId=");
                    outline107.append(this.mActivePointerId);
                    outline107.append(" in onTouchEvent");

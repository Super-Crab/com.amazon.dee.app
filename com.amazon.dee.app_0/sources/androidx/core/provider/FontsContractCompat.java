...
public class FontsContractCompat {
    ...
    private static final SelfDestructiveThread sBackgroundThread = new SelfDestructiveThread(FontHelper.FONTS_PATH, 10, 10000);
    ...
    public static Typeface getFontSync(final Context context, final FontRequest fontRequest, @Nullable final ResourcesCompat.FontCallback fontCallback, @Nullable final Handler handler, boolean z, int i, final int i2) {
        final String str = fontRequest.getIdentifier() + ProcessIdUtil.DEFAULT_PROCESSID + i2;
        ...
        if (typeface != null) {
            ...
            Callable<TypefaceResult> callable = new Callable<TypefaceResult>() { // from class: androidx.core.provider.FontsContractCompat.1
                ...
                /* renamed from: call */
                public TypefaceResult mo130call() throws Exception {
    ...
    public static ProviderInfo getProvider(@NonNull PackageManager packageManager, @NonNull FontRequest fontRequest, @Nullable Resources resources) throws PackageManager.NameNotFoundException {
        ...
        if (resolveContentProvider != null) {
            ...
            StringBuilder outline115 = GeneratedOutlineSupport1.outline115("Found content provider ", providerAuthority, ", but package was not ");
            outline115.append(fontRequest.getProviderPackage());
            throw new PackageManager.NameNotFoundException(outline115.toString());
        }
        throw new PackageManager.NameNotFoundException(GeneratedOutlineSupport1.outline72("No package found for authority: ", providerAuthority));
    }

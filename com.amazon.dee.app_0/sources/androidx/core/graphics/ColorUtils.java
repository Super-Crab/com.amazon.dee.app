...
public final class ColorUtils {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, to = 95.047d) double d, @FloatRange(from = 0.0d, to = 100.0d) double d2, @FloatRange(from = 0.0d, to = 108.883d) double d3, @NonNull double[] dArr) {
        if (dArr.length == 3) {
            ...
            dArr[0] = Math.max((double) FrostVideoEffectController.VIDEO_STRENGTH_CLEAR, (116.0d * pivotXyzComponent2) - 16.0d);
    ...
    public static double calculateContrast(@ColorInt int i, @ColorInt int i2) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline32(i2, GeneratedOutlineSupport1.outline107("background can not be translucent: #")));
    }
    ...
    public static Color compositeColors(@NonNull Color color, @NonNull Color color2) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Color models must match (");
        outline107.append(color.getModel());
        outline107.append(" vs. ");
        outline107.append(color2.getModel());
        outline107.append(")");

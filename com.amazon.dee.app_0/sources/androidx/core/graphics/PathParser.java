    ...
    public static Path createPathFromPathData(String str) {
        ...
        if (createNodesFromPathData != null) {
            try {
                ...
                throw new RuntimeException(GeneratedOutlineSupport1.outline72("Error in parsing ", str), e);
            }
        }
        return null;
    }
    ...
    */
    ...
    private static float[] getFloats(String str) {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport1.outline75("error in parsing \"", str, EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED), e);
        }
    }
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d17 == FrostVideoEffectController.VIDEO_STRENGTH_CLEAR) {
                Log.w(PathParser.LOGTAG, " Points are coincident");
                return;
            }
            double d18 = (1.0d / d17) - 0.25d;
            if (d18 < FrostVideoEffectController.VIDEO_STRENGTH_CLEAR) {
            ...
            int i = (atan22 > FrostVideoEffectController.VIDEO_STRENGTH_CLEAR ? 1 : (atan22 == FrostVideoEffectController.VIDEO_STRENGTH_CLEAR ? 0 : -1));
            if (z2 != (i >= 0)) {

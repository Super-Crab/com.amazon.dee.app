...
public interface SupportMenuItem extends MenuItem {
    ...
    MenuItem mo87setActionView(int i);

    @Override // android.view.MenuItem
    /* renamed from: setActionView */
    MenuItem mo88setActionView(View view);
    ...
    SupportMenuItem mo89setContentDescription(CharSequence charSequence);
    ...
    MenuItem mo90setShowAsActionFlags(int i);

    SupportMenuItem setSupportActionProvider(ActionProvider actionProvider);

    @Override // android.view.MenuItem
    /* renamed from: setTooltipText */
    SupportMenuItem mo91setTooltipText(CharSequence charSequence);
}

...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        public Uri getStream(int i) {
            ...
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Stream items available: ");
            outline107.append(getStreamCount());
            outline107.append(" index requested: ");
            outline107.append(i);
    ...
    public static void configureMenuItem(MenuItem menuItem, IntentBuilder intentBuilder) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107(HISTORY_FILENAME_PREFIX);
        outline107.append(intentBuilder.getActivity().getClass().getName());
        shareActionProvider.setShareHistoryFileName(outline107.toString());
    ...
    public static void configureMenuItem(Menu menu, int i, IntentBuilder intentBuilder) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("Could not find menu item with id ", i, " in the supplied menu"));
    }
}

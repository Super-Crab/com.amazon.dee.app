...
public abstract class ActionProvider {
    ...
    public void setVisibilityListener(VisibilityListener visibilityListener) {
        if (this.mVisibilityListener != null && visibilityListener != null) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("setVisibilityListener: Setting a new ActionProvider.VisibilityListener when one is already set. Are you reusing this ");
            outline107.append(getClass().getSimpleName());
            outline107.append(" instance while it is still in use somewhere else?");

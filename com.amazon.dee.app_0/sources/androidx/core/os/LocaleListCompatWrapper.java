        ...
        for (int i = 0; i < localeArr.length; i++) {
            ...
            if (locale != null) {
                if (!hashSet.contains(locale)) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("list[", i, "] is a repetition"));
                }
            } else {
                throw new NullPointerException(GeneratedOutlineSupport1.outline52("list[", i, "] is null"));
            }
        }

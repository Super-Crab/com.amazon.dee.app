...
public class ShortcutInfoCompat {
    ...
    private PersistableBundle buildExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i < this.mPersons.length) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107(EXTRA_PERSON_);
                int i2 = i + 1;
                outline107.append(i2);
                persistableBundle.putPersistableBundle(outline107.toString(), this.mPersons[i].toPersistableBundle());
                i = i2;
            }
        }
    ...
    static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i2 < i) {
            ...
            personArr[i2] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(outline107.toString()));
            i2 = i3;
        }
        return personArr;
    }

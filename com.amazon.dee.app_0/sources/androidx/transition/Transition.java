...
public abstract class Transition implements Cloneable {
    ...
    private static int[] parseMatchOrder(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if ("id".equalsIgnoreCase(trim)) {
                ...
                throw new InflateException(GeneratedOutlineSupport1.outline75("Unknown match type in matchOrder: '", trim, "'"));
            }
            i++;
        }
        return iArr;
    ...
    public Transition mo208addListener(@NonNull TransitionListener transitionListener) {
    ...
    public Transition mo210addTarget(@NonNull View view) {
    ...
    public Transition mo214removeListener(@NonNull TransitionListener transitionListener) {
        ArrayList<TransitionListener> arrayList = this.mListeners;
        if (arrayList == null) {
            return this;
        }
    ...
    public Transition mo216removeTarget(@NonNull View view) {
    ...
    public Transition mo219setDuration(long j) {
        this.mDuration = j;
        return this;
    }
    ...
    public Transition mo220setInterpolator(@Nullable TimeInterpolator timeInterpolator) {
    ...
    public Transition mo221setSceneRoot(ViewGroup viewGroup) {
    ...
    public Transition mo222setStartDelay(long j) {
        this.mStartDelay = j;
        return this;
    }
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo209addTarget(@IdRes int i) {
        if (i != 0) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo215removeTarget(@IdRes int i) {
        if (i != 0) {
    ...
    public String toString(String str) {
        ...
        if (this.mDuration != -1) {
            sb = GeneratedOutlineSupport1.outline87(GeneratedOutlineSupport1.outline113(sb, "dur("), this.mDuration, ") ");
        }
        if (this.mStartDelay != -1) {
            sb = GeneratedOutlineSupport1.outline87(GeneratedOutlineSupport1.outline113(sb, "dly("), this.mStartDelay, ") ");
        }
        if (this.mInterpolator != null) {
            StringBuilder outline113 = GeneratedOutlineSupport1.outline113(sb, "interp(");
            outline113.append(this.mInterpolator);
            outline113.append(") ");
            sb = outline113.toString();
        }
        if (this.mTargetIds.size() > 0 || this.mTargets.size() > 0) {
            String outline72 = GeneratedOutlineSupport1.outline72(sb, "tgts(");
            if (this.mTargetIds.size() > 0) {
                String str2 = outline72;
                for (int i = 0; i < this.mTargetIds.size(); i++) {
                    if (i > 0) {
                        str2 = GeneratedOutlineSupport1.outline72(str2, ", ");
                    }
                    StringBuilder outline1072 = GeneratedOutlineSupport1.outline107(str2);
                    outline1072.append(this.mTargetIds.get(i));
            ...
            if (this.mTargets.size() > 0) {
                for (int i2 = 0; i2 < this.mTargets.size(); i2++) {
                    if (i2 > 0) {
                        outline72 = GeneratedOutlineSupport1.outline72(outline72, ", ");
                    }
                    StringBuilder outline1073 = GeneratedOutlineSupport1.outline107(outline72);
                    outline1073.append(this.mTargets.get(i2));
                    outline72 = outline1073.toString();
                }
            }
            return GeneratedOutlineSupport1.outline72(outline72, ")");
        }
        return sb;
    }
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo212addTarget(@NonNull String str) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo218removeTarget(@NonNull String str) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo217removeTarget(@NonNull Class cls) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo211addTarget(@NonNull Class cls) {
        if (this.mTargetTypes == null) {
    ...
    public Transition(Context context, AttributeSet attributeSet) {
        ...
        if (namedInt >= 0) {
            mo219setDuration(namedInt);
        }
        long namedInt2 = TypedArrayUtils.getNamedInt(obtainStyledAttributes, xmlResourceParser, "startDelay", 2, -1);
        if (namedInt2 > 0) {
            mo222setStartDelay(namedInt2);
        }
        int namedResourceId = TypedArrayUtils.getNamedResourceId(obtainStyledAttributes, xmlResourceParser, "interpolator", 0, 0);
        if (namedResourceId > 0) {
            mo220setInterpolator(AnimationUtils.loadInterpolator(context, namedResourceId));
        }

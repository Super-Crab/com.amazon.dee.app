...
public class TransitionManager {
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            this.mTransition.mo208addListener(new TransitionListenerAdapter() { // from class: androidx.transition.TransitionManager.MultiListener.1
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (!sPendingTransitions.contains(sceneRoot)) {
            ...
            Transition m207clone = transition.m207clone();
            m207clone.mo221setSceneRoot(sceneRoot);
            if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
                m207clone.setCanRemoveViews(true);
            }
            sceneChangeSetup(sceneRoot, m207clone);
            scene.enter();
            sceneChangeRunTransition(sceneRoot, m207clone);
        }
    }
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition m207clone = transition.m207clone();
        sceneChangeSetup(viewGroup, m207clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, m207clone);
    }

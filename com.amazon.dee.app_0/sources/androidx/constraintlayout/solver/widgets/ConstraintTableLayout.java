...
public class ConstraintTableLayout extends ConstraintWidgetContainer {
    ...
    public String getColumnsAlignmentRepresentation() {
        ...
        for (int i = 0; i < size; i++) {
            int i2 = this.mVerticalSlices.get(i).alignment;
            if (i2 == 1) {
                str = GeneratedOutlineSupport1.outline72(str, "L");
            } else if (i2 == 0) {
                str = GeneratedOutlineSupport1.outline72(str, "C");
            } else if (i2 == 3) {
                str = GeneratedOutlineSupport1.outline72(str, "F");
            } else if (i2 == 2) {
                str = GeneratedOutlineSupport1.outline72(str, "R");
            }
        }
        return str;
    }

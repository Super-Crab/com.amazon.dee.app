    ...
    public String toString() {
        if (this.state == 1) {
            if (this.resolvedTarget == this) {
                ...
                outline107.append(this.myAnchor);
                outline107.append(", RESOLVED: ");
                outline107.append(this.resolvedOffset);
                outline107.append("]  type: ");
                outline107.append(sType(this.type));
                return outline107.toString();
            }
            StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("[");
            outline1072.append(this.myAnchor);
            outline1072.append(", RESOLVED: ");
            outline1072.append(this.resolvedTarget);
            outline1072.append(":");
            outline1072.append(this.resolvedOffset);
            outline1072.append("] type: ");
            outline1072.append(sType(this.type));
            return outline1072.toString();
        }
        StringBuilder outline1073 = GeneratedOutlineSupport1.outline107("{ ");
        outline1073.append(this.myAnchor);
        outline1073.append(" UNRESOLVED} type: ");
        outline1073.append(sType(this.type));

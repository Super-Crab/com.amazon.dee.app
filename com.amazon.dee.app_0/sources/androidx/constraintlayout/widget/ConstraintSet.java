...
public class ConstraintSet {
                        ...
                        default:
                            switch (i2) {
                                ...
                                case 74:
                                    ...
                                    continue;
                                case 75:
                                    StringBuilder outline107 = GeneratedOutlineSupport1.outline107("unused attribute 0x");
                                    outline107.append(Integer.toHexString(index));
                                    outline107.append("   ");
                                    outline107.append(mapToConstant.get(index));
                                    Log.w(TAG, outline107.toString());
                                    continue;
                                default:
                                    StringBuilder outline1072 = GeneratedOutlineSupport1.outline107("Unknown attribute 0x");
                                    outline1072.append(Integer.toHexString(index));
                                    outline1072.append("   ");
                                    outline1072.append(mapToConstant.get(index));
        ...
        switch (i2) {
            case 1:
                if (i4 == 1) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("Left to "), sideToString(i4), " undefined"));
                }
            ...
            case 2:
                if (i4 == 1) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("right to "), sideToString(i4), " undefined"));
                }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(GeneratedOutlineSupport1.outline91(sb, sideToString(i4), " unknown"));
        }
    }
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            this.mConstraints.put(num, constraintSet.mConstraints.get(num).m119clone());
        }
    }
    ...
    public void clone(ConstraintLayout constraintLayout) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (id != -1) {
                ...
                if (pivotX != FrostVideoEffectController.VIDEO_STRENGTH_CLEAR || pivotY != FrostVideoEffectController.VIDEO_STRENGTH_CLEAR) {

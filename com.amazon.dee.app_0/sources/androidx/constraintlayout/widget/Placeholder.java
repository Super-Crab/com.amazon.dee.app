...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.getTextBounds(WebConstants.UriConstants.QUESTIONMARK_KEY, 0, 1, rect);
            canvas.drawText(WebConstants.UriConstants.QUESTIONMARK_KEY, ((width / 2.0f) - (rect.width() / 2.0f)) - rect.left, ((rect.height() / 2.0f) + (height / 2.0f)) - rect.bottom, paint);
        }
    }

...
class TtsSpeechMarksEmitter implements ITtsSpeechMarksEmitter {
    ...
    @Override // amazon.speech.tts.ITtsSpeechMarksEmitter
    ...
    void doScheduleSpeechMark(final String str) {
        ...
        Runnable runnable = new Runnable() { // from class: amazon.speech.tts.TtsSpeechMarksEmitter.2
    ...
    public synchronized void scheduleSpeechMark(String str) {
        if (this.mTtsSpeechMarksListener != null) {
    ...
    TtsSpeechMarksEmitter(TtsSpeechMarksListener ttsSpeechMarksListener, HandlerWrapper handlerWrapper, Context context, SpeechMarkBroadcaster speechMarkBroadcaster) {
        ...
        this.mCurrentTimeProvider = new ICurrentTimeProvider() { // from class: amazon.speech.tts.TtsSpeechMarksEmitter.1
            @Override // amazon.speech.tts.TtsSpeechMarksEmitter.ICurrentTimeProvider

...
public interface PortletRequest {
    ...
    public enum P3PUserInfos {
        ...
        public static P3PUserInfos[] valuesCustom() {
            P3PUserInfos[] valuesCustom = values();
            int length = valuesCustom.length;
            P3PUserInfos[] p3PUserInfosArr = new P3PUserInfos[length];
            System.arraycopy(valuesCustom, 0, p3PUserInfosArr, 0, length);
            return p3PUserInfosArr;
        }

...
public final class Platform {
    ...
    public static final <R> R m12583synchronized(@NotNull Object lock, @NotNull Function0<? extends R> block) {
        R mo12560invoke;
        Intrinsics.checkParameterIsNotNull(lock, "lock");
        Intrinsics.checkParameterIsNotNull(block, "block");
        synchronized (lock) {
            try {
                mo12560invoke = block.mo12560invoke();

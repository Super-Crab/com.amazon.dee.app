...
public class AsyncTimeout extends Timeout {
    ...
    public final Sink sink(@NotNull final Sink sink) {
        ...
        return new Sink() { // from class: okio.AsyncTimeout$sink$1
            ...
            public String toString() {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("AsyncTimeout.sink(");
                outline107.append(sink);
                outline107.append(')');
            ...
            public AsyncTimeout mo12584timeout() {
    ...
    public final Source source(@NotNull final Source source) {
        ...
        return new Source() { // from class: okio.AsyncTimeout$source$1
            ...
            @NotNull
            public String toString() {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("AsyncTimeout.source(");
            ...
            @NotNull
            /* renamed from: timeout */
            public AsyncTimeout mo12585timeout() {
                return AsyncTimeout.this;
            }
        };
    }

...
public class Timeout {
    ...
    public final Timeout deadline(long j, @NotNull TimeUnit unit) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline56("duration <= 0: ", j).toString());
    }
    ...
    public Timeout timeout(long j, @NotNull TimeUnit unit) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline56("timeout < 0: ", j).toString());
    }

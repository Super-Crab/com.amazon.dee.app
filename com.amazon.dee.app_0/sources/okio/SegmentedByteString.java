...
public final class SegmentedByteString extends ByteString {
    ...
    public ByteString substring(int i, int i2) {
        ...
        if (i >= 0) {
            if (!(i2 <= size())) {
                StringBuilder outline109 = GeneratedOutlineSupport1.outline109("endIndex=", i2, " > length(");
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline53("endIndex=", i2, " < beginIndex=", i).toString());
        }
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline52("beginIndex=", i, " < 0").toString());
    }

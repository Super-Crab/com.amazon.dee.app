...
public abstract class ParameterHandler<T> {
                ...
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        if (value != null) {
                            ...
                            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("Field map contained null value for key '", key, "'."));
                        }
                    } else {
                ...
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        if (value != null) {
                            ...
                            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("Header map contained null value for key '", key, "'."));
                        }
                    } else {
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        T value = entry.getValue();
                        if (value != null) {
                            requestBuilder.addPart(Headers.of("Content-Disposition", GeneratedOutlineSupport1.outline75("form-data; name=\"", key, EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED), "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
                        } else {
                            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("Part map contained null value for key '", key, "'."));
                        }
                    } else {
    ...
    public static final class Path<T> extends ParameterHandler<T> {
        ...
        void apply(RequestBuilder requestBuilder, @Nullable T t) throws IOException {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline91(GeneratedOutlineSupport1.outline107("Path parameter \""), this.name, "\" value must not be null."));
        }
    }
                ...
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        if (value != null) {
                            ...
                            throw new IllegalArgumentException(GeneratedOutlineSupport1.outline75("Query map contained null value for key '", key, "'."));
                        }
                    } else {

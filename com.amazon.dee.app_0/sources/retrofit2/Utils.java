...
public final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return GeneratedOutlineSupport1.outline91(new StringBuilder(), Utils.typeToString(this.componentType), "[]");
        }
    }
    ...
    public static final class WildcardTypeImpl implements WildcardType {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                ...
                outline107.append(Utils.typeToString(this.lowerBound));
                ...
                outline1072.append(Utils.typeToString(this.upperBound));
    ...
    public static Type getParameterUpperBound(int i, ParameterizedType parameterizedType) {
        ...
        StringBuilder outline109 = GeneratedOutlineSupport1.outline109("Index ", i, " not in range [0,");
        outline109.append(actualTypeArguments.length);
        outline109.append(") for ");
        outline109.append(parameterizedType);
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i, String str, Object... objArr) {
        StringBuilder outline113 = GeneratedOutlineSupport1.outline113(str, " (parameter #");
        outline113.append(i + 1);
        outline113.append(")");
        return methodError(method, th, outline113.toString(), objArr);
    }
    ...
    */
    ...
    public static RuntimeException methodError(Method method, @Nullable Throwable th, String str, Object... objArr) {
        StringBuilder outline113 = GeneratedOutlineSupport1.outline113(String.format(str, objArr), "\n    for method ");
        outline113.append(method.getDeclaringClass().getSimpleName());
        outline113.append(".");
        outline113.append(method.getName());
        return new IllegalArgumentException(outline113.toString(), th);
    }
    ...
    public static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        ...
        outline113.append(i + 1);
        outline113.append(")");
        return methodError(method, outline113.toString(), objArr);
    }
}

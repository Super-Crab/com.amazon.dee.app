...
public final class RequestFactory {
    ...
    public static final class Builder {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            if (annotation instanceof DELETE) {
                parseHttpMethodAndPath(Constants.REQUEST_METHOD_DELETE, ((DELETE) annotation).value(), false);
                ...
                parseHttpMethodAndPath(SmartDeviceDataProvider.METHOD_HTTP_PUT, ((PUT) annotation).value(), true);
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (this.isMultipart) {
                    ...
                    Headers of = Headers.of("Content-Disposition", GeneratedOutlineSupport1.outline75("form-data; name=\"", value5, EntertainmentConstants.PLAYER_INFO_JSON_ATTRIBUTE_PLAYER_INFO_PAYLOAD_DESERIALIZED), "Content-Transfer-Encoding", part.encoding());
                    if (Iterable.class.isAssignableFrom(rawType8)) {
                        if (type instanceof ParameterizedType) {
    ...
    public Request create(Object[] objArr) throws IOException {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport1.outline86(GeneratedOutlineSupport1.outline109("Argument count (", length, ") doesn't match expected count ("), parameterHandlerArr.length, ")"));
    }
}

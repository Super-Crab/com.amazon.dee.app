...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public Interceptor.Chain withConnectTimeout(int i, @NotNull TimeUnit unit) {
        ...
        return new RealInterceptorChain(this.interceptors, this.transmitter, this.exchange, this.index, this.request, this.call, Util.checkDuration("timeout", i, unit), this.readTimeout, this.writeTimeout);
    }
    ...
    public Interceptor.Chain withReadTimeout(int i, @NotNull TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return new RealInterceptorChain(this.interceptors, this.transmitter, this.exchange, this.index, this.request, this.call, this.connectTimeout, Util.checkDuration("timeout", i, unit), this.writeTimeout);
    }
    ...
    public Interceptor.Chain withWriteTimeout(int i, @NotNull TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return new RealInterceptorChain(this.interceptors, this.transmitter, this.exchange, this.index, this.request, this.call, this.connectTimeout, this.readTimeout, Util.checkDuration("timeout", i, unit));
    }
    ...
    */
    public final okhttp3.Response proceed(@org.jetbrains.annotations.NotNull okhttp3.Request r17, @org.jetbrains.annotations.NotNull okhttp3.internal.connection.Transmitter r18, @org.jetbrains.annotations.Nullable okhttp3.internal.connection.Exchange r19) throws java.io.IOException {
        /*

                ...
                while (true) {
                    ...
                    if (awaitTaskToRun != null) {
                        ...
                        if (isLoggable) {
                            ...
                            TaskLoggerKt.access$log(awaitTaskToRun, queue$okhttp, PlaybackStates.STARTING);
                        }
                        try {
                            ...
                            if (isLoggable) {
                                ...
                                outline107.append(TaskLoggerKt.formatDuration(nanoTime));
                                TaskLoggerKt.access$log(awaitTaskToRun, queue$okhttp, outline107.toString());
                            }
                        } catch (Throwable th) {
                            if (isLoggable) {
                                ...
                                outline1072.append(TaskLoggerKt.formatDuration(nanoTime2));
                                TaskLoggerKt.access$log(awaitTaskToRun, queue$okhttp, outline1072.toString());
                            }
                            throw th;
                        }
                    } else {

...
public final class ConnectionSpecSelector {
    ...
    public final ConnectionSpec configureSecureSocket(@NotNull SSLSocket sslSocket) throws IOException {
        ...
        if (connectionSpec == null) {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unable to find acceptable protocols. isFallback=");
            outline107.append(this.isFallback);
            outline107.append(JsonReaderKt.COMMA);
            outline107.append(" modes=");
            outline107.append(this.connectionSpecs);
            outline107.append(JsonReaderKt.COMMA);
            outline107.append(" supported protocols=");
            ...
            throw new UnknownServiceException(outline107.toString());
        }

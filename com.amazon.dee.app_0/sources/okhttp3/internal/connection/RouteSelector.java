...
public final class RouteSelector {
    ...
    private final Proxy nextProxy() throws IOException {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("No route to ");
        outline107.append(this.address.url().host());
        outline107.append("; exhausted proxy configurations: ");
        outline107.append(this.proxies);
        throw new SocketException(outline107.toString());
    }
    ...
    private final void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (proxy.type() != Proxy.Type.DIRECT && proxy.type() != Proxy.Type.SOCKS) {
            ...
            if (address instanceof InetSocketAddress) {
                ...
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Proxy.address() is not an InetSocketAddress: ");
                outline107.append(address.getClass());

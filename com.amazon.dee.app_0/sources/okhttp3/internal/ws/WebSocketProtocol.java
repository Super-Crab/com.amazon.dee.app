...
public final class WebSocketProtocol {
    ...
    public final String closeCodeExceptionMessage(int i) {
        if (i < 1000 || i >= 5000) {
            return GeneratedOutlineSupport1.outline49("Code must be in range [1000,5000): ", i);
        }
        if ((1004 <= i && 1006 >= i) || (1015 <= i && 2999 >= i)) {
            return GeneratedOutlineSupport1.outline52("Code ", i, " is reserved and may not be used.");
        }
        return null;
    }

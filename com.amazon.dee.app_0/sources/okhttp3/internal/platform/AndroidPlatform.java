...
public final class AndroidPlatform extends Platform {
    ...
    public static final class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public String toString() {
            StringBuilder outline107 = GeneratedOutlineSupport1.outline107("CustomTrustRootIndex(trustManager=");
            outline107.append(this.trustManager);
            outline107.append(", findByIssuerAndSignatureMethod=");
            outline107.append(this.findByIssuerAndSignatureMethod);
            outline107.append(")");
    ...
    static {
        ...
        if (isAndroid) {
            ...
            if (1 == 0) {
                StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Expected Android API level 21+ but was ");

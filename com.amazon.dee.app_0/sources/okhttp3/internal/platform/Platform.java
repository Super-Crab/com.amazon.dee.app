...
public class Platform {
    ...
    /* compiled from: Platform.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001a\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u00110\u00102\f\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00130\u0010J\u0014\u0010\u0014\u001a\u00020\u00152\f\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00130\u0010J\b\u0010\u0016\u001a\u00020\u000eH\u0002J\b\u0010\u0017\u001a\u00020\u000eH\u0007J\u0010\u0010\u0018\u001a\u00020\u00192\b\b\u0002\u0010\r\u001a\u00020\u000eR\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\u00020\u00078BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u0006\u0010\bR\u0014\u0010\t\u001a\u00020\u00078BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\t\u0010\bR\u0016\u0010\n\u001a\n \f*\u0004\u0018\u00010\u000b0\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000eX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u001a"}, d2 = {"Lokhttp3/internal/platform/Platform$Companion;", "", "()V", WavDirectory.LIST_INFO, "", DriveModeVoxUiConstants.WARN, "isConscryptPreferred", "", "()Z", "isOpenJSSEPreferred", "logger", "Ljava/util/logging/Logger;", "kotlin.jvm.PlatformType", MetricsConfiguration.PLATFORM, "Lokhttp3/internal/platform/Platform;", "alpnProtocolNames", "", "", "protocols", "Lokhttp3/Protocol;", "concatLengthPrefixed", "", "findPlatform", MetricsConstants.Method.CACHE_GET, "resetForTests", "", "okhttp"}, k = 1, mv = {1, 1, 16})
    /* loaded from: classes4.dex */
    public static final class Companion {
        ...
        public final Platform findPlatform() {
            ...
            Platform buildIfSupported3 = Android10Platform.Companion.buildIfSupported();
            if (buildIfSupported3 != null) {
                return buildIfSupported3;
            }
            Platform buildIfSupported4 = AndroidPlatform.Companion.buildIfSupported();
            ...
            Jdk9Platform buildIfSupported5 = Jdk9Platform.Companion.buildIfSupported();
            if (buildIfSupported5 != null) {
                return buildIfSupported5;
            }
            Platform buildIfSupported6 = Jdk8WithJettyBootPlatform.Companion.buildIfSupported();
            return buildIfSupported6 != null ? buildIfSupported6 : new Platform();
        }
        ...
        public final byte[] concatLengthPrefixed(@NotNull List<? extends Protocol> protocols) {
            ...
            for (String str : alpnProtocolNames(protocols)) {
                buffer.mo12596writeByte(str.length());
                buffer.mo12607writeUtf8(str);
            }
    ...
    public void logCloseableLeak(@NotNull String message, @Nullable Object obj) {
        Intrinsics.checkParameterIsNotNull(message, "message");
        if (obj == null) {
            message = GeneratedOutlineSupport1.outline72(message, " To see where this was allocated, set the OkHttpClient logger level to FINE: Logger.getLogger(OkHttpClient.class.getName()).setLevel(Level.FINE);");
        }
    ...
    public final CertificateChainCleaner buildCertificateChainCleaner(@NotNull SSLSocketFactory sslSocketFactory) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("Unable to extract the trust manager on ");
        outline107.append(Companion.get());
        outline107.append(", ");
        outline107.append("sslSocketFactory is ");
        outline107.append(sslSocketFactory.getClass());

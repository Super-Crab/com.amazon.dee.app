...
public final class FormBody extends RequestBody {
    ...
    private final long writeOrCountBytes(BufferedSink bufferedSink, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            if (i > 0) {
                buffer.mo12596writeByte(38);
            }
            buffer.mo12607writeUtf8(this.encodedNames.get(i));
            buffer.mo12596writeByte(61);
            buffer.mo12607writeUtf8(this.encodedValues.get(i));
        }
        if (z) {
    ...
    public final int m12462deprecated_size() {
        return size();
    }
    ...
    /* compiled from: FormBody.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0013\b\u0007\u0012\n\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004J\u0016\u0010\t\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u00072\u0006\u0010\u000b\u001a\u00020\u0007J\u0016\u0010\f\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u00072\u0006\u0010\u000b\u001a\u00020\u0007J\u0006\u0010\r\u001a\u00020\u000eR\u0010\u0010\u0002\u001a\u0004\u0018\u00010\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"Lokhttp3/FormBody$Builder;", "", HttpAuthHeader.Parameters.Charset, "Ljava/nio/charset/Charset;", "(Ljava/nio/charset/Charset;)V", "names", "", "", "values", BulkOperationType.add, "name", "value", "addEncoded", JsonPOJOBuilder.DEFAULT_BUILD_METHOD, "Lokhttp3/FormBody;", "okhttp"}, k = 1, mv = {1, 1, 16})
    /* loaded from: classes4.dex */

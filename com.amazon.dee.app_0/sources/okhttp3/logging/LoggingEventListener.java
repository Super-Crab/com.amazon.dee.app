...
public final class LoggingEventListener extends EventListener {
    ...
    private final void logWithTime(String str) {
        ...
        logger.log(JsonReaderKt.BEGIN_LIST + millis + " ms] " + str);
    }
    ...
    public void callStart(@NotNull Call call) {
        ...
        StringBuilder outline107 = GeneratedOutlineSupport1.outline107("callStart: ");
        outline107.append(call.request());
        logWithTime(outline107.toString());
    }
    ...
    public void connectFailed(@NotNull Call call, @NotNull InetSocketAddress inetSocketAddress, @NotNull Proxy proxy, @Nullable Protocol protocol, @NotNull IOException ioe) {
        ...
        Intrinsics.checkParameterIsNotNull(proxy, "proxy");
        Intrinsics.checkParameterIsNotNull(ioe, "ioe");
        logWithTime("connectFailed: " + protocol + Chars.SPACE + ioe);
    }
    ...
    public void connectStart(@NotNull Call call, @NotNull InetSocketAddress inetSocketAddress, @NotNull Proxy proxy) {
        ...
        Intrinsics.checkParameterIsNotNull(inetSocketAddress, "inetSocketAddress");
        Intrinsics.checkParameterIsNotNull(proxy, "proxy");
        logWithTime("connectStart: " + inetSocketAddress + Chars.SPACE + proxy);
    }

...
public class Assert {
    ...
    public static void assertNull(Object obj) {
        if (obj != null) {
            ...
            assertNull(outline107.toString(), obj);
        }
    }
    ...
    public static String format(String str, Object obj, Object obj2) {
        String outline72 = (str == null || str.length() <= 0) ? "" : GeneratedOutlineSupport1.outline72(str, " ");
        return outline72 + "expected:<" + obj + "> but was:<" + obj2 + Config.Compare.GREATER_THAN;
    }
